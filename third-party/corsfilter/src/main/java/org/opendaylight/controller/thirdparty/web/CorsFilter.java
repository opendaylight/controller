 ...
 */
package org.opendaylight.controller.thirdparty.corsfilter;
...
@WebFilter(
  ...
  initParams={
    ...
    @WebInitParam(name="cors.allowed.methods", value="GET,POST,HEAD,OPTIONS,PUT,DELETE"),
    @WebInitParam(name="cors.allowed.headers", value="Content-Type,X-Requested-With,accept,authorization, origin,Origin,Access-Control-Request-Method,Access-Control-Request-Headers"),
