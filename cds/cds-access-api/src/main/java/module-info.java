 ...
 */
/**
 * Clustered Datastore (CDS) frontend API for accessing a backend implementation.
 */
module org.opendaylight.controller.cluster.access.api {
    ...
    requires transitive org.opendaylight.controller.model.cds.types;
