...
abstract sealed class JournalSegmentWriter<E> implements JournalWriter<E>
    ...
    JournalSegmentWriter(final FileChannel channel, final long firstIndex, final int maxSegmentSize,
            final int maxEntrySize, final JournalIndex index, final JournalSerdes namespace) {
