...
public final class SegmentedJournal<E> implements Journal<E> {
    ...
    private final SegmentedByteBufJournal byteJournal;
    private final SegmentedJournalWriter<E> writer;
    private final ByteBufMapper<E> mapper;

    public SegmentedJournal(final SegmentedByteBufJournal byteJournal, final ByteBufMapper<E> mapper) {
        ...
        writer = new SegmentedJournalWriter<>(byteJournal.writer(), mapper);
    }
    ...
    public JournalReader<E> openReader(final long index, final JournalReader.Mode mode) {
        final var byteReader = switch (mode) {
            case ALL -> byteJournal.openReader(index);
            case COMMITS -> byteJournal.openCommitsReader(index);
        };
