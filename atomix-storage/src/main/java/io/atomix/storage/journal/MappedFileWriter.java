...
final class MappedFileWriter extends FileWriter {
    ...
    MappedFileWriter(final Path path, final FileChannel channel, final int maxSegmentSize) {
        super(path, channel, maxSegmentSize);
    ...
    DiskFileWriter toDisk() {
        return new DiskFileWriter(null, null, 0, 0);
    }
