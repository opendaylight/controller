...
public final class SegmentedByteJournal implements ByteJournal {
    ...
    private final @NonNull ByteJournalWriter writer;
    ...
    @Override
    public ByteJournalReader openReader(final long index) {
        return openReader(index, SegmentedByteJournalReader::new);
    }

    @NonNullByDefault
    private ByteJournalReader openReader(final long index,
            final BiFunction<SegmentedByteJournal, JournalSegment, ByteJournalReader> constructor) {
    ...
    @Override
    public ByteJournalReader openCommitsReader(final long index) {
        return openReader(index, SegmentedByteJournalReader.Commits::new);
    }
