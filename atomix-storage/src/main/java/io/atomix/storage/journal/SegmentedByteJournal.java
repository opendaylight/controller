...
public final class SegmentedByteJournal implements ByteJournal {
    ...
    public SegmentedByteJournal(final String name, final StorageLevel storageLevel, final File directory,
            final int maxSegmentSize, final int maxEntrySize, final int maxEntriesPerSegment,
            final double indexDensity, boolean flushOnCommit) {
    ...
    @Override
    public ByteJournalReader newReader(long index) {
     ...
     */
    @Override
    public ByteJournalReader newReader(long index, JournalReader.Mode mode) {
     ...
     */
    JournalSegment nextSegment(long index) {
    ...
    protected Collection<JournalSegment> loadSegments() {
        ...
        final var segmentsMap = new TreeMap<>();
        ...
        Iterator<Map.Entry<Long, JournalSegment>> iterator = segmentsMap.entrySet().iterator();
    ...
    public static final class Builder {
         ...
         */
        public SegmentedByteJournal<E> build() {
            return new SegmentedByteJournal<>(
                name,
                storageLevel,
                directory,
                namespace,
