...
public final class BufThenFileOutputStream extends OutputStream {
     ...
     * Default constructor.
     *
     * @param directory the directory where to create temporary files
     * @param buf the output buffer
     * @param threshold the cutover threshold
     */
    public BufThenFileOutputStream(final Path directory, final ByteBuf buf, final int threshold) {
     ...
     *
     * @return the file, or {@code null} if the output is below threshold
     */
    public @Nullable TransientFile file() {
