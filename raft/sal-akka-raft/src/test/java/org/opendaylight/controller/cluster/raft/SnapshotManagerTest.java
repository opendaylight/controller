...
//    }
    ...
    public void testPersistSendInstallSnapshot() throws Exception {
        ...
        verify(mockDataPersistenceProvider).saveSnapshotForInstall(snapshotCaptor.capture(),
            callbackCaptor.capture());

        final var baos = new ByteArrayOutputStream();
        snapshotCaptor.getValue().writeTo(baos);
        callbackCaptor.getValue().accept((PlainSnapshotSource) () -> new ByteArrayInputStream(baos.toByteArray()),
            null);
