...
class ToStoreEntryMapperTest {
    ...
    static void beforeAll() {
        // Common assertion
        assertEquals(18, ToStoreEntryMapperV1.THRESHOLD_MIN);
    }
    ...
    private static List<Arguments> rejectedThreshold() {
        return List.of(arguments(Integer.MIN_VALUE), arguments(-1), arguments(0), arguments(17));
    }
    ...
    private static List<Arguments> acceptedThreshold() {
        return List.of(arguments(18), arguments(Integer.MAX_VALUE));
    }
}
