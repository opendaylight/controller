...
class ToStoreEntryMapperTest {
    ...
    static void beforeAll() {
        // Common assertion
        assertEquals(40, ToStoreEntryMapper.THRESHOLD_MIN);
    }
    ...
    void rejectedThreshold(final int threshold) {
        final var ex = assertThrows(IllegalArgumentException.class,
            () -> new ToStoreEntryMapper("", tempDir, threshold, CompressionType.NONE));
    ...
    void acceptedThreshold(final int threshold) {
        assertDoesNotThrow(() -> new ToStoreEntryMapper("", tempDir, threshold, CompressionType.NONE));
    }
