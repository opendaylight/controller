...
public interface SnapshotStore {
    ...
    /**
     * Saves a snapshot synchronously.
     *
     * @param <T> the type of {@link StateSnapshot}
     * @param raftSnapshot the {@link RaftSnapshot}
     * @param lastIncluded last included index/term
     ...
     */
    <T extends StateSnapshot> Instant saveSnapshot(RaftSnapshot raftSnapshot, EntryInfo lastIncluded, T snapshot,
        StateSnapshot.Writer<T> writer) throws IOException;
