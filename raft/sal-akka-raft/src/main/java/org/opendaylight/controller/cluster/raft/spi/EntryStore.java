 ...
 * (via {@link PersistCallback}s), or defined to terminate the actor on failure.
 */
@NonNullByDefault
public interface EntryStore {
     ...
     */
    // FIXME: remove in favor of RaftCallback<Long> reporting body entry, or perhaps overall journal size inculding
    //        the entry
