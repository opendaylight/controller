 ...
 */
abstract sealed class AbstractRecovery<T extends @NonNull State> permits JournalRecovery, PekkoRecovery {
    final RaftActor actor;
    final RaftActorSnapshotCohort<T> snapshotCohort;
    final RaftActorRecoveryCohort recoveryCohort;
    ...
    @NonNullByDefault
    AbstractRecovery(final RaftActor actor, final RaftActorSnapshotCohort<T> snapshotCohort,
