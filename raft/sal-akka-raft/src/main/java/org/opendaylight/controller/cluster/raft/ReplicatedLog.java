...
public interface ReplicatedLog {
     ...
     *   <li>{@code snapshotEntry is set to EntryInfo.of{commitIndex, -1)}</li>
    ...
    interface Recovery {
         ...
         *       relationship, for purposes of {@link #applyEntry(LogEntry)} and {@link #recoverEntry(LogEntry)}.
         *       The entries reported by those methods have a linear relationship to the values set here</li>
         ...
         * <p>
         *
         * <p>The implication of this method is that the first entry reported by {@link #recoverEntry(LogEntry)} has:
         * <ul>
         *   <li>{@code index == lastIncluded.index() + 1}</li>
         *   <li>{@cide term >= lastIncluded.term()}</li>
