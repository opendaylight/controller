...
public final class SnapshotManager {
     ...
     */
    @NonNullByDefault
    private record Capture(CaptureSnapshot request) implements Task {
        Capture {
     ...
     */
    @NonNullByDefault
    private record PersistApply(Snapshot snapshot, ApplyLeaderSnapshot.@Nullable Callback callback) implements Persist {
        PersistApply {
            requireNonNull(snapshot);
        }
    }
     ...
     */
    private record PersistCapture(CaptureSnapshot request) implements Persist {
        PersistCapture {
            requireNonNull(request);
        }
    }
