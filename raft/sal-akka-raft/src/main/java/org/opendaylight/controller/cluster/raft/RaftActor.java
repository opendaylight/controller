...
public abstract class RaftActor extends AbstractUntypedPersistentActor {
    ...
    protected void handleRecover(final Object message) throws Exception {
        ...
        if (recoveredLog != null) {
            ...
            pekkoRecovery = null;
            applyRecoveredLog(recoveredLog);
    ...
    @VisibleForTesting
    protected void applyRecoveredLog(final ReplicatedLog recoveredLog) {
    ...
    private @NonNull Snapshot getSnapshot() {
        ...
        if (isRecoveryApplicable()) {
            final var replLog = replicatedLog();
            final var captureSnapshot = replLog.startCapture(replLog.lastMeta(), -1, true, hasFollowers());
