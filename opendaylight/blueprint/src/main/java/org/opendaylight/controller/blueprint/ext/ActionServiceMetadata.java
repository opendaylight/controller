 ...
 * @author Robert Varga
 */
final class ActionServiceMetadata extends AbstractInvokableService {
    /*
     * Implementation note:
     *
    ...
    @Override
    boolean acceptableStrategy(final RpcRoutingStrategy strategy) {
        // FIXME: BUG-7608: action-service is a no-op for now
        // return strategy.isContextBasedRouted();
        return false;
    }
}
