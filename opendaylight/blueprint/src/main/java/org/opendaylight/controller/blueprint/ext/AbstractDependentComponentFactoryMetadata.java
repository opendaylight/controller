...
abstract class AbstractDependentComponentFactoryMetadata implements DependentComponentFactoryMetadata {
    ...
    protected void setDependendencyDesc(final String dependendencyDesc) {
    ...
    protected void retrieveService(final String name, final Class<?> interfaceClass, final Consumer<Object> onServiceRetrieved) {
        retrieveService(name, interfaceClass.getName(), onServiceRetrieved);
    }

    protected void retrieveService(final String name, final String interfaceName, final Consumer<Object> onServiceRetrieved) {
