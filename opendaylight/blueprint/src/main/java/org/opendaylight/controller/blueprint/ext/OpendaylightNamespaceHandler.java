...
public class OpendaylightNamespaceHandler implements NamespaceHandler {
    ...
    static final String ROUTED_RPC_REG_CONVERTER_NAME = "org.opendaylight.RoutedRpcRegConverter";
    ...
    public Metadata parse(Element element, ParserContext context) {
        ...
        } else if (nodeNameEquals(element, RpcImplementationBean.RPC_IMPLEMENTATION)) {
