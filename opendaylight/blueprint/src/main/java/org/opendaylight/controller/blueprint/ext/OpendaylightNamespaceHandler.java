...
public class OpendaylightNamespaceHandler implements NamespaceHandler {
    ...
    public Metadata parse(Element element, ParserContext context) {
        ...
        if (nodeNameEquals(element, RESTART_DEPENDENTS)) {
            return parseRestartDependentsOnUpdates(element, context);
        }
...
//        }
    ...
    private static Metadata parseRestartDependentsOnUpdates(Element element, ParserContext context) {
        ...
        metadata.setRuntimeClass(RestartDependentsOnUpdates.class);
