...
import java.net.URL;
import org.opendaylight.controller.blueprint.ext.DataStoreAppConfigMetadata.BindingContext;
 ...
 */
public class DataStoreAppConfigDefaultXMLReader {
    ...
    private final org.opendaylight.controller.blueprint.ext.DataStoreAppConfigMetadata.BindingContext bindingContext;
    ...
    // TODO public <T extends DataObject> read(Class<T> dataObjectClass, String pathToXMLFileResourceOnClasspath) {

    public DataObject createDefaultInstance(FallbackConfigProvider fallback) throws ConfigXMLReaderException {
