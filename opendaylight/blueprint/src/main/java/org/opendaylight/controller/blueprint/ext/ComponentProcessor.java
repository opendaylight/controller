...
public class ComponentProcessor implements ComponentDefinitionRegistryProcessor {
    ...
    private boolean restartDependentsOnUpdate;
    ...
    public void setRestartDependentsOnUpdate(boolean restartDependentsOnUpdate) {
        this.restartDependentsOnUpdate = restartDependentsOnUpdate;
    }
    ...
    private void processBeanMetadata(MutableBeanMetadata bean) {
        if(restartDependentsOnUpdate && bean.getRuntimeClass() != null &&
            ...
            LOG.debug("{}: processMutableBeanMetadata: {}, runtime {}", logName(), bean.getId(),
