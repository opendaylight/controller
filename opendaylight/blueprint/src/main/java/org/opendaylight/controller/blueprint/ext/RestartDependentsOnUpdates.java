 ...
 */
public class RestartDependentsOnUpdates implements ComponentDefinitionRegistryProcessor {
    private static final Logger LOG = LoggerFactory.getLogger(RestartDependentsOnUpdates.class);
    ...
    private void processMutableBeanMetadata(MutableBeanMetadata bean) {
        if(bean.getRuntimeClass() != null && AbstractPropertyPlaceholder.class.isAssignableFrom(
