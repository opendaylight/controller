...
public class Device implements IDevice {
    ...
    public Device(DeviceManagerImpl deviceManager,
        ...
        this.macAddressString =
                HexEncode.longToHexString(entity.getMacAddress());
    ...
    public Device(DeviceManagerImpl deviceManager,
        ...
        this.macAddressString =
                HexEncode.longToHexString(this.entities[0].getMacAddress());
        this.entityClass = entityClass;
        Arrays.sort(this.entities);
        vlanIds = computeVlandIds();
    }
    ...
    protected boolean updateAttachmentPoint(NodeConnector port, long lastSeen){
        ...
        if (!deviceManager.isValidAttachmentPoint(port)) return false;
