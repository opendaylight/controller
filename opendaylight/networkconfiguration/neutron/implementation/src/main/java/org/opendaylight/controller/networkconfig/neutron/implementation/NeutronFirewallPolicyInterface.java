...
public class NeutronFirewallPolicyInterface implements INeutronFirewallPolicyCRUD, IConfigurationContainerAware, IObjectReader {
    ...
    private void allocateCache() {
        ...
        try {
            // neutron caches
            this.clusterContainerService.createCache("neutronFirewallPolicys",
    ...
    private void retrieveCache() {
        ...
        firewallPolicyDB = (ConcurrentMap<String, NeutronFirewallPolicy>) clusterContainerService
                .getCache("neutronFirewallPolicys");
    ...
    private void destroyCache() {
        ...
        clusterContainerService.destroyCache("neutronFirewallPolicys");
    }
    ...
    @Override
    public List<NeutronFirewallPolicy> getAllNeutronFirewallPolicys() {
        Set<NeutronFirewallPolicy> allFirewallPolicys = new HashSet<NeutronFirewallPolicy>();
        for (Entry<String, NeutronFirewallPolicy> entry : firewallPolicyDB.entrySet()) {
            ...
            allFirewallPolicys.add(firewallPolicy);
        }
        logger.debug("Exiting getFirewallPolicys, Found {} OpenStackFirewallPolicy", allFirewallPolicys.size());
        List<NeutronFirewallPolicy> ans = new ArrayList<NeutronFirewallPolicy>();
        ans.addAll(allFirewallPolicys);
        return ans;
    }
    ...
    public boolean addNeutronFirewallPolicy(NeutronFirewallPolicy input) {
        ...
        //TODO: add code to find INeutronFirewallPolicyAware services and call newtorkCreated on them
        return true;
    }
    ...
    public boolean removeNeutronFirewallPolicy(String uuid) {
        ...
        //TODO: add code to find INeutronFirewallPolicyAware services and call newtorkDeleted on them
        return true;
    }
