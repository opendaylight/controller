...
//      TODO: Madhu Review Here
//        if (neutronSecurityRuleExists(input.getSecurityRuleUUID())) {
//            return false;
//        }
//        securityRuleDB.putIfAbsent(input.getSecurityRuleUUID(), input);
//
//        INeutronSecurityGroupCRUD secGroup = NeutronCRUDInterfaces.getINeutronSecurityGroupCRUD(this);
//
////        NeutronSecurityGroup targetSecGroup = secGroup.getNeutronSecurityGroup(input.getSecurityRuleGroupID());
//       String id = input.getSecurityRuleUUID();
//        secGroup.addNeutronSecurityGroup(id, input);
//
//        return true;
