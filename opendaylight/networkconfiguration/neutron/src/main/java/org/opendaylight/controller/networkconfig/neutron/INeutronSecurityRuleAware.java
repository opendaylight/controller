...
public interface INeutronSecurityRuleAware {
     ...
     *
     * @param securityRule
     *            instance of proposed new Neutron Security Rule object
     * @return integer
     ...
     *
     * @param securityRule
     *            instance of new Neutron Security Rule object
     * @return void
     */
     ...
     *
     * @param delta
     *            updates to the security rule object using patch semantics
     * @param original
     *            instance of the Neutron Security Rule object to be updated
     * @return integer
     *            the return value is understood to be a HTTP status code.  A return value outside of 200 through 299
     ...
     *
     * @param securityRule
     *            instance of modified Neutron Security Rule object
     * @return void
     */
     ...
     *
     * @param securityRule
     *            instance of the Neutron Security Rule object to be deleted
     * @return integer
     *            the return value is understood to be a HTTP status code.  A return value outside of 200 through 299
     ...
     *
     * @param securityRule
     *            instance of deleted Neutron Security Rule object
     * @return void
     */
