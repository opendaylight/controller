...
public interface INeutronSecurityGroupCRUD {
     ...
     *
     * @param uuid
     *            UUID of the Security Group object
     * @return boolean
     */
     ...
     *
     * @param input
     *            OpenStackSecurity Group object
     ...
     *
     * @param uuid
     *            identifier for the security group object
     ...
     *
     * @param uuid
     *            identifier of the security group object
     * @param delta
     *            OpenStackSecurity Group object containing changes to apply
