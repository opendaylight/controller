...
public class NeutronLoadBalancerPool extends ConfigurationObject implements Serializable {
    ...
    public HashMap<String, NeutronLoadBalancerPoolMember> getMembers() {
        return member;
    }

    public void addMember(String memberId, NeutronLoadBalancerPoolMember poolMember) {
        member.put(memberId, poolMember);
    }
