...
public interface INeutronSecurityRuleCRUD {
     ...
     *
     * @param uuid
     *            UUID of theSecurity Rule object
     * @return boolean
     */
     ...
     *
     * @param uuid
     *            UUID of the Security Rule object
     ...
     *
     * @param uuid
     *            identifier for the security rule object
     ...
     *
     * @param uuid
     *            identifier of the security rule object
     * @param delta
     *            OpenStackSecurity Rule object containing changes to apply
