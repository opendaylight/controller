...
public interface INeutronSecurityGroupAware {
     ...
     *
     * @param securityGroup
     *            instance of proposed new Neutron Security Group object
     * @return integer
     ...
     *
     * @param securityGroup
     *            instance of new Neutron Security Group object
     * @return void
     */
     ...
     *
     * @param delta
     *            updates to the security group object using patch semantics
     * @param original
     *            instance of the Neutron Security Group object to be updated
     * @return integer
     *            the return value is understood to be a HTTP status code.  A return value outside of 200 through 299
     ...
     *
     * @param securityGroup
     *            instance of modified Neutron Security Group object
     * @return void
     */
     ...
     *
     * @param securityGroup
     *            instance of the Neutron Security Group object to be deleted
     * @return integer
     *            the return value is understood to be a HTTP status code.  A return value outside of 200 through 299
     ...
     *
     * @param securityGroup
     *            instance of deleted Neutron Security Group object
     * @return void
     */
