...
public class QueryContextTest {
  ...
  public void testSimpleQuery() {
    ...
    Query<PersonBean> query = queryContext.createQuery(
        "people.id==200", PersonBean.class);
  ...
  public void testXmlElementWrapper() {
    ...
    QueryContext queryContext = new QueryContextImpl();
    Query<PersonBean> query = queryContext.createQuery(
        "people.emails.email==john@cisco.com", PersonBean.class);
    Assert.assertNotNull(query);
  ...
  @Test
  public void testXmlWrapperOfWrapper(){
  ...
  @Test
  public void testXmlElementWrapperListofList() {
    // create Stringlist
  ...
  @Test
  public void testPrimitiveIteratableTypes() {
    ...
    List<BookBean> found = query.filter(books);
    Assert.assertNotNull(found);
  ...
  @Test
  public void testCompositeIteratableTypes() {
    QueryContext queryContext = new QueryContextImpl();
