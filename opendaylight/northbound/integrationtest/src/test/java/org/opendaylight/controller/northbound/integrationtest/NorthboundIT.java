...
public class NorthboundIT {
    ...
    public void testSubnetsNorthbound() throws JSONException {
        ...
        String ports2[] = {"OF|1@OF|00:00:00:00:00:00:00:02", "OF|2@OF|00:00:00:00:00:00:00:02", "OF|3@OF|00:00:00:00:00:00:00:02", "OF|4@OF|00:00:00:00:00:00:00:02"};
        List<String> nodePorts2 = Arrays.asList(ports2);


        String name3 = "testSubnet3";
        String subnet3 = "3.3.3.3/24";
        String ports3[] = {"OF|1@OF|00:00:00:00:00:00:00:03", "OF|2@OF|00:00:00:00:00:00:00:03", "OF|3@OF|00:00:00:00:00:00:00:03"};
        List<String> nodePorts3 = Arrays.asList(ports3);
        ...
        // Test PUT subnet2
        JSONObject jo2 = new JSONObject().put("name", name2).put("subnet", subnet2).put("nodeConnectors", nodePorts2);
        // execute HTTP request and verify response code
        ...
        JSONObject jo3New = new JSONObject().put("name", name3).put("subnet", subnet3).put("nodeConnectors", nodePorts3);
        // execute HTTP request and verify response code
        ...
        for (int i = 0; i < subnetConfigArray.length(); i++) {
            ...
            if (subnetConfig.getString("name").equals(name1)) {
                ...
                JSONArray nodePortsGet2 = subnetConfig.getJSONArray("nodeConnectors");
                Assert.assertEquals(nodePorts2.get(0), nodePortsGet2.get(0));
                Assert.assertEquals(nodePorts2.get(1), nodePortsGet2.get(1));
                Assert.assertEquals(nodePorts2.get(2), nodePortsGet2.get(2));
                Assert.assertEquals(nodePorts2.get(3), nodePortsGet2.get(3));
            } else if (subnetConfig.getString("name").equals(name3)) {
                Assert.assertEquals(subnet3, subnetConfig.getString("subnet"));
                JSONArray nodePortsGet = subnetConfig.getJSONArray("nodeConnectors");
                Assert.assertEquals(nodePorts3.get(0), nodePortsGet.get(0));
                Assert.assertEquals(nodePorts3.get(1), nodePortsGet.get(1));
                Assert.assertEquals(nodePorts3.get(2), nodePortsGet.get(2));
            } else {
        ...
        List<String> newNodePorts2 = new ArrayList<String>(nodePorts2);
        newNodePorts2.remove(3);
        JSONObject jo2New = new JSONObject().put("name", name2).put("subnet", subnet2).put("nodeConnectors", newNodePorts2);
        // execute HTTP request and verify response code
        ...
        Assert.assertEquals(nodePorts2.get(1), nodePortsGet2.get(1));
        Assert.assertEquals(nodePorts2.get(2), nodePortsGet2.get(2));
        Assert.assertTrue(nodePortsGet2.length() == 3);
