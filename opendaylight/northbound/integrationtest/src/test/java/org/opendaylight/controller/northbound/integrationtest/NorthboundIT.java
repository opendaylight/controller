...
public class NorthboundIT {
    ...
    public void testFlowProgrammer() throws JSONException {
        ...
        // status.
        String result = getJsonResult(baseURL + "STUB/51966/static-flow/test1", "GET");
        Assert.assertTrue(result.equals("404"));

        // test add flow1
        String fc = "{\"dynamic\":\"false\", \"name\":\"test1\", \"node\":{\"@id\":\"51966\",\"@type\":\"STUB\"}, \"actions\":[\"DROP\"]}";
        result = getJsonResult(baseURL + "STUB/51966/static-flow/test1", "PUT", fc);
        Assert.assertTrue(httpResponseCode == 201);

        // test get returns flow that was added.
        result = getJsonResult(baseURL + "STUB/51966/static-flow/test1", "GET");
        ...
        result = getJsonResult(baseURL + "STUB/51966/static-flow/test2", "PUT", fc);
        ...
        result = getJsonResult(baseURL + "STUB/51966/static-flow/test2", "DELETE");
        Assert.assertTrue(httpResponseCode == 200);

        result = getJsonResult(baseURL + "STUB/51966/static-flow/test2", "GET");
        Assert.assertTrue(result.equals("404"));
    }
