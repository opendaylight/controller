...
//        INeutronNetworkCRUD securityGroupInterface = NeutronCRUDInterfaces.getINeutronSecurityGroupCRUD(this);
//        if (securityGroupInterface == null) {
...
//                    throw new InternalServerErrorException("Security Group object could not be initialized properly");
//                }
                ...
                if (testMap.containsKey(test.getSecurityGroupUUID())) {
                    throw new BadRequestException("Security Group UUID already exists");
                }
//                testMap.put(test.getSecurityGroupUUID(), test);
//                if (!securityGroupInterface.networkExists(test.getSecurityGroupUUID())) {
