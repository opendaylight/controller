...
//        INeutronNetworkCRUD firewallInterface = NeutronCRUDInterfaces.getINeutronFirewallCRUD(this);
//        if (firewallInterface == null) {
...
//                    throw new InternalServerErrorException("Firewall object could not be initialized properly");
//                }
...
//                testMap.put(test.getFirewallUUID(), test);
//                if (!firewallInterface.networkExists(test.getFirewallUUID())) {
