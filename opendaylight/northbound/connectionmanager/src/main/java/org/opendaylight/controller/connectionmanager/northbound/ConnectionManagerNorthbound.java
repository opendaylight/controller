...
public class ConnectionManagerNorthbound {
    ...
    /**
     *
     * Retrieve a list of all the nodes connected to this controller.
     *
     ...
     *
     * Request URL:
     * http://localhost:8080/controller/nb/v2/connectionmanager/nodes
     *
   ...
   public Nodes getNodes() {
       return getNodesForController(null);
   }
     ...
     * </pre>
     */
    @Path("/nodes/controller/{controllerAddress}")
    @GET
    @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
    @TypeHint(Nodes.class)
    @StatusCodes( {
    ...
    public Nodes getNodes(@PathParam("controllerAddress") String controllerAddress) {
        return getNodesForController(controllerAddress);
    }

    private Nodes getNodesForController(String controllerAddress) {
