...
public class ByteEncoder extends AbstractEncoder{
    ...
    public  void encodeInt16(int value, EncodeDataContainer ba) {
        ba.adjustSize(2);
    ...
    public void encodeShort(Short value, EncodeDataContainer ba) {
    ...
    public short decodeShort(EncodeDataContainer ba) {
        short value = decodeShort(ba.getBytes(), ba.getLocation());
        ba.advance(2);
        return value;
    }

    public int decodeInt16(EncodeDataContainer ba) {
    ...
    public void encodeInt32(Integer value, EncodeDataContainer ba) {
        if(value==null) value = 0;
        ba.adjustSize(4);
    ...
    public int decodeInt32(EncodeDataContainer ba) {
    ...
    public void encodeInt64(Long value, EncodeDataContainer ba) {
    ...
    public long decodeInt64(EncodeDataContainer ba) {
    ...
    public void encodeString(String value, EncodeDataContainer ba) {
        if (value == null) {
            encodeNULL(ba);
        } else {
            byte bytes[] = value.getBytes();
    ...
    public String decodeString(EncodeDataContainer ba) {
        if (isNULL(ba)) {
            return null;
        }
    ...
    public void encodeBoolean(boolean value, EncodeDataContainer ba) {
        ba.adjustSize(1);
    ...
    public boolean decodeBoolean(EncodeDataContainer ba) {
    ...
    public void encodeAndAddObject(Object value, EncodeDataContainer ba,Class<?> objectType) {
        if (value == null) {
            encodeNULL(ba);
        } else {
