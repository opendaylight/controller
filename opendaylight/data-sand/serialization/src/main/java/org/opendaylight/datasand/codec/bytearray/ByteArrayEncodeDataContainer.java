...
public class ByteArrayEncodeDataContainer extends EncodeDataContainer{
    ...
    public ByteArrayEncodeDataContainer(byte[] _bytes,TypeDescriptorsContainer _container) {
        super(_container,EncodeDataContainer.ENCODER_TYPE_BYTE_ARRAY);
        this.bytes = _bytes;
    }

    public ByteArrayEncodeDataContainer(byte[] _bytes, Object _codingOption,TypeDescriptorsContainer _container) {
        super(_codingOption,_container,EncodeDataContainer.ENCODER_TYPE_BYTE_ARRAY);
        this.bytes = _bytes;
    }

    public ByteArrayEncodeDataContainer(int size,TypeDescriptorsContainer _container) {
        super(_container,EncodeDataContainer.ENCODER_TYPE_BYTE_ARRAY);
        this.bytes = new byte[size];
    }

    public ByteArrayEncodeDataContainer(int size, Object _codingOption,TypeDescriptorsContainer _container) {
        super(_codingOption,_container,EncodeDataContainer.ENCODER_TYPE_BYTE_ARRAY);
        this.bytes = new byte[size];
    }
    ...
    public static byte[] toSingleByteArray(ByteArrayEncodeDataContainer source){
        ByteArrayEncodeDataContainer enc = new ByteArrayEncodeDataContainer(1024,source.getTypeDescriptorContainer());
    ...
    public static ByteArrayEncodeDataContainer fromSingleByteArray(ByteArrayEncodeDataContainer source){
        ByteArrayEncodeDataContainer result = new ByteArrayEncodeDataContainer(1024,source.getTypeDescriptorContainer());
        ...
        for(int i=0;i<subMapSize;i++){
            ...
            for(int j=0;j<size;j++){
                ...
                ByteArrayEncodeDataContainer subBASource = new ByteArrayEncodeDataContainer(subData,source.getTypeDescriptorContainer());
