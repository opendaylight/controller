...
public class ByteEncoder extends AbstractEncoder{
    ...
    public void encodeAndAddObject(Object value, EncodeDataContainer _ba,Class<?> objectType) {
        ...
        if (value == null) {
            ...
            EncodeDataContainer subBA = new ByteArrayEncodeDataContainer(1024,ba.getTypeDescriptorContainer());
    ...
    public void encodeAndAddList(List<?> list, EncodeDataContainer ba,Class<?> componentType) {
        if (list == null) {
            ...
            for (Object o: list) {
                ByteArrayEncodeDataContainer subBA = new ByteArrayEncodeDataContainer(1024,ba.getTypeDescriptorContainer());
                if (String.class.equals(componentType)) {
