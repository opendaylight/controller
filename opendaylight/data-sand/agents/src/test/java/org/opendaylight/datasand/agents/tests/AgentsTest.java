...
import org.opendaylight.datasand.agents.clustermap1.ClusterMap;
import org.opendaylight.datasand.agents.clustermap1.PeerListener;
...
public class AgentsTest {
    ...
    public void testClusterMapString() {
        ...
        ClusterMap<String, String> map1 = new ClusterMap<>(125, m1,null);
        ClusterMap<String, String> map2 = new ClusterMap<>(125, m2,null);
    ...
    public void testClusterMapTestObject() {
        ...
        AutonomousAgentManager m1 = new AutonomousAgentManager(container);
        AutonomousAgentManager m2 = new AutonomousAgentManager(container);
        ClusterMap<String, TestObject> map1 = new ClusterMap<>(125, m1,null);
        ClusterMap<String, TestObject> map2 = new ClusterMap<>(125, m2,null);
    ...
    @Test
    public void testUnreachableAndTimeout(){
        TypeDescriptorsContainer container = new TypeDescriptorsContainer("./node1");
        AutonomousAgentManager m1 = new AutonomousAgentManager(container);
        ClusterMap<String, TestObject> map1 = new ClusterMap<>(125, m1,null);
        ...
        ClusterMap<String, TestObject> map3 = new ClusterMap<>(125, m3,null);
        ...
        ClusterMap<String, TestObject> map4 = new ClusterMap<>(125, m4,null);
        ...
        map4 = new ClusterMap<>(125, m4,null);
    ...
    public void testClusterTypeDescriptors(){
        ...
        ClusterMap<String, TypeDescriptor> cm1 = new ClusterMap<>(223, m1,new PeerListener<String,TypeDescriptor>(container1));
        ...
        ClusterMap<String, TypeDescriptor> cm2 = new ClusterMap<>(223, m2,new PeerListener<String,TypeDescriptor>(container2));
