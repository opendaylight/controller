...
public class ClusterMap<K, V> extends AutonomousAgent implements Map<K, V> {
    ...
    static {
        EncodeUtils.registerSerializer(CCommand.class, new CCommand(), ClusterMapClassCodes.CODE_CCommand);
        EncodeUtils.registerSerializer(ChangeID.class, new ChangeID(), ClusterMapClassCodes.CODE_ChangeID);
    }
