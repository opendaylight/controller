...
public class CMCommand implements ISerializer {
    ...
    public CMCommand(int _op, Object _key, Object _value, long _changeNumber) {
        this.operation = _op;
        this.key = _key;
        this.value = _value;
