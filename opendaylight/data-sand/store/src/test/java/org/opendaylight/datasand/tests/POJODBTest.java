...
public class POJODBTest {
    ...
    public void testPojoSerialization(){
        ...
        ByteArrayEncodeDataContainer dc = new ByteArrayEncodeDataContainer(1024,database.getTypeDescriptorsContainer());
        dc.getEncoder().encodeObject(before, dc, PojoObject.class);
        byte[] data = dc.getBytes();
        dc = new ByteArrayEncodeDataContainer(data,database.getTypeDescriptorsContainer());
