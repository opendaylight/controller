...
public class DataSandJDBCServer  {
    ...
    public DataSandJDBCServer(ObjectDataStore a) {
        this.database = a;
        this.agent = new DataSandJDBCConnection(new AutonomousAgentManager(new TypeDescriptorsContainer("JDBC-Server")),this.database);
    }
    ...
    public static void parseExternalQuery(DataSandJDBCResultSet rs) throws SQLException {
        ...
        for (Map.Entry<String, DataSandJDBCResultSet> entry : rs.getSubQueries()
                .entrySet()) {
