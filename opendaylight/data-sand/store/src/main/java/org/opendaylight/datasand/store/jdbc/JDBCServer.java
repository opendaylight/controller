...
public class JDBCServer extends Thread {
    ...
    public static void parseTables(JDBCResultSet rs,TypeDescriptorsContainer container) throws SQLException {
    ...
    public static void parseFields(JDBCResultSet rs,TypeDescriptorsContainer container) throws SQLException {
        String lowSQL = rs.getSQL().toLowerCase();
    ...
    public static void parseCriteria(JDBCResultSet rs,TypeDescriptorsContainer container) {
        String lowSQL = rs.getSQL().toLowerCase();
        int where = lowSQL.indexOf("where");
