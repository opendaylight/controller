...
public class DataSandJDBCStatement implements PreparedStatement {
    ...
    private static Map<Integer, DataSandJDBCResultSet> queries = new ConcurrentHashMap<Integer, DataSandJDBCResultSet>();
    ...
    public static DataSandJDBCResultSet getQuery(int id) {
        return queries.get(id);
    }

    public static DataSandJDBCResultSet removeQuery(int id) {
