...
public class ByteArrayObjectDataStore extends ObjectDataStore{
    ...
    public static class NETask implements Runnable {
        ...
        public NETask(JDBCResultSet _rs, TypeDescriptor _main, ByteArrayObjectDataStore _db) {
            this.rs = _rs;
    ...
    public Object getEncodedKeyObject(Object dataKey) {
        ...
        ByteArrayEncodeDataContainer ba = (ByteArrayEncodeDataContainer)EncodeDataContainerFactory.newContainer(null,null,this.getEncoderType(),this.getTypeDescriptorsContainer());
