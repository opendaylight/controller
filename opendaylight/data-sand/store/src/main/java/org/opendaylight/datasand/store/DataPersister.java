...
public class DataPersister {
    ...
    private EncodeDataContainer writeBuffer = null;
    ...
    public void save() {
        try {
            EncodeDataContainer ba = new EncodeDataContainer(1024,container);
    ...
    public void load() {
        ...
        if (f.exists()) {
            ...
            try {
                ...
                in.read(data);
                in.close();
                EncodeDataContainer ba = new EncodeDataContainer(data,container);
    ...
    public DataPersister(String location, Class<?> _type,TypeDescriptorsContainer _container) {
        this.container = _container;
        this.dataFileLocation = location + "/" + _type.getName() + ".dat";
        this.dataFileDefLocation = location + "/" + _type.getName() + ".loc";
        this.writeBuffer = new EncodeDataContainer(1024,this.container);
