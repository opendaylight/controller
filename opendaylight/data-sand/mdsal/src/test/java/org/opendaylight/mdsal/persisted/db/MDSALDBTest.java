...
public class MDSALDBTest {
    ...
    public void mdsalEncoderTest() {
        ByteArrayEncodeDataContainer ba = new ByteArrayEncodeDataContainer(1024,database.getTypeDescriptorsContainer());
        ...
        ByteArrayEncodeDataContainer singleSource = new ByteArrayEncodeDataContainer(data,database.getTypeDescriptorsContainer());
