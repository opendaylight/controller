...
import org.opendaylight.controller.bundle.provider.OpendaylightBundleProvider;
...
public class BundleProviderModule extends org.opendaylight.controller.config.yang.config.bundle_provider.impl.AbstractBundleProviderModule {
    private static final Logger log = LoggerFactory.getLogger(BundleProviderModule.class);
