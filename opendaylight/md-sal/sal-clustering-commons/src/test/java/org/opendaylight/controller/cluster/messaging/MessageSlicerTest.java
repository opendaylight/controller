...
public class MessageSlicerTest extends AbstractMessagingTest {
    ...
    public void testHandledMessages() {
        ...
        final MessageSlicer slicer = newMessageSlicer(100);
    ...
    public void testSliceWithInputStreamFailure() throws IOException {
        ...
        final MessageSlicer slicer = newMessageSlicer(2);
        slicer.slice(IDENTIFIER, new BytesMessage(new byte[]{}), testProbe.ref(), testProbe.ref(),
                mockOnFailureCallback);
    ...
    public void testMessageSliceReplyWithNoState() {
        final MessageSlicer slicer = newMessageSlicer(1000);
    ...
    public void testCloseAllSlicedMessageState() throws IOException {
        ...
        final MessageSlicer slicer = newMessageSlicer(1);
        slicer.slice(IDENTIFIER, new BytesMessage(new byte[]{1, 2}), testProbe.ref(), testProbe.ref(),
                mockOnFailureCallback);

        slicer.closeAllSlicedMessageState();
    ...
    public void testCheckExpiredSlicedMessageState() throws IOException {
        ...
        final MessageSlicer slicer = MessageSlicer.builder().messageSliceSize(1)
    ...
    private MessageSlicer newMessageSlicer(final int messageSliceSize) {
        return MessageSlicer.builder().messageSliceSize(messageSliceSize)
