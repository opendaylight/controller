...
public class Ctrl1919Test {
    ...
    public void testListTranslation() throws IOException {
        final Map<QName, Object> newPredicate = ImmutableMap.<QName, Object>builder()
                .put(A, (byte) 1)
                .put(B, (short) 1)
                .put(C, 1)
                .put(D, 1L)
                ...
                .put(H, Uint64.ONE)
                .build();
        final Map<QName, Object> oldPredicate = ImmutableMap.<QName, Object>builder()
                .put(A, (byte) 1)
                .put(B, (short) 1)
                .put(C, 1)
                .put(D, 1L)
        ...
        final MapNode inputNode = Builders.mapBuilder()
                .withNodeIdentifier(LST_ID)
                .withChild(Builders.mapEntryBuilder()
                    .withNodeIdentifier(NodeIdentifierWithPredicates.of(LST, oldPredicate))
