...
public class NormalizedNodeStreamReaderWriterTest {
    ...
    public void testNormalizedNodeStreaming() throws IOException {
        ...
        assertEquals(1049631, bytes.length);
    ...
    /*
     * This tests the encoding of a MapNode with a million entries, each of them having the key leaf (a string)
     * and an integer.
     */
    @Test
    public void testMillionEntries() throws IOException {
