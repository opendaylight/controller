...
public class ValueSerializerTest{
    ...
    public void testSerializeShort(){
        ...
        ValueSerializer.serialize(builder1, any(NormalizedNodeSerializationContext.class), v1);

        assertEquals(ValueType.SHORT_TYPE, (Integer) builder1.getType());
        assertEquals("5", builder.getValue());
    ...
    public void testSerializeInteger(){
        ...
        assertEquals(ValueType.INT_TYPE, (Integer) builder1.getType());
    ...
    public void testSerializeLong(){
        ...
        assertEquals(ValueType.LONG_TYPE, (Integer) builder1.getType());
    ...
    public void testSerializeByte(){
        ...
        assertEquals(ValueType.BYTE_TYPE, (Integer) builder1.getType());
        assertEquals("5", builder1.getValue());
    ...
    public void testSerializeBits(){
        ...
        assertEquals(ValueType.BITS_TYPE, (Integer) builder1.getType());
    ...
    public void testSerializeEmptyString(){
        ...
        assertEquals(ValueType.STRING_TYPE, (Integer) builder1.getType());
    ...
    public void testSerializeBoolean(){
        ...
        assertEquals(ValueType.BOOL_TYPE, (Integer) builder.getIntValueType());
        ...
        assertEquals(ValueType.BOOL_TYPE, (Integer) builder1.getType());
    ...
    public void testSerializeQName(){
        ...
        assertEquals(ValueType.QNAME_TYPE, (Integer) builder.getIntValueType());
        ...
        assertEquals(ValueType.QNAME_TYPE, (Integer) builder1.getType());
    ...
    public void testSerializeBigInteger(){
        ...
        assertEquals(ValueType.BIG_INTEGER_TYPE, (Integer) builder.getIntValueType());
        ...
        assertEquals(ValueType.BIG_INTEGER_TYPE, (Integer) builder1.getType());
    ...
    public void testSerializeBigDecimal(){
        ...
        assertEquals(ValueType.BIG_DECIMAL_TYPE, (Integer) builder.getIntValueType());
        ...
        assertEquals(ValueType.BIG_DECIMAL_TYPE, (Integer) builder1.getType());
    ...
    public void testDeSerializeShort(){
        ...
        nodeBuilder.setIntValueType(ValueType.SHORT_TYPE);
    ...
    public void testDeSerializeByte(){
        NormalizedNodeMessages.Node.Builder nodeBuilder = NormalizedNodeMessages.Node.newBuilder();
        nodeBuilder.setIntValueType(ValueType.BYTE_TYPE);
        nodeBuilder.setValue("25");
    ...
    public void testDeSerializeInteger(){
        NormalizedNodeMessages.Node.Builder nodeBuilder = NormalizedNodeMessages.Node.newBuilder();
        nodeBuilder.setIntValueType(ValueType.INT_TYPE);
        nodeBuilder.setValue("25");
    ...
    public void testDeSerializeLong(){
        NormalizedNodeMessages.Node.Builder nodeBuilder = NormalizedNodeMessages.Node.newBuilder();
        nodeBuilder.setIntValueType(ValueType.LONG_TYPE);
        nodeBuilder.setValue("25");
    ...
    public void testDeSerializeBoolean(){
        NormalizedNodeMessages.Node.Builder nodeBuilder = NormalizedNodeMessages.Node.newBuilder();
        nodeBuilder.setIntValueType(ValueType.BOOL_TYPE);
    ...
    public void testDeSerializeQName(){
        NormalizedNodeMessages.Node.Builder nodeBuilder = NormalizedNodeMessages.Node.newBuilder();
        nodeBuilder.setIntValueType(ValueType.QNAME_TYPE);
    ...
    public void testDeSerializeBits(){
        NormalizedNodeMessages.Node.Builder nodeBuilder = NormalizedNodeMessages.Node.newBuilder();
        nodeBuilder.setIntValueType(ValueType.BITS_TYPE);
        nodeBuilder.setValue("[foo, bar]");
    ...
    public void testDeSerializeYangIdentifier(){
        ...
        pathBuilder.setType(PathArgumentType.NODE_IDENTIFIER);

        idBuilder.addArguments(pathBuilder);

        nodeBuilder.setIntValueType(ValueType.YANG_IDENTIFIER_TYPE);
    ...
    public void testDeSerializeString(){
        NormalizedNodeMessages.Node.Builder nodeBuilder = NormalizedNodeMessages.Node.newBuilder();
        nodeBuilder.setIntValueType(ValueType.STRING_TYPE);
        nodeBuilder.setValue("25");
    ...
    public void testDeSerializeBigInteger(){
        NormalizedNodeMessages.Node.Builder nodeBuilder = NormalizedNodeMessages.Node.newBuilder();
        nodeBuilder.setIntValueType(ValueType.BIG_INTEGER_TYPE);
        nodeBuilder.setValue("25");
    ...
    public void testDeSerializeBigDecimal(){
        NormalizedNodeMessages.Node.Builder nodeBuilder = NormalizedNodeMessages.Node.newBuilder();
        nodeBuilder.setIntValueType(ValueType.BIG_DECIMAL_TYPE);
        nodeBuilder.setValue("25");
