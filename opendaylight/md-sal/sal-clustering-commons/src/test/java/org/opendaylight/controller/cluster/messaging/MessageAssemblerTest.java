...
public class MessageAssemblerTest extends AbstractMessagingTest {
    ...
    @Mock
    private Consumer<Object> mockAssembledMessageCallback;
    ...
    public void testHandledMessages() {
        ...
        final MessageAssembler assembler = newMessageAssembler();
    ...
    public void testAssembledMessageStateExpiration() throws IOException {
        ...
        final MessageAssembler assembler = newMessageAssemblerBuilder()
    ...
    private MessageAssembler newMessageAssembler() {
        return newMessageAssemblerBuilder().build();
    }

    private Builder newMessageAssemblerBuilder() {
