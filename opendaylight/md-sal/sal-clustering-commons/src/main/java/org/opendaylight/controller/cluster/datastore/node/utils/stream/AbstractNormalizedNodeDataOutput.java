...
abstract class AbstractNormalizedNodeDataOutput implements NormalizedNodeDataOutput, NormalizedNodeStreamWriter {
    ...
    public void startLeafSet(final NodeIdentifier name, final int childSizeHint) throws IOException {
        ...
        startLeafSet(name, NodeTypes.LEAF_SET);
    }

    @Override
    public void startOrderedLeafSet(final NodeIdentifier name, final int childSizeHint) throws IOException {
        LOG.trace("Starting a new ordered leaf set");
        startLeafSet(name, NodeTypes.ORDERED_LEAF_SET);
    }

    private void startLeafSet(final NodeIdentifier name, final byte nodeType) throws IOException {
