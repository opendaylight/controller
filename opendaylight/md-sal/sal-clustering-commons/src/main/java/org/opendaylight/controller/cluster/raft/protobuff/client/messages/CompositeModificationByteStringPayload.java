...
public class CompositeModificationByteStringPayload extends Payload implements
    ...
    public CompositeModificationByteStringPayload(Object modification){
        PersistentMessages.CompositeModification compositeModification =
                (PersistentMessages.CompositeModification)
                        Preconditions.checkNotNull(modification, "modification should not be null");
        this.byteString = compositeModification.toByteString();
    }
