...
public final class SimpleReplicatedLogEntryHandler implements PayloadHandler {
    ...
    private final PayloadRegistry registry = PayloadRegistry.INSTANCE;
    ...
    public void writeTo(final DataOutput out, final SerializablePayload payload) throws IOException {
        ...
        final PayloadHandler entryPayloadHandler = registry.getHandler(entryPayload.getPayloadType());
        entryPayloadHandler.writeTo(out, entryPayload);
    }
    ...
    public SerializablePayload readFrom(final DataInput in) throws IOException {
        ...
        final PayloadHandler payloadHandler = registry.getHandler(entryPayloadType);
