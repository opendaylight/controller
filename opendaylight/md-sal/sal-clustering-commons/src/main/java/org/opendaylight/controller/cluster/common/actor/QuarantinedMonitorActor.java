 ...
 * quarantined by another. Once this node gets quarantined, execute the Effect that is
 * passed in (should restart the actor system or the entire karaf container).
 *
