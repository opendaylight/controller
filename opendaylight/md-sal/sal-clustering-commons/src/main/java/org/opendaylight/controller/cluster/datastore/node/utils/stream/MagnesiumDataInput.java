...
final class MagnesiumDataInput extends AbstractNormalizedNodeDataInput {
    ...
    private NodeIdentifier readNodeIdentifier(final byte header) throws IOException {
        switch (header & MagnesiumPathArgument.QNAME_REF_4B) {
    ...
    private static void verifyPathIdentifierOnly(final byte header) throws InvalidNormalizedNodeStreamException {
        if ((header & (MagnesiumPathArgument.QNAME_REF_4B | MagnesiumPathArgument.SIZE_4B)) != 0) {
    ...
    private @NonNull QName decodeQName() throws IOException {
        ...
        final QName qname;
        try {
            qname = QNameFactory.create(module, localName);
