...
/**
 * Provides schema sources from {@link org.opendaylight.controller.cluster.schema.repository.RemoteSchemaRepository}.
 */
@Beta
public class RemoteSchemaProvider implements SchemaSourceProvider<YangTextSchemaSource> {
    ...
    private final RemoteSchemaRepository remoteRepo;
    ...
    public RemoteSchemaProvider(RemoteSchemaRepository remoteRepo, ExecutionContext executionContext) {
