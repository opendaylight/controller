...
abstract class AbstractStreamDictionary {
    ...
    final void attach(@Nonnull final Object owner) {
        Preconditions.checkState(owner == null, "Dictionary %s is attached to %s, cannot attach to %s", this,
                this.owner, owner);
        this.owner = Preconditions.checkNotNull(owner);
    }

    final void detach(@Nonnull final Object owner) {
        Preconditions.checkState(owner != null, "Dictionary %s is already detached", this);
