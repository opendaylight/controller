...
public class AssembledMessageState implements AutoCloseable {
     ...
     * @param filedBackedStreamFactory factory for creating the FileBackedOutputStream instance used for streaming
     */
    public AssembledMessageState(final Identifier identifier, final int totalSlices,
            final FileBackedOutputStreamFactory filedBackedStreamFactory, final String logContext) {
