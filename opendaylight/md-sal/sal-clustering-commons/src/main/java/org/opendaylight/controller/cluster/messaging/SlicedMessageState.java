...
public class SlicedMessageState<T> implements AutoCloseable {
    ...
    public SlicedMessageState(final Identifier identifier, final FileBackedOutputStream fileBackedStream,
            ...
            final Consumer<Throwable> onFailureCallback) throws IOException {
    ...
    public byte[] getNextSlice() throws IOException {
        ...
        LOG.debug("Next slice: total size: {}, offset: {}, size: {}, index: {} hashCode: {}", totalMessageSize,
                start, size, currentSliceIndex, currentSliceHashCode);
    ...
    private void closeStream() {
        if (messageInputStream != null) {
            try {
                ...
                LOG.warn("Error closing message stream", e);
            }
