...
final class MagnesiumValue {
    ...
    // FIXME: revise these, too
    static final byte REF_1B  = 0x18;
    static final byte REF_2B  = 0x19;
    static final byte REF_4B  = 0x1A;
    ...
    // FIXME: eliminate BITS_32, as bits type can define as many as 4294967295 individual bits, hence we need to
    //        cover as many as 2^31 bits being present (i.e. the Set size constraint).
