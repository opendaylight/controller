...
final class MagnesiumValue {
     ...
     */
    // FIXME: we do *NOT* want to assign shorthands to empty strings, as that wastes a shorthand slot
     ...
     */
    static final byte DECIMAL64      = 0x17;
     ...
     */
    static final byte REF_4B  = 0x3F;

    /**
     * Empty bits value. This code point starts the range ending with {@link #BITS_31}, where the number of bits can
     * be extracted as {@code code & 0x1F)}. Last three values of this range are used to
     */
    static final byte BITS_0         = 0x40;
    static final byte BITS_1B        = 0x5D; // Unsigned
    static final byte BITS_2B        = 0x5E; // Unsigned
    static final byte BITS_4B        = 0x5F; // Signed
