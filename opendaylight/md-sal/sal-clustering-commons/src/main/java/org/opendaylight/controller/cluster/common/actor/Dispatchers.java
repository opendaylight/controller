...
public class Dispatchers {
    public enum DispatcherType {
        ...
        public String dispatcherPathIn(final ActorContext actorContext) {
            return dispatcherPathIn(actorContext.system());
        }

        public String dispatcherPathIn(final ActorSystem actorSystem) {
            return dispatcherPathIn(actorSystem.dispatchers());
        }
        ...
        public MessageDispatcher dispatcherIn(final ActorContext actorContext) {
            return dispatcherIn(actorContext.system());
        }

        public MessageDispatcher dispatcherIn(final ActorSystem actorSystem) {
            return dispatcherIn(actorSystem.dispatchers());
        }
