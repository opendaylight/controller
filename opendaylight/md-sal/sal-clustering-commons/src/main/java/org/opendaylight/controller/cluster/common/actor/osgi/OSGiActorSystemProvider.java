...
import org.opendaylight.controller.cluster.datastore.util.AkkaConfigFactory;
import org.opendaylight.controller.cluster.datastore.util.DefaultActorSystemProvider;
...
public final class OSGiActorSystemProvider implements ActorSystemProvider {
    ...
    private DefaultActorSystemProvider delegate;
    ...
    public OSGiActorSystemProvider(@Reference final AkkaConfigurationReader reader, final BundleContext bundleContext) {
        ...
        delegate = new DefaultActorSystemProvider(
