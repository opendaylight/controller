...
final class MagnesiumDataOutput extends AbstractNormalizedNodeDataOutput {
    ...
    // Singleton state indicating we are inside a MapEntryNode's LeafNode whose value has been emitted as part of the
    // MapEntryNode's NodeIdentifierWithPredicates
    private static final State KEY_LEAF_STATE = new State() {

    };

    private final Queue<State> stack = new ArrayDeque<>();
    ...
    private void writeValue(final QName value) throws IOException {
