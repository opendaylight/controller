 ...
 * number of internal copy operations is capped at {@code 2 * MAX_ARRAY_SIZE}. The number of produced chunks is also
 * well-controlled:
 * <ul>
...
public final class ChunkedOutputStream extends OutputStream {
    ...
    public ChunkedOutputStream(final int requestedInitialCapacity, final int requestedMaxChunk) {
        maxChunkSize = ceilingPowerOfTwo(requestedMaxChunk);
