...
final class MagnesiumTokens {
    ...
    static final class NodeType {
        ...
        /**
         * Reference a previously {@link #ADDR_DEFINE}d identifier constant. This node byte is followed by 1-4 bytes,
         * with each byte's highest-order bit indicating whether there is a next byte to be read.
         */
        static final byte ADDR_LOOKUP_VAR = 0x30;
         ...
         *
         * <p>
         * The predicate is encoded as a {@link #ADDR_DEFINE} or {@link #ADDR_LOOKUP_1B}/{@link #ADDR_LOOKUP_VAR},
