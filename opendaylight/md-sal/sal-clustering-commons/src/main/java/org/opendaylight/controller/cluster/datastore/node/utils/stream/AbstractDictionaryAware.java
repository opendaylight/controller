...
abstract class AbstractDictionaryAware<T extends AbstractNormalizedNodeDictionary> implements DictionaryAware<T> {
    private T dictionary;

    AbstractDictionaryAware(final T dictionary) {
        this.dictionary = Preconditions.checkNotNull(dictionary);
        dictionary.attach(this);
    }
