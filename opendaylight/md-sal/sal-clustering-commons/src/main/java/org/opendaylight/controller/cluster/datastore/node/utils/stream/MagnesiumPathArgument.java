 ...
 *      +-+-+-+-+-+-+-+-+
 *     </pre>
 *     Where QName coding is achieved via {@link #QNAME_DEF}, {@link #QNAME_REF1}, {@link #QNAME_REF2} and
 *     {@link #QNAME_REF4}.
 *   </li>
...
final class MagnesiumPathArgument {
    ...
    static final byte AID_COUNT_4B                    = (byte) 0xF8; // Signed, also a mask

    static final byte QNAME_DEF                       = 0x00;
    static final byte QNAME_REF1                      = 0x08; // Unsigned
    static final byte QNAME_REF2                      = 0x10; // Unsigned
    static final byte QNAME_REF4                      = 0x18; // Signed, Also a mask
    ...
    static final byte SIZE_4B                         = (byte) 0xE0; // Also a mask
