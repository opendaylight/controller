...
public class MessageSlicer {
     ...
     */
    public MessageSlicer(final int messageSliceSize, final FileBackedOutputStreamFactory filedBackedStreamFactory) {
        this.filedBackedStreamFactory = filedBackedStreamFactory;
