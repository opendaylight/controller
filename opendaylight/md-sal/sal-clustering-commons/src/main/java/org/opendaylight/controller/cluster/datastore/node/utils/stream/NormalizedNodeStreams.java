...
public final class NormalizedNodeStreams {
    ...
    public static NormalizedNodeStreamReader newStreamReader(@Nonnull final DataInput stream) {
        return new NormalizedNodeInputStreamReader(stream);
    }

    public static NormalizedNodeStreamReader newReaderForDictionary(@Nonnull final DataInput stream,
