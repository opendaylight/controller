...
public class CommonConfig extends AbstractConfig {
    ...
    public boolean isMetricCaptureEnabled(){
        if (cachedMetricCaptureEnableFlag != null) return cachedMetricCaptureEnableFlag;
    ...
    public Integer getMailBoxCapacity() {
        ...
        if (cachedMailBoxCapacity != null) return cachedMailBoxCapacity;
    ...
    public FiniteDuration getMailBoxPushTimeout() {
        ...
        if (cachedMailBoxPushTimeout != null) return cachedMailBoxPushTimeout;
    ...
    public static class Builder<T extends Builder> extends AbstractConfig.Builder<Builder>{
        ...
        public CommonConfig build() {
            Config config = merge(configHolder, (String) configHolder.get(TAG_ACTOR_SYSTEM_NAME));
