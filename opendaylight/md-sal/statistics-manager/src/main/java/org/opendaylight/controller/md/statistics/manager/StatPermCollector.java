...
public interface StatPermCollector extends Runnable, AutoCloseable {
     ...
     * @param statTypes
     */
    void connectedNodeRegistration(InstanceIdentifier<Node> flowNode,
     ...
     * @param flowNode
     */
    void disconnectedNodeUnregistration(InstanceIdentifier<Node> flowNode);
     ...
     * registration in its internal {@link Node} map.
     * Otherwise return false.
     *
     * @param InstanceIdentifier<FlowCapableNode> flowNode
     * @return
     */
    boolean isProvidedFlowNodeActive(InstanceIdentifier<Node> flowNode);
