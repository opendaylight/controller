...
abstract class StatAbstractListenCommit<T extends DataObject, N extends NotificationListener>
     ...
     * and notifies StatCollector for collect next statistics.
     * If the FlowCapableNode is connected, methods submit changes  TODO finish description
     *
     * @param WriteTransaction trans - transaction contain all statistics put
    ...
    protected void cleaningOperationalDS(final WriteTransaction trans, final boolean isResponseFromStatCollector,
            final List<InstanceIdentifier<T>> elemForDelete, final InstanceIdentifier<FlowCapableNode> nodeIdent) {
