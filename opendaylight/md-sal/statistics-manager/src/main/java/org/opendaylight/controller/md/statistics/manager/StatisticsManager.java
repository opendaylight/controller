 ...
 * Created: Aug 27, 2014
 */
public interface StatisticsManager extends AutoCloseable, Runnable, TransactionChainListener {
     ...
     * defined in {@link InventoryOperation}
     *
     * @param inventoryOper - operation for DataStore
     */
    void enqueue(final InventoryOperation inventoryOper);

    /**
     * Method provides access to StatisticCollector process represent by
     * {@link StatPermCollector} Access is used mainly for notification
     * to the statistic collecting continuation -> collectNextStatistics()
     * or for check actually locked or registered
     * {@link org.opendaylight.yang.gen.v1.urn.opendaylight.flow.inventory.rev130819.FlowCapableNode}
     *
     * @return {@link StatPermCollector}
     */
    StatPermCollector getStatCollector();
    ...
    /**
     * Method returns NEW ReadTransaction service for {@link StatNodeRegistration}
     * from {@link org.opendaylight.controller.md.sal.binding.api.DataBroker}
     *
     * @return {@link ReadTransaction}
     */
