...
public class StatPermCollectorImpl implements StatPermCollector {
    ...
    public void collectNextStatistics(final TransactionId xid) {
        if (actualTransactionId != null && actualTransactionId.equals(xid)) {
            if (wakeMe) {
    ...
    private synchronized void setActualTransactionId(final TransactionId transactionId) {
