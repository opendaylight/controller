...
public class StatNotifyCommitPort extends StatAbstractNotifyCommit<OpendaylightPortStatisticsListener>
    ...
    private void statPortCommit(final List<NodeConnectorStatisticsAndPortNumberMap> portStats, final NodeId nodeId,
        ...
        for (final NodeConnectorStatisticsAndPortNumberMap nConnectPort : portStats) {
            ...
            final InstanceIdentifier<NodeConnector> nodeConectIdent = nodeIdent.child(NodeConnector.class, key);
            final InstanceIdentifier<FlowCapableNodeConnectorStatistics> nodeConnStatIdent = nodeConectIdent
            ...
            // FIXME : we need to add check for nodeConnector after fix InventoryManager and remove true for create parent
