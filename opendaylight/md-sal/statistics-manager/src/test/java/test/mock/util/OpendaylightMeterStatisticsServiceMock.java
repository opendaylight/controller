...
public class OpendaylightMeterStatisticsServiceMock implements OpendaylightMeterStatisticsService {
    ...
    public Future<RpcResult<GetAllMeterConfigStatisticsOutput>> getAllMeterConfigStatistics(GetAllMeterConfigStatisticsInput input) {
        ...
        mcsBuilder.setMeterId(TestUtils.getMeter().getMeterId());
        mcsBuilder.setMeterName(TestUtils.getMeter().getMeterName());
        mcsBuilder.setContainerName(TestUtils.getMeter().getContainerName());
    ...
    public Future<RpcResult<GetAllMeterStatisticsOutput>> getAllMeterStatistics(GetAllMeterStatisticsInput input) {
        ...
        msBuilder.setByteInCount(TestUtils.COUNTER_64_TEST_VALUE);
        msBuilder.setPacketInCount(TestUtils.COUNTER_64_TEST_VALUE);
        msBuilder.setKey(new MeterStatsKey(TestUtils.getMeter().getMeterId()));
