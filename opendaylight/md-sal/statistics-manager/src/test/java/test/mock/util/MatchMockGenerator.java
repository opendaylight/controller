...
public class MatchMockGenerator {
    ...
    public static Match getRandomMatch() {
        ...
        METADATA_BUILDER.setMetadata(BigInteger.valueOf(Util.nextLong(0, Long.MAX_VALUE)));
        METADATA_BUILDER.setMetadataMask(BigInteger.valueOf(Util.nextLong(0, Long.MAX_VALUE)));
