...
public class RpcProviderRegistryMock implements RpcProviderRegistry {
    ...
    public RpcProviderRegistryMock(NotificationProviderServiceMock notificationProviderService) {
        this.flowStatisticsServiceMock = new OpendaylightFlowStatisticsServiceMock(notificationProviderService);
        this.flowTableStatisticsServiceMock = new OpendaylightFlowTableStatisticsServiceMock();
        this.groupStatisticsServiceMock = new OpendaylightGroupStatisticsServiceMock();
        this.meterStatisticsServiceMock = new OpendaylightMeterStatisticsServiceMock();
        this.portStatisticsServiceMock = new OpendaylightPortStatisticsServiceMock();
        this.queueStatisticsServiceMock = new OpendaylightQueueStatisticsServiceMock();
    }
