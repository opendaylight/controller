...
public class OpendaylightFlowStatisticsServiceMock implements OpendaylightFlowStatisticsService {
    ...
    public Future<RpcResult<GetAggregateFlowStatisticsFromFlowTableForGivenMatchOutput>> getAggregateFlowStatisticsFromFlowTableForGivenMatch(GetAggregateFlowStatisticsFromFlowTableForGivenMatchInput input) {
        ...
        afsuBuilder.setByteCount(TestUtils.COUNTER_64_TEST_VALUE);
    ...
    public Future<RpcResult<GetAllFlowsStatisticsFromAllFlowTablesOutput>> getAllFlowsStatisticsFromAllFlowTables(GetAllFlowsStatisticsFromAllFlowTablesInput input) {
        ...
        FlowAndStatisticsMapListBuilder flowAndStatisticsMapListBuilder = new FlowAndStatisticsMapListBuilder(TestUtils.getFlow());
        flowAndStatisticsMapListBuilder.setTableId(TestUtils.getFlow().getTableId());
        flowAndStatisticsMapListBuilder.setContainerName(TestUtils.getFlow().getContainerName());
        flowAndStatisticsMapListBuilder.setBarrier(TestUtils.getFlow().isBarrier());
        flowAndStatisticsMapListBuilder.setByteCount(TestUtils.COUNTER_64_TEST_VALUE);
