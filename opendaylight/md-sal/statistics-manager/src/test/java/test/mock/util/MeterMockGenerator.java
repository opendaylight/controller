...
public class MeterMockGenerator {
    ...
    public static Meter getRandomMeter() {
        METER_BAND_HEADER_BUILDER.setKey(new MeterBandHeaderKey(new BandId(nextLong(0, 4294967295L))));
        METER_BAND_HEADER_BUILDER.setBandBurstSize(nextLong(0, 4294967295L));
        METER_BAND_HEADER_BUILDER.setBandRate(nextLong(0, 4294967295L));
        List<MeterBandHeader> meterBandHeaders = new ArrayList<>();
        METER_BUILDER.setKey(new MeterKey(new MeterId(nextLong(0, 4294967295L))));
