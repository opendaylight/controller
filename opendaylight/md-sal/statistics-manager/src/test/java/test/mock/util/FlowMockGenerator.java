...
public class FlowMockGenerator {
    ...
    public static Flow getRandomFlow() {
        ...
        FLOW_BUILDER.setOutGroup(nextLong(0, 4294967296L));
        FLOW_BUILDER.setTableId((short) RND.nextInt(256));
        FLOW_BUILDER.setOutPort(BigInteger.valueOf(nextLong(0, Long.MAX_VALUE)));
        ...
        FLOW_BUILDER.setCookie(new FlowCookie(BigInteger.valueOf(nextLong(0, Long.MAX_VALUE))));
