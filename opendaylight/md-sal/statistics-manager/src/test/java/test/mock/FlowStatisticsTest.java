...
public class FlowStatisticsTest extends StatisticsManagerTest {
    ...
    @Test
    public void getStatisticsForAddedFlowTest() throws ExecutionException, InterruptedException, ReadFailedException {
    ...
    @Test
    public void deletedFlowTest() throws ExecutionException, InterruptedException, ReadFailedException {
        NotificationProviderServiceMock notificationMock = new NotificationProviderServiceMock();
        RpcProviderRegistryMock rpcRegistry = new RpcProviderRegistryMock(notificationMock);
        ProviderContextMock providerContext = new ProviderContextMock(rpcRegistry, getDataBroker(), notificationMock.getNotifBroker());
        ...
        flowOptional = readTx.read(LogicalDatastoreType.OPERATIONAL, flowII).checkedGet();
