...
public class DOMTransactionChainAdapter extends ForwardingObject
    ...
    private final Cache<AsyncTransaction<?, ?>, org.opendaylight.mdsal.common.api.AsyncTransaction<?, ?>> transactions =
            CacheBuilder.newBuilder().weakKeys().weakValues().build();

    private final org.opendaylight.mdsal.common.api.TransactionChainListener listener;
    private final DOMTransactionChain delegate;

    public DOMTransactionChainAdapter(final org.opendaylight.mdsal.common.api.TransactionChainListener listener,
    ...
    private <T extends org.opendaylight.mdsal.common.api.AsyncTransaction<?, ?>> T track(
            final AsyncTransaction<?, ?> controllerTx, final T mdsalTx) {
