...
final class ListenerStateCapture<P extends Path<P>, D, DCL extends DataChangeListener<P, D>> {
    ...
    public ListenerStateCapture(P path, Iterable<DataChangeListenerRegistration<P, D, DCL>> listeners,Predicate<P> containsPredicate) {
        super();
        this.path = path;
