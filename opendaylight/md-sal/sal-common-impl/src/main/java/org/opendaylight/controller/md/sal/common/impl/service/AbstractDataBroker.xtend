...
@Data
package class ListenerStateCapture<P extends Path<P>, D> {

    @Property
    P path;

    @Property
    Collection<DataChangeListenerRegistration<P, D, ?>> listeners;
...
package class TwoPhaseCommit<P extends Path<P>, D> implements Callable<RpcResult<TransactionStatus>> {
    ...
    def void publishDataChangeEvent(ImmutableList<ListenerStateCapture<P, D>> listeners) {
