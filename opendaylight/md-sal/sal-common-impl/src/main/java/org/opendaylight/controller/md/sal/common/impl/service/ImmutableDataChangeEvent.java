...
final class ImmutableDataChangeEvent<P extends Path<P>, D> implements DataChangeEvent<P,D> {
    ...
    static final class Builder<P extends Path<P>,D> {
        ...
        protected void setUpdatedOperationalSubtree(D updatedOperationalSubtree) {
        ...
        protected void setOriginalOperationalSubtree(D originalOperationalSubtree) {
        ...
        protected void setOriginalConfigurationSubtree(D originalConfigurationSubtree) {
        ...
        protected void setUpdatedConfigurationSubtree(D updatedConfigurationSubtree) {
