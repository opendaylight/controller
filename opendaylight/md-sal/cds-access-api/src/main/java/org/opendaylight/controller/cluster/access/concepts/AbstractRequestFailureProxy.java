...
public abstract class AbstractRequestFailureProxy<T extends Identifier & WritableObject> extends
    ...
    protected AbstractRequestFailureProxy(final @Nonnull RequestFailure<T> failure) {
        super(failure);
    ...
    protected abstract RequestFailure<T> createFailure(@Nonnull T target, long sequence, @Nonnull RequestException cause);
}