 ...
 * @author Robert Varga
 */
final class ExistsTransactionSuccessProxy extends AbstractTransactionSuccessProxy<ExistsTransactionSuccess> {
    private static final long serialVersionUID = 1L;
    private boolean exists;

    public ExistsTransactionSuccessProxy() {
        // For Externalizable
    }

    ExistsTransactionSuccessProxy(final ExistsTransactionSuccess request) {
        super(request);
