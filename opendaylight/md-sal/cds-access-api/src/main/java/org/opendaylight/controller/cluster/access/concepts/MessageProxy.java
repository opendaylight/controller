 ...
 */
interface MessageProxy<T extends WritableIdentifier, C extends Message<T, C>> extends Externalizable {
    ...
    default void readExternal(final ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        readExternal(in, target, sequence);
    }

    void readExternal(@NonNull ObjectInput in, @NonNull T target, long sequence)
