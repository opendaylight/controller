...
public final class ModifyTransactionRequest extends TransactionRequest {
    ...
    private static final class Proxy extends AbstractRequestProxy<TransactionRequestIdentifier> {
        ...
        public void writeExternal(final ObjectOutput out) throws IOException {
            ...
            for (TransactionOperation op : modifications) {
                out.writeObject(op);
            }
        ...
        AbstractRequest<?> readResolve() {
            return new ModifyTransactionRequest(getIdentifier(), getFrontendRef(), modifications, finish);
        }
    }
    ...
    public Optional<FinishTransaction> getFinish() {
        return Optional.ofNullable(finish);
    }

    public List<TransactionModification> getOperations() {
    ...
    @Override
    Proxy writeReplace() {
        return new Proxy(getIdentifier(), getFrontendRef(), modifications);
    }
}
