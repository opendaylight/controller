...
public abstract class AbstractRequestProxy<T extends Identifier & WritableObject, C extends Request<T, C>>
    ...
    public void writeExternal(final ObjectOutput out) throws IOException {
        ...
        // FIXME: http://doc.akka.io/docs/akka/current/java/serialization.html#Programmatic seems to be a more efficient
        //        and complete way of doing serialization.
    ...
    protected abstract C createMessage(@Nonnull T target, long sequence, ActorRef replyTo);
}