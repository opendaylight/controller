...
public abstract class AbstractRequestProxy<T extends Identifier & WritableObject> extends AbstractMessageProxy<T, Request<T>> {
    ...
    protected AbstractRequestProxy(final @Nonnull Request<T> request) {
        super(request);
    ...
    protected abstract Message<T, Request<T>> createMessage(@Nonnull T target, long sequence, ActorRef replyTo);
}