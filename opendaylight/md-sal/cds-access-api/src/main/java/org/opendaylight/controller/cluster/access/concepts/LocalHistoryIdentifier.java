...
public final class LocalHistoryIdentifier implements Comparable<LocalHistoryIdentifier>, Identifier {
    ...
    @Override
    public int compareTo(final LocalHistoryIdentifier o) {
        int cmp = frontendId.compareTo(o.frontendId);
        return cmp == 0 ? Long.compareUnsigned(historyId, o.historyId) : cmp;
    }
