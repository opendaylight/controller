...
public abstract class AbstractReadTransactionRequest<T extends AbstractReadTransactionRequest<T>> extends TransactionRequest<T> {
    ...
    AbstractReadTransactionRequest(final TransactionIdentifier identifier, final long sequence,
    ...
    @Override
    protected abstract AbstractReadTransactionRequestProxy<T> externalizableProxy(final ABIVersion version);
}
