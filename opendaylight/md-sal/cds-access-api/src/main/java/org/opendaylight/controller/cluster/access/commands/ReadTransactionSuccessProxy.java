 ...
 * @author Robert Varga
 */
final class ReadTransactionSuccessProxy extends AbstractTransactionSuccessProxy<ReadTransactionSuccess> {
    private static final long serialVersionUID = 1L;
    private Optional<NormalizedNode<?, ?>> data;

    public ReadTransactionSuccessProxy() {
        // For Externalizable
    }

    ReadTransactionSuccessProxy(final ReadTransactionSuccess request) {
        super(request);
