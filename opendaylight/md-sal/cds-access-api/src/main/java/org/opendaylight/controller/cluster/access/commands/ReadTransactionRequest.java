...
@Beta
public final class ReadTransactionRequest extends AbstractReadTransactionRequest {
    private static final class Proxy extends AbstractReadRequestProxy {
        ...
        protected ReadTransactionRequest readResolve() {
            return new ReadTransactionRequest(getIdentifier(), getReplyTo(), getPath());
        }
    }

    private static final long serialVersionUID = 1L;

    public ReadTransactionRequest(final TransactionRequestIdentifier identifier, final ActorRef frontendRef,
