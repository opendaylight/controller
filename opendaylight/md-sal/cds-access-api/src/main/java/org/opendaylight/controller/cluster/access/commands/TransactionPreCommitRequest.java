...
public final class TransactionPreCommitRequest extends TransactionRequest<TransactionPreCommitRequest> {
    ...
    private TransactionPreCommitRequest(final TransactionPreCommitRequest request, final long retry) {
        super(request, retry);
    }

    public TransactionPreCommitRequest(final TransactionIdentifier target, final long sequence, final long retry,
    ...
    @Override
    protected TransactionPreCommitRequest cloneAsRetry(final long retry) {
        return new TransactionPreCommitRequest(this, retry);
    }
