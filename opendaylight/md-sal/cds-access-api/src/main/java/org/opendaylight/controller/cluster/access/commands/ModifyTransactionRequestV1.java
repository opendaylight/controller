 ...
 * @author Robert Varga
 */
final class ModifyTransactionRequestV1 extends AbstractTransactionRequestProxy<ModifyTransactionRequest> {
    private static final long serialVersionUID = 1L;
    private List<TransactionModification> modifications;
    private Optional<PersistenceProtocol> protocol;

    public ModifyTransactionRequestV1() {
        // For Externalizable
    }

    ModifyTransactionRequestV1(final ModifyTransactionRequest request) {
        super(request);
