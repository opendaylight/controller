...
public final class TransactionDoCommitRequest extends TransactionRequest<TransactionDoCommitRequest> {
    ...
    private TransactionDoCommitRequest(final TransactionDoCommitRequest request, final long retry) {
        super(request, retry);
    }

    public TransactionDoCommitRequest(final TransactionIdentifier target, final long sequence, final long retry,
    ...
    @Override
    protected TransactionDoCommitRequest cloneAsRetry(final long retry) {
        return new TransactionDoCommitRequest(this, retry);
    }
