...
public final class CreateLocalHistory implements Serializable {
    private static final class Proxy implements Externalizable {
        ...
        private CreateLocalHistory readResolve() {
            return new CreateLocalHistory(frontendId, historyId);
        }
    }
    ...
    public CreateLocalHistory(final FrontendIdentifier frontendId, final long historyId) {
        this.frontendId = Preconditions.checkNotNull(frontendId);
        this.historyId = historyId;
    }
    ...
    public String toString() {
        return MoreObjects.toStringHelper(CreateLocalHistory.class).add("frontend", frontendId)
