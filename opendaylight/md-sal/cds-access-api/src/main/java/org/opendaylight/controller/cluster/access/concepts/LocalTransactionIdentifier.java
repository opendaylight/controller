...
@Beta
public final class LocalTransactionIdentifier implements Comparable<LocalTransactionIdentifier>, Identifier {
    ...
    @Override
    public int compareTo(final LocalTransactionIdentifier o) {
        int cmp = Long.compareUnsigned(transactionId, o.localHistory);
        return cmp == 0 ? Long.compareUnsigned(transactionId, o.transactionId) : cmp;
    }
