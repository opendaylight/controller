...
abstract class AbstractLocalHistoryRequest extends AbstractRequest<LocalHistoryIdentifier> implements LocalHistoryMessage {
    static abstract class LocalHistoryRequestProxy extends AbstractRequestProxy<LocalHistoryIdentifier> {
        ...
        @Override
        abstract AbstractLocalHistoryRequest readResolve();
    }
    private static final long serialVersionUID = 1L;
