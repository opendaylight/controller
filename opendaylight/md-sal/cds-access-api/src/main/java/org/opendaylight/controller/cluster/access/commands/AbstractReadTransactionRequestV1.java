 ...
 */
abstract class AbstractReadTransactionRequestV1<T extends AbstractReadTransactionRequest<T>> extends AbstractTransactionRequestProxy<T> {
    private static final long serialVersionUID = 1L;
    private YangInstanceIdentifier path;

    AbstractReadTransactionRequestV1() {
        // For Externalizable
    }

    AbstractReadTransactionRequestV1(final T request) {
        super(request);
    }
