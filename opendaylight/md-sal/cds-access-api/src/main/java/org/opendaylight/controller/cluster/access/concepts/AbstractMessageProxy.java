...
abstract class AbstractMessageProxy<T extends WritableIdentifier, C extends Message<T, C>>
    ...
    @Override
    public void readExternal(final @NonNull ObjectInput in, final @NonNull T target, final long sequence)
            throws IOException, ClassNotFoundException {
        message = createMessage(target, sequence);
    }
