...
public final class RequestEnvelope extends Envelope<Request<?, ?>> {
    ...
    public RequestEnvelope(final Request<?, ?> message, final ABIVersion version, final long sequence, final long retry) {
     ...
     */
    public @Nonnull RequestEnvelope incrementRetry() {
