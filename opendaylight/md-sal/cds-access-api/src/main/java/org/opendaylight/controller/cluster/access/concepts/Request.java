...
public abstract class Request<T extends Identifier> extends Message<T, Request<T>> {
    protected static abstract class AbstractRequestProxy<T extends Identifier> extends AbstractProxy<T, Request<T>> {
        ...
        protected AbstractRequestProxy(final T identifier, final ActorRef frontendRef) {
            super(identifier);
            this.replyTo = Preconditions.checkNotNull(frontendRef);
        }
    ...
    protected Request(final T identifier, final ActorRef frontendRef) {
        super(identifier);
        this.replyTo = Preconditions.checkNotNull(frontendRef);
    }
