...
public class TransactionPreCommitRequestProxyV1Test extends AbstractRequestProxyTest<TransactionPreCommitRequestProxyV1> {
    ...
    private static final TransactionPreCommitRequest REQUEST = new TransactionPreCommitRequest(TRANSACTION_IDENTIFIER, 0, ACTOR_REF);
