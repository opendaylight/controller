...
public class TransactionCommitSuccessProxyV1Test
    ...
    private static final TransactionCommitSuccess REQUEST = new TransactionCommitSuccess(TRANSACTION_IDENTIFIER, 0);
    private static final TransactionCommitSuccessProxyV1 OBJECT = new TransactionCommitSuccessProxyV1(REQUEST);
