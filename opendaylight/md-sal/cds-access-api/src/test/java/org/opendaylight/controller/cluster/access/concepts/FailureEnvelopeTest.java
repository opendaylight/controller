...
public class FailureEnvelopeTest extends EnvelopeTest<FailureEnvelope> {
    ...
    @Override
    protected void doAdditionalAssertions(FailureEnvelope envelope, FailureEnvelope resolvedObject) {
