...
public abstract class AbstractEnvelopeTest<E extends Envelope<?>> {
    protected static final class EnvelopeDetails<E extends Envelope<?>> {
        protected final @NonNull E envelope;
        protected final int expectedSize;

        protected EnvelopeDetails(E envelope, int expectedSize) {
