...
public class TransactionCanCommitSuccessProxyV1Test
    ...
    private static final TransactionCanCommitSuccess REQUEST = new TransactionCanCommitSuccess(
            TRANSACTION_IDENTIFIER, 0);
    private static final TransactionCanCommitSuccessProxyV1 OBJECT = new TransactionCanCommitSuccessProxyV1(REQUEST);
