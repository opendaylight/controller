...
public class NotLeaderExceptionTest extends RequestExceptionTest<NotLeaderException> {
    ...
    private static final NotLeaderException OBJECT = new NotLeaderException(ACTOR);
    ...
    protected void checkMessage() {
        ...
        final String checkMessage = new StringBuilder("Actor ").append(ACTOR.toString()).append(" is not the current leader").toString();
