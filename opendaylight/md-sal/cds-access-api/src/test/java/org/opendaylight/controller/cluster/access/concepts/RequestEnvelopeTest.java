...
public class RequestEnvelopeTest extends EnvelopeTest<RequestEnvelope> {
    ...
    @Override
    protected void doAdditionalAssertions(RequestEnvelope envelope, RequestEnvelope resolvedObject) {
