...
public class TransactionAbortSuccessProxyV1Test
    ...
    private static final TransactionAbortSuccess REQUEST = new TransactionAbortSuccess(TRANSACTION_IDENTIFIER, 0);
    private static final TransactionAbortSuccessProxyV1 OBJECT = new TransactionAbortSuccessProxyV1(REQUEST);
