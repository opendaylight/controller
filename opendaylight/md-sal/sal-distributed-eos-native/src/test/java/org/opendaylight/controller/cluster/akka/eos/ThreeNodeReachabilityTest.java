...
public class ThreeNodeReachabilityTest extends AbstractNativeEosTest {
    ...
    public void setUp() throws Exception {
        node1 = startupRemote(2550, Collections.singletonList("member-1"), TWO_NODE_SEED_NODES);
        node2 = startupRemote(2551, Collections.singletonList("member-2"), TWO_NODE_SEED_NODES);
    ...
    public void tearDown() throws Exception {
        node1.getActorSystem().terminate();
        node2.getActorSystem().terminate();

        node1.getActorSystem().getWhenTerminated().toCompletableFuture().get();
        node2.getActorSystem().getWhenTerminated().toCompletableFuture().get();

        if (node3 != null) {
            node3.getActorSystem().terminate();
            node3.getActorSystem().getWhenTerminated().toCompletableFuture().get();
        }
    }
    ...
    public void testNodeLateStart() throws Exception {
        ...
        verifyListenerState(firstEntityListener1, ENTITY_1, 0, true, true, false);
        verifyListenerState(firstEntityListener2, ENTITY_1, 0, true, false, false);
        ...
        verifyListenerState(secondEntityListener1, ENTITY_2, 0, true, false, false);
        verifyListenerState(secondEntityListener2, ENTITY_2, 0, true, true, false);

        unregisterCandidates(node1, ENTITY_1, "member-1");

        verifyListenerState(firstEntityListener1, ENTITY_1, 1, true, false, true);
        verifyListenerState(firstEntityListener2, ENTITY_1, 1, true, true, false);

        unregisterCandidates(node2, ENTITY_1, "member-2");

        verifyListenerState(firstEntityListener1, ENTITY_1, 2, false, false, false);
        verifyListenerState(firstEntityListener2, ENTITY_1, 2, false, false, true);

        startNode3();

        final MockEntityOwnershipListener firstEntityListener3 = registerListener(node3, ENTITY_1);
        verifyListenerState(firstEntityListener3, ENTITY_1, 0, false, false, false);
        ...
        verifyListenerState(firstEntityListener2, ENTITY_1, 3, true, false, false);

        verifyListenerState(firstEntityListener3, ENTITY_1, 1, true, true, false);
    }
    ...
    public void testReachabilityChangesDuringRuntime() throws Exception {
        ...
        verifyListenerState(firstEntityListener1, ENTITY_1, 0, true, false, false);
        verifyListenerState(firstEntityListener2, ENTITY_1, 0, true, true, false);
        verifyListenerState(firstEntityListener3, ENTITY_1, 0, true, false, false);
        ...
        verifyListenerState(firstEntityListener3, ENTITY_1, 1, true, false, false);

        verifyListenerState(secondEntityListener1, ENTITY_2, 1, true, true, false);
        ...
        verifyListenerState(firstEntityListener3, ENTITY_1, 2, false, false, false);

        verifyListenerState(secondEntityListener1, ENTITY_2, 2, false, false, true);
    ...
    public void testSingletonMoving() throws Exception {
        ...
        verifyListenerState(listener1, ENTITY_1, 1, true, false, false);
        verifyListenerState(listener2, ENTITY_2, 1, true, true, false);

        node1.getActorSystem().terminate();
        node1.getActorSystem().getWhenTerminated().toCompletableFuture().get();

        verifyListenerState(listener1, ENTITY_1, 2, true, true, false);
        ...
        verifyListenerState(listener3, ENTITY_2, 0, true, false, false);
        ...
        verifyListenerState(node1Listener, ENTITY_1, 0, true, false, false);
    }
    ...
    private void startNode3(final int membersPresent) throws Exception {
        node3 = startupRemote(2552, Collections.singletonList("member-3"), THREE_NODE_SEED_NODES);
