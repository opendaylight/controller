...
import org.opendaylight.controller.cluster.akka.eos.registry.listener.type.EntityTypeListenerRegistry;
...
public class OwnerSupervisorTest extends AbstractNativeEosTest {
    ...
    public void testCandidatePickingWhenUnreachableCandidates() throws Exception {
        ...
        node.getActorSystem().terminate();
        node.getActorSystem().getWhenTerminated().toCompletableFuture().get();
    }
