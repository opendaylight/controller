...
public class ThreeNodeBaseTest extends AbstractNativeEosTest {
    ...
    public void testInitialNotificationsWithOwner() {
        ...
        final MockEntityOwnershipListener listener1 = registerListener(node1, ENTITY_1);
        verifyListenerState(listener1, ENTITY_1, 0, true, true, false);

        final MockEntityOwnershipListener listener2 = registerListener(node2, ENTITY_1);
        verifyListenerState(listener2, ENTITY_1, 0, true, false, false);

        final MockEntityOwnershipListener listener3 = registerListener(node3, ENTITY_1);
        verifyListenerState(listener3, ENTITY_1, 0, true, false, false);
    }
    ...
    public void testMultipleEntities() {
        ...
        verifyListenerState(firstEntityListener1, ENTITY_1, 2, true, false, false);
        verifyListenerState(firstEntityListener2, ENTITY_1, 2, true, false, true);
        verifyListenerState(firstEntityListener3, ENTITY_1, 2, true, true, false);

        unregisterCandidates(node3, ENTITY_1, "member-3");

        verifyListenerState(firstEntityListener1, ENTITY_1, 3, false, false, false);
        verifyListenerState(firstEntityListener2, ENTITY_1, 3, false, false, false);
        verifyListenerState(firstEntityListener3, ENTITY_1, 3, false, false, true);
        ...
        verifyListenerState(firstEntityListener1, ENTITY_1, 4, true, true, false);
        verifyListenerState(firstEntityListener2, ENTITY_1, 4, true, false, false);
        verifyListenerState(firstEntityListener3, ENTITY_1, 4, true, false, false);
    }
}
