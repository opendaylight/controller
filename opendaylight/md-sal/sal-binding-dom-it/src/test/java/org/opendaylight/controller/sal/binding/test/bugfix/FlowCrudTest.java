...
public class FlowCrudTest extends AbstractDataServiceTest{
    ...
    private final static Logger log = Logger
            .getLogger(WriteParentReadChildTest.class.getName());
    ...
    public void my_flowTest() throws InterruptedException, ExecutionException{
        ...
        Flow flowUp = this.createFlowUp();

        DataObject createdFlow = CrudTestUtil.doCreateTest(flow,
                this.baDataService, FLOW_INSTANCE_ID_BA);
        CrudTestUtil.doReadTest(createdFlow, this.baDataService,
                FLOW_INSTANCE_ID_BA);
        CrudTestUtil.doUpdateTest(flowUp, createdFlow, this.baDataService,
                FLOW_INSTANCE_ID_BA);
        CrudTestUtil.doRemoveTest(flowUp, this.baDataService,
                FLOW_INSTANCE_ID_BA);
