...
public abstract class AbstractConsensus implements ConsensusStrategy {

    // TODO: Is this where check should live? (Alternative) Make Participant's implementation have the check, e.g. participant.hasNewerState(candidate).
    /**
     ...
     * @return
     */
    protected boolean isCandidateStateLatest(Participant participant, Participant candidate, String votedFor) {
