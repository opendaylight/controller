...
public class RaftStrategy implements ConsensusStrategy {
    ...
    @Override
    public VoteRequestReceivedAction onVoteRequestReceived(Participant participant, Candidate candidate, String votedFor) {
        ...
        return grantVote ? VoteRequestReceivedAction.GRANT_VOTE : VoteRequestReceivedAction.NONE;
    }
}
