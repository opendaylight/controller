...
public final class SnapshotManager {
    ...
    @NonNull CaptureSnapshot newCaptureSnapshot(final RaftEntryMeta lastLogEntry, final long replicatedToAllIndex,
        ...
        final var replLog = context.getReplicatedLog();
        final var lastAppliedEntry = AbstractReplicatedLog.computeLastAppliedEntry(context.getReplicatedLog(),
            context.getLastApplied(), lastLogEntry, context.hasFollowers());
