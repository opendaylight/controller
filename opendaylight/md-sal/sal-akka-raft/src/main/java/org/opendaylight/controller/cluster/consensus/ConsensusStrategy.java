...
public interface ConsensusStrategy {
     ...
     * @param requester the Participant who requested the vote
     * @param currentChoice the id of the Participant who the voter has already voted for in the current term
     * @return
     */
    VoteRequestReceivedAction onVoteRequestReceived(Participant voter, Participant requester, String currentChoice);
}
