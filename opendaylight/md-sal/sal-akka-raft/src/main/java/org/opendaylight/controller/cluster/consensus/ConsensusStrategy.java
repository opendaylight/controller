...
public interface ConsensusStrategy {
    ...
    /**
     * Callback to be invoked by a Candidate when it sends a vote.
     *
     * @param candidate the leader that sent the heartbeat
     * @return
     */
    VoteSentAction onVoteSent(Candidate candidate);
}
