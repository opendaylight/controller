...
/**
 * Actor created by the leader to periodically send KeepAlive messages to all followers to prevent
 * election timeouts. This actor serves as a backup in case the leader is busy and normal AppendEntries
 * heart beats are delayed.
 *
