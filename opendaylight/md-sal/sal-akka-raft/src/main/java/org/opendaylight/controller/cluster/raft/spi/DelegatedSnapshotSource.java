...
/**
 * A {@link SnapshotSource} which delegates to a different {@link SnapshotSource}.
 *
 * @param <T> type of deleted source.
 */
@NonNullByDefault
public abstract sealed class DelegatedSnapshotSource<T extends SnapshotSource> extends BaseSnapshotSource
