...
class RaftActorSnapshotMessageSupport {
    ...
    private void onGetSnapshot(ActorRef sender, GetSnapshot getSnapshot) {
        ...
        if (context.getPersistenceProvider().isRecoveryApplicable()) {
            ...
            final Optional<Timeout> maybeTimeout = getSnapshot.getTimeout();
            final FiniteDuration timeout =
                    maybeTimeout.isPresent() ? maybeTimeout.get().duration() : snapshotReplyActorTimeout;
            ...
            ActorRef snapshotReplyActor = context.actorOf(GetSnapshotReplyActor.props(captureSnapshot,
                    ...
                    timeout, context.getId(), context.getPeerServerInfo(true)));
