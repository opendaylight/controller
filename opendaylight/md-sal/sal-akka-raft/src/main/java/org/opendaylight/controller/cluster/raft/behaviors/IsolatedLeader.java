 ...
 *
 */
public class IsolatedLeader extends Leader {
    ...
    protected void scheduleIsolatedLeaderCheck(FiniteDuration isolatedCheckInterval) {
        // we do not want to schedule isolated leader check for IsolatedLeader
        return;
    }

    @Override
    protected void scheduleInstallSnapshotCheck(FiniteDuration interval) {
        // we do not want to schedule install snapshot for IsolatedLeader
        return;
    }
}
