...
public abstract class AbstractLeader extends AbstractRaftActorBehavior {
    ...
    protected AbstractLeader(RaftActorContext context, RaftState state,
        ...
        appendEntriesMessageSlicer = MessageSlicer.builder().logContext(logName())
            ...
            .expireStateAfterInactivity((int) (context.getConfigParams().getElectionTimeOutInterval().toMillis() * 3),
    ...
    protected RaftActorBehavior handleAppendEntriesReply(ActorRef sender, AppendEntriesReply appendEntriesReply) {
        ...
        possiblyCleanupSharedAppendEntriesStreams();
    ...
    private void possiblyCleanupSharedAppendEntriesStreams() {
        if (sharedSerializedAppendEntriesStreams.isEmpty()) {
            return;
        }

        Iterator<SharedFileBackedOutputStream> iter = sharedSerializedAppendEntriesStreams.values().iterator();
        while (iter.hasNext()) {
            SharedFileBackedOutputStream next = iter.next();
