...
public abstract class AbstractLeader extends AbstractRaftActorBehavior {
    ...
    public AbstractLeader(RaftActorContext context) {
        ...
        calculateMinReplicaCountAndMinIsolatedLeaderPeerCount();
    ...
    public void calculateMinReplicaCountAndMinIsolatedLeaderPeerCount(){
            ...
            if (reply.isSuccess()) {
                if(followerToSnapshot.isLastChunk(reply.getChunkIndex())) {
                    ...
                    if(followerState ==  FollowerState.VOTING_NOT_INITIALIZED){
                        ...
                        actor().tell(unInitFollowerSnapshotSuccess, actor());
                    }
