 ...
 * <p>Leaders:
 * <ul>
 *   <li>Upon election: send initial empty {@linkplain AppendEntries} RPCs (heartbeat) to each server; repeat during idle
 *       periods to prevent election timeouts (§5.2)</li>
