                ...
                new Procedure<ReplicatedLogEntry>() {
                    public void apply(ReplicatedLogEntry evt) throws Exception {
                        ...
                        if (journal.size() > SNAPSHOT_ENTRY_COUNT) {
                            LOG.debug("Initiating Snapshot Capture..");
                            ...
                            LOG.debug("Persisting of snapshot done:"+sn.getLogMessage());
                            ...
                            LOG.debug("Removed in-memory snapshotted entries, adjusted snaphsotIndex and term");
                        }
    ...
    private static class Snapshot implements Serializable {
        ...
        public String getLogMessage() {
            return "Snapshot={" +
                ...
                "LastAppliedIndex:" + this.getLastAppliedIndex()  + ", " +
                "LastAppliedTerm:" + this.getLastAppliedTerm()  + ", " +
                "UnAppliedEntries size:" + this.getUnAppliedEntries().size()  + ", " +
                "}";
        }
    }
