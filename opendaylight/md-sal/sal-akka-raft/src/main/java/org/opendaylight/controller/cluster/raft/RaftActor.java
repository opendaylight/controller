...
public abstract class RaftActor extends UntypedPersistentActor {
    ...
    public void onReceiveRecover(Object message) {
        if (message instanceof SnapshotOffer) {
            ...
            onLogEntryRecovery((ReplicatedLogEntry)message);
    ...
    private void onLogEntryRecovery(ReplicatedLogEntry logEntry) {
        initRecoveryTimer();
        ...
        appendRecoveryLogEntry(logEntry.getData());
     ...
     */
    protected abstract void appendRecoveryLogEntry(Payload data);
