...
public abstract class RaftActor extends UntypedPersistentActor {
    ...
    private static final int SNAPSHOT_ENTRY_COUNT = 50;
    ...
    @Override public void onReceiveRecover(Object message) {
        if (message instanceof SnapshotOffer) {
            ...
            LOG.debug("Applied snapshot to replicatedLog. " +
                "snapshotIndex="+replicatedLog.snapshotIndex +
                ", snapshotTerm="+replicatedLog.snapshotTerm +
                ", journal-size="+replicatedLog.size());
