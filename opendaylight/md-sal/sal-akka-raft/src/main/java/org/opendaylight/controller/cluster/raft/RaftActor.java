...
public abstract class RaftActor extends AbstractUntypedPersistentActor {
    ...
    protected boolean isLeaderActive() {
        return currentBehavior.state() == RaftState.Leader && !shuttingDown && leadershipTransferInProgress == null;
    }
    ...
    /**
     * This method is called during operations such as leadership transfer and actor shutdown when the leader
     * must pause or stop its duties. This method allows derived classes to gracefully pause or finish work
     * prior to performing the operation. On completion of the work, the run method must be called to proceed
