...
public class Leader extends AbstractRaftActorBehavior {
    ...
    public Leader(RaftActorContext context) {
        ...
        //TODO: shouldn't minReplicationCount be one less than the vote count?
        ...
        minIsolatedLeaderPeerCount = getMajorityVoteCount(followers.size()) - 1;
    ...
    @Override public RaftActorBehavior handleMessage(ActorRef sender, Object originalMessage) {
        ...
        try {
            if (message instanceof SendHeartBeat) {
                ...
                if (isLeaderIsolated()) {
                    LOG.info("At least {} followers need to be active, Leader {} switching from Leader to IsolatedLeader",
    ...
    protected boolean isLeaderIsolated() {
        int count = minIsolatedLeaderPeerCount;
    ...
    private void scheduleIsolatedLeaderCheck(FiniteDuration isolatedCheckInterval) {
