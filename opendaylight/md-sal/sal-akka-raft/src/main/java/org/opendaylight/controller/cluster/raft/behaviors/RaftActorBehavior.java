...
public abstract class RaftActorBehavior implements AutoCloseable {
     ...
     */
    private final @NonNull RaftRoles raftRole;
    ...
    RaftActorBehavior(final RaftActorContext context, final RaftRoles raftRole) {
    ...
    /**
     * Returns the {@linkplain RaftRoles} associated with this behavior.
     *
     * @return the {@linkplain RaftRoles} constant
     */
    public final @NonNull RaftRoles raftRole() {
        return raftRole;
    }
