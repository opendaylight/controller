...
public class DefaultConfigParamsImpl implements ConfigParams {
    ...
    private static final int MAX_APPEND_ENTRIES_MESSAGE_SIZE = 1024 * 100; //100KB
    ...
    private int maxAppendEntriesMessageSize = MAX_APPEND_ENTRIES_MESSAGE_SIZE;
    ...
    public void setMaxAppendEntriesMessageSize(final int appendEntriesMessageSize) {
        this.maxAppendEntriesMessageSize = appendEntriesMessageSize;
    }
