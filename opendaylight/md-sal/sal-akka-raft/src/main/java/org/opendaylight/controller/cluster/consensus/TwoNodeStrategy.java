...
public class TwoNodeStrategy extends AbstractConsensus {
    ...
    public DataSentAction onDataSent(Leader leader) {
        TwoNodeAction action = getTwoNodeAction(leader, TwoNodeAction.NONE, TwoNodeAction.NONE, TwoNodeAction.BECOME_FOLLOWER);
    ...
    public HeartbeatNotReceivedAction onHeartbeatNotReceived(Follower follower) {
        TwoNodeAction action = getTwoNodeAction(follower, TwoNodeAction.BECOME_LEADER, TwoNodeAction.NONE, TwoNodeAction.NONE);
    ...
    public ElectionTimeoutAction onElectionTimeout(Candidate candidate) {
        TwoNodeAction action = getTwoNodeAction(candidate, TwoNodeAction.BECOME_LEADER, TwoNodeAction.BECOME_LEADER, TwoNodeAction.NONE);
    ...
    private TwoNodeAction getTwoNodeAction(Participant participant, TwoNodeAction primaryAction, TwoNodeAction activeSecondaryAction, TwoNodeAction passiveSecondaryAction) {
