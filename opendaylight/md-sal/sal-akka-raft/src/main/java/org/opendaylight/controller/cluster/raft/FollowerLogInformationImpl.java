...
public class FollowerLogInformationImpl implements FollowerLogInformation{
    ...
    @Override public boolean isFollowerActive(FiniteDuration timeoutDuration) {
        long elapsed = stopwatch.elapsed(timeoutDuration.unit());
        return (stopwatch.isRunning()) && timeoutDuration.$greater$eq(
            Duration.create(elapsed,timeoutDuration.unit()));
    }

    @Override public void markFollowerActive() {
