...
final class AR implements Externalizable {
    ...
    public void readExternal(final ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        boolean success = (flags & SUCCESS) != 0;
        ...
        boolean forceInstallSnapshot = (flags & FORCE_INSTALL_SNAPSHOT) != 0;
        boolean needsLeaderAddress = (flags & NEEDS_LEADER_ADDRESS) != 0;

        appendEntriesReply = new AppendEntriesReply(followerId, term, success, logLastIndex, logLastTerm,
                payloadVersion, forceInstallSnapshot, needsLeaderAddress, raftVersion, RaftVersions.CURRENT_VERSION);
    }
