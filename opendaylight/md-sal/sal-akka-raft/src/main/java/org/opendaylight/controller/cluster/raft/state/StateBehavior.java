 ...
 * <ul>
 *   <li>{@link StoppedState}, which is where we start from</a>
 ...
 */
@NonNullByDefault
public sealed interface StateBehavior permits RaftStateBehavior, StartingState, StoppedState {

    // TODO: async?
    StoppedState toStopped();
}
