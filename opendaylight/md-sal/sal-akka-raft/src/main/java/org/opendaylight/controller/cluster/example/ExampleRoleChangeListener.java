...
public class ExampleRoleChangeListener extends AbstractUntypedActor implements AutoCloseable{
    ...
    private static final String NOTIFIER_AKKA_URL = "akka://raft-test/user/";
    ...
    protected void handleReceive(Object message) throws Exception {
        ...
        } else if (message instanceof ExampleRoleChangeNotification) {
            // called by the Notifier
            ExampleRoleChangeNotification notification = (ExampleRoleChangeNotification) message;
