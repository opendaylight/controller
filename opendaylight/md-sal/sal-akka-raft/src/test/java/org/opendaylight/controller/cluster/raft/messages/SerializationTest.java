...
public class SerializationTest {
    ...
    @Test
    public void testReplicatedLogImplEntry() {
        ReplicatedLogImplEntry expected = new ReplicatedLogImplEntry(
                1, 2, new MockRaftActorContext.MockPayload("1"));
        ReplicatedLogImplEntry actual = (ReplicatedLogImplEntry) SerializationUtils.clone(expected);
        assertEquals("Entry getTerm", expected.getTerm(), actual.getTerm());
        assertEquals("Entry getIndex", expected.getIndex(), actual.getIndex());
        assertEquals("Entry getData", expected.getData(), actual.getData());
    }
