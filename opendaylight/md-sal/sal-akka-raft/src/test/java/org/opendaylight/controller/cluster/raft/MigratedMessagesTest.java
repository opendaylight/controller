...
public class MigratedMessagesTest extends AbstractActorTest {
    ...
    private TestActorRef<MockRaftActor> doTestSnapshotAfterStartupWithMigratedServerConfigPayload(final boolean persistent) {
        String persistenceId = factory.generateActorId("test-actor-");
    ...
    private TestActorRef<MockRaftActor> doTestSnapshotAfterStartupWithMigratedMessage(final String id, final boolean persistent,
            final Consumer<Snapshot> snapshotVerifier) {
