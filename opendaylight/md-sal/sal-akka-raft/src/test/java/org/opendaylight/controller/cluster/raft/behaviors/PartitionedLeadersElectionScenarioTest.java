...
public class PartitionedLeadersElectionScenarioTest extends AbstractLeaderElectionScenarioTest {
    ...
    private void resolvePartitionedLeadersWithLeaderMember2SendingHeartbeatFirst() {
        ...
        assertEquals("member 3 election term", 3, member3Context.getTermInformation().term());
    ...
    private void sendElectionTimeoutToNowCandidateMember2() {
        ...
        assertEquals("getTerm", member2Context.getTermInformation().term(), requestVoteReply.getTerm());
        ...
        assertEquals("member 1 election term", 3, member1Context.getTermInformation().term());
        assertEquals("member 2 election term", 3, member2Context.getTermInformation().term());
        assertEquals("member 3 election term", 2, member3Context.getTermInformation().term());
    ...
    private void sendInitialElectionTimeoutToFollowerMember3() {
        ...
        assertEquals("member 1 election term", 2, member1Context.getTermInformation().term());
        assertEquals("member 2 election term", 2, member2Context.getTermInformation().term());
        assertEquals("member 3 election term", 2, member3Context.getTermInformation().term());
    ...
    private void sendInitialElectionTimeoutToFollowerMember2() {
        ...
        assertEquals("member 1 election term", 2, member1Context.getTermInformation().term());
        assertEquals("member 2 election term", 2, member2Context.getTermInformation().term());
        assertEquals("member 3 election term", 1, member3Context.getTermInformation().term());
