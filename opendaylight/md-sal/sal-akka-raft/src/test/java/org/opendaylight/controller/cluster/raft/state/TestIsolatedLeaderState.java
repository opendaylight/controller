...
@NonNullByDefault
public record TestIsolatedLeaderState(LeaderStuff stuff) implements IsolatedLeaderState {
    public TestIsolatedLeaderState {
    ...
    @Override
    public StoppedState toStopped() {
        return TestStoppedState.INSTANCE;
    }
