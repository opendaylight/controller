...
public class LeadershipTransferIntegrationTest extends AbstractRaftActorIntegrationTest {
    ...
    @Test
    public void testLeaderTransferSkippedWithNoFollowers() throws Throwable {
        testLog.info("testLeaderTransferSkippedWithNoFollowers starting");
        ...
        testLog.info("testLeaderTransferSkippedWithNoFollowers ending");
    }
}
