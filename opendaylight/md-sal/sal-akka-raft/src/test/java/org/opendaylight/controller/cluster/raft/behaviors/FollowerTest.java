...
public class FollowerTest extends AbstractRaftActorBehaviorTest {
    ...
    public void testThatAnElectionTimeoutIsTriggered(){
        new JavaTestKit(getSystem()) {{
            ...
            new Within(DefaultConfigParamsImpl.HEART_BEAT_INTERVAL.$times(3)) {
                protected void run() {

                    Follower follower = new Follower(createActorContext(getTestActor()));

                    final Boolean out = new ExpectMsg<Boolean>(DefaultConfigParamsImpl.HEART_BEAT_INTERVAL.$times(3), "ElectionTimeout") {
