...
public class ReplicationAndSnapshotsWithLaggingFollowerIntegrationTest extends AbstractRaftActorIntegrationTest {
    ...
    private void setupLeaderWithSingleFollower(final DefaultConfigParamsImpl leaderConfig) {
        ...
        Map<String, String> leaderPeerAddresses = Map.of(follower1Id, follower1Actor.path().toString());
    ...
    public void testReceivingSnapshotDuringInstallSnapshotFromDifferentLeader() {
        ...
        final MockPayload payload8 = sendPayloadData(leaderActor, "eight");
        final MockPayload payload9 = sendPayloadData(leaderActor, "nine");
        final MockPayload payload10 = sendPayloadData(leaderActor, "ten");
        ...
        final MockPayload payload11 = sendPayloadData(leaderActor, "eleven");
        final MockPayload payload12 = sendPayloadData(leaderActor, "twelve");
        final MockPayload payload13 = sendPayloadData(leaderActor, "thirteen");
        final MockPayload payload14 = sendPayloadData(leaderActor, "fourteen");
        final MockPayload payload15 = sendPayloadData(leaderActor, "fifteen");

        List<InstallSnapshotReply> installSnapshotRepliesFromNewLeader = MessageCollectorActor.expectMatching(
                leaderCollectorActor, InstallSnapshotReply.class, 4);
