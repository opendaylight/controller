...
public class RaftActorServerConfigurationSupportTest extends AbstractActorTest {
    ...
    public void testChangeToVotingWithNoLeader() {
        ...
        // via he server config. The server config will also contain 2 voting peers that are down (ie no
        // actors created).
        ...
        // down nodes are switched to non-voting, node1 shoild only need a vote from node2.
        ...
        MessageCollectorActor.expectFirstMatching(node1Collector, ApplyState.class);
        verifyServerConfigurationPayloadEntry(node1RaftActor.getRaftActorContext().getReplicatedLog(),
        ...
        MessageCollectorActor.expectFirstMatching(node2Collector, ApplyState.class);
