...
public class RaftActorServerConfigurationSupportTest extends AbstractActorTest {
    ...
    abstract static class AbstractMockRaftActor extends MockRaftActor {
        ...
        AbstractMockRaftActor(final String id, final Map<String, String> peerAddresses, final Optional<ConfigParams> config,
                final boolean persistent, final TestActorRef<MessageCollectorActor> collectorActor) {
    ...
    public static class CollectingMockRaftActor extends AbstractMockRaftActor {
        ...
        CollectingMockRaftActor(final String id, final Map<String, String> peerAddresses, final Optional<ConfigParams> config,
                final boolean persistent, final TestActorRef<MessageCollectorActor> collectorActor) {
        ...
        public static Props props(final String id, final Map<String, String> peerAddresses,
                final ConfigParams config, final boolean persistent, final TestActorRef<MessageCollectorActor> collectorActor) {
