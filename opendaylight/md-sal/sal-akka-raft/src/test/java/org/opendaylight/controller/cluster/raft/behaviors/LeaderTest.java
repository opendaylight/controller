...
public class LeaderTest extends AbstractLeaderTest<Leader> {
    ...
    public void testInstallSnapshot() {
        ...
        Snapshot snapshot = Snapshot.create(ByteState.of(bytes), List.of(), lastAppliedIndex, 1, lastAppliedIndex, 2,
            new TermInfo(-1), null);
    ...
    public void testForceInstallSnapshot() {
        ...
        Snapshot snapshot = Snapshot.create(ByteState.of(bytes), List.of(),
                lastAppliedIndex, -1, lastAppliedIndex, -1, new TermInfo(-1), null);
    ...
    public void testSendSnapshotfromInstallSnapshotReply() {
        ...
        ByteString bs = toByteString(leadersSnapshot);
        Snapshot snapshot = Snapshot.create(ByteState.of(bs.toByteArray()), List.of(), commitIndex, 2, commitIndex, 2,
            new TermInfo(-1), null);
    ...
    public void testHandleInstallSnapshotReplyWithInvalidChunkIndex() {
        ...
        ByteString bs = toByteString(leadersSnapshot);
        Snapshot snapshot = Snapshot.create(ByteState.of(bs.toByteArray()), List.of(), commitIndex, 1, commitIndex, 2,
            new TermInfo(-1), null);
