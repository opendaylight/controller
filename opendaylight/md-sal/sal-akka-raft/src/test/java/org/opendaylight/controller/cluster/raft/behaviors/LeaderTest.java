...
public class LeaderTest extends AbstractLeaderTest<Leader> {
    ...
    public void testThatLeaderSendsAHeartbeatMessageToAllFollowers() {
        ...
        long term = 1;
        actorContext.setTermInformation(term, "");
    ...
    public void testHandleReplicateMessageWithHigherTermThanPreviousEntry() {
        ...
        long prevTerm = actorContext.getTermInformation().currentTerm();
        long newTerm = prevTerm + 1;
        actorContext.setTermInformation(newTerm, "");
    ...
    public void testInstallSnapshot() {
        ...
        actorContext.getReplicatedLog().setSnapshotIndex(snapshotIndex);
        actorContext.getReplicatedLog().setSnapshotTerm(snapshotTerm);
        actorContext.setTermInformation(currentTerm, leaderActor.path().toString());
    ...
    public void testSendSnapshotfromInstallSnapshotReply() {
        ...
        followerActor.underlyingActor().clear();
        leader.handleMessage(followerActor, new InstallSnapshotReply(actorContext.getTermInformation().currentTerm(),
    ...
    public void testHandleAppendEntriesReplySuccess() {
        ...
        leaderActorContext.setTermInformation(1, "leader");
    ...
    public void testLaggingFollowerStarvation() {
        ...
        leaderActorContext.setPeerAddresses(peerAddresses);
        leaderActorContext.setTermInformation(1, leaderActorId);
