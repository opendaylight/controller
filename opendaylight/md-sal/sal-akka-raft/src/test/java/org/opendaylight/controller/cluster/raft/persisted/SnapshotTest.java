...
public class SnapshotTest {
    ...
    private void testSerialization(byte[] state, List<ReplicatedLogEntry> unapplied) throws Exception {
        ...
        Snapshot expected = Snapshot.create(ByteSource.wrap(state), unapplied, lastIndex, lastTerm, lastAppliedIndex,
        ...
        assertArrayEquals("state", expected.getState().read(), cloned.getState().read());
