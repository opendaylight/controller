        ...
        new JavaTestKit(getSystem()) {
            {
                ...
                MockRaftActorContext leaderActorContext = new MockRaftActorContext(persistenceId, getSystem(), leaderActor.self());
                leaderActorContext.setConfigParams(config);
                ...
                leaderActorContext.setCommitIndex(4);
                leaderActorContext.setLastApplied(4);
                leaderActorContext.getTermInformation().update(1, persistenceId);
                ...
                leaderActorContext.setReplicatedLog(logBuilder.createEntries(0, 8, 1).build());
                leaderActor.setRaftActorContext(leaderActorContext);

                assertEquals(8, leaderActor.getReplicatedLog().size());

                leaderActor.onReceiveCommand(new CaptureSnapshot(6,1,4,1));
                leaderActorContext.setSnapshotCaptureInitiated(true);
                ...
                assertFalse(leaderActorContext.isSnapshotCaptureInitiated());
        ...
        new JavaTestKit(getSystem()) {
            {
                ...
                MockRaftActorContext followerActorContext = new MockRaftActorContext(persistenceId, getSystem(), followerActor.self());
                followerActorContext.setConfigParams(config);
                ...
                followerActorContext.setPeerAddresses(peerAddresses);
                followerActorContext.setCommitIndex(4);
                followerActorContext.setLastApplied(4);
                followerActorContext.getTermInformation().update(1, persistenceId);
                ...
                MockRaftActorContext.MockReplicatedLogBuilder logBuilder = new MockRaftActorContext.MockReplicatedLogBuilder();
                followerActorContext.setReplicatedLog(logBuilder.createEntries(0, 6, 1).build());
                followerActor.setRaftActorContext(followerActorContext);
                ...
                followerActorContext.setSnapshotCaptureInitiated(true);
                ...
                assertFalse(followerActorContext.isSnapshotCaptureInitiated());
                ...
                followerActor.onReceiveCommand(new AppendEntries(1, "leader", 7, 1, entries , 6, 7));
                assertEquals(1, followerActor.getReplicatedLog().size());
