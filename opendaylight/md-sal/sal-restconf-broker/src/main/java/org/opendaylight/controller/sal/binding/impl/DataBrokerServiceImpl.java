...
import org.opendaylight.controller.sal.listeners.RemoteDataChangeNotificationListener;
import org.opendaylight.controller.sal.tools.RemoteStreamTools;
import org.opendaylight.controller.sal.transactions.RemoteDataModificationTransaction;
...
public class DataBrokerServiceImpl implements DataBrokerService  {
    ...
    public DataObject readConfigurationData(InstanceIdentifier<? extends DataObject> path) {
        return (DataObject) this.restconfClientContext.getConfigurationDatastore().readData(path);
    }

    @Override
    public DataObject readOperationalData(InstanceIdentifier<? extends DataObject> path) {
        return (DataObject) this.restconfClientContext.getOperationalDatastore().readData(path);
    }
