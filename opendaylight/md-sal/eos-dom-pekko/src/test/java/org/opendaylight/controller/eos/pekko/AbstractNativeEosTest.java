...
import org.opendaylight.controller.eos.pekko.owner.supervisor.command.OwnerSupervisorReply;
...
public abstract class AbstractNativeEosTest {
    ...
    protected static MockNativeEntityOwnershipService startupNativeService(final int port, final List<String> roles,
        ...
        final org.apache.pekko.actor.ActorSystem system = org.apache.pekko.actor.ActorSystem.create("ClusterSystem", config);
    ...
    protected static final class MockNativeEntityOwnershipService extends PekkoEntityOwnershipService {
