...
/**
 * Data tree store mutation capabilities (without transaction semantics).
 *
 * @see WriteTransaction
 *
 * @author unascribed - Original version in WriteTransaction
 * @author Michael Vorburger - Split WriteTransaction VS WriteableDataStore
 */
