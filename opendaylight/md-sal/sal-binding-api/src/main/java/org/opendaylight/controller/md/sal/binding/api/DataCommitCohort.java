...
public interface DataCommitCohort {
    ...
    public static final ListenableFuture<?> NOOP_FUTURE = Futures.immediateFuture(null);;
    ...
    public interface CohortTransaction {
         ...
         *
         **/
        @Nonnull ListenableFuture<?> preCommit();
     ...
     */
    @Nonnull
    CohortTransaction canCommit(@Nonnull Object txId, @Nonnull DataTreeModification candidate)
            throws DataValidationFailedException;
