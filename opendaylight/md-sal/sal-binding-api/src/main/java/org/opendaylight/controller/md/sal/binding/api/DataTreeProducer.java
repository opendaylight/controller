...
public interface DataTreeProducer extends DataTreeProducerFactory, AutoCloseable {
     ...
     *
     * @param barrier Indicates whether this transaction should be a barrier. A barrier transaction
     ...
     * @throws {@link IllegalThreadStateException} if the calling thread context does not match the
