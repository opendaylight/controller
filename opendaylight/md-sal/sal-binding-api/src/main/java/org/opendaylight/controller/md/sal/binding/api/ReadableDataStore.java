...
/**
 * Data store read access (without transaction semantics).
 *
 * @see ReadTransaction
 *
 * @author unascribed - Original version in ReadTransaction
 * @author Michael Vorburger - Split ReadTransaction VS ReadableDataStore
 */
public interface ReadableDataStore {
     ...
     *
     * <p>If the target is a subtree, then the whole subtree is read (and will be
