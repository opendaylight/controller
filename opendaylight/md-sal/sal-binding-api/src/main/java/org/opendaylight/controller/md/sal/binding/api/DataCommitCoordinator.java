...
public interface DataCommitCoordinator {
     ...
     *
     * @param validator
     * @return Registration object for supplied validator. Invoking {@link DataCommitCohortRegistration#close()}
     * method will unregister validator.
     */
    <T extends DataCommitCohort> DataCommitCohortRegistration<T> registerCommitCohort(LogicalDatastoreType store, T cohort);
}
