...
/**
 * A transaction that provides read access to a data store.
 *
 * <p>For more information on usage and examples, please see the documentation in {@link AsyncReadTransaction}.
 */
