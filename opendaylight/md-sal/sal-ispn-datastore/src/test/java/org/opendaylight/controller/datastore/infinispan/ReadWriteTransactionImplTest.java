...
public class ReadWriteTransactionImplTest {
    ...
    public void testBasic() throws Exception{
        ...
        final ReadWriteTransactionImpl actor1 = new ReadWriteTransactionImpl("test", schemaContext,
                treeCache,
                MoreExecutors.listeningDecorator(Executors.newSingleThreadExecutor()),
                1,new ListenerRegistrationManager(MoreExecutors.listeningDecorator(Executors.newSingleThreadExecutor())));
        ...
        final ReadWriteTransactionImpl actor2 = new ReadWriteTransactionImpl("test", schemaContext,
                treeCache,
                MoreExecutors.listeningDecorator(Executors.newSingleThreadExecutor()),
                2, new ListenerRegistrationManager(MoreExecutors.listeningDecorator(Executors.newSingleThreadExecutor())));
