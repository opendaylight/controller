...
public class TestModel {
    ...
    public static final QName AUG_QNAME = QName.create("urn:opendaylight:params:xml:ns:yang:controller:md:sal:dom:store:aug", "2014-03-13",
            "name");
    ...
    public static final QName FAMILY_QNAME = QName.create("urn:opendaylight:params:xml:ns:yang:controller:md:sal:dom:store:notification-test", "2014-04-15",
                "family");
    ...
    public static final InstanceIdentifier FAMILY_PATH = InstanceIdentifier.of(FAMILY_QNAME);
    public static final InstanceIdentifier FAMILY_DESC_PATH = InstanceIdentifier.builder(FAMILY_PATH).node(DESC_QNAME).build();
    public static final InstanceIdentifier CHILDREN_PATH = InstanceIdentifier.builder(FAMILY_PATH).node(CHILDREN_QNAME).build();
  ...
  private static final InstanceIdentifier GRAND_CHILD_2_NAME_PATH = InstanceIdentifier.builder(CHILDREN_2_PATH)
    ...
    public static ContainerNode createTestContainer() {
        ...
        final InstanceIdentifier.AugmentationIdentifier augmentationIdentifier = new InstanceIdentifier.AugmentationIdentifier(null, childAugmentations);
    ...
    public static ContainerNode createFamily(){
        final DataContainerNodeAttrBuilder<InstanceIdentifier.NodeIdentifier,ContainerNode> familyContainerBuilder = ImmutableContainerNodeBuilder
                .create()
                .withNodeIdentifier(new InstanceIdentifier.NodeIdentifier(FAMILY_QNAME));
