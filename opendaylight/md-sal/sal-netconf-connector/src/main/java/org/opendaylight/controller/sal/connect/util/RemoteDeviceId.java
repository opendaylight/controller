...
public class RemoteDeviceId {
    ...
    public RemoteDeviceId(final String name) {
        ...
        this.bindingPath = InstanceIdentifier.builder(Nodes.class).child(Node.class, key).build();
        this.path = getBIPath(bindingPath, name);
    }

    private static org.opendaylight.yangtools.yang.data.api.InstanceIdentifier getBIPath(final InstanceIdentifier<Node> bindingPath, final String name) {
        // TODO how to transform binding path to BI path ?
