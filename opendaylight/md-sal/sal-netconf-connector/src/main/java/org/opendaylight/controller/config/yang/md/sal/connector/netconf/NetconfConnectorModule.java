...
public final class NetconfConnectorModule extends org.opendaylight.controller.config.yang.md.sal.connector.netconf.AbstractNetconfConnectorModule
{
    ...
    public static final int INITIAL_CONNECTION_ATTEMPT_TIMEOUT = 1000;
    public static final int CONNECTION_ATTEMPT_SLEEP_FACTOR = 2;
    ...
    public java.lang.AutoCloseable createInstance() {
        ...
        final RemoteDeviceSalFacade salFacade = new NetconfDeviceSalFacade(id, domBroker, bindingBroker, bundleContext, globalProcessingExecutor);
        ...
        // Closing listener issues a close on device and then close on salFacade
        return listener;
    }
    ...
    private ExecutorService getGlobalProcessingExecutor() {
        // TODO shouldnt this be injected ?
    ...
    private ReconnectStrategy getReconnectStrategy() {
        ...
        final double sleepFactor = CONNECTION_ATTEMPT_SLEEP_FACTOR;
        final int minSleep = INITIAL_CONNECTION_ATTEMPT_TIMEOUT;
