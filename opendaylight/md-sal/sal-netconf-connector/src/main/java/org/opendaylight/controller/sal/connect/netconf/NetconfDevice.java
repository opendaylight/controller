 ...
 */
public final class NetconfDevice implements RemoteDevice<NetconfSessionCapabilities, NetconfMessage, NetconfDeviceCommunicator> {
    ...
    private boolean shouldListenOnSchemaChange(final NetconfSessionCapabilities remoteSessionCapabilities) {
