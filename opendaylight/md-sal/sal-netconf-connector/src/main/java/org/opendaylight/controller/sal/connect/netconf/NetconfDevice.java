...
public final class NetconfDevice implements RemoteDevice<NetconfSessionPreferences, NetconfMessage> {
    ...
    @Override
    public void onRemoteSessionFailed() {
        salFacade.onDeviceFailed();
    }
...
//                    Collection<QName> filteredQNames = Collections2.filter(remoteSessionCapabilities.getModuleBasedCaps(), new Predicate<QName>() {
//                        @Override
//                        public boolean apply(QName qName) {
//                            if (capabilities.getUnresolvedSourceNamesToRevisions().containsKey(qName.getLocalName())
//                                    && capabilities.getUnresolvedSourceNamesToRevisions().get(qName.getLocalName()).equals(qName.getFormattedRevision())) {
//                                return false;
//                            } else {
//                                return true;
//                            }
...
//                    });
                ...
                public void onFailure(final Throwable t) {
                    ...
                    if (t instanceof MissingSchemaSourceException) {
                        ...
                        capabilities.addUnresolvedCapability(getQNameFromSourceIdentifier(missingSource), FailureReason.MissingSource);
        ...
        private Collection<QName> getQNameFromSourceIdentifiers(Collection<SourceIdentifier> identifiers) {
            ...
            for (SourceIdentifier source : identifiers) {
                qNames.add(getQNameFromSourceIdentifier(source));
            }
            return qNames;
        }
