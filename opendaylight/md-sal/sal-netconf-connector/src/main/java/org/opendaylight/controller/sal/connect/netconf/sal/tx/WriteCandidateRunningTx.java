...
public class WriteCandidateRunningTx extends WriteCandidateTx {
    ...
    private void unlockRunning() {
        try {
            ...
            LOG.warn("{}: Failed to unlock running. Failed to cleanup after successful transaction", e);
            throw new RuntimeException(id + ": Failed to unlock running. Failed to cleanup after successful transaction", e);
        }
    }
}
