...
public final class KeepaliveSalFacade implements RemoteDeviceHandler<NetconfSessionPreferences> {
    ...
    private static final DataContainerChild<?, ?> EMPTY_FILTER = NetconfMessageTransformUtil.emptyFilter();
    private static final ContainerNode KEEPALIVE_PAYLOAD =
            NetconfMessageTransformUtil.wrap(NETCONF_GET_CONFIG_QNAME, getSourceNode(NETCONF_RUNNING_QNAME), EMPTY_FILTER);
