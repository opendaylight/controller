...
public final class KeepaliveSalFacade implements RemoteDeviceHandler<NetconfSessionPreferences> {
    ...
    private static final class RequestTimeoutTask implements Runnable {
        ...
        private final CheckedFuture<DOMRpcResult, DOMRpcException> domRpcResultDOMRpcExceptionCheckedFuture;

        public RequestTimeoutTask(final CheckedFuture<DOMRpcResult, DOMRpcException> domRpcResultDOMRpcExceptionCheckedFuture) {
            this.domRpcResultDOMRpcExceptionCheckedFuture = domRpcResultDOMRpcExceptionCheckedFuture;
        }

        @Override
        public void run() {
            if (!domRpcResultDOMRpcExceptionCheckedFuture.isDone()) {
                domRpcResultDOMRpcExceptionCheckedFuture.cancel(true);
            }
        }
    }
