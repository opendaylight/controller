...
public class GroupProvider implements AutoCloseable {
    ...
    public void start() {
        ...
        this.commitHandler = new GroupCommitHandler(this.salGroupService);
        this.commitHandlerRegistration = this.dataService.registerCommitHandler(groupDataObjectPath, commitHandler);
        GroupProvider.LOG.info("Group Config Provider started.");
    }
