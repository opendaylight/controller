...
public class FlowProvider implements AutoCloseable {
    ...
    public void start() {
        ...
        this.commitHandler = new FlowCommitHandler(this.salFlowService);
        this.commitHandlerRegistration = this.dataService.registerCommitHandler(flowDataObjectPath, this.commitHandler);
        FlowProvider.LOG.info("Flow Config Provider started.");
    }
