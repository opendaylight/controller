...
public class MeterProvider implements AutoCloseable {
    ...
    /* DataCommitHanndler */
    private MeterCommitHandler commitHandler;
    ...
    public void start() {
        ...
        /* DataChangeListener registration -> New ThreePhaseCommit and new DataStore */
        ...
        /* DataCommitHandler registration -> Old TwoPhaseCommit TODO removeIt after change to new DataStore */
        this.commitHandler = new MeterCommitHandler(this.salMeterService);
        this.commitHandlerRegistration = this.dataService.registerCommitHandler(meterDataObjectPath, this.commitHandler);
        MeterProvider.LOG.info("Meter Config Provider started.");
    }
