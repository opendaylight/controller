...
class FlowNodeConfigProvider implements AutoCloseable {
    ...
    val FlowNodeConfigDataCommitHandler commitHandler = new FlowNodeConfigDataCommitHandler(this);
    
    static val LOG = LoggerFactory.getLogger(FlowNodeConfigProvider);
