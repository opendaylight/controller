...
public enum FlowCookieManager {
    ...
    private final static Logger LOG = LoggerFactory.getLogger(FlowCookieManager.class);
    ...
    private static void validationInputValues(final DataProviderService dataService,
        ...
        try {
            ...
            LOG.error("Input validation exception: ", e);
            throw e;
        }
    ...
    private static void validationTableIdentifier(final InstanceIdentifier<Table> tableIdentifier) {
        if (tableIdentifier == null) {
            String errMsg = "Input validation exception: TableIdentifier can not be null !";
            LOG.error(errMsg);
