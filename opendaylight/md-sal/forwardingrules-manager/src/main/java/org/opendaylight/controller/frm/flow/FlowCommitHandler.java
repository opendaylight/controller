...
@Deprecated
/**
 * @deprecated we don't want support CommitHandler, please use {@link FlowChangeListener}
 */
public class FlowCommitHandler implements DataCommitHandler<InstanceIdentifier<? extends DataObject>,DataObject> {
     ...
     * @deprecated we don't want support CommitHandler, please use {@link FlowChangeListener}
     */
    public FlowCommitHandler(final SalFlowService manager) {
    ...
    public DataCommitTransaction<InstanceIdentifier<? extends DataObject>, DataObject> requestCommit(
        ...
        return new FlowTransaction(modification, this.salFlowService);
    }
}