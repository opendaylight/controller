...
public abstract class AbstractChangeListener implements DataChangeListener {
     ...
     *            but parent Node.class InstanceIdentifier is only used for a check
     *
     * @return boolean - is the Node available in DataStore/OPERATIONAL
     */
    protected boolean isNodeAvailable(final InstanceIdentifier<? extends DataObject> identifier,
        ...
        try {
            ...
            String errMsg = "Unexpected exception by reading Node " + nodeInstanceId;
            LOG.error(errMsg, e);
            return false;
        }
        finally {
