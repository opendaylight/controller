 ...
 *  add, update and remove {@link Flow} processing from {@link AsyncDataChangeEvent}.
 *
...
public class FlowChangeListener extends AbstractChangeListener {
    ...
    protected boolean preconditionForChange(final InstanceIdentifier<? extends DataObject> identifier,
        ...
        return update != null
                ? (dataObj instanceof Flow && update instanceof Flow && isNodeAvaliable(identifier, trans))
                : (dataObj instanceof Flow && isNodeAvaliable(identifier, trans));
    }
}
