 ...
 *
 */
public class GroupChangeListener extends AbstractChangeListener<Group> {

    private static final Logger LOG = LoggerFactory.getLogger(GroupChangeListener.class);

    private ListenerRegistration<DataChangeListener> listenerRegistration;

    public GroupChangeListener (final ForwardingRulesManager manager, final DataBroker db) {
        super(manager);
        Preconditions.checkNotNull(db, "DataBroker can not be null!");
        /* Build Path */
        InstanceIdentifier<Group> groupWildCardIdentifier = InstanceIdentifier.create(Nodes.class)
        ...
        this.listenerRegistration = db.registerDataChangeListener(LogicalDatastoreType.CONFIGURATION,
                groupWildCardIdentifier, GroupChangeListener.this, DataChangeScope.SUBTREE);
    }
    ...
    public void remove(final InstanceIdentifier<Group> identifier, final Group removeDataObj,
        ...
        LOG.debug("Transaction {} - Remove Group has removed group: {}", uri, removeDataObj);
    }
    ...
    public void update(final InstanceIdentifier<Group> identifier,
        ...
        LOG.debug("Transaction {} - Update Group has updated group {} with group {}", uri, original, update);
    }
    ...
    public void add(final InstanceIdentifier<Group> identifier, final Group addDataObj,
        ...
        LOG.debug("Transaction {} - Add Group has added group: {}", uri, addDataObj);
    }
}
