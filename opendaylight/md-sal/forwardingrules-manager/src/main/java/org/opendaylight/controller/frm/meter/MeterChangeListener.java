 ...
 *  add, update and remove {@link Meter} processing from {@link AsyncDataChangeEvent}.
 *
...
public class MeterChangeListener extends AbstractChangeListener {
    ...
    protected boolean preconditionForChange(final InstanceIdentifier<? extends DataObject> identifier,
        ...
        return update != null
                ? (dataObj instanceof Meter && update instanceof Meter && isNodeAvaliable(identifier, trans))
                : (dataObj instanceof Meter && isNodeAvaliable(identifier, trans));
    }
}
