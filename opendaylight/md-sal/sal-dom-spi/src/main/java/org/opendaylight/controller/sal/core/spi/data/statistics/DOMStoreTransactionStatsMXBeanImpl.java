...
public class DOMStoreTransactionStatsMXBeanImpl extends AbstractMXBean
     ...
     * Constructor.
     *
     * @param statsTracker the backing DOMStoreTransactionStatsTracker
     ...
     */
    public DOMStoreTransactionStatsMXBeanImpl(DOMStoreTransactionStatsTracker statsTracker,
    ...
    public long getSubmittedWriteTransactionCount() {
        return statsTracker.getSubmittedWriteTransactionCount();
    }
