 ...
 */
@Beta
public final class SnapshotBackedWriteTransaction<T> extends AbstractDOMStoreTransaction<T> implements DOMStoreWriteTransaction {
     ...
     */
    public SnapshotBackedWriteTransaction(final T identifier, final boolean debug,
