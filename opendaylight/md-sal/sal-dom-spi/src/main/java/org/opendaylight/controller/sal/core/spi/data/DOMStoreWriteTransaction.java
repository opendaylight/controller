...
public interface DOMStoreWriteTransaction extends DOMStoreTransaction {
    ...
    /**
     *
     * Seals transaction, and returns three-phase commit instance associated
     * with this transaction to be coordinated by Coordinator.
     *
     * @return Three Phase Commit coordination instance for this transaction.
     */
    DOMStoreThreePhaseCommit requestCommit();
