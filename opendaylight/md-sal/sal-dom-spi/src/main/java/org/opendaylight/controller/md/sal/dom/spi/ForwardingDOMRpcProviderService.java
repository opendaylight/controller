...
public abstract class ForwardingDOMRpcProviderService extends ForwardingObject implements DOMRpcProviderService {
    ...
    @Override
    public DOMRpcImplementationRegistration registerRpcImplementation(final DOMRpcImplementation implementation, final SchemaPath... types) {
        return delegate().registerRpcImplementation(implementation, types);
    }

    @Override
    public DOMRpcImplementationRegistration registerRpcImplementation(final DOMRpcImplementation implementation, final Collection<SchemaPath> types) {
        return delegate().registerRpcImplementation(implementation, types);
    }
}
