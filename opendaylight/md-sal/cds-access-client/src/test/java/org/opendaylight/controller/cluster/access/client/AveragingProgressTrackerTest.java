...
public class AveragingProgressTrackerTest {
    ...
    public void estimateIsolatedDelayTest2() {
        ...
        assertEquals(1499990000, delay);

        delay = averagingProgressTracker.openTask(TIME_2);
        assertEquals(1999990000, delay);
    ...
    @Test
    public void estimateIsolatedDelayTest3() {
        long delay = averagingProgressTracker.openTask(TIME_1);
        assertEquals(CHECKER, delay);
    ...
    @Test
    public void estimateIsolatedDelayTest4() {
        long delay = averagingProgressTracker.openTask(TIME_2);
        assertEquals(1499990000, delay);
    ...
    @Test
    public void estimateIsolatedDelayMaxValueTest() {
        final long highValue = CHECKER * CHECKER;
        averagingProgressTracker.openTask(highValue);
        final long result = averagingProgressTracker.estimateAllowed(highValue);
        Assert.assertTrue(result > highValue);
    }
