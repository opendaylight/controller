...
class ActorBehaviorTest {
    ...
    private void assertRecoveryFlow(final SelectedSnapshot currentStateSnapshot) {
        // actor explicitly requests for clientId snapshot
        probe.expectMsgClass(MockedSnapshotStore.LoadRequest.class);
        probe.reply(Optional.ofNullable(currentStateSnapshot));
        ...
        // snapshot exists
        if (currentStateSnapshot.snapshot() instanceof ClientIdentifier clientId
