...
abstract class AbstractReceivingClientConnection<T extends BackendInfo> extends AbstractClientConnection<T> {
    ...
    AbstractReceivingClientConnection(final ClientActorContext context, final T backend,
    ...
    AbstractReceivingClientConnection(final AbstractReceivingClientConnection<T> oldConnection) {
        super(oldConnection);
        this.inflight = oldConnection.inflight;
    ...
    final void appendToInflight(final TransmittedConnectionEntry e) {
        inflight.offer(e);
    }
