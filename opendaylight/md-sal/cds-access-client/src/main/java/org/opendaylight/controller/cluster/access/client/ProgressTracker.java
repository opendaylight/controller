...
public class ProgressTracker {
     ...
     */
    protected long elapsedBeforeIdle;
    ...
    /**
     * Create a default idle tracker.
     *
     * @param now tick number corresponding to caller's present
     */
    public ProgressTracker(final long now) {
        this(now, 1_000_000_000.0);
    }

    /**
     * Create an idle tracker with specified ticks per task value to use as default.
     *
     * @param now tick number corresponding to caller's present
     * @param ticksPerTask value to use as default
     */
    public ProgressTracker(final long now, final double ticksPerTask) {
