...
final class ReconnectingClientConnection<T extends BackendInfo> extends AbstractReceivingClientConnection<T> {
    ...
    ConnectedClientConnection<T> toConnected(final T backend) {
        // FIXME
        return null;
    }
