...
public final class TerminatedException extends RequestException {
    ...
    private final Instant terminationInstant;

    TerminatedException(final Instant terminationInstant) {
        super("Terminated at " + terminationInstant.toString());
        this.terminationInstant = terminationInstant;
    }

    /**
     * {@return the instant when the {@link ClientActorBehavior} was declared to be terminating}
     */
    public Instant terminationInstant() {
        return terminationInstant;
    }
