...
public class StructuredDataToXmlProvider implements MessageBodyWriter<StructuredData> {
    ...
    public void writeTo(StructuredData t, Class<?> type, Type genericType, Annotation[] annotations,
        ...
        try {
            ...
            transformer.transform(new DOMSource(domTree), new StreamResult(new OutputStreamWriter(entityStream, "UTF-8")));
