 ...
 * <br>
 * <br>
 * <b>Note:</b> Enumerations defined within are provided by the ietf restconf
 * draft.
 *
 * @author Devin Avery
...
public class RestconfError {
    ...
    public static enum ErrorTag {
        IN_USE("in-use", 409 /* Conflict */), INVALID_VALUE("invalid-value", 400 /*
                                                                                  * Bad
                                                                                  * Request
                                                                                  */), TOO_BIG("too-big", 413 /*
                                                                                                               * Request
                                                                                                               ...
                                                                                                               * Large
                                                                                                               */), MISSING_ATTRIBUTE(
                "missing-attribute", 400 /* Bad Request */), BAD_ATTRIBUTE("bad-attribute", 400 /*
                                                                                                 * Bad
                                                                                                 * Request
                                                                                                 */), UNKNOWN_ATTRIBUTE(
                "unknown-attribute", 400 /* Bad Request */), BAD_ELEMENT("bad-element", 400 /*
                                                                                             * Bad
                                                                                             * Request
                                                                                             */), UNKNOWN_ELEMENT(
                "unknown-element", 400 /* Bad Request */), UNKNOWN_NAMESPACE("unknown-namespace", 400 /*
                                                                                                       * Bad
                                                                                                       * Request
                                                                                                       */), ACCESS_DENIED(
                "access-denied", 403 /* Forbidden */), LOCK_DENIED("lock-denied", 409 /* Conflict */), RESOURCE_DENIED(
                "resource-denied", 409 /* Conflict */), ROLLBACK_FAILED("rollback-failed", 500 /* INTERNAL_SERVER_ERROR */), DATA_EXISTS(
                "data-exists", 409 /* Conflict */), DATA_MISSING("data-missing", 409 /* Conflict */), OPERATION_NOT_SUPPORTED(
                "operation-not-supported", 501 /* Not Implemented */), OPERATION_FAILED("operation-failed", 500 /* INTERNAL_SERVER_ERROR */), PARTIAL_OPERATION(
                "partial-operation", 500 /* INTERNAL_SERVER_ERROR */), MALFORMED_MESSAGE("malformed-message", 400 /*
                                                                                                                   * Bad
                                                                                                                   * Request
                                                                                                                   */);
     ...
     *
     * @param errorType
     *            The enumerated type indicating the layer where the error
     *            occurred.
     * @param errorTag
     *            The enumerated tag representing a more specific error cause.
     * @param errorMessage
     *            A string which provides a plain text string describing the
     *            error.
     */
     ...
     *            error.
     * @param errorAppTag
     *            A string which represents an application-specific error tag
     *            that further specifies the error cause.
     */
     ...
     *            that further specifies the error cause.
     * @param errorInfo
     *            A string, <b>formatted as XML</b>, which contains additional
     *            error information.
     */
    public RestconfError(ErrorType errorType, ErrorTag errorTag, String errorMessage, String errorAppTag,
            String errorInfo) {
