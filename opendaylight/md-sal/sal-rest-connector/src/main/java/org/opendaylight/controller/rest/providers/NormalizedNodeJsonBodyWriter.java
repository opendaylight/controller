...
@Provider
@Produces({ Draft02.MediaTypes.API + RestconfConstants.JSON, Draft02.MediaTypes.DATA + RestconfConstants.JSON,
        Draft02.MediaTypes.OPERATION + RestconfConstants.JSON, MediaType.APPLICATION_JSON })
