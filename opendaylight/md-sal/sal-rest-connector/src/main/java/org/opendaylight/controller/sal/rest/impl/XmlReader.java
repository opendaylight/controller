...
public class XmlReader {
    ...
    private SimpleNodeWrapper resolveSimpleNodeFromStartElement(final StartElement startElement) throws XMLStreamException {
        ...
        final URI namespace = URI.create(namespaceURI.isEmpty() ? null : namespaceURI);
        final String localName = startElement.getName().getLocalPart();
        
        return new SimpleNodeWrapper(namespace, localName, data);
    }
    ...
    private CompositeNodeWrapper resolveCompositeNodeFromStartElement(final StartElement startElement) {
        ...
        return new CompositeNodeWrapper(namespace, localName);
    }
