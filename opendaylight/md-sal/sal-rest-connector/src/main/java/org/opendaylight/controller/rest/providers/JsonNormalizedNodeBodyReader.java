...
@Provider
@Consumes({ Draft02.MediaTypes.DATA + RestconfConstants.JSON, Draft02.MediaTypes.OPERATION + RestconfConstants.JSON,
...
public class JsonNormalizedNodeBodyReader extends AbstractIdentifierAwareJaxRsProvider implements MessageBodyReader<NormalizedNodeContext> {
    ...
    public JsonNormalizedNodeBodyReader(final RestSchemaController restSchemaCx) {
        super(restSchemaCx);
    }
