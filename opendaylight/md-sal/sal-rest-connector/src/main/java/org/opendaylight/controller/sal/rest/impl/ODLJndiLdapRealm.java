...
/**
 * An extended implementation of the default <code>JdniLdapRealm</code> that is
...
public class ODLJndiLdapRealm extends JndiLdapRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(
        ...
        try {
            ...
            String message = String.format("AAA LDAP connection from " + username);
              LOG.info(message);
            return super.doGetAuthenticationInfo(token);
        } catch (ClassCastException e) {
            LOG.info("Couldn't service LDAP connection " + e);
        }
    }
