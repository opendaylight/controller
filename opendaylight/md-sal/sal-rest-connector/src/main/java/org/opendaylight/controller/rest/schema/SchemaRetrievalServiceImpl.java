...
public class SchemaRetrievalServiceImpl implements SchemaRetrievalService {
    ...
    private final RestSchemaContextImpl salContext;

    private static final Splitter SLASH_SPLITTER = Splitter.on("/");
    private static final String MOUNT_ARG = RestSchemaContextImpl.MOUNT;

    public SchemaRetrievalServiceImpl(final RestSchemaContextImpl controllerContext) {
