 ...
 */
package org.opendaylight.controller.rest.schema;
...
public class SchemaRetrievalServiceImpl implements SchemaRetrievalService {
    ...
    private final RestSchemaControllerImpl salContext;

    private static final Splitter SLASH_SPLITTER = Splitter.on("/");
    private static final String MOUNT_ARG = RestSchemaControllerImpl.MOUNT;

    public SchemaRetrievalServiceImpl(final RestSchemaControllerImpl controllerContext) {
