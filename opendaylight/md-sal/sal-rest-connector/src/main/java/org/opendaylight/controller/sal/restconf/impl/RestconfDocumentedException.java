...
/**
 * Unchecked exception to communicate error information, as defined in the ietf
 * restcong draft, to be sent to the client.
 *
 * @author Devin Avery
...
public class RestconfDocumentedException extends WebApplicationException {
    ...
    /**
     * Constructs an instance with an error message. The error type defaults to
     * APPLICATION and the error tag defaults to OPERATION_FAILED.
     *
     * @param message
    ...
    /**
     * Constructs an instance with an error message and exception cause. The
     * stack trace of the exception is included in the error info.
     *
     * @param message
     *            A string which provides a plain text string describing the
     *            error.
