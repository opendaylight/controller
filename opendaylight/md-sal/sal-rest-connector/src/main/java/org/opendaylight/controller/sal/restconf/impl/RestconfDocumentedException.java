/*
 * Copyright (c) 2013 Brocade Communications Systems, Inc. and others.  All rights reserved.
 *
...
public class RestconfDocumentedException extends WebApplicationException {
    ...
    private static String toErrorInfo( Throwable cause ) {
