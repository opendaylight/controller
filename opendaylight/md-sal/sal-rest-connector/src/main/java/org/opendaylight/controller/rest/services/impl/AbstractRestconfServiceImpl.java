...
public class AbstractRestconfServiceImpl {
    ...
    protected final RestBrokerFacade dataBroker;
    protected final RestSchemaContext schemaCx;
    ...
    public AbstractRestconfServiceImpl(final RestBrokerFacade dataBroker, final RestSchemaContext schemaCx) {
        this.dataBroker = Preconditions.checkNotNull(dataBroker);
        this.schemaCx = Preconditions.checkNotNull(schemaCx);
    }

    protected Module getRestconfModule() {
        final Module restconfModule = schemaCx.getRestconfModule();
