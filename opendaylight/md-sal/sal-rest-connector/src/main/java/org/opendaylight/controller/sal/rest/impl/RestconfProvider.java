...
public class RestconfProvider implements BundleActivator, Provider {
    ...
    public void start(BundleContext context) throws Exception {
        brokerServiceTrancker = new ServiceTracker<>(context, Broker.class, null);
        brokerServiceTrancker.open();
        final Broker broker = brokerServiceTrancker.getService();
