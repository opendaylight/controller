...
public class RestConnectorProvider implements Provider, AutoCloseable, RestConnector, RestConnectorRuntimeMXBean {
    ...
    public void onSessionInitiated(final ProviderSession session) {
        LOG.info("REST_CONNECTOR_BUNDLE: REGISTERING SERVLETS");
        ...
        final RestSchemaContext rsCx = new RestSchemaContextImpl();
        rsCx.setGlobalSchema(schemaService.getGlobalContext());
        rsCx.setMountService(moutpointService);
        listenerRegistration = schemaService.registerSchemaContextListener(rsCx);
        ...
        try {
            httpService.registerServlet(REST_CONNECTOR_BASE_PATH, restconfServletInit(broker, rsCx), null, null);
    ...
    private ServletContainer restconfServletInit(final RestBrokerFacade br, final RestSchemaContext rsCx) {
        servicesAndStatistics = new RestconfStatisticsServiceWrapperImpl(br, rsCx);
        final ResourceConfig rc = new ResourceConfig();
        rc.register(new RestconfDocumentedExceptionMapper(rsCx), ExceptionMapper.class);
        rc.register(new JsonNormalizedNodeBodyReader(rsCx), MessageBodyReader.class);
        rc.register(new XmlNormalizedNodeBodyReader(rsCx), MessageBodyReader.class);
