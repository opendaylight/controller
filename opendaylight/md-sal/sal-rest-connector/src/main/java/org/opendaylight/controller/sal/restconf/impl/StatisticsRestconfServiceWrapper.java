...
public class StatisticsRestconfServiceWrapper implements RestconfService {
    ...
    public BigInteger getSuccessGet() {
        return BigInteger.valueOf(successGet.get());
    }
    ...
    public BigInteger getFailureGet() {
        return BigInteger.valueOf(failureGet.get());
    }
