...
public class RestconfImpl implements RestconfService {
    ...
    public NormalizedNodeContext invokeRpc(final String identifier, final NormalizedNodeContext payload, final UriInfo uriInfo) {
        ...
        final NormalizedNode<?, ?> resultData = null;
...
//            }
    ...
    public Response createConfigurationData(final String identifier, final NormalizedNodeContext payload, final UriInfo uriInfo) {
        ...
        try {
            if (mountPoint != null) {
                final QName contextLastPathArg = normalizedII.getLastPathArgument().getNodeType();
                final QName dataRoot = payload.getData().getNodeType();
                if (dataRoot.compareTo(contextLastPathArg) != 0) {
                    // FIXME find how to build a parent YangInstanceIdentifier
                }
