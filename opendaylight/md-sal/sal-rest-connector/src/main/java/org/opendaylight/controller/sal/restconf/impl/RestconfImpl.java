...
public class RestconfImpl implements RestconfService {
    ...
    public StructuredData readConfigurationData(final String identifier, UriInfo info) {
        ...
        return new StructuredData(compositeNode, iiWithData.getSchemaNode(), iiWithData.getMountPoint());
    }
    ...
    public StructuredData readOperationalData(final String identifier, UriInfo info) {
        ...
        CompositeNode compositeNode = datastoreNormalizedNodeToCompositeNode(data, iiWithData.getSchemaNode());
        data = pruneDataAtDepth(data, parseDepthParameter(info));
        return new StructuredData(compositeNode, iiWithData.getSchemaNode(), mountPoint);
    }
    ...
    public Response subscribeToStream(final String identifier, final UriInfo uriInfo) {
        ...
        broker.registerToListenDataChanges(toDatastore(identifier), parseScopeParameter(uriInfo), listener);
    ...
    private DataChangeScope parseScopeParameter(UriInfo uriInfo) {
        // TODO Auto-generated method stub
        return null;
    }

    private LogicalDatastoreType toDatastore(String identifier) {
        // TODO Auto-generated method stub
        return null;
    }
    ...
    private CompositeNodeWrapper topLevelElementAsCompositeNodeWrapper(final NodeWrapper<?> node,
        ...
        if (node instanceof CompositeNodeWrapper) {
            ...
            return new CompositeNodeWrapper(node.getNamespace(), node.getLocalName());
        }
