...
public class RestconfImpl implements RestconfService {
    ...
    private CheckedFuture<DOMRpcResult, DOMRpcException> invokeSalRemoteRpcSubscribeRPC(final NormalizedNodeContext payload) {
        ...
        QName outputQname = QName.create(payload.getInstanceIdentifierContext().getSchemaNode().getQName(), "output");
        QName streamNameQname = QName.create(outputQname, "stream-name");
