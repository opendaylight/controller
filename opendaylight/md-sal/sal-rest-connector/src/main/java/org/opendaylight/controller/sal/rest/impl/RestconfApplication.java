...
public class RestconfApplication extends Application {
    ...
    public Set<Class<?>> getClasses() {
        return ImmutableSet.<Class<?>> builder().add(RestconfDocumentedExceptionMapper.class)
                .add(XmlNormalizedNodeBodyReader.class).add(JsonNormalizedNodeBodyReader.class)
                .add(NormalizedNodeJsonBodyWriter.class).add(NormalizedNodeXmlBodyWriter.class)
                .add(SchemaExportContentYinBodyWriter.class).add(SchemaExportContentYangBodyWriter.class).build();
    }
    ...
    public Set<Object> getSingletons() {
        ...
        // singletons.add(new RestconfCompositeWrapper(StatisticsRestconfServiceWrapper.getInstance(),
        // schemaRetrieval));
        return singletons;
    }
