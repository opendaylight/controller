...
public class RestconfDocumentedExceptionMapper implements ExceptionMapper<RestconfDocumentedException> {
    ...
    public RestconfDocumentedExceptionMapper(final RestSchemaContext restSchemaCx) {
    ...
    public Response toResponse(final RestconfDocumentedException exception) {
        ...
        final DataNodeContainer errorsSchemaNode = (DataNodeContainer) restSchemaCx.getRestconfModuleErrorsSchemaNode();
        ...
        final List<DataSchemaNode> schemaList = RestSchemaContextImpl.findInstanceDataChildrenByName(errorsSchemaNode,
        ...
        final NormalizedNodeContext errContext =  new NormalizedNodeContext(new InstanceIdentifierContext<>(null,
                (DataSchemaNode) errorsSchemaNode, null, restSchemaCx.getGlobalSchema()), errContBuild.build());
    ...
    private MapEntryNode toErrorEntryNode(final RestconfError error, final DataSchemaNode errListSchemaNode) {
        ...
        List<DataSchemaNode> lsChildDataSchemaNode = RestSchemaContextImpl.findInstanceDataChildrenByName(
        ...
        lsChildDataSchemaNode = RestSchemaContextImpl.findInstanceDataChildrenByName(
