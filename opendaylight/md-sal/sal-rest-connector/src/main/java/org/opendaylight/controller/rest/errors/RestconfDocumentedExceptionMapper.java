...
package org.opendaylight.controller.rest.errors;
...
public class RestconfDocumentedExceptionMapper implements ExceptionMapper<RestconfDocumentedException> {
    ...
    private final RestSchemaController schemaController;

    public RestconfDocumentedExceptionMapper(final RestSchemaController schemaController) {
    ...
    public Response toResponse(final RestconfDocumentedException exception) {
        ...
        if (accepts != null && !accepts.contains(MediaType.WILDCARD_TYPE)) {
            mediaType = accepts.get(0); // just pick the first non wildcarded one
        } else {
        ...
        final DataNodeContainer errorsSchemaNode = (DataNodeContainer) schemaController.getRestconfModuleErrorsSchemaNode();
        ...
        final List<DataSchemaNode> schemaList = RestSchemaControllerImpl.findInstanceDataChildrenByName(errorsSchemaNode,
        ...
        final NormalizedNodeContext errContext =  new NormalizedNodeContext(new InstanceIdentifierContext<>(null,
                (DataSchemaNode) errorsSchemaNode, null, schemaController.getGlobalSchema()), errContBuild.build());
    ...
    private MapEntryNode toErrorEntryNode(final RestconfError error, final DataSchemaNode errListSchemaNode) {
        ...
        List<DataSchemaNode> lsChildDataSchemaNode = RestSchemaControllerImpl.findInstanceDataChildrenByName(
        ...
        lsChildDataSchemaNode = RestSchemaControllerImpl.findInstanceDataChildrenByName(
