...
public class BrokerFacade {
    ...
    public CheckedFuture<Void, TransactionCommitFailedException> commitConfigurationDataPut(
        ...
        checkPreconditions();
        return putDataViaTransaction(domDataBroker.newReadWriteTransaction(), CONFIGURATION, path, payload,ControllerContext.getInstance().getRootOperation());
    }
    ...
    public CheckedFuture<Void, TransactionCommitFailedException> commitConfigurationDataPost(
            final YangInstanceIdentifier path, final NormalizedNode<?, ?> payload) {
        checkPreconditions();
        return postDataViaTransaction(domDataBroker.newReadWriteTransaction(), CONFIGURATION, path, payload,ControllerContext.getInstance().getRootOperation());
    }
    ...
    protected final void ensureParentsByMerge(final LogicalDatastoreType store,
        ...
        while (iterator.hasNext()) {
            ...
            try {
                d = rwTx.read(store, currentPath).get();
            } catch (InterruptedException | ExecutionException e) {
