...
public class BrokerFacade implements DataReader<InstanceIdentifier, NormalizedNode<?, ?>> {
    ...
    public NormalizedNode<?, ?> readConfigurationDataBehindMountPoint(final MountInstance mountPoint,
    ...
    public NormalizedNode<?, ?> readOperationalDataBehindMountPoint(final MountInstance mountPoint,
            final InstanceIdentifier path) {
...
//        return mountPoint.readOperationalData(path);
    ...
    private NormalizedNode<?, ?> readDataViaTransaction(final DOMDataReadTransaction transaction,
        ...
        final DOMDataReadTransaction readTransaction = domDataBroker.newReadOnlyTransaction();
        final ListenableFuture<Optional<NormalizedNode<?, ?>>> listenableFuture = readTransaction.read(datastore, path);
