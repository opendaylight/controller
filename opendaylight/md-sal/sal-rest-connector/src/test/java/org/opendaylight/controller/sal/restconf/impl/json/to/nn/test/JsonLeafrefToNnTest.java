...
public class JsonLeafrefToNnTest extends AbstractBodyReaderTest {
    ...
    public JsonLeafrefToNnTest() throws NoSuchFieldException,
            SecurityException {
        super();
    ...
    public static void initialize() {
        schemaContext = schemaContextLoader("/json-to-cnsn/leafref",
                schemaContext);
    ...
    public void jsonIdentityrefToNormalizeNode() throws NoSuchFieldException,
        ...
        InputStream inputStream = this.getClass().getResourceAsStream(
                "/json-to-cnsn/leafref/json/data.json");
