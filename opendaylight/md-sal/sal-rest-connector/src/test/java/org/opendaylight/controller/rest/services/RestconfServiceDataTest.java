...
public class RestconfServiceDataTest {
    ...
    public void patchConfig_204_NoContent_ResponseTest() {
        when(mockRestconfServiceData.patchConfigurationData(anyString(), any(NormalizedNodeContext.class))).thenReturn(
                Response.status(Status.NO_CONTENT).build());
        final Response resp = mockRestconfServiceData.patchConfigurationData("", mockNormalizedNodeContext);
