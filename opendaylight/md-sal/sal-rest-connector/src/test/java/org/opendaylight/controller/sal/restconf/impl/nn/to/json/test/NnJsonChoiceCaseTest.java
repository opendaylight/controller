...
public class NnJsonChoiceCaseTest extends AbstractBodyReaderTest {
    ...
    public static void initialization() {
        ...
        schemaContext = schemaContextLoader("/cnsn-to-json/choice",
                schemaContext);
    ...
    public void nodeSchemasOnVariousChoiceCasePathTest() {
        testWrapper("/cnsn-to-json/choice/xml/data_various_path_err.xml",
    ...
    public void nodeSchemasOnVariousChoiceCasePathAndMultipleChoicesTest() {
        testWrapper(
                "/cnsn-to-json/choice/xml/data_more_choices_same_level_various_paths_err.xml",
                "choice-case-test:cont");
    }
    ...
    public void nodeSchemasWithRandomOrderAccordingLevel() {
        testWrapper("/cnsn-to-json/choice/xml/data_random_level.xml",
                "choice-case-test:cont");
    }
    ...
    public void nodeSchemasNotInFirstCase() {
        testWrapper("/cnsn-to-json/choice/xml/data_no_first_case.xml",
                "choice-case-test:cont");
    }
    ...
    public void nodeSchemaAsList() {
        testWrapper("/cnsn-to-json/choice/xml/data_list.xml",
                "choice-case-test:cont");
    }
    ...
    public void nodeSchemaAsContainer() {
        testWrapper("/cnsn-to-json/choice/xml/data_container.xml",
                "choice-case-test:cont");
    }
    ...
    public void nodeSchemaAsLeafList() {
        testWrapper("/cnsn-to-json/choice/xml/data_leaflist.xml",
                "choice-case-test:cont");
    }
    ...
    public void nodeSchemasInMultipleChoicesTest() {
        testWrapper(
                "/cnsn-to-json/choice/xml/data_more_choices_same_level.xml",
                "choice-case-test:cont");
    }
    ...
    public void nodeSchemasInCaseNotDefinedWithCaseKeyword() {
        testWrapper(
                "/cnsn-to-json/choice/xml/data_case_defined_without_case.xml",
                "choice-case-test:cont");
    }
    ...
    public void nodeSchemasInThreeChoicesAtSameLevel() {
        testWrapper(
                "/cnsn-to-json/choice/xml/data_three_choices_same_level.xml",
                "choice-case-test:cont");
    }
