...
public class RestPostOperationTest extends JerseyTest {
    ...
    String xmlDataRpcInput;
    CompositeNodeWrapper cnSnDataOutput;
    String jsonDataRpcInput;
    String xmlData2;
    ...
    @Test
    public void postOperationalDataViaUrl200() throws URISyntaxException, IOException {
    ...
    @Test
    public void postOperationalDataViaUrl204() throws URISyntaxException, IOException {
        controllerContext.setSchemas(schemaContextTestModule);
    ...
    @Test
    public void postOperationalDataViaUrl500() throws URISyntaxException, IOException {
        controllerContext.setSchemas(schemaContextTestModule);
    ...
    @Test
    public void postOperationalDataViaUrl400() throws URISyntaxException, IOException {
        controllerContext.setSchemas(schemaContextTestModule);
    ...
    @Test
    public void postOperationalDataViaUrl404() throws URISyntaxException, IOException {
        controllerContext.setSchemas(schemaContextTestModule);
