...
//        set(TestProperties.RECORD_LOG_LEVEL, Level.ALL.intValue());
    ...
    // TODO: add test to RPC without input data

    // TODO: add test missing namespace in root element
    ...
    // TODO: why tests with root element without namespace work in POST config/datastore?
    ...
    public void postConfigStatusCodes() throws UnsupportedEncodingException {
        ...
        assertEquals(204, post(uri, MediaType.APPLICATION_XML, xmlData));
        
        mockCommitConfigurationDataPostMethod(null);
        assertEquals(202, post(uri, MediaType.APPLICATION_XML, xmlData));
        
        mockCommitConfigurationDataPostMethod(TransactionStatus.FAILED);
        assertEquals(500, post(uri, MediaType.APPLICATION_XML, xmlData));
    }
