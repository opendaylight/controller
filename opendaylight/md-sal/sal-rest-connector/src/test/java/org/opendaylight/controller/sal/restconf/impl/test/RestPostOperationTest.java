...
public class RestPostOperationTest extends JerseyTest {
    ...
    @Test
    @Ignore // find exatly why we are not able to build payload
    ...
    public void createConfigurationDataTest() throws UnsupportedEncodingException, ParseException {
        ...
        // TODO : check again URI_2 -> Why do we need a block there ?
        final String URI_2 = "/config/test-interface:interfaces/block";
