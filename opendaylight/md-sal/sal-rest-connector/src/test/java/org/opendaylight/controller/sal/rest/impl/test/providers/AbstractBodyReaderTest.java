...
public abstract class AbstractBodyReaderTest {
    ...
    protected static SchemaContext schemaContextLoader(final String yangPath, final int modulesNumber,
            final String moduleName, final String dataSchemaName, final SchemaContext schemaContext) {
        return TestRestconfUtils.loadSchemaContext(yangPath, schemaContext);
    }
