...
public class JsonMapperTest {
    ...
    public static void init() throws FileNotFoundException {
        compositeNode = TestUtils.loadCompositeNode("/cnsn-to-json/json_mapper_test/xml/data.xml");
        modules = TestUtils.resolveModulesFrom("/cnsn-to-json/json_mapper_test");
    }
