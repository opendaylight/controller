...
public class CutDataToCorrectDepthTest extends JerseyTest {
    ...
    private static UnkeyedListNode unkeyedList(
            ...
            final DataContainerNodeAttrBuilder<YangInstanceIdentifier.NodeIdentifier, UnkeyedListEntryNode>... entryNodes) {
        ...
        for (DataContainerNodeAttrBuilder<YangInstanceIdentifier.NodeIdentifier, UnkeyedListEntryNode> unkeyedListEntryNodeBuilder : entryNodes) {
            unkeyedListEntryNodeBuilder.withNodeIdentifier(identifier);
            builder.withChild(unkeyedListEntryNodeBuilder.build());
        }
        return builder.build();
    }

    private static DataContainerNodeAttrBuilder<YangInstanceIdentifier.NodeIdentifier, UnkeyedListEntryNode> unkeyedEntry(
    ...
    @Ignore
    //part with application/xml will fail (due to missing unkeyed list node transformation). Firstly patch
    // https://git.opendaylight.org/gerrit/#/c/12263/ has to be merged
    @Test
    ...
    private UnkeyedListNode nodeDataDepth3Operational() {
        return unkeyedList(
                "depth2-cont1",
                unkeyedEntry(
    ...
    private ContainerNode nodeDataDepth3() {
        return container(
                ...
                unkeyedList("depth2-cont1",
                        unkeyedEntry(container("depth3-cont1"), leaf("depth3-leaf1", "depth3-leaf1-value"))),
                mapNode("depth2-list2",
                        mapEntryNode("depth2-list2", 2, leaf("depth3-lf1-key", "depth3-lf1-key-value"),
                                leaf("depth3-lf2-key", "depth3-lf2-key-value"), leaf("depth3-lf3", "depth3-lf3-value"))),
                leafList("depth2-lfLst1", "depth2-lflst1-value1", "depth2-lflst1-value2", "depth2-lflst1-value3"),
    ...
    private ContainerNode nodeDataDepth2() {
        return container(
                "depth1-cont",
                unkeyedList("depth2-cont1", unkeyedEntry()),
                mapNode("depth2-list2",
                        mapEntryNode("depth2-list2", 2, leaf("depth3-lf1-key", "depth3-lf1-key-value"),
