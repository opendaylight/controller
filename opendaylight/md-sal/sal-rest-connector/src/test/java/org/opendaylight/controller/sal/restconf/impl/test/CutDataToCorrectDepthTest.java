...
public class CutDataToCorrectDepthTest extends JerseyTest {
    ...
    public class RestImpl {
        ...
        public NormalizedNodeContext getData(@Encoded @PathParam("identifier") String identifier,
            ...
            final WriterParameters writerParameters = QueryParametersParser.parseKnownWriterParameters(uriInfo);
    ...
    @Test
    public void depth1Test() throws IOException, InterruptedException {
        Response response = target("/config/nested-module:depth1-cont").queryParam("depth", "1").request(mediaType)
                .get();
    ...
    @Test
    public void depth2Test() throws IOException, InterruptedException {
        Response response = target("/config/nested-module:depth1-cont").queryParam("depth", "2").request(mediaType)
                .get();
        txtDataToNormalizedNode(response, mediaType, "/config/nested-module:depth1-cont");
    ...
    @Test
    public void depth3Test() throws IOException, InterruptedException {
        Response response = target("/config/nested-module:depth1-cont").queryParam("depth", "3").request(mediaType)
                .get();
        txtDataToNormalizedNode(response, mediaType, "/config/nested-module:depth1-cont");
    ...
    @Test
    public void depth4Test() throws IOException, InterruptedException {
        Response response = target("/config/nested-module:depth1-cont").queryParam("depth", "4").request(mediaType)
                .get();
        txtDataToNormalizedNode(response, mediaType, "/config/nested-module:depth1-cont");
    ...
    @Test
    public void depth5Test() throws IOException, InterruptedException {
        Response response = target("/config/nested-module:depth1-cont").queryParam("depth", "5").request(mediaType)
                .get();
        txtDataToNormalizedNode(response, mediaType, "/config/nested-module:depth1-cont");
    ...
    @Test
    public void depthUnboundedTest() throws IOException, InterruptedException {
        Response response = target("/config/nested-module:depth1-cont").queryParam("depth", "unbounded").request
                (mediaType)
                .get();
        txtDataToNormalizedNode(response, mediaType, "/config/nested-module:depth1-cont");
        verifyResponse(nodeDataDepth5());
    ...
    private void verifyResponse(final NormalizedNode<?, ?> nodeData) throws WebApplicationException, IOException, InterruptedException {
