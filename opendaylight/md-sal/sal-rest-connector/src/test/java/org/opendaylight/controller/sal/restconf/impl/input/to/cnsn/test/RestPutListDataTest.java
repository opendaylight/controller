...
//            verifyException(e, ErrorType.PROTOCOL, ErrorTag.DATA_MISSING);
    ...
    public void putListDataTest(final String uriKey1, final String uriKey2, final String payloadKey1,
        ...
        List<DataSchemaNode> testChildren = RestSchemaControllerImpl.findInstanceDataChildrenByName(
        ...
        if (payloadKey2 != null) {
            testChildren = RestSchemaControllerImpl.findInstanceDataChildrenByName(
