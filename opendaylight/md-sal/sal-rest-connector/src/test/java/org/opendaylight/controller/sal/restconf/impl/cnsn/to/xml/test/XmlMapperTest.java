...
public class XmlMapperTest {
    ...
    public static void init() {
        compositeNode = TestUtils.readInputToCnSn("/xml-to-cnsn/xml_mapper_test/xml/data-leaf-list.xml",
                XmlToCompositeNodeProvider.INSTANCE);
        modules = TestUtils.loadModulesFrom("/xml-to-cnsn/xml_mapper_test");
    }
