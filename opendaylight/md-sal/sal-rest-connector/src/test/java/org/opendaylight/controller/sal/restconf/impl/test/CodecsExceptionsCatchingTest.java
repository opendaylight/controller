...
public class CodecsExceptionsCatchingTest extends JerseyTest {
    ...
    private static ControllerContext controllerContext = ControllerContext
            .getInstance();
    ...
    public static void init() throws FileNotFoundException {
        ...
        final SchemaContext schemaContext = TestUtils
                .loadSchemaContext("/decoding-exception/yang");
    ...
    protected Application configure() {
        ...
        resourceConfig = resourceConfig.registerInstances(restConf,
                ...
                new XmlNormalizedNodeBodyReader(),
                new JsonNormalizedNodeBodyReader());
    ...
    public void StringToNumberConversionError() {
        final Response response = target("/config/number:cont").request(
                MediaType.APPLICATION_XML).put(
                Entity.entity("<cont xmlns=\"number\"><lf>3f</lf></cont>",
                        MediaType.APPLICATION_XML));
        final String exceptionMessage = response.readEntity(String.class);
        assertTrue(exceptionMessage
                .contains("Incorrect lexical representation of integer value"));
    }
}