...
public final class ClusterAdminRpcService {
    ...
    @VisibleForTesting ListenableFuture<RpcResult<RemoveShardReplicaOutput>> removeShardReplica(
    ...
    @VisibleForTesting ListenableFuture<RpcResult<ChangeMemberVotingStatesForShardOutput>> changeMemberVotingStatesForShard(
    ...
    private ClassToInstanceMap<Rpc<?, ?>> getRpcClassToInstanceMap() {
