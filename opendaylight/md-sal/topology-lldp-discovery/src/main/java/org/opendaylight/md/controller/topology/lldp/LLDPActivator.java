...
public class LLDPActivator extends AbstractBindingAwareProvider {
    ...
    public void onSessionInitiated(final ProviderContext session) {
        ...
        LLDPActivator.provider.setDataService(dataService);
        ...
        LLDPActivator.provider.setNotificationService(notificationService);
        LLDPActivator.provider.start();
    }

    protected void stopImpl(final BundleContext context) {
        LLDPActivator.provider.close();
    }
}
