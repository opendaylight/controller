...
public class ModelGenerator {
  ...
  private void processIdentities(Module module, JSONObject models) throws JSONException {
    ...
    private JSONObject processContainer(ContainerSchemaNode container, String moduleName,
        ...
        JSONObject properties = processChildren(containerChildren, container.getQName(), moduleName, models, isConfig);
        moduleJSON.put(PROPERTIES_KEY, properties);
        return moduleJSON;
    }

    private JSONObject processChildren(Set<DataSchemaNode> nodes, QName parentQName, String moduleName,
            JSONObject models) throws JSONException, IOException {
        return processChildren(nodes, parentQName, moduleName, models, null);
    }
    ...
    private JSONObject processChildren(Set<DataSchemaNode> nodes, QName parentQName, String moduleName,
        ...
        for (DataSchemaNode node : nodes) {
            if (isConfig == null || node.isConfiguration() == isConfig) {
                ...
                String name = resolveName(node,schemaContext,true);
    ...
    private JSONObject processListSchemaNode(ListSchemaNode listNode, String moduleName,
        ...
        JSONObject childSchemaProperties = processChildren(listChildren, listNode.getQName(), moduleName, models);
