...
import org.opendaylight.controller.sal.rest.doc.util.ThreadSafeDateFormat;
...
public class BaseYangSwaggerGenerator {
    ...
    protected final ThreadSafeDateFormat SIMPLE_DATE_FORMAT = new ThreadSafeDateFormat();
