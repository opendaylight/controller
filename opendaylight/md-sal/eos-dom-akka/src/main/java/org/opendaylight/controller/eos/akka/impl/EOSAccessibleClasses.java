 ...
 */
package org.opendaylight.controller.eos.akka.impl;
...
public final class EOSAccessibleClasses extends DelegatingAccessibleClasses {
    private EOSAccessibleClasses(final ClassLoader classLoader) {
     ...
     */
    public EOSAccessibleClasses() {
        this(EOSAccessibleClasses.class.getClassLoader());
    }

    @Activate
    public EOSAccessibleClasses(final BundleContext bundleContext) {
