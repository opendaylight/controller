...
public final class NativeEntityOwnershipService implements DOMEntityOwnershipService {
    ...
    @VisibleForTesting
    NativeEntityOwnershipService(final ActorSystem actorSystem) throws ExecutionException, InterruptedException {
        ...
        final ActorRef<BootstrapCommand> eosBootstrap =
                Adapter.spawn(actorSystem, Behaviors.setup(context -> EOSMain.create()), "EOSBootstrap");
    ...
    @Inject
    @Activate
    public NativeEntityOwnershipService(@Reference final ActorSystemProvider provider)
