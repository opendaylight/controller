...
public class MessageBusAppImplModule extends
    ...
    public java.lang.AutoCloseable createInstance() {
        ...
        final EventSourceRegistryImpl eventSourceRegistry = new EventSourceRegistryImpl(eventSourceTopology);
        final NetconfEventSourceManager netconfEventSourceManager = NetconfEventSourceManager.create(dataBroker, domPublish,domMount, bindingMount, eventSourceRegistry, getNamespaceToStream());
