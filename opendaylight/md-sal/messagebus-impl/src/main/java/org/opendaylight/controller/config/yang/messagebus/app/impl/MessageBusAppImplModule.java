...
import org.opendaylight.controller.messagebus.registry.EventSourceRegistry;
...
public class MessageBusAppImplModule extends
    ...
    public java.lang.AutoCloseable createInstance() { 
        ...
        final EventSourceRegistry eventSourceRegistry = EventSourceRegistry.create(eventSourceTopology, rpcRegistry);
        NetconfEventSourceManager.create(dataBroker, domPublish,domMount, bindingMount, rpcRegistry, getNamespaceToStream());
