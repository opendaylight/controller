...
public class InitializationContext {
    ...
    private final MdSAL mdSal = new MdSAL();
    private final DataStore dataStore = new DataStore(mdSal);
    private final EventSourceTopology eventSourceTopology = new EventSourceTopology(dataStore);
    private final EventSourceManager eventSourceManager = new EventSourceManager(dataStore, mdSal, eventSourceTopology);
    private final EventAggregator eventAggregator = new EventAggregator(mdSal, eventSourceTopology);
