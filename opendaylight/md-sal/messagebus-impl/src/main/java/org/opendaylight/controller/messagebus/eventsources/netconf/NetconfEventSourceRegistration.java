...
/**
 * Helper class to keep connection status of netconf and event source registration object
 *
 */
public class NetconfEventSourceRegistration implements AutoCloseable{
    ...
    public static NetconfEventSourceRegistration create(final Node node,
    ...
    private void registrationEventSource(){
        final Optional<DOMMountPoint> netconfMount = netconfEventSourceManager.getDomMounts().getMountPoint(domMountPath(node.getNodeId()));
