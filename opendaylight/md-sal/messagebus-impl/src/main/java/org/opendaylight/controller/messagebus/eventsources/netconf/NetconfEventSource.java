...
public class NetconfEventSource implements EventSource, DOMNotificationListener {
    ...
    private void initializeNotificationTopicRegistrationList() {
        ...
        for (String urnPrefix : this.urnPrefixToStreamMap.keySet()) {
            ...
            notificationTopicRegistrationList.add(new StreamNotificationTopicRegistration(streamName,urnPrefix, this.nodeId, this.netconfMount, this));
        }
    }
    ...
    public void onNotification(final DOMNotification notification) {
        ...
        //TODO: obtain and set eventTime from notification - if it is not possible, simple publish notification
        //TODO: if eventTime is obtained - identify if replay notification is running
        //TODO: catch replayComplete notification and end indicator of replay
        Date eventTime = null;
        for(NotificationTopicRegistration notifReg : notificationTopicRegistrationList){
            ...
            if(topicIdsForNotification != null && topicIdsForNotification.isEmpty() == false){
                //TODO: compare eventTime with last event time in notifReg,
                // if replay is running - ignore notification with older time then last event time
                if(notifReg instanceof StreamNotificationTopicRegistration){
                    ...
                    streamReg.setLastEventTime(eventTime);
                }
