...
public class NetconfEventSource implements EventSourceService, NotificationListener {
    ...
    public NetconfEventSource(MdSAL mdSal, String nodeId) {
    ...
    public void onNotification(CompositeNode notification) {
        LOGGER.info("NetconfEventSource {} received nodification {}. Will publish to MD-SAL.", nodeId, notification);
