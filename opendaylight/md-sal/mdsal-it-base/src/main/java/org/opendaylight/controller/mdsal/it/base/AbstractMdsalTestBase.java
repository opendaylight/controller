...
//        return new Option[]{editConfigurationFilePut("etc/system.properties",
//                "karaf.shell.init.script", "")};return new Option[]{editConfigurationFilePut("etc/system.properties",
