...
public class XSQLModule extends
    org.opendaylight.controller.config.yang.config.xsql.impl.AbstractXSQLModule {
    public XSQLModule(
    ...
    public XSQLModule(
        org.opendaylight.controller.config.api.ModuleIdentifier identifier,
        org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,
        org.opendaylight.controller.config.yang.config.xsql.impl.XSQLModule oldModule,
