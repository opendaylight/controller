...
public class XSQLBluePrint implements DatabaseMetaData {
    ...
    private Map<String, XSQLBluePrintNode> cache =
        new HashMap<String, XSQLBluePrintNode>();
    ...
    public XSQLBluePrintNode getBluePrintNode(String nodeName) {
        ...
        for (XSQLBluePrintNode n : cache.values()) {
            if (n.getName().toLowerCase().indexOf(nodeName.toLowerCase())
                != -1) {
                return n;
            }
        }
    ...
    public XSQLBluePrintNode getNQLBluePrintNode(String nodeName) {
        if (nodeName.indexOf(".") != -1) {
            return (XSQLBluePrintNode) cache
                .get(nodeName.substring(nodeName.lastIndexOf(".") + 1));
        }
    ...
    public void saveBluePrintCache(String hostName) {
        try {
            ObjectOutputStream out = new ObjectOutputStream(
                new FileOutputStream(hostName + "-" + CACHE_FILE_NAME));
    ...
    private static Map<Class, Set<Class>> superClassMap =
