...
public final class ToasterProviderModule extends
    ...
    public java.lang.AutoCloseable createInstance() {
        ...
        BindingDataBroker dataBrokerService = getDataBrokerDependency();
        opendaylightToaster.setDataProvider(dataBrokerService);

        final ListenerRegistration<BindingDataChangeListener> dataChangeListenerRegistration = dataBrokerService
