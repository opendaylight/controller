...
public class KitchenServiceImpl extends AbstractMXBean
    ...
    public Future<RpcResult<Void>> makeBreakfast(EggsType eggsType, Class<? extends ToastType> toastType,
        ...
        // Call makeToast and use JdkFutureAdapters to convert the Future to a
        // ListenableFuture,
        // The OpendaylightToaster impl already returns a ListenableFuture so
        // the conversion is
        // actually a no-op.
        ...
        // Combine the 2 ListenableFutures into 1 containing a list of
        // RpcResults.
    ...
    public Boolean makeScrambledWithWheat() {
        try {
            // This call has to block since we must return a result to the JMX
            // client.
