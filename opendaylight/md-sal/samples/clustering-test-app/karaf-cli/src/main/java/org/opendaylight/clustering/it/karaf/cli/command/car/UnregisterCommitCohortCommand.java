...
public class UnregisterCommitCohortCommand implements Action {
    ...
    public Object execute() throws Exception {
        final UnregisterCommitCohortInput input = new UnregisterCommitCohortInputBuilder().build();
        return carService.unregisterCommitCohort(input);
    }
}
