...
public class RegisterLoggingDtclCommand implements Action {
    ...
    public Object execute() throws Exception {
        final RegisterLoggingDtclInput input = new RegisterLoggingDtclInputBuilder().build();
        return carService.registerLoggingDtcl(input);
    }
}
