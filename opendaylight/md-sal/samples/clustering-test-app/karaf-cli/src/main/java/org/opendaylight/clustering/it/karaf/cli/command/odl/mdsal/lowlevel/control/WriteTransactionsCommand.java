...
public class WriteTransactionsCommand implements Action {
    ...
    public Object execute() throws Exception {
        final WriteTransactionsInput input = new WriteTransactionsInputBuilder()
                .setId(id)
        ...
        return controlService.writeTransactions(input);
    }
}
