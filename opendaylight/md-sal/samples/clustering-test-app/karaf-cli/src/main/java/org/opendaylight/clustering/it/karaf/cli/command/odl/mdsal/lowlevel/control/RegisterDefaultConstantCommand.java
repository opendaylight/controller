...
public class RegisterDefaultConstantCommand implements Action {
    ...
    public Object execute() throws Exception {
        final RegisterDefaultConstantInput input = new RegisterDefaultConstantInputBuilder()
                .setConstant(constant)
                .build();

        return controlService.registerDefaultConstant(input);
    }
}
