...
public class UnsubscribeDtclCommand implements Action {
    ...
    public Object execute() throws Exception {
        final UnsubscribeDtclInput input = new UnsubscribeDtclInputBuilder().build();
        return controlService.unsubscribeDtcl(input);
    }
}
