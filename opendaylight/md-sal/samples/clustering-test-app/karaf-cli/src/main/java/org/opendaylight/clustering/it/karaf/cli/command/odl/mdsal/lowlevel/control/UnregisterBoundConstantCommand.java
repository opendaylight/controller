...
public class UnregisterBoundConstantCommand implements Action {
    ...
    public Object execute() throws Exception {
        final UnregisterBoundConstantInput input = new UnregisterBoundConstantInputBuilder()
                .setContext(context)
                        .build();

        return controlService.unregisterBoundConstant(input);
    }
}
