...
public class RegisterOwnershipCommand implements Action {
    ...
    public Object execute() throws Exception {
        final RegisterOwnershipInput input = new RegisterOwnershipInputBuilder()
                .setCarId(carId)
                .build();
        return carService.registerOwnership(input);
    }
}
