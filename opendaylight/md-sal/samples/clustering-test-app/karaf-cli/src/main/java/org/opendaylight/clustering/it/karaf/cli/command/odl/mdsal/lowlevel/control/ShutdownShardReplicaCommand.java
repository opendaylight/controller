...
public class ShutdownShardReplicaCommand implements Action {
    ...
    public Object execute() throws Exception {
        final ShutdownShardReplicaInput input = new ShutdownShardReplicaInputBuilder()
                .setShardName(shardName)
                .build();

        return controlService.shutdownShardReplica(input);
    }
}
