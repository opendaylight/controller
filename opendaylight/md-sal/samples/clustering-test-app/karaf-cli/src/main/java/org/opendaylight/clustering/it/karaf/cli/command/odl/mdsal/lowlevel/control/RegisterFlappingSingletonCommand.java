...
@Service
@Command(scope = "test-app", name = "register-flapping-singleton", description = "Run a register-flapping-singleton test")
public class RegisterFlappingSingletonCommand implements Action {
    ...
    public Object execute() throws Exception {
        final RegisterFlappingSingletonInput input = new RegisterFlappingSingletonInputBuilder().build();
        return controlService.registerFlappingSingleton(input);
    }
}
