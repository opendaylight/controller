...
public class UnregisterConstantCommand implements Action {
    ...
    public Object execute() throws Exception {
        final UnregisterConstantInput input = new UnregisterConstantInputBuilder().build();
        return controlService.unregisterConstant(input);
    }
}
