...
public class UnregisterSingletonConstantCommand implements Action {
    ...
    public Object execute() throws Exception {
        final UnregisterSingletonConstantInput input = new UnregisterSingletonConstantInputBuilder().build();
        return controlService.unregisterSingletonConstant(input);
    }
}
