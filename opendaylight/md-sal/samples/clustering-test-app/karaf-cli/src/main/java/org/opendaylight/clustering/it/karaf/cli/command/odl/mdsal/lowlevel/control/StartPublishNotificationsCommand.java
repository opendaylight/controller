...
@Service
@Command(scope = "test-app", name = "start-publish-notifications", description = "Run a start-publish-notifications test")
public class StartPublishNotificationsCommand implements Action {
    ...
    public Object execute() throws Exception {
        final StartPublishNotificationsInput input = new StartPublishNotificationsInputBuilder()
                .setId(id)
                .setSeconds(Uint32.valueOf(seconds))
                .setNotificationsPerSecond(Uint32.valueOf(notificationsPerSecond))
                .build();

        return controlService.startPublishNotifications(input);
    }
}
