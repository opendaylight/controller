...
@Service
@Command(scope = "test-app", name = "register-singleton-constant", description = "Run a register-singleton-constant text")
public class RegisterSingletonConstantCommand implements Action {
    ...
    public Object execute() throws Exception {
        final RegisterSingletonConstantInput input = new RegisterSingletonConstantInputBuilder()
                .setConstant(constant)
                .build();

        return controlService.registerSingletonConstant(input);
    }
}
