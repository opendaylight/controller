...
public class AddShardReplicaCommand implements Action {
    ...
    public Object execute() throws Exception {
        final AddShardReplicaInput input = new AddShardReplicaInputBuilder()
                .setShardName(shardName)
                .build();

        return controlService.addShardReplica(input);
    }
}
