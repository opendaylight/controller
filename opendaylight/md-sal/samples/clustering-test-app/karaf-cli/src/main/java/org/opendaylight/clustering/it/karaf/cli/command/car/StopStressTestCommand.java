...
public class StopStressTestCommand implements Action {
    ...
    public Object execute() throws Exception {
        final StopStressTestInput input = new StopStressTestInputBuilder().build();
        return carService.stopStressTest(input);
    }
}
