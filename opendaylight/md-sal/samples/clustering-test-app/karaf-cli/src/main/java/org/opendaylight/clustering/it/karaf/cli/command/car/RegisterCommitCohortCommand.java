...
public class RegisterCommitCohortCommand implements Action {
    ...
    public Object execute() throws Exception {
        final RegisterCommitCohortInput input = new RegisterCommitCohortInputBuilder().build();
        return carService.registerCommitCohort(input);
    }
}
