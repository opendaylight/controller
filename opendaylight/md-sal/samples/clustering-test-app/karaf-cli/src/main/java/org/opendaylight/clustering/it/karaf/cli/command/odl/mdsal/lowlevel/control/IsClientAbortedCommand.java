...
public class IsClientAbortedCommand implements Action {
    ...
    public Object execute() throws Exception {
        final IsClientAbortedInput input = new IsClientAbortedInputBuilder().build();
        return controlService.isClientAborted(input);
    }
}
