...
public class RegisterBoundConstantCommand implements Action {
    ...
    public Object execute() throws Exception {
        final RegisterBoundConstantInput input = new RegisterBoundConstantInputBuilder()
                .setConstant(constant)
                .setContext(context)
                .build();

        return controlService.registerBoundConstant(input);
    }
}
