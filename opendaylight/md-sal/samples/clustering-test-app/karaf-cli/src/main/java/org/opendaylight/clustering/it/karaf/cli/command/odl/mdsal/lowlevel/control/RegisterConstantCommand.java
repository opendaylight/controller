...
public class RegisterConstantCommand implements Action {
    ...
    public Object execute() throws Exception {
        final RegisterConstantInput input = new RegisterConstantInputBuilder()
                .setConstant(constant)
                .build();

        return controlService.registerConstant(input);
    }
}
