...
public class PeopleProvider implements PeopleService, AutoCloseable {
    ...
    private RoutedRpcRegistration<CarPurchaseService> rpcRegistration;

    public void setDataProvider(final DataBroker salDataProvider) {
        this.dataProvider = salDataProvider;
    }

    public void setRpcRegistration(final RoutedRpcRegistration<CarPurchaseService> rpcRegistration) {
