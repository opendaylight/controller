...
@Singleton
@Component(service = PurchaseCarProvider.class)
public final class PurchaseCarProvider {
    ...
    private ListenableFuture<RpcResult<BuyCarOutput>> buyCar(final BuyCarInput input) {
