...
public class ClusterProviderMBean implements ClusteringItProviderRuntimeMXBean{
    ...
    @Override
    public void carsStressTest(final Integer numCars, Integer numThreads, final Boolean writeOnly) {
        log.info("carsStressTest starting : numCars: {}, numThreads: {}, writeOnly: {}", numCars, numThreads,writeOnly);
            ...
            Callable<Void> task = new Callable<Void>() {
                ...
                public Void call() throws Exception {
                    ...
                    for(int i = 0; i < numCars; i++) {
                        CarEntry car = new CarEntryBuilder().setId(new CarId("car"+count.incrementAndGet())).build();
