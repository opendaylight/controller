...
public class CarProvider implements CarService {
    ...
    public Future<RpcResult<StopStressTestOutput>> stopStressTest() {
        ...
        stopStressTestOutput = new StopStressTestOutputBuilder().setCount(succcessCounter.longValue());
        StopStressTestOutput result = stopStressTestOutput.build();
        log.info(" Executed Stop Stress test; No. of cars created {} ; No. of cars failed {} ", succcessCounter, failureCounter);
