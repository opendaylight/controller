...
//        YangInstanceIdentifier entityId = YangInstanceIdentifier.builder().node(Cars.QNAME).node(CarEntry.QNAME).
//                nodeWithKey(CarEntry.QNAME, QName.create(Cars.QNAME, "id"), input.getCarId()).build();
