...
public class CarProvider implements CarService {
    ...
    private volatile DOMDataTreeCommitCohortRegistration<CarEntryDataTreeCommitCohort> commitCohortReg;
    ...
    @Override
    public Future<RpcResult<Void>> registerCommitCohort() {
