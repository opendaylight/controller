...
abstract class AbstractTransactionHandler {
    ...
    private synchronized void startCollection() {
        ...
        executor.schedule(this::checkCollection, TRANSACTIONS_COMPLETED_TIMEOUT_SECONDS, TimeUnit.SECONDS);
    ...
    private synchronized void checkCollection() {
        ...
        runTimedOut(new TimeoutException("Collection did not finish in " + TRANSACTIONS_COMPLETED_TIMEOUT_SECONDS + " seconds"));
    }
