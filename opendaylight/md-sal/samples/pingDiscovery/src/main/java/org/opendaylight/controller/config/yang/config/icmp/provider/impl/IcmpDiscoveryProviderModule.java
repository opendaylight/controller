...
import org.opendaylight.controller.sample.pingdiscovery.impl.PingServiceExecSystemImpl;
...
org.opendaylight.controller.config.yang.config.icmp.provider.impl.AbstractIcmpDiscoveryProviderModule {
    ...
    public java.lang.AutoCloseable createInstance() {
        ...
        mountHandler.setDependencyMgr( dependencyManager );
        mountHandler.setBundleContextDepMgr( bundleContextMgr );
        mountHandler.setDataBrokerService(dataBrokerService);
        ...
        final IcmpDiscoveryServiceImpl icmpDiscoverServiceImpl = new IcmpDiscoveryServiceImpl();

        final PingServiceExecSystemImpl pingServiceImpl = new PingServiceExecSystemImpl() ;

        icmpDiscoverServiceImpl.setManagers(devMgr, profMgr, pingServiceImpl );
