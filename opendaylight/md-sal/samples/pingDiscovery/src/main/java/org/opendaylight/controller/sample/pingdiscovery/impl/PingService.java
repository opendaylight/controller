...
public class PingService {
    ...
    private static final Pattern VALID_PING_RESPONSE =
            Pattern.compile( "[0-9]+ bytes from .*\\: icmp_seq=[0-9]+ ttl=[0-9]+ time=([0-9]+\\.[0-9]+) ms" );
    ...
    {
        return ping( host, 1, 3000 );
    }

    public static double ping( String host, int count, int timeoutSeconds )
    {
        try
        {
