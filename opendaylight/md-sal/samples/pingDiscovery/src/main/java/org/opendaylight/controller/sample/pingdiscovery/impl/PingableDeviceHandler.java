...
/**
 * This class is responsible for handling the RPC call, or DataRead to a SINGLE node.
 * <br><br>DEMONSTRATES: Shows how to our logic gets notified about an RPC call or read to the
 * config or operational data stores on a single node.
 * @author Devin Avery
 * @author Greg Hall
 *
 */
public class PingableDeviceHandler implements RpcImplementation,
    ...
    public CompositeNode readOperationalData(
        ...
        //A GET was just performed to opendaylight-inventory:nodes/node/<node_id>/yang-ext:mount:/icmpdata:icmpdata
