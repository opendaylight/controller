...
public class PortConsumerImpl implements IPortUpdateImpl {
    ...
    public PortConsumerImpl() {
        ...
        if (!(cacheStartup())) {
            ...
            System.out.println("Unable to allocate/retrieve port cache");
        ...
        if (null == portService) {
            ...
            System.out.println("Consumer SAL Port Service is down or NULL.");
        ...
        if (null == portListener) {
            ...
            System.out.println("Listener to listen on port data modifcation events.");
