...
public class TestModel {
    ...
    public static ContainerNode createTestContainer() {
        ...
        ContainerNode switchFeatures = ImmutableContainerNodeBuilder
            .create()
            .withNodeIdentifier(new InstanceIdentifier.NodeIdentifier(
    ...
    public static MapEntryNode createAugmentedListEntry(int id, String name) {
        ...
        ContainerNode augCont = ImmutableContainerNodeBuilder
            .create()
            .withNodeIdentifier(new InstanceIdentifier.NodeIdentifier(AUG_CONT_QNAME))
        ...
        final InstanceIdentifier.AugmentationIdentifier augmentationIdentifier =
            new InstanceIdentifier.AugmentationIdentifier(childAugmentations);
    ...
    public static ContainerNode createFamily() {
        final DataContainerNodeAttrBuilder<InstanceIdentifier.NodeIdentifier, ContainerNode>
        ...
        final DataContainerNodeBuilder<InstanceIdentifier.NodeIdentifierWithPredicates, MapEntryNode>
            firstChildBuilder =
