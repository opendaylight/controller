...
import org.opendaylight.controller.md.sal.dom.odl.sql.OdlSqlAdapterService;
...
public class ODLSQLModule
    ...
    public java.lang.AutoCloseable createInstance() {
        final RpcRegistration<OdlSqlAdapterService> service = getRpcRegistryDependency()
                .addRpcImplementation(OdlSqlAdapterService.class, new ODLSQLServiceImpl());
