...
import org.opendaylight.controller.md.sal.dom.odl.sql.jdbc.JDBCConnection;
/**
 * @author Sharon Aicler(saichler@gmail.com)
 **/
public class ODLSQLJDBCDriver implements Driver {

    public static ODLSQLJDBCDriver drv = new ODLSQLJDBCDriver();

    public ODLSQLJDBCDriver() {
        try {
