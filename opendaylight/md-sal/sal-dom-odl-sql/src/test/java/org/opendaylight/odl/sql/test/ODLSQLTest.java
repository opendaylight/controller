...
package org.opendaylight.odl.sql.test;
...
public class ODLSQLTest {
    private static final String DATASTORE_TEST_YANG = "/sal-persisted-dom-test.yang";
    private BluePrint bluePrint = null;
    private static final ODLSQLAdapter adapter = new ODLSQLAdapter();
    ...
    public void testQueryParsingSimpleNoCriteria() {
        ...
        JDBCResultSet rs = new JDBCResultSet(sql,adapter);
    ...
    private static void parseTables(String sql,BluePrint bp,JDBCResultSet rs){
        try{
    ...
    public void testQueryParsingComplexWithCriteriaAndGrouping() {
        ...
        JDBCResultSet rs = new JDBCResultSet(sql,adapter);
        try{
            JDBCServer.checkAndBreakSubQueries(rs, adapter);
    ...
    private static void parseFields(String sql,BluePrint bp,JDBCResultSet rs){
        try{
    ...
    private static void log(String str) {
        System.out.print("*** ODL SQL Tests -");
    ...
    private static InputStream getInputStream(final String resourceName) {
        return ODLSQLTest.class.getResourceAsStream(DATASTORE_TEST_YANG);
    }
