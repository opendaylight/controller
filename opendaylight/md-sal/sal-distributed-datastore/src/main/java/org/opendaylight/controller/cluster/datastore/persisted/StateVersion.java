 ...
 */
@Beta
public enum StateVersion implements WritableObject {
    ...
    StateVersion(final int intVersion) {
     ...
     *
     * @return Current {@link StateVersion}
     */
    public static @Nonnull StateVersion current() {
        return BORON;
    }

    /**
     * Return the {@link StateVersion} corresponding to an unsigned short integer. This method is provided for callers
     ...
     */
    public static @Nonnull StateVersion valueOf(final short s) throws FutureVersionException, PastVersionException {
    ...
    /**
     * Read an {@link StateVersion} from a {@link DataInput}. This method is provided for callers which do not have
     * a recovery strategy for dealing with unsupported versions.
     *
     * @param in Input from which to read
     * @return An {@link StateVersion}
     * @throws IOException If read fails or an unsupported version is encountered
     */
    public static @Nonnull StateVersion readFrom(final @Nonnull DataInput in) throws IOException {
