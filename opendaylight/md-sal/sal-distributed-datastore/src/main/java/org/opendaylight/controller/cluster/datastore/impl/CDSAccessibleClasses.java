 ...
 */
package org.opendaylight.controller.cluster.datastore.impl;
...
public final class CDSAccessibleClasses extends DelegatingAccessibleClasses {
    private CDSAccessibleClasses(final ClassLoader classLoader) {
     ...
     */
    public CDSAccessibleClasses() {
        this(CDSAccessibleClasses.class.getClassLoader());
    }

    @Activate
    public CDSAccessibleClasses(final BundleContext bundleContext) {
