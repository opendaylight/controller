...
/**
 * A remotable version of {@link DataTreeChanged}. This message
 * is used when propagating a delta across cluster nodes. Receiving
 * node needs to perform data reconstruction.
 */
public final class DataTreeDelta implements Externalizable {
    ...
    public void readExternal(final ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        for (int i = 0; i < size; ++i) {
            ...
            if (node != null) {
                changes.add(new DefaultDataTreeCandidate(treeId, node));
            }
        }
    }
}
