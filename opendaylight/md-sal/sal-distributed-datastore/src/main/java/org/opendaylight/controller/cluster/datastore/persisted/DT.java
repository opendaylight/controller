 ...
 */
final class DT extends AbstractProxy<ClientIdentifier> {
    @java.io.Serial
    ...
    @Override
    protected DisableTrackingPayload createObject(final ClientIdentifier identifier, final byte[] serialized) {
