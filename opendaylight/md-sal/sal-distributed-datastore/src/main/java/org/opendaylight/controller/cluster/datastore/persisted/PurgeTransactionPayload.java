...
public final class PurgeTransactionPayload extends AbstractIdentifiablePayload<TransactionIdentifier> {
    ...
    public static PurgeTransactionPayload create(final PayloadVersion version,
        ...
        return new PurgeTransactionPayload(PayloadVersion.MAGNESIUM.gte(version), transactionId, out.toByteArray());
    }
