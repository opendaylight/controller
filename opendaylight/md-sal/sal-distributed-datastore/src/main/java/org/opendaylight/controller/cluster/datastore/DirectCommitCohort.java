 ...
 * a direct commit on the backed. If resolution of actor succeeds, the transaction is assumed
...
final class DirectCommitCohort implements DOMStoreThreePhaseCommitCohort {
    ...
    static DOMStoreThreePhaseCommitCohort create(final ActorContext actorContext, final Future<ActorSelection> ret) {
