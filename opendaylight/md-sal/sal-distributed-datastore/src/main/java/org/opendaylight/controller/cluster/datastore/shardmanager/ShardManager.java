...
class ShardManager extends AbstractUntypedPersistentActorWithMetering {
    ...
    protected ActorRef newShardActor(final ShardInformation info) {
        return getContext().actorOf(info.newProps().withDispatcher(shardDispatcherPath), info.getShardId().toString());
    }
    ...
    private abstract static class AutoFindPrimaryFailureResponseHandler implements FindPrimaryResponseHandler {
         ...
         */
        protected AutoFindPrimaryFailureResponseHandler(final ActorRef targetActor, final String shardName, final String persistenceId,
                final ActorRef shardManagerActor) {
