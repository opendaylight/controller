...
/**
 * A single component of a {@link ShardedTransaction}. Provides data access
...
abstract class AbstractTransactionComponent {
    ...
    abstract DOMStoreThreePhaseCommitCohort uncoordinatedCommit(ActorContext actorContext);
}
