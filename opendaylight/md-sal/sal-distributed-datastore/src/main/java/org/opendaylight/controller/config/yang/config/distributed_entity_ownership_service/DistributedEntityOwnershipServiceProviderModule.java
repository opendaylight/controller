...
public class DistributedEntityOwnershipServiceProviderModule extends AbstractDistributedEntityOwnershipServiceProviderModule {
    ...
    public AutoCloseable createInstance() {
        ...
        EntityOwnershipService delegate = OsgiServiceUtils.waitForService(EntityOwnershipService.class, bundleContext,
                OsgiServiceUtils.FIVE_MINUTES, null);
        return new ForwardingEntityOwnershipService(delegate);
    }
    ...
    private static class ForwardingEntityOwnershipService extends ForwardingObject
        ...
        public ForwardingEntityOwnershipService(EntityOwnershipService delegate) {
