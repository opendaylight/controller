...
public sealed class DisableTrackingPayload extends AbstractIdentifiablePayload<ClientIdentifier> {
    ...
    public static @NonNull DisableTrackingPayload readFrom(final DataInput in) throws IOException {
        return DisableTrackingPayload.create(ClientIdentifier.readFrom(in),
