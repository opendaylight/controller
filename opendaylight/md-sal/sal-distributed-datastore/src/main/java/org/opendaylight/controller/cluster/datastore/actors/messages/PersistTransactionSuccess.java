...
public final class PersistTransactionSuccess extends RequestSuccess<GlobalTransactionIdentifier> {
    private static final class Proxy extends AbstractSuccessProxy<GlobalTransactionIdentifier> {
        ...
        @Override
        protected PersistTransactionSuccess readResolve() {
            return new PersistTransactionSuccess(getIdentifier(), commitedTransactionId);
        }
    }
    ...
    public PersistTransactionSuccess(final GlobalTransactionIdentifier identifier, final long committedTransactionId) {
        super(identifier);
