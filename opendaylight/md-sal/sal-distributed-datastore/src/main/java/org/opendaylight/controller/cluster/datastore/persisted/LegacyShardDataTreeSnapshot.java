 ...
 */
@Beta
public final class LegacyShardDataTreeSnapshot extends AbstractShardDataTreeSnapshot {
    private final NormalizedNode<?, ?> rootNode;

    @Deprecated
    public LegacyShardDataTreeSnapshot(final @Nullable NormalizedNode<?, ?> rootNode) {
