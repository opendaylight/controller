...
public final class ShardSnapshotActor extends AbstractUntypedActorWithMetering {
    ...
    private static final class SerializeSnapshot {
        ...
        SerializeSnapshot(final AbstractShardDataTreeSnapshot snapshot, final ActorRef replyTo) {
            this.snapshot = Preconditions.checkNotNull(snapshot);
            this.replyTo = Preconditions.checkNotNull(replyTo);
        }

        AbstractShardDataTreeSnapshot getSnapshot() {
            return snapshot;
        }
    ...
    public static void requestSnapshot(final ActorRef snapshotActor, AbstractShardDataTreeSnapshot snapshot,
