...
final class CDSShardAccessImpl implements CDSShardAccess, LeaderLocationListener, AutoCloseable {
    ...
    private final Collection<LeaderLocationListener> listeners = Sets.newConcurrentHashSet();
                ...
                if (failure instanceof LocalShardNotFoundException) {
                    ...
                    makeLeaderLocalAsk
                            .completeWith(actorContext
                                    .executeOperationAsync(actorRef, new MakeLeaderLocal(), makeLeaderLocalTimeout));
                }
            }
