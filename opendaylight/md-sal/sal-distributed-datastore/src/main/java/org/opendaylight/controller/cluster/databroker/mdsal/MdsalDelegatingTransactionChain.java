...
class MdsalDelegatingTransactionChain implements DOMTransactionChain,
    ...
    public MdsalDelegatingTransactionChain(final Object txChainIdentifier, final SchemaContext schemaContext,
    ...
    public DOMDataReadOnlyTransaction newReadOnlyTransaction() {
        ...
        final DOMDataReadOnlyTransaction readTx =
                new MdsalDelegatingReadTransaction(newTransactionIdentifier(), readTxDelegate);
    ...
    public DOMDataReadWriteTransaction newReadWriteTransaction() {
        ...
        final DOMDataTreeReadTransaction readTxDelegate = txChainDelegate.newReadOnlyTransaction();
        final DOMDataReadOnlyTransaction readTx =
                new MdsalDelegatingReadTransaction(readWriteTxId, readTxDelegate);
        ...
        final DOMDataWriteTransaction writeTx =
                new MdsalDelegatingWriteTransaction(readWriteTxId, writeTxDelegate);

        final DOMDataReadWriteTransaction readWriteTx =
                new MdsalDelegatingReadWriteTransaction(readWriteTxId, schemaContext,
                        readTx, writeTx);
    ...
    public DOMDataWriteTransaction newWriteOnlyTransaction() {
        final DOMDataTreeWriteTransaction writeTxDelegate = txChainDelegate.newWriteOnlyTransaction();
        final DOMDataWriteTransaction writeTx =
                new MdsalDelegatingWriteTransaction(newTransactionIdentifier(), writeTxDelegate);
