...
public final class ImmutableUnsignedLongSet extends UnsignedLongSet implements Immutable, WritableObject {
    ...
    //
    // Based on all of this, we choose to default to 8188 entries, so that we end up with 65_520-byte arrays. In this
    // case the array roughly fits in the L1 and the complete dataset fits into L2.
    //
    ...
    //       leverage?
    private static final int DEFAULT_MAX_ARRAY = 8182;
