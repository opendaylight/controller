...
final class RemoteTransactionContextSupport {
    ...
    private TransactionContext createValidTransactionContext(final ActorSelection transactionActor, final String transactionPath,
            final short remoteTransactionVersion) {
