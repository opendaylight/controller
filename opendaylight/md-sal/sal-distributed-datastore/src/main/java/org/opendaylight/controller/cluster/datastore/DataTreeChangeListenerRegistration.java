...
public final class DataTreeChangeListenerRegistration extends AbstractUntypedActor {
    private final ListenerRegistration<DOMDataTreeChangeListener> registration;

    public DataTreeChangeListenerRegistration(final ListenerRegistration<DOMDataTreeChangeListener> registration) {
    ...
    private static final class DataTreeChangeListenerRegistrationCreator implements Creator<DataTreeChangeListenerRegistration> {
        ...
        @Override
        public DataTreeChangeListenerRegistration create() {
            return new DataTreeChangeListenerRegistration(registration);
        }
    }
}
