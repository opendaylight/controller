...
abstract class AbstractTransactionComponentFactory<F extends LocalTransactionFactory> implements ShardInfoListener {
    ...
    private void onFindPrimaryShardSuccess(PrimaryShardInfo primaryShardInfo, TransactionProxy parent,
        ...
        if(localContext != null) {
            transactionContextAdapter.executeTxOperatonsOnComplete(localContext);
        } else {
            RemoteTransactionSupport remote = new RemoteTransactionSupport(transactionContextAdapter,
                    parent, shardName);
    ...
    private void onFindPrimaryShardFailure(Throwable failure, TransactionProxy parent,
        ...
        transactionContextAdapter.executeTxOperatonsOnComplete(new NoOpTransactionContext(failure,
    ...
    final AbstractTransactionComponent newTransactionComponent(final TransactionProxy parent, final String shardName) {
        ...
        return new DefaultTransactionComponent(transactionContextAdapter, parent);
    }
