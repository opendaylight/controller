...
final class ClientBackedTransactionChain implements DOMStoreTransactionChain {
    ...
    @GuardedBy("this")
    private final Map<ClientSnapshot, Boolean> openSnapshots = new WeakHashMap<>();
    ...
    public synchronized void close() {
        for (ClientSnapshot snap : openSnapshots.keySet()) {
    ...
    private synchronized <T extends ClientSnapshot> T recordSnapshot(final T snapshot) {
