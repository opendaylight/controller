...
/**
 * Message sent to the local {@link org.opendaylight.controller.cluster.datastore.ShardedDataTreeActor} when a clustered
 * shard was created locally. The backend shards/replicas will be handled by the ShardManager but the
 * {@link org.opendaylight.controller.cluster.datastore.ShardedDataTreeActor} needs to handle the registration of the
