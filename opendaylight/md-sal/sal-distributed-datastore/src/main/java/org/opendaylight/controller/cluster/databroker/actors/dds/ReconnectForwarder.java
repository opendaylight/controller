...
abstract class ReconnectForwarder {
    ...
    private static final class Bouncing extends ReconnectForwarder {
        ...
        Bouncing(final ConnectedClientConnection successor, final Map<LocalHistoryIdentifier, ProxyReconnectCohort> cohorts) {
            super(successor);
    ...
    static ReconnectForwarder forCohorts(final ConnectedClientConnection successor,
        ...
        return new Bouncing(successor, Maps.uniqueIndex(Collections2.transform(cohorts,
