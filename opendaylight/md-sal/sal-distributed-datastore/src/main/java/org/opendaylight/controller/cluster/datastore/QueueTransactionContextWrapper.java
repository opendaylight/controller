...
public class QueueTransactionContextWrapper extends TransactionContextWrapper {
    private static final Logger LOG = LoggerFactory.getLogger(QueueTransactionContextWrapper.class);
    ...
    QueueTransactionContextWrapper(final TransactionIdentifier identifier, final ActorUtils actorUtils,
    ...
    private void enqueueTransactionOperation(final TransactionOperation operation) {
        ...
        try {
            ...
            synchronized (queuedTxOperations) {
                ...
                queuedTxOperations.add(new AbstractMap.SimpleImmutableEntry<>(operation, havePermit));
    ...
    void executePriorTransactionOperations(final TransactionContext localTransactionContext) {
        while (true) {
            ...
            // synchronously).
            final Collection<Map.Entry<TransactionOperation, Boolean>> operationsBatch;
            synchronized (queuedTxOperations) {
            ...
            for (Map.Entry<TransactionOperation, Boolean> oper : operationsBatch) {
