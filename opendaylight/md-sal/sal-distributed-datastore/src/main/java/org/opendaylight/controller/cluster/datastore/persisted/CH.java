 ...
 */
final class CH extends AbstractProxy<LocalHistoryIdentifier> {
    @java.io.Serial
    ...
    @Override
    protected CreateLocalHistoryPayload createObject(final LocalHistoryIdentifier identifier, final byte[] serialized) {
