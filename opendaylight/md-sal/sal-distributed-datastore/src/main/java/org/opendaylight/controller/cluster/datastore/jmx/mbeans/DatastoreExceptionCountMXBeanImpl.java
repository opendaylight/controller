...
/**
 * This is the implementation for the DatastoreExceptionMXBean interface. It
 * uses the DatastoreExceptionTracker to get the counter values. It also has a
 * setter to configure the timer interval in which the counter value should be
 * reset.
 * @author evijayd
 *
 */
...
public class DatastoreExceptionCountMXBeanImpl extends AbstractMXBean implements DatastoreExceptionCountMXBean {
    ...
    @Override
    public void setResetCounterTimerInterval(long resetTimerInterval) {
    ...
    public long getExceptionCountThreshold() {
        return DatastoreExceptionTracker.getExceptionCountThreshold();
    }

    @Override
    public void setExceptionCountThreshold(long exceptionCountThreshold) {
        LOG.debug("setting the exception count threshold to: {}", exceptionCountThreshold);
        DatastoreExceptionTracker.setExceptionCountThreshold(exceptionCountThreshold);
    }
}