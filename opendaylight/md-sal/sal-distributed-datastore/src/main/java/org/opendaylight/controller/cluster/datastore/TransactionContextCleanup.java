 ...
 */
final class TransactionContextCleanup extends FinalizablePhantomReference<TransactionFutureCallback> {
    ...
    private TransactionContextCleanup(TransactionFutureCallback referent, TransactionContext cleanup) {
        super(referent, QUEUE);
        this.cleanup = cleanup;
    }

    static void track(final TransactionFutureCallback referent, final TransactionContext cleanup) {
    ...
    static void untrack(final TransactionContextImpl cleanup) {
