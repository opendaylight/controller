 ...
 */
final class TransactionContextCleanup extends FinalizablePhantomReference<RemoteTransactionSupport> {
    ...
    private TransactionContextCleanup(RemoteTransactionSupport referent, TransactionContext cleanup) {
        super(referent, QUEUE);
        this.cleanup = cleanup;
    }

    static void track(final RemoteTransactionSupport referent, final TransactionContext cleanup) {
