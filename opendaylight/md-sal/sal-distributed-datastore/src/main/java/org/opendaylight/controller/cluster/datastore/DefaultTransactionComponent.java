 ...
 */
final class DefaultTransactionComponent extends AbstractTransactionComponent {
    private static final Logger LOG = LoggerFactory.getLogger(DefaultTransactionComponent.class);
    private final TransactionContextAdapter transactionContextAdapter;
    private final TransactionProxy parent;

    DefaultTransactionComponent(final TransactionContextAdapter transactionContextAdapter, final TransactionProxy parent) {
