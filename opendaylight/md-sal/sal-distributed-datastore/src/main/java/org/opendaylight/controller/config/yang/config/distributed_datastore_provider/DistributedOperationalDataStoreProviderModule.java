...
public class DistributedOperationalDataStoreProviderModule extends
    ...
    public java.lang.AutoCloseable createInstance() {
        ...
        WaitingServiceTracker<DOMStore> tracker = WaitingServiceTracker.create(DOMStore.class, bundleContext,
                "(type=distributed-operational)");
        DOMStore delegate = tracker.waitForService(WaitingServiceTracker.FIVE_MINUTES);
        return new ForwardingDOMStore(delegate, tracker);
    }
