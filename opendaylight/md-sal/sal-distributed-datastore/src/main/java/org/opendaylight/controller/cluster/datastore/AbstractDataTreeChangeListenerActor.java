...
abstract class AbstractDataTreeChangeListenerActor extends AbstractUntypedActor {
    ...
    AbstractDataTreeChangeListenerActor(final DOMDataTreeChangeListener listener,
