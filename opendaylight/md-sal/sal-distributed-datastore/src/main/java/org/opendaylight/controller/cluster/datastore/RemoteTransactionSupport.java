 ...
 * successfully or not.
 */
final class RemoteTransactionSupport {
    private static final Logger LOG = LoggerFactory.getLogger(RemoteTransactionSupport.class);
    ...
    RemoteTransactionSupport(final TransactionContextAdapter transactionContextAdapter, final TransactionProxy parent,
    ...
    void setPrimaryShard(ActorSelection primaryShard) {
        ...
        if (getTransactionType() == TransactionType.WRITE_ONLY &&
            ...
            transactionContextAdapter.executeTxOperatonsOnComplete(createValidTransactionContext(this.primaryShard,
    ...
    void createTransactionContext(Throwable failure, Object response) {
        ...
        transactionContextAdapter.executeTxOperatonsOnComplete(localTransactionContext);
    }
