...
final class ModuleShardBackendResolver extends BackendInfoResolver<ShardBackendInfo> {
    ...
    Long resolveShardForPath(final YangInstanceIdentifier path) {
        // this should work for prefix based shards aswell since the strategy factory would get the correct
        // strategy from configuration which will return the correct shardName
