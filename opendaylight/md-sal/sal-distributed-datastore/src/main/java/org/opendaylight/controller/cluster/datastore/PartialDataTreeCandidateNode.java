...
final class PartialDataTreeCandidateNode implements DataTreeCandidateNode {
    ...
    PartialDataTreeCandidateNode(PathArgument identifier) {
    ...
    PartialDataTreeCandidateNode(PathArgument identifier, Collection<DataTreeCandidateNode> children) {
    ...
    @Override
    public DataTreeCandidateNode getModifiedChild(PathArgument identifier) {
