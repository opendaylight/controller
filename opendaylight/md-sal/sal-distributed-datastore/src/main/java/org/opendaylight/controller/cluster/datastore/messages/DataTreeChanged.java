...
/**
 * A message about a DataTree having been changed. This class is Serializable by itself,
 * but its users must be vary that it may lose some information when serialized. Specifically
 * it assumes remote receivers keep track of what messages they have seen, e.g. by mutating
 * their own copy of data tree and recovering the tree from there.
 */
