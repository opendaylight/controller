...
public class DatastoreContext implements ClientActorConfig {
    ...
    public static class Builder implements org.opendaylight.yangtools.concepts.Builder<DatastoreContext> {
        ...
        public Builder setRecoverySnapshotIntervalSeconds(final int recoverySnapshotInterval) {
            datastoreContext.setRecoverySnapshotIntervalSeconds(recoverySnapshotInterval);
            return this;
        }
