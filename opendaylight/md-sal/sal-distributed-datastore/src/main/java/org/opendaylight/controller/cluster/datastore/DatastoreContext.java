...
public class DatastoreContext {
    ...
    private TreeType treeType = TreeType.OPERATIONAL;
    ...
    /**
     * @deprecated Use {@link #getDataStoreName()} or {@link #getTreeType()} instead.
     */
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * @deprecated Use {@link #treeType(LogicalDatastoreType)} or {@link #dataStoreName(String)}.
         */
        @Deprecated
        ...
        public Builder treeType(TreeType treeType){
            datastoreContext.treeType = Preconditions.checkNotNull(treeType);
