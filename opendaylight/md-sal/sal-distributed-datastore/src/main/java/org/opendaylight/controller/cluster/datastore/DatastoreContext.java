...
public class DatastoreContext {
    ...
    public static final int DEFAULT_SHARD_TX_COMMIT_QUEUE_CAPACITY = 100000;
    ...
    private long shardCommitCacheExpiryTimeoutInMillis = DEFAULT_SHARD_COMMIT_CACHE_EXPIRY_TIMEOUT_IN_MS;
    ...
    private DatastoreContext(DatastoreContext other) {
        ...
        this.shardCommitCacheExpiryTimeoutInMillis = other.shardCommitCacheExpiryTimeoutInMillis;
    ...
    public long getShardCommitCacheExpiryTimeoutInMillis() {
        return shardCommitCacheExpiryTimeoutInMillis;
    }
    ...
    public static class Builder {
        ...
        public Builder shardCommitCacheExpiryTimeoutInMillis(long value) {
            datastoreContext.shardCommitCacheExpiryTimeoutInMillis = value;
            return this;
        }
