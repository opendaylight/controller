...
public class DatastoreContext implements ClientActorConfig {
    ...
    private Map<String, Persistence> shardPersistanceMap = new HashMap<>();
    ...
    public Persistence getShardPersistence(final String shardName) {
        return shardPersistanceMap.get(shardName);
    }

    public void setShardPersistece(final String shardName, final Persistence persistence) {
        this.shardPersistanceMap.put(shardName, persistence);
    }
    ...
    public static class Builder implements org.opendaylight.yangtools.concepts.Builder<DatastoreContext> {
        ...
        public Builder shardPersistenceMap(final Map<String, Persistence> shardPersistanceMap) {
