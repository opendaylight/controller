...
public class DatastoreContext {
    ...
    private boolean tellBasedProtocolEnabled = false;
    ...
    private DatastoreContext(final DatastoreContext other) {
        ...
        this.tellBasedProtocolEnabled = other.tellBasedProtocolEnabled;
    ...
    public boolean isTellBasedProtocolEnabled() {
        return tellBasedProtocolEnabled;
    }
    ...
    public static class Builder {
        ...
        public Builder tellBasedProtocolEnabled(boolean value) {
            datastoreContext.tellBasedProtocolEnabled = value;
            return this;
        }
