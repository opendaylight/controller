...
class EntityOwnershipShard extends Shard {
    ...
    private void writeNewOwner(YangInstanceIdentifier entityPath, String newOwner) {
        ...
        commitCoordinator.commitModification(new MergeModification(entityPath.node(ENTITY_OWNER_QNAME),
                ImmutableNodes.leafNode(new YangInstanceIdentifier.NodeIdentifier(ENTITY_OWNER_QNAME), newOwner)), this);
    }
