...
class CompositeDataTreeCohort {
    ...
    private enum State {
        /**
         * Cohorts are idle, no messages were send.
         */
        IDLE,
        /**
         * CanCommit message was send to all participating cohorts.
         */
        CAN_COMMIT_SEND,
        /**
        ...
        /**
         * PreCommit message was send to all participating cohorts.
         */
        PRE_COMMIT_SEND,
        /**
    ...
    void canCommit(DataTreeCandidateTip tip) throws ExecutionException, TimeoutException {
        ...
        processResponses(canCommitsFuture, State.CAN_COMMIT_SEND, State.CAN_COMMIT_SUCCESSFUL);
    }
