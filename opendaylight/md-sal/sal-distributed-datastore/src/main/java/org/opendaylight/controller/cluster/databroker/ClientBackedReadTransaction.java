...
/**
 * An implementation of {@link DOMStoreReadTransaction} backed by a {@link ClientTransaction}. Used for standalone
 * transactions.
 *
 * @author Robert Varga
 */
final class ClientBackedReadTransaction extends ClientBackedTransaction implements DOMStoreReadTransaction {
    ...
    ClientBackedReadTransaction(final ClientTransaction delegate, @Nullable final ClientBackedTransactionChain parent) {
        super(delegate);
        this.parent = parent;
