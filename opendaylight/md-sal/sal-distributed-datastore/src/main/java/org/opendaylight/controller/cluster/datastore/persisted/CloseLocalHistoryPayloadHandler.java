...
public final class CloseLocalHistoryPayloadHandler extends AbstractPayloadHandler<CloseLocalHistoryPayload> {
    ...
    static {
        PayloadRegistry.INSTANCE.registerHandler(PayloadRegistry.PayloadTypeCommon.CLOSE_LOCAL_HISTORY_PAYLOAD,
                new CloseLocalHistoryPayloadHandler());
    }

    private CloseLocalHistoryPayloadHandler() {
    }

    @Override
    protected void doWrite(final DataOutput out, final CloseLocalHistoryPayload payload) throws IOException {
