...
public final class PurgeTransactionPayloadHandler extends AbstractPayloadHandler<PurgeTransactionPayload> {
    ...
    static {
        PayloadRegistry.INSTANCE.registerHandler(PayloadRegistry.PayloadTypeCommon.PURGE_TRANSACTION_PAYLOAD,
                new PurgeTransactionPayloadHandler());
    }

    private PurgeTransactionPayloadHandler() {
    }

    @Override
    protected void doWrite(final DataOutput out, final PurgeTransactionPayload payload) throws IOException {
