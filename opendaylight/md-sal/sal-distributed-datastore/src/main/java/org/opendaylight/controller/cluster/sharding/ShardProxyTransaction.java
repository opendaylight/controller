...
class ShardProxyTransaction implements DOMDataTreeShardWriteTransaction {
    ...
    public static final ListenableFuture<Void> NULL_FUTURE = Futures.immediateFuture(null);
    public static final ListenableFuture<Boolean> VALIDATE_FUTURE = Futures.immediateFuture(true);
