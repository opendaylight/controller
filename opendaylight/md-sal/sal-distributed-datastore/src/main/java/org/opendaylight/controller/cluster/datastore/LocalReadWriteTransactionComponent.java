...
final class LocalReadWriteTransactionComponent extends LocalWritableTransactionComponent<DOMStoreReadWriteTransaction> {
    private static final Logger LOG = LoggerFactory.getLogger(LocalReadWriteTransactionComponent.class);

    LocalReadWriteTransactionComponent(final TransactionIdentifier identifier, final DOMStoreReadWriteTransaction delegate) {
