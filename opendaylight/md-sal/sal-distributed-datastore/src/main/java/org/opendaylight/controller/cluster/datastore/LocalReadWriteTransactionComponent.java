 ...
 */
final class LocalReadWriteTransactionComponent extends AbstractTransactionComponent {
    private final DOMStoreReadWriteTransaction delegate;

    LocalReadWriteTransactionComponent(DOMStoreReadWriteTransaction delegate) {
