...
public abstract sealed class CommitTransactionPayload extends IdentifiablePayload<TransactionIdentifier>
    ...
    private static final class SimpleMagnesium extends Simple implements MagnesiumPayload {
        @java.io.Serial
        private static final long serialVersionUID = 1L;
    ...
    @Deprecated(since = "7.0.0", forRemoval = true)
    private static final class ChunkedMagnesium extends Chunked implements MagnesiumPayload {
        @java.io.Serial
        private static final long serialVersionUID = 1L;
