...
public final class FrontendClientMetadata implements Identifiable<ClientIdentifier>, WritableObject {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(identifier, currentHistories, purgedHistories);
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FrontendClientMetadata)) {
            return false;
        }

        final FrontendClientMetadata other = (FrontendClientMetadata) o;
        return identifier.equals(other.identifier) && purgedHistories.equals(other.purgedHistories)
                && currentHistories.equals(other.currentHistories);
    }
