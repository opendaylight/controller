 ...
 */
class ForwardingDOMStore extends ForwardingObject implements DOMStore, AutoCloseable {
    private final DOMStore delegate;
    private final AutoCloseable closeable;

    ForwardingDOMStore(DOMStore delegate, AutoCloseable closeable) {
