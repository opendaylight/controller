...
final class DistributedDataStoreClientBehavior extends ClientActorBehavior<ShardBackendInfo>
    ...
    protected ConnectedClientConnection<ShardBackendInfo> connectionUp(final Long shard,
    ...
    ModuleShardBackendResolver moduleResolver() {
        return (ModuleShardBackendResolver) resolver();
    }
}
