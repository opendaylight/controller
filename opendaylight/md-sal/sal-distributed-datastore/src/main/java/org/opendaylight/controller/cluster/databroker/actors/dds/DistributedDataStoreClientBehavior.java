...
final class DistributedDataStoreClientBehavior extends ClientActorBehavior implements DistributedDataStoreClient {
    ...
    private void localConnectionUp(final Long shard, final ConnectingClientConnection<ShardBackendInfo> conn,
     ...
     */
    @GuardedBy("connectionsLock")
    private void remoteConnectionUp(final Long shard, final ConnectingClientConnection<ShardBackendInfo> conn,
            final ShardBackendInfo backend) {
        final ConnectedClientConnection<ShardBackendInfo> newConn = conn.toRemoteConnected(backend);
