    ...
    private static TransactionContext createLocalTransactionContext(final LocalTransactionFactory factory, final TransactionProxy parent) {
        switch(parent.getType()) {
            case READ_ONLY:
                ...
                return new LocalTransactionContext(parent.getIdentifier(), readOnly) {
                    @Override
            ...
            case READ_WRITE:
                ...
                return new LocalTransactionContext(parent.getIdentifier(), readWrite) {
                    @Override
                    protected DOMStoreWriteTransaction getWriteDelegate() {
                        return readWrite;
                    }
            ...
            case WRITE_ONLY:
                ...
                return new LocalTransactionContext(parent.getIdentifier(), writeOnly) {
                    @Override
                    protected DOMStoreWriteTransaction getWriteDelegate() {
                        return writeOnly;
                    }
