...
abstract class AbstractTransactionStateTracker implements Identifiable<TransactionIdentifier> {
    ...
    private static <T extends TransactionIdentifier> void finishCommit(final CompletableFuture<TransactionSuccess<?>> future, final Response<TransactionIdentifier, ?> response) {
    ...
    abstract <T extends TransactionRequest<T>> T doCommit(boolean coordinated);
