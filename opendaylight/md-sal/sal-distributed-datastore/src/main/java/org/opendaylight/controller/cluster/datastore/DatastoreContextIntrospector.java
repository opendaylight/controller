...
public class DatastoreContextIntrospector {
    ...
    private static void introspectPrimitiveTypes() {
        ...
        Set<Class<?>> prmitives = ImmutableSet.<Class<?>>builder().addAll(
                Primitives.allWrapperTypes()).add(String.class).build();
        for(Class<?> primitive: prmitives) {
            try {
    ...
    public boolean update(Dictionary<String, Object> properties) {
        ...
        Collections.sort(keys, new Comparator<String>() {
            ...
            public int compare(String key1, String key2) {
                return key1.startsWith(context.getDataStoreType()) ? 1 :
                           key2.startsWith(context.getDataStoreType()) ? -1 : key1.compareTo(key2);
            }
        });
    ...
    private Object convertValue(String name, Object from) throws Exception {
        ...
        // property type is the yamg-generated NonZeroUint32Type, it's constructor takes a Long so
