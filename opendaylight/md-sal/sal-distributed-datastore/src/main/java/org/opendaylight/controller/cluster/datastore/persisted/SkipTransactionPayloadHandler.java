...
public final class SkipTransactionPayloadHandler extends AbstractPayloadHandler<SkipTransactionsPayload> {
    ...
    static {
        PayloadRegistry.INSTANCE.registerHandler(PayloadRegistry.PayloadTypeCommon.SKIP_TRANSACTION_PAYLOAD,
                new SkipTransactionPayloadHandler());
    }

    private SkipTransactionPayloadHandler() {
    }

    @Override
    protected void doWrite(final DataOutput out, final SkipTransactionsPayload payload) throws IOException {
