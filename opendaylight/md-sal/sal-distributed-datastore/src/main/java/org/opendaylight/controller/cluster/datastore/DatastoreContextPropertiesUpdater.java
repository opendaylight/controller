...
public class DatastoreContextPropertiesUpdater implements AutoCloseable {
    ...
    /**
     * Base init of updater for DatastoreContext settings. This constructor supports access from OSGi.
     *
     * @param introspector
     *            - introspection on DatastoreContext
     * @param propsResolver
     *            - specific object which has to contain field "Dictionary(String, Object) properties" for resolving
     *            base properties
     */
    public DatastoreContextPropertiesUpdater(final DatastoreContextIntrospector introspector,
            final Object propsResolver) {
        this(introspector, PropertiesResolver.resolveProps(propsResolver));
    }
