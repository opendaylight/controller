...
public sealed class CloseLocalHistoryPayload extends AbstractIdentifiablePayload<LocalHistoryIdentifier> {
    ...
    public static @NonNull CloseLocalHistoryPayload readFrom(final DataInput in) throws IOException {
        return CloseLocalHistoryPayload.create(LocalHistoryIdentifier.readFrom(in),
