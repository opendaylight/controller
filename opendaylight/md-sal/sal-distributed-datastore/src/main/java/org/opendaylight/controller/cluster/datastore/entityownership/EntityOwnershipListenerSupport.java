...
class EntityOwnershipListenerSupport extends EntityOwnershipChangePublisher {
    ...
    @Override
    void notifyEntityOwnershipListeners(final DOMEntity entity, final boolean wasOwner, final boolean isOwner, final boolean hasOwner) {
    ...
    void notifyEntityOwnershipListener(final DOMEntity entity, final boolean wasOwner, final boolean isOwner, final boolean hasOwner,
    ...
    @GuardedBy("listenerLock")
    private void notifyListeners(final DOMEntity entity, final boolean wasOwner, final boolean isOwner, final boolean hasOwner,
            final Collection<ListenerActorRefEntry> listenerEntries) {
