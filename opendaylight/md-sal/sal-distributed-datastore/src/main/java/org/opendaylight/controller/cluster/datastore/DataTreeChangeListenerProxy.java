...
abstract class DataTreeChangeListenerProxy<T extends DOMDataTreeChangeListener> extends AbstractListenerRegistration<T> {
    ...
    public DataTreeChangeListenerProxy(final ActorUtils actorUtils, final T listener,
...
//    final class DataTreeChangeListenerProxyFactory {
//        private final ActorUtils actorUtils;
//        private final YangInstanceIdentifier registeredPath;
//        private final T listener;
//
//        public DataTreeChangeListenerProxyFactory(final ActorUtils actorUtils, final T listener,
//                final YangInstanceIdentifier registeredPath) {
...
//        }
//
//        public DataTreeChangeListenerProxy<T> create() {
//            if (registeredPath.isEmpty() && actorUtils.getConfiguration().getAllShardNames().size() > 1) {
//                return new DataTreeChangeListenerMultiShardProxy<>(actorUtils, listener, registeredPath);
//            }
//            return new DataTreeChangeListenerSingleShardProxy<>(actorUtils, listener, registeredPath);
...
//    }
    ...
    static final class DataTreeChangeListenerMultiShardProxy<T extends DOMDataTreeChangeListener>
        ...
        private final Logger LOG = LoggerFactory.getLogger(DataTreeChangeListenerMultiShardProxy.class);
    ...
    static final class DataTreeChangeListenerSingleShardProxy<T extends DOMDataTreeChangeListener>
            extends DataTreeChangeListenerProxy<T> {
        private final Logger LOG = LoggerFactory.getLogger(DataTreeChangeListenerSingleShardProxy.class);
