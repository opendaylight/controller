...
public class BatchedModifications extends MutableCompositeModification {
    ...
    private Optional<List<String>> participatingShardNames = Optional.empty();
    ...
    public void setReady(Optional<List<String>> possibleParticipatingShardNames) {
        this.ready = true;
        this.participatingShardNames = requireNonNull(possibleParticipatingShardNames);
    }

    public Optional<List<String>> getParticipatingShardNames() {
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        if (getVersion() >= DataStoreVersions.FLUORINE_VERSION) {
            if (in.readBoolean()) {
                ...
                List<String> shardNames = new ArrayList<>(count);
