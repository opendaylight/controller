...
public class ShardManager extends AbstractUntypedPersistentActorWithMetering {
    ...
    protected void handleRecover(Object message) throws Exception {
        if (message instanceof RecoveryCompleted) {
            ...
            LOG.info ("setting recovery complete, to persist shards");
    ...
    private void createLocalShards() {
        ...
        for(String shardName : memberShardNames){
            ...
            LOG.info ("sending for persistence of {}", shardName);
    ...
    protected class ShardPersister {
        ...
        public void addShard(String shardName) {
            ...
            LOG.debug("addShard, localShardList {}", localShardPersistMap);
            persistShardList();
        }

        public void removeShard(String shardName) {
            localShardPersistMap.remove(shardName);
            LOG.debug("removeShard, localShardList {}", localShardPersistMap);
            persistShardList();
        }
        ...
        public void updateShardInitializedState(String shardName) {
            ...
            LOG.debug("updateShardInitializedState, localShardList{}", localShardPersistMap);
            persistShardList();
        }

        public void setShardManagerRecoverState(boolean flag) {
            LOG.debug ("setting shardManagerRecoverState {}", flag);
            this.shardManagerRecoverState = flag;
            if (!localShardPersistMap.isEmpty()) {
                LOG.debug ("persisting Shardlist");
                persistShardList();
            }
        }
