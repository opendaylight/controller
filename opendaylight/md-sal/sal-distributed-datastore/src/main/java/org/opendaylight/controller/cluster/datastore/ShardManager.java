...
public class ShardManager extends AbstractUntypedPersistentActorWithMetering {
    ...
    protected ShardManager(Builder builder) {
        ...
        this.datastoreContext = builder.datastoreContext;
        ...
        for(ShardInformation shardInfo: localShards.values()) {
            if(shardInfo.isShardInitialized()) {
                ...
                getSender().tell(new akka.actor.Status.Failure(new IllegalStateException(
                        "Some or all shards are not initialized")), getSelf());
                replyActor.tell(PoisonPill.getInstance(), getSelf());
            }
        }
    }
    ...
    private void createLocalShards() {
        ...
        for(String shardName : memberShardNames){
            ...
            localShards.put(shardName, new ShardInformation(shardName, shardId, peerAddresses, datastoreContext,
                    Shard.builder().restoreFromSnapshot(shardSnapshots.get(shardName)), peerAddressResolver));
        }
    ...
    protected static class ShardInformation {
        ...
        private ShardInformation(String shardName, ShardIdentifier shardId,
                ...
                Shard.Builder<?> builder, ShardPeerAddressResolver addressResolver) {
    ...
    public static class Builder {
        ...
        public Builder datastoreContext(DatastoreContext datastoreContext) {
            checkSealed();
            this.datastoreContext = datastoreContext;
            return this;
        }
