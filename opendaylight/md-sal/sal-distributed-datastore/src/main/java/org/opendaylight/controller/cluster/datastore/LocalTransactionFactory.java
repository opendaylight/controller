...
final class LocalTransactionFactory extends TransactionReadyPrototype<TransactionIdentifier> implements DOMStoreTransactionFactory {
    ...
    private final SimpleComponentFactory parent;
    private final ActorSelection leader;
    private final DataTree dataTree;

    public LocalTransactionFactory(final SimpleComponentFactory parent, final ActorSelection leader, final DataTree dataTree) {
