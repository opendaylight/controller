 ...
 * disconnected from each other. These are used by {@link TransactionComponentFactory} to instantiate
...
final class LocalTransactionFactory extends TransactionReadyPrototype<TransactionIdentifier> implements DOMStoreTransactionFactory {
    ...
    public LocalTransactionFactory(final SimpleTransactionComponentFactory parent, final ActorSelection leader, final DataTree dataTree) {
