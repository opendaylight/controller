 ...
 * local shards.
 */
abstract class TransactionComponentFactory<F extends DOMStoreTransactionFactory> implements ShardInfoListener {
    ...
    @Override
    public void onShardInfoUpdated(String shardName, PrimaryShardInfo primaryShardInfo) {
        ...
        if (existing != null) {
            ...
            knownLocal.remove(shardName, existing);
        }
    }
