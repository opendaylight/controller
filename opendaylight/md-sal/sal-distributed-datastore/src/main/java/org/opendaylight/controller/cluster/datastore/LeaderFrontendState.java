...
final class LeaderFrontendState implements Identifiable<ClientIdentifier> {
    ...
    private @Nullable LocalHistorySuccess handleCreateHistory(final @NonNull CreateLocalHistoryRequest request,
            final @NonNull RequestEnvelope envelope, final long now) throws RequestException {
    ...
    private @Nullable LocalHistorySuccess handleDestroyHistory(final @NonNull DestroyLocalHistoryRequest request,
            final @NonNull RequestEnvelope envelope, final long now) {
    ...
    private @Nullable LocalHistorySuccess handlePurgeHistory(final @NonNull PurgeLocalHistoryRequest request,
            final @NonNull RequestEnvelope envelope, final long now) {
        final var id = request.getTarget();
