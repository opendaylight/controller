...
final class TransactionContext {
    ...
    PersistTransactionRequest toAbortRequest(final ActorRef replyTo) {
        return PersistTransactionRequest.createAbort(gtid, replyTo, null);
    }
    ...
    PersistTransactionRequest toDoCommitRequest(final ActorRef replyTo) {
        return PersistTransactionRequest.createDoCommit(gtid, replyTo, mod);
    }
}
