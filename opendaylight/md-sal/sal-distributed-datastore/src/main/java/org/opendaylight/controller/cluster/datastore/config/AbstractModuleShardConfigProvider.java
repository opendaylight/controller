...
abstract class AbstractModuleShardConfigProvider implements ModuleShardConfigProvider {
    ...
    protected static Config loadConfigFromPath(final String configPath) {
    ...
    protected static void readModulesConfig(final Config modulesConfig,
                                            final Map<String, ModuleConfig.Builder> moduleConfigMap,
    ...
    protected static Map<String, ModuleConfig.Builder> readModuleShardsConfig(final Config moduleShardsConfig) {
