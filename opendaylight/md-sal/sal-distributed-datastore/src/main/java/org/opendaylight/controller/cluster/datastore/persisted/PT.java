 ...
 */
final class PT extends AbstractProxy<TransactionIdentifier> {
    @java.io.Serial
    ...
    @Override
    protected PurgeTransactionPayload createObject(final TransactionIdentifier identifier, final byte[] serialized) {
