...
final class SimpleTransactionComponentFactory extends TransactionComponentFactory<LocalTransactionFactory> implements AutoCloseable {
    ...
    private final ShardInfoListenerRegistration<SimpleTransactionComponentFactory> reg;

    private SimpleTransactionComponentFactory(final ActorContext actorContext) {
        super(actorContext);
        this.reg = actorContext.registerShardInfoListener(this);
    }

    static SimpleTransactionComponentFactory create(ActorContext actorContext) {
        return new SimpleTransactionComponentFactory(actorContext);
    }
    ...
    synchronized DOMStoreTransactionChain createTransactionChain() {
    ...
    @Override
    public synchronized void onShardInfoUpdated(String shardName, PrimaryShardInfo primaryShardInfo) {
