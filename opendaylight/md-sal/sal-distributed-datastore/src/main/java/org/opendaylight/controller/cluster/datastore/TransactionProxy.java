 ...
 */
class TransactionProxy extends AbstractDOMStoreTransaction<TransactionIdentifier> implements DOMStoreReadWriteTransaction {
    ...
    protected TransactionProxy(final ComponentFactory componentFactory, final TransactionType type) {
