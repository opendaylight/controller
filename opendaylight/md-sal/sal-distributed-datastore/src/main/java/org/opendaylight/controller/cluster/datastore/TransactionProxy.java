...
public class TransactionProxy extends AbstractDOMStoreTransaction<TransactionIdentifier> implements DOMStoreReadWriteTransaction {
    ...
    private final AbstractTransactionComponentFactory componentFactory;
    ...
    @VisibleForTesting
    public TransactionProxy(final AbstractTransactionComponentFactory componentFactory, final TransactionType type) {
        super(componentFactory.nextIdentifier(), false);
