...
@NotThreadSafe
@VisibleForTesting
public final class ShardDataTree extends ShardDatTreeTransactionParent {
    ...
    private ShardDataTreeTransactionChain ensureTransactionChain(final String chainId) {
        ...
        if (chain == null) {
            chain = new ShardDataTreeTransactionChain(this, takeSnapshot());
    ...
    @Override
    protected DOMStoreThreePhaseCommitCohort finishTransaction(final DataTreeModification transaction) {
