...
public class DistributedShardedDOMDataTree implements DOMDataTreeService, DOMDataTreeShardingService, DistributedShardFactory {
    ...
    public <T extends DOMDataTreeListener> ListenerRegistration<T> registerListener(
            ...
            final boolean allowRxMerges, final Collection<DOMDataTreeProducer> producers) throws DOMDataTreeLoopException {
    ...
    public <T extends DOMDataTreeShard> ListenerRegistration<T> registerDataTreeShard(
            @Nonnull final DOMDataTreeIdentifier prefix, @Nonnull final T shard, @Nonnull final DOMDataTreeProducer producer)
    ...
    private DistributedShardRegistration initDefaultShard(final LogicalDatastoreType logicalDatastoreType)
        ...
        return createDistributedShard(new DOMDataTreeIdentifier(logicalDatastoreType, YangInstanceIdentifier.EMPTY), names);
    }

    private ListenerRegistration<DistributedShardFrontend> initDefaultShardOld(
