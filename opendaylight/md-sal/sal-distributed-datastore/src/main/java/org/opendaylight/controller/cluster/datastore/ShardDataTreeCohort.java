...
final class ShardDataTreeCohort implements DOMStoreThreePhaseCommitCohort {
    ...
    ShardDataTreeCohort(final ShardDataTree dataTree, DataTreeModification transaction) {
    ...
    public ListenableFuture<Void> commit() {
         ...
         *        persist on the candidate (which gives us a Future) and then chaining the commit on top of
         *        that future.
         */
