...
public class NotifyProducerCreated implements Serializable {
    ...
    private final ImmutableList<DOMDataTreeIdentifier> subtrees;

    public NotifyProducerCreated(final Collection<DOMDataTreeIdentifier> subtrees) {
        this.subtrees =
                ImmutableList.<DOMDataTreeIdentifier>builder().addAll(Preconditions.checkNotNull(subtrees)).build();
    }
