...
public final class OSGiDOMStore
    ...
    void activate(final Map<String, ?> properties) {
        ...
        OSGiDistributedDataStore.LOG.info("Distributed Datastore type {} started", datastoreType);
    }

    @Deactivate
    void deactivate() {
        datastore.close();
        OSGiDistributedDataStore.LOG.info("Distributed Datastore type {} stopped", datastoreType);
    }
}
