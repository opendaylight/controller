...
public class RemoveShardReplica {
     ...
     */
    public RemoveShardReplica (@Nonnull String shardName, @Nonnull String memberName, @Nonnull String dataStoreType){
        ...
        this.dataStoreType = Preconditions.checkNotNull(dataStoreType, "dataStoreType should not be null");
    }
    ...
    public String toString() {
        return "RemoveShardReplica{" + "shardName='" + shardName +
                "', memberName='" + memberName + "', dataStoreType=" + dataStoreType + '}';
    }
}
