...
import org.opendaylight.controller.cluster.datastore.messages.CreatePrefixShard;
import org.opendaylight.controller.cluster.datastore.messages.NotifyProducerCreated;
import org.opendaylight.controller.cluster.datastore.messages.NotifyProducerRemoved;
import org.opendaylight.controller.cluster.datastore.messages.PrefixShardCreated;
import org.opendaylight.controller.cluster.datastore.messages.PrefixShardRemoved;
import org.opendaylight.controller.cluster.datastore.messages.ProducerCreated;
import org.opendaylight.controller.cluster.datastore.messages.ProducerRemoved;
import org.opendaylight.controller.cluster.datastore.messages.RemovePrefixShard;
...
public class ShardedDataTreeActor extends AbstractUntypedPersistentActor {
    ...
    private void onCreatePrefixShard(final CreatePrefixShard message) {
        ...
        try {
            final ListenerRegistration<ShardFrontend> shardFrontendRegistration = shardingService.registerDataTreeShard(configuration.getPrefix(), new ShardFrontend(client, configuration.getPrefix()), producer);
