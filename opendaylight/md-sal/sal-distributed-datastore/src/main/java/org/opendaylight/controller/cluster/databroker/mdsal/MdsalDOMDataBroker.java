 ...
 * and {@link DOMDataReadOnlyTransaction} provided by this data broker. See {@link MdsalDelegatingReadWriteTransaction}
 * and {@link MdsalDelegatingReadTransaction} respectively.
 */
// FIXME try to refactor some of the implementation to abstract class for better reusability
public class MdsalDOMDataBroker implements DOMDataBroker {
    ...
    public MdsalDOMDataBroker(final ShardedDOMDataBrokerAdapter delegateDataBroker,
    ...
    public DOMDataReadOnlyTransaction newReadOnlyTransaction() {
        return new MdsalDelegatingReadTransaction(newTransactionIdentifier(),
                delegateDataBroker.newReadOnlyTransaction());
    }

    @Override
    public DOMDataReadWriteTransaction newReadWriteTransaction() {
        return new MdsalDelegatingReadWriteTransaction(newTransactionIdentifier(), schemaService.getGlobalContext(),
                newReadOnlyTransaction(), newWriteOnlyTransaction());
    }

    @Override
    public DOMDataWriteTransaction newWriteOnlyTransaction() {
        return new MdsalDelegatingWriteTransaction(newTransactionIdentifier(),
    ...
    public DOMTransactionChain createTransactionChain(final TransactionChainListener listener) {
        return new MdsalDelegatingTransactionChain(chainNum.getAndIncrement(), schemaService.getGlobalContext(),
