...
abstract class LocalThreePhaseCommitCohort extends AbstractThreePhaseCommitCohort<ActorSelection> {
    ...
    void initiateDirectCommit() {
        final TransactionRateLimitingCallback rateLimitingCallback = new TransactionRateLimitingCallback(actorContext);
        ...
        delegate = DirectCommitCohort.create(actorContext, messageFuture);
        cohortFutures = Collections.emptyList();
    }
