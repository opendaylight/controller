...
/**
 *  Direct implementation of TransactionContextWrapper. Operation are not queued but executed directly
 *  on TransactionContext. Always has completed context and executes on local shard.
 */
