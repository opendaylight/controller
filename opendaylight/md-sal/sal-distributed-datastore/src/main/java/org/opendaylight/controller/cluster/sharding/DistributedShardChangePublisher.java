...
import org.opendaylight.mdsal.dom.store.inmemory.ChildShardContext;
...
public class DistributedShardChangePublisher extends AbstractDOMStoreTreeChangePublisher {
    ...
    private static final class DOMDataTreeListenerWithSubshards implements DOMDataTreeChangeListener {
        ...
        private synchronized DataTreeCandidate applyChanges(final Collection<DataTreeCandidate> changes) {
