...
public class DistributedShardChangePublisher extends AbstractDOMStoreTreeChangePublisher {

    private static final Logger LOG = LoggerFactory.getLogger(DistributedShardChangePublisher.class);

    private static final int DEFAULT_MAX_NOTIFICATIONS = 1000;
    ...
    // This will be useful for signaling backpressure
    ...
    public DistributedShardChangePublisher(final DataStoreClient client,
        ...
        notificationManager = QueuedNotificationManager.create(
                executor, MANAGER_INVOKER, DEFAULT_MAX_NOTIFICATIONS, "DataTreeChangeListenerQueueMgr");
    }

    @Override
    protected void notifyListener(@Nonnull final AbstractDOMDataTreeChangeListenerRegistration<?> registration,
                                  @Nonnull final Collection<DataTreeCandidate> changes) {
    ...
    DataTreeCandidate applyChanges(final YangInstanceIdentifier listenerPath,
    ...
    private final class DOMDataTreeListenerWithSubshards implements DOMDataTreeChangeListener {
        ...
        public void onDataTreeChanged(@Nonnull final Collection<DataTreeCandidate> changes) {
            ...
            delegate.onDataTreeChanged(Collections.singleton(applyChanges(listenerPath, changes)));
        }

        void onDataTreeChanged(final YangInstanceIdentifier pathFromRoot,
                                            final Collection<DataTreeCandidate> changes) {
        ...
        synchronized void addSubshard(final ChildShardContext context) {
