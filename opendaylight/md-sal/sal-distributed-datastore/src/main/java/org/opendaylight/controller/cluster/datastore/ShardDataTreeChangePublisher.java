...
final class ShardDataTreeChangePublisher extends AbstractDOMStoreTreeChangePublisher {
    ...
    @Override
    protected synchronized void notifyListeners(Collection<AbstractDOMDataTreeChangeListenerRegistration<?>> registrations,
            YangInstanceIdentifier path, DataTreeCandidateNode node) {
    ...
    protected synchronized void registrationRemoved(AbstractDOMDataTreeChangeListenerRegistration<?> registration) {
        // Synchronized block is the important thing, really
