...
public class Shard extends RaftActor {
    ...
    protected Shard(final ShardIdentifier name, final Map<String, String> peerAddresses,
        ...
        setPersistence(datastoreContext.isPersistent() ? new PersistentDataProvider(this) :
                new NonPersistentRaftDataProvider());
    ...
    private void onDatastoreContext(DatastoreContext context) {
        ...
        if(datastoreContext.isPersistent() && !persistence().isRecoveryApplicable()) {
            ...
            setPersistence(new NonPersistentRaftDataProvider());
        }
