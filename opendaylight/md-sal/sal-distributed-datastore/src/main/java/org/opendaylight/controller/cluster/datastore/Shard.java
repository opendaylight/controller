...
public class Shard extends RaftActor {
    ...
    private static final YangInstanceIdentifier DATA_TREE_ROOT_PATH = YangInstanceIdentifier.builder().build();
    ...
    private void finishCommit(@Nonnull final ActorRef sender, final @Nonnull String transactionID) {
        ...
        if(cohortEntry == null) {
            ...
            if(cohortEntry != null) {
                ...
                sender.tell(CommitTransactionReply.INSTANCE, getSelf());
            } else {
        ...
        if(cohortEntry != null) {
            ...
            Futures.addCallback(future, new FutureCallback<Void>() {
                ...
                public void onSuccess(Void v) {
                    ...
                    if(sender != null) {
                        sender.tell(AbortTransactionReply.INSTANCE, self);
                    }
                }
    ...
    protected void createSnapshot() {
        if (createSnapshotTransaction == null) {
            ...
            createSnapshotTransaction.tell(new ReadData(DATA_TREE_ROOT_PATH), self());
    ...
    protected void applySnapshot(ByteString snapshot) {
        ...
        try {
            ...
            transaction.delete(DATA_TREE_ROOT_PATH);

            // Add everything from the remote node back
            transaction.write(DATA_TREE_ROOT_PATH, node);
