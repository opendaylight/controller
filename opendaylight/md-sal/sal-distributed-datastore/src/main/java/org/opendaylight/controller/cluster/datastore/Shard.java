...
import org.opendaylight.controller.cluster.datastore.utils.Dispatchers.DispatcherType;
...
public class Shard extends RaftActor {
    ...
    protected Shard(final AbstractBuilder<?, ?> builder) {
        ...
        // TODO - use FileBackedOutputStreamFactory RaftActorContext
        responseMessageSlicer = MessageSlicer.builder().logContext(this.name)
                ...
                .filedBackedStreamFactory(new FileBackedOutputStreamFactory(
                    getRaftActorContext().getConfigParams().getFileBackedStreamingThreshold(),
                    getRaftActorContext().getConfigParams().getTempFileDirectory()))
