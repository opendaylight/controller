...
public class Shard extends RaftActor {
    ...
    protected Shard(final ShardIdentifier name, final Map<String, String> peerAddresses,
        ...
        super(name.toString(), new HashMap<>(peerAddresses), Optional.of(datastoreContext.getShardRaftConfig()),
                ElectionStrategyFactory.getElectionStrategy());
    ...
    public void onReceiveCommand(final Object message) throws Exception {
        ...
        try {
            if (CreateTransaction.SERIALIZABLE_CLASS.isInstance(message)) {
                ...
                handleLocalModification((ReadyLocalTransaction)message);
    ...
    private void handleLocalModification(final ReadyLocalTransaction message) {
        if (isLeader()) {
            try {
                commitCoordinator.handleLocalModifications(message, getSender(), this);
            } catch (Exception e) {
