...
import org.opendaylight.controller.cluster.datastore.jmx.ShardMBeanFactory;
import org.opendaylight.controller.cluster.datastore.jmx.ShardStatsMBean;
...
public class Shard extends UntypedProcessor {
    ...
    private final ShardStatsMBean shardMBean;
