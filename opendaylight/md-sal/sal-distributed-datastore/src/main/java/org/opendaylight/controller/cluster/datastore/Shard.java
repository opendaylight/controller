...
import org.opendaylight.controller.cluster.datastore.actors.localhistory.PersistTransactionRequest;
...
public class Shard extends RaftActor {
    ...
    private void handlePersistTransactionRequest(final PersistTransactionRequest message) {
        ...
        throw new IllegalArgumentException("Unhandled fate " + message.getFate());
    }
