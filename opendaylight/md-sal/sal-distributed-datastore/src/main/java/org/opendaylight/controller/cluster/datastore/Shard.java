...
//        guard=true;
//        ShardRecoveryCoordinator local = recoveryCoordinator;
//        latch2.countDown();
//        Uninterruptibles.awaitUninterruptibly(latch,2, TimeUnit.SECONDS);
//        Uninterruptibles.sleepUninterruptibly(2, TimeUnit.SECONDS);
//        local.submit(snapshot, store.newWriteOnlyTransaction());
    ...
    protected void onRecoveryComplete() {
        //Uninterruptibles.awaitUninterruptibly(latch2,2, TimeUnit.SECONDS);
        if(recoveryCoordinator != null) {
