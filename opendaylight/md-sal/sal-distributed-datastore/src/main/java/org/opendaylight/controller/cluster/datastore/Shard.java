...
public class Shard extends RaftActor {
        ...
        if (createTransaction.getTransactionType()
            ...
            return getContext().actorOf(
                ShardTransaction.props(store.newReadOnlyTransaction(), getSelf(),
                        shardContext), transactionId.toString());
    ...
    private void commit(final ActorRef sender, Object serialized) {
        Modification modification = MutableCompositeModification
            .fromSerializable(serialized, shardContext.getSchemaContext());
    ...
    private void registerChangeListener(
        ...
        AsyncDataChangeListener<YangInstanceIdentifier, NormalizedNode<?, ?>>
            listener = new DataChangeListenerProxy(shardContext, dataChangeListenerPath);
    ...
    private void createTransactionChain() {
        ...
        ActorRef transactionChain = getContext().actorOf(
                ShardTransactionChain.props(chain, shardContext));
