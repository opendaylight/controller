...
public final class CommitTransactionPayloadChunkedHandler
    ...
    @Override
    protected void doWriteSkipPayloadType(final DataOutput out, final CommitTransactionPayload.Chunked payload)
            throws IOException {
    ...
    @Override
    protected CommitTransactionPayload.Chunked doRead(final DataInput in) throws IOException {
