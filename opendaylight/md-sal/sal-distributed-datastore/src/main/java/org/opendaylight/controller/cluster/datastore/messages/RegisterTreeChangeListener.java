...
public final class RegisterTreeChangeListener implements Externalizable {
    private static final long serialVersionUID = 1L;
    private ActorRef dataTreeChangeListenerPath;
    private YangInstanceIdentifier path;

    public RegisterTreeChangeListener(YangInstanceIdentifier path, ActorRef dataTreeChangeListenerPath) {
