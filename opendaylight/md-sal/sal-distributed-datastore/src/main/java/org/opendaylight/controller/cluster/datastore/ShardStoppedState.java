...
import org.opendaylight.controller.cluster.raft.state.StoppedState;

@NonNullByDefault
record ShardStoppedState() implements StoppedState {
    ...
    // FIXME: invariant configuration bits and pieces
}
