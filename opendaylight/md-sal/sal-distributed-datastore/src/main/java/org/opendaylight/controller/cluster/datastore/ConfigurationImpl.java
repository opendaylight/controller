...
public class ConfigurationImpl implements Configuration {
    ...
    @Override public Map<String, ShardStrategy> getModuleNameToShardStrategyMap() {
        ...
        for(Module m : modules){
            map.put(m.getName(), m.getShardingStrategy());
        }
        return map;
    }
    ...
    private class Module {
        ...
        private final ShardStrategy shardingStrategy;

        Module(String name, String nameSpace, String shardingStrategy) {
            this.name = name;
            this.nameSpace = nameSpace;
            if(ModuleShardStrategy.NAME.equals(shardingStrategy)){
                this.shardingStrategy = new ModuleShardStrategy(name, ConfigurationImpl.this);
            } else {
                this.shardingStrategy = new DefaultShardStrategy();
            }
        }
        ...
        public ShardStrategy getShardingStrategy() {
