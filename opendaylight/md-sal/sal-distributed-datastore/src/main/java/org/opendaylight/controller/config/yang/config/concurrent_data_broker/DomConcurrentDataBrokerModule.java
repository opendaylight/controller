...
public class DomConcurrentDataBrokerModule extends AbstractDomConcurrentDataBrokerModule {
    ...
    public AutoCloseable createInstance() {
        ...
        DOMDataBroker delegate = OsgiServiceUtils.waitForService(DOMDataBroker.class, bundleContext,
                OsgiServiceUtils.FIVE_MINUTES, "(type=default)");
        return new ForwardingConcurrentDOMBroker(delegate);
    }
    ...
    private static class ForwardingConcurrentDOMBroker extends ForwardingDOMDataBroker implements AutoCloseable {
        ...
        ForwardingConcurrentDOMBroker(DOMDataBroker delegate) {
