...
/**
 * This class monitors peers for MemberRemoved messages, and periodically send them YouAreDown
 * messages until MemberUp is received.
 *
 *
...
public class NodeMonitor extends UntypedActor {
    ...
    public void onReceive(Object message) throws Exception {
        ...
        if (message instanceof ClusterEvent.MemberUp) {
            ...
            // check to see if we got quarantine by another node
