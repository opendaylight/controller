    ...
    public static final class ShardSnapshot implements Serializable {
        ...
        private static final class Proxy implements SerialForm {
            ...
            public void resolveTo(final String name, final Snapshot snapshot) {
                shardSnapshot = new ShardSnapshot(true, name, snapshot);
            }
        ...
        public ShardSnapshot(final @NonNull String name, final @NonNull Snapshot snapshot) {
            this(false, name, snapshot);
        }

        public ShardSnapshot(final boolean legacy, final @NonNull String name, final @NonNull Snapshot snapshot) {
            this.legacy = legacy;
        ...
        private Object writeReplace() {
            return legacy ? new Proxy(this) : new DSS(this);
        }
    }
}
