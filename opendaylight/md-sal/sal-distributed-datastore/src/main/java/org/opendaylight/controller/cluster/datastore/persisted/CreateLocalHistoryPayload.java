...
public sealed class CreateLocalHistoryPayload extends AbstractIdentifiablePayload<LocalHistoryIdentifier> {
    ...
    public static @NonNull CreateLocalHistoryPayload readFrom(final DataInput in) throws IOException {
        return CreateLocalHistoryPayload.create(LocalHistoryIdentifier.readFrom(in),
