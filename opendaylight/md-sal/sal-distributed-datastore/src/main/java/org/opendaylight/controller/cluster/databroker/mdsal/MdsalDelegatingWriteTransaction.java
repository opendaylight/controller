...
class MdsalDelegatingWriteTransaction implements DOMDataWriteTransaction {
    ...
    public MdsalDelegatingWriteTransaction(final Object txIdentifier, final DOMDataTreeWriteTransaction delegateTx) {
