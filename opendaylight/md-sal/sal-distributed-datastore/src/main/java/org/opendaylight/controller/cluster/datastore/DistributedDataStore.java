...
public class DistributedDataStore implements DOMStore, SchemaContextListener,
    ...
    private final ShardInfoListenerRegistration<SimpleTransactionComponentFactory> updateReg;
    ...
    public DistributedDataStore(ActorSystem actorSystem, ClusterWrapper cluster,
        ...
        this.componentFactory = new SimpleTransactionComponentFactory(actorContext);
        this.updateReg = actorContext.registerShardInfoListener(componentFactory);
