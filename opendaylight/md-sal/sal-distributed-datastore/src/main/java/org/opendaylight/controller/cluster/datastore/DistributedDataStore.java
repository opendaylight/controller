...
public class DistributedDataStore implements DOMStore, SchemaContextListener,
    ...
    public DistributedDataStore(ActorSystem actorSystem, ClusterWrapper cluster,
        ...
        this.componentFactory = new SimpleComponentFactory(actorContext);
    ...
    public DOMStoreTransactionChain createTransactionChain() {
        return new ShardedTransactionChain(actorContext);
    }

    @Override
    public DOMStoreReadTransaction newReadOnlyTransaction() {
        return new ShardedTransaction(componentFactory, TransactionType.READ_ONLY);
    }

    @Override
    public DOMStoreWriteTransaction newWriteOnlyTransaction() {
        actorContext.acquireTxCreationPermit();
        return new ShardedTransaction(componentFactory, TransactionType.WRITE_ONLY);
    }

    @Override
    public DOMStoreReadWriteTransaction newReadWriteTransaction() {
        actorContext.acquireTxCreationPermit();
        return new ShardedTransaction(componentFactory, TransactionType.READ_WRITE);
    }
