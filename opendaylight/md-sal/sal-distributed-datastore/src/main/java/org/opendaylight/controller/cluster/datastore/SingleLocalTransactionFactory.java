 ...
 */
final class SingleLocalTransactionFactory extends TransactionReadyPrototype<TransactionIdentifier>
        implements LocalTransactionFactory {

    private static final Logger LOG = LoggerFactory.getLogger(SingleLocalTransactionFactory.class);
    private final ActorSelection leader;
    private final DataTree dataTree;
    private final ActorContext actorContext;

    SingleLocalTransactionFactory(final ActorContext actorContext, final ActorSelection leader, final DataTree dataTree) {
