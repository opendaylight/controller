 ...
 */
final class ShardedTransactionChain extends AbstractTransactionContextFactory<LocalTransactionChain> implements DOMStoreTransactionChain {
    ...
    private final SingleTransactionContextFactory parent;
    private volatile State currentState = IDLE_STATE;

    ShardedTransactionChain(final SingleTransactionContextFactory parent) {
