 ...
 */
final class ShardedTransactionChain extends TransactionComponentFactory<LocalTransactionChain> implements DOMStoreTransactionChain {
    ...
    private final SimpleTransactionComponentFactory parent;
    private final long counter = 0;
    private volatile State currentState = IDLE_STATE;

    ShardedTransactionChain(final SimpleTransactionComponentFactory parent) {
    ...
    protected LocalTransactionChain factoryForShard(final String shardName, final ActorSelection shardLeader, final DataTree dataTree) {
        final LocalTransactionChain ret = new LocalTransactionChain(this, shardName, shardLeader, dataTree);
