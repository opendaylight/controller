 ...
 */
final class ShardedTransactionChain extends AbstractTransactionComponentFactory<LocalTransactionChain> implements DOMStoreTransactionChain {
    ...
    ShardedTransactionChain(final SingleTransactionComponentFactory parent) {
