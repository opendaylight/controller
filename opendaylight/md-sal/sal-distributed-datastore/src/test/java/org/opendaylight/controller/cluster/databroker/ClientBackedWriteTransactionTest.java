...
public class ClientBackedWriteTransactionTest extends ClientBackedTransactionTest<ClientBackedWriteTransaction> {
    ...
    public void setUp() throws Exception {
        ...
        Mockito.when(delegate.ready()).thenReturn(readyCohort);
    ...
    public void testMerge() throws Exception {
        ...
        Mockito.verify(delegate, Mockito.times(1)).merge(path, data);
    }

    @Test
    public void testDelete() throws Exception {
        object().delete(path);
        Mockito.verify(delegate, Mockito.times(1)).delete(path);
    }
