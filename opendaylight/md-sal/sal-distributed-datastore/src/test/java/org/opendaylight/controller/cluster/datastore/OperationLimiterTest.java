...
public class OperationLimiterTest {
    ...
    @Test
    public void testAddMaxPermits(){
        OperationLimiter limiter = new OperationLimiter(new TransactionIdentifier("foo", 1), 100, 1);
        ...
        assertEquals(110, limiter.availablePermits());
        ...
        assertEquals(193, limiter.availablePermits());
