...
public class DistributedDataStoreTest extends AbstractActorTest {
    private static final FrontendIdentifier<DistributedDataStoreFrontend> UNKNOWN_ID =
            FrontendIdentifier.create(MemberName.forName("local"),new DistributedDataStoreFrontend("unknown"));
