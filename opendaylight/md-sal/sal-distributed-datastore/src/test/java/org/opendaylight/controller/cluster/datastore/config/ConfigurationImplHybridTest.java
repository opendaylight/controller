...
public class ConfigurationImplHybridTest extends ConfigurationImplBaseTest {
    ...
    public ConfigurationImpl createConfiguration() {
        Config moduleShardsConf = generateModuleShards(ImmutableList.of(
                generateShard("default", "default", ImmutableList.of("member-1", "member-2", "member-3")),
                generateShard("people", "people-1", ImmutableList.of("member-1")),
                generateShard("cars", "cars-1", ImmutableList.of("member-1")),
                generateShard("test", "test-1", ImmutableList.of("member-1"))
        ));
