...
public class JsonExportTest extends AbstractShardTest {
    ...
    private static final String RESOURCES_DIR = FileSystems.getDefault().getPath(".") + "/src/test/resources";
    private static final String EXPORT_DIR = RESOURCES_DIR + "/json-export";
    ...
    private static final String EXPECTED_JOURNAL_FILE = RESOURCES_DIR + "/expectedJournalExport.json";
    private static final String ACTUAL_JOURNAL_FILE = EXPORT_DIR + "/journals/"
            + "member-1-shard-inventory-config0-journal.json";
    private static final String EXPECTED_SNAPSHOT_FILE = RESOURCES_DIR + "/expectedSnapshotExport.json";
    ...
    private String readFileAsString(String filePath) throws IOException, InterruptedException {
