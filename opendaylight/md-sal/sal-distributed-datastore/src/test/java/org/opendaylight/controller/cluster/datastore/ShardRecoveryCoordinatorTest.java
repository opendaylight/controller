...
public class ShardRecoveryCoordinatorTest {
    ...
    private ShardDataTree carsDataTree;
    ...
    public void setUp(){
        ...
        carsDataTree = new ShardDataTree(carsSchemaContext);
    }
    ...
    public void testAppendRecoveredLogEntryCompositeModificationByteStringPayload() throws IOException {
        ...
        assertEquals(false, readCar(peopleDataTree).isPresent());
    }
    ...
    public void testApplyRecoverySnapshot(){
        ...
        coordinator.applyRecoverySnapshot(createCarsSnapshot());
    ...
    private Optional<NormalizedNode<?,?>> readCar(ShardDataTree shardDataTree){
    ...
    private byte[] createCarsSnapshot(){
        TipProducingDataTree dataTree = InMemoryDataTreeFactory.getInstance().create();
        dataTree.setSchemaContext(carsSchemaContext);
