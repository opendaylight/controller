...
import static org.opendaylight.controller.cluster.datastore.entityownership.DOMDistributedEntityOwnershipServiceMdsal.ENTITY_OWNERSHIP_SHARD_NAME;
...
public class DOMDistributedEntityOwnershipIntegrationTest {
    ...
    private final DatastoreContext.Builder followerDatastoreContextBuilder = DatastoreContext.newBuilder()
            .shardHeartbeatIntervalInMillis(100).shardElectionTimeoutFactor(10000);
    ...
    private static DOMDistributedEntityOwnershipServiceMdsal newOwnershipService(final DistributedDataStore datastore) {
        return DOMDistributedEntityOwnershipServiceMdsal.start(datastore.getActorContext(),
    ...
    public void testFunctionalityWithThreeNodes() throws Exception {
        ...
        final DistributedDataStore leaderDistributedDataStore = leaderNode.configDataStore();
        ...
        final DOMEntityOwnershipCandidateRegistration follower1Entity2Reg = follower1EntityOwnershipService
                .registerCandidate(ENTITY2);
        ...
        verify(follower1MockListener, timeout(15000).times(2)).ownershipChanged(
                or(ownershipChange(ENTITY4, false, true, true), ownershipChange(ENTITY2, false, false, false)));
        verify(leaderMockListener, timeout(15000).times(2)).ownershipChanged(
                or(ownershipChange(ENTITY4, false, false, true), ownershipChange(ENTITY2, false, false, false)));
        ...
        final DOMEntityOwnershipCandidateRegistration leaderEntity2Reg = leaderEntityOwnershipService
                .registerCandidate(ENTITY2);
    ...
    public void testLeaderAndFollowerCandidatesRemovedAfterShutdown() throws Exception {
        ...
        final DOMEntityOwnershipService follower2EntityOwnershipService = newOwnershipService(
                follower2Node.configDataStore());
        final DOMEntityOwnershipService follower3EntityOwnershipService = newOwnershipService(
                follower3Node.configDataStore());
        final DOMEntityOwnershipService follower4EntityOwnershipService = newOwnershipService(
    ...
    public void testCloseCandidateRegistrationInQuickSuccession() throws CandidateAlreadyRegisteredException {
        ...
        final DOMEntityOwnershipCandidateRegistration candidate1 = leaderEntityOwnershipService
                .registerCandidate(ENTITY1);
        final DOMEntityOwnershipCandidateRegistration candidate2 = follower1EntityOwnershipService
                .registerCandidate(ENTITY1);
        final DOMEntityOwnershipCandidateRegistration candidate3 = follower2EntityOwnershipService
                .registerCandidate(ENTITY1);
        ...
        final ArgumentCaptor<DOMEntityOwnershipChange> leaderChangeCaptor = ArgumentCaptor
                .forClass(DOMEntityOwnershipChange.class);
        final ArgumentCaptor<DOMEntityOwnershipChange> follower1ChangeCaptor = ArgumentCaptor
                .forClass(DOMEntityOwnershipChange.class);
        final ArgumentCaptor<DOMEntityOwnershipChange> follower2ChangeCaptor = ArgumentCaptor
                .forClass(DOMEntityOwnershipChange.class);
        ...
        for (int i = 0; i < 100; i++) {
            ...
            if (!leaderEntityOwnershipService.getOwnershipState(ENTITY1).isPresent()
                    || (EntityOwnershipState.NO_OWNER
                            .equals(leaderEntityOwnershipService.getOwnershipState(ENTITY1).get()))
                            && follower1EntityOwnershipService.getOwnershipState(ENTITY1).isPresent()
                            && (EntityOwnershipState.NO_OWNER
                                    .equals(follower1EntityOwnershipService.getOwnershipState(ENTITY1).get()))
                            && follower2EntityOwnershipService.getOwnershipState(ENTITY1).isPresent()
                            && (EntityOwnershipState.NO_OWNER
                                    .equals(follower2EntityOwnershipService.getOwnershipState(ENTITY1).get()))
    ...
    public void testEntityOwnershipShardBootstrapping() throws Throwable {
        ...
        final DistributedDataStore follower1DistributedDataStore = follower1Node.configDataStore();
        ...
        final DOMEntityOwnershipCandidateRegistration candidateReg = follower1EntityOwnershipService
                .registerCandidate(ENTITY1);
        Uninterruptibles.sleepUninterruptibly(300, TimeUnit.MILLISECONDS);
        verify(leaderMockListener, never()).ownershipChanged(ownershipChange(ENTITY1));
        ...
        final Object reply = follower1Node.kit().expectMsgAnyClassOf(JavaTestKit.duration("5 sec"), Success.class,
                Failure.class);
    ...
    public void testOwnerSelectedOnRapidUnregisteringAndRegisteringOfCandidates() throws Exception {
        ...
        final DOMEntityOwnershipCandidateRegistration leaderEntity1Reg = leaderEntityOwnershipService
                .registerCandidate(ENTITY1);
    ...
    private static void verifyGetOwnershipState(final DOMEntityOwnershipService service, final DOMEntity entity,
        ...
        assertEquals("isOwner & hasOwner", EntityOwnershipState.from(isOwner, hasOwner), state.get());
    }
