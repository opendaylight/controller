    ...
    public void testNormalizedNodeEncodeDecode(){
        ...
        NormalizedNodeMessages.Container node =
            new NormalizedNodeToNodeCodec(TestModel.createTestContext())
                .encode(InstanceIdentifier.builder().build(),
                    containerNode);
        ...
        new NormalizedNodeToNodeCodec(TestModel.createTestContext()).decode(TestModel.TEST_PATH,
            normalizedNode);
    }
}
