...
public class TransactionChainProxyTest extends AbstractTransactionProxyTest {
    ...
    public void setUp() {
        super.setUp();
        MockitoAnnotations.initMocks(TransactionChainProxy.class);
    }
    ...
    public void testTransactionChainsHaveUniqueId() {
        try (TransactionChainProxy one = new TransactionChainProxy(mockComponentFactory, historyId)) {
            try (TransactionChainProxy two = new TransactionChainProxy(mockComponentFactory, historyId)) {
