...
public class TransactionChainProxyTest extends AbstractTransactionProxyTest {
    ...
    public void testTransactionChainsHaveUniqueId(){
        ShardedTransactionChain one = new ShardedTransactionChain(mock(ComponentFactory.class));
        ShardedTransactionChain two = new ShardedTransactionChain(mock(ComponentFactory.class));
