...
public class DistributedEntityOwnershipIntegrationTest {
    ...
    private static void verifyGetOwnershipState(DOMEntityOwnershipService service, DOMEntity entity,
    ...
    private static void verifyCandidates(DistributedDataStore dataStore, DOMEntity entity, String... expCandidates) throws Exception {
    ...
    private static void verifyOwner(final DistributedDataStore dataStore, DOMEntity entity, String expOwner) {
