...
public class DatastoreContextIntrospectorTest {
    ...
    public void testGetDatastoreContextForShard() {
        ...
        DatastoreContext shardContext = operIntrospector.newContextFactory().getDatastoreContext("topology");
        ...
        shardContext = operIntrospector.newContextFactory().getDatastoreContext("topology");
        ...
        shardContext = configIntrospector.newContextFactory().getDatastoreContext("topology");
        assertEquals(55, shardContext.getShardTransactionIdleTimeout().toMinutes());
        ...
        shardContext = configIntrospector.newContextFactory().getDatastoreContext("default");
