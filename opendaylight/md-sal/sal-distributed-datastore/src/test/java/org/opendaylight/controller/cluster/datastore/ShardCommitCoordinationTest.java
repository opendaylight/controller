...
public class ShardCommitCoordinationTest extends AbstractShardTest {
    ...
    public void testMultipleTransactionsWithMixedParticipatingShards() throws Exception {
        ...
        final List<String> participatingShardNames1 = ImmutableList.of(shardAId.getShardName(),
                shardBId.getShardName());
        final List<String> participatingShardNames2 = ImmutableList.of("shardX", shardBId.getShardName());
