...
//                expectMsgClass(duration("5 seconds"), PrimaryNotFoundException.class);
    ...
    public void testRegisterForShardLeaderChanges() {
        ...
        shardManager.tell(new RegisterForShardLeaderChanges(mockCallback), kit.getRef());

        Success reply = kit.expectMsgClass(Duration.apply(5, TimeUnit.SECONDS), Success.class);
