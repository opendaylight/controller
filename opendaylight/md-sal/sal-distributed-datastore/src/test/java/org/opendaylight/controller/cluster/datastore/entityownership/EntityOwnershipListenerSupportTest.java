...
public class EntityOwnershipListenerSupportTest extends AbstractActorTest {
    ...
    public void testNotifyEntityOwnershipListeners() {
        ...
        verify(mockListener1, timeout(5000)).ownershipChanged(entity1, false, true, true);
        verify(mockListener2, timeout(5000)).ownershipChanged(entity1, false, true, true);
        verify(mockListener3, timeout(5000)).ownershipChanged(entity1, false, true, true);
        ...
        verify(mockListener1, timeout(5000)).ownershipChanged(entity2, false, false, false);
        verify(mockListener3, timeout(5000)).ownershipChanged(entity2, false, false, false);
        Uninterruptibles.sleepUninterruptibly(300, TimeUnit.MILLISECONDS);
        verify(mockListener2, never()).ownershipChanged(eq(entity2), anyBoolean(), anyBoolean(), anyBoolean());
        assertEquals("# of listener actors", 3, actorContext.children().size());
        ...
        verify(mockListener3, timeout(5000)).ownershipChanged(entity3, false, true, true);
        Uninterruptibles.sleepUninterruptibly(300, TimeUnit.MILLISECONDS);
        verify(mockListener1, never()).ownershipChanged(eq(entity3), anyBoolean(), anyBoolean(), anyBoolean());
        verify(mockListener2, never()).ownershipChanged(eq(entity3), anyBoolean(), anyBoolean(), anyBoolean());
        ...
        Uninterruptibles.sleepUninterruptibly(300, TimeUnit.MILLISECONDS);
        verify(mockListener1, never()).ownershipChanged(eq(entity4), anyBoolean(), anyBoolean(), anyBoolean());
        verify(mockListener2, never()).ownershipChanged(eq(entity4), anyBoolean(), anyBoolean(), anyBoolean());
        verify(mockListener3, never()).ownershipChanged(eq(entity4), anyBoolean(), anyBoolean(), anyBoolean());
        ...
        verify(mockListener2, timeout(5000)).ownershipChanged(entity1, true, false, true);
        verify(mockListener3, timeout(5000)).ownershipChanged(entity1, true, false, true);
        Uninterruptibles.sleepUninterruptibly(300, TimeUnit.MILLISECONDS);
        verify(mockListener1, never()).ownershipChanged(eq(entity1), anyBoolean(), anyBoolean(), anyBoolean());
        ...
        verify(mockListener2, timeout(5000)).ownershipChanged(entity1, false, false, false);
        Uninterruptibles.sleepUninterruptibly(300, TimeUnit.MILLISECONDS);
        verify(mockListener1, never()).ownershipChanged(eq(entity1), anyBoolean(), anyBoolean(), anyBoolean());
        verify(mockListener3, never()).ownershipChanged(eq(entity1), anyBoolean(), anyBoolean(), anyBoolean());
        ...
        verify(mockListener1, timeout(5000)).ownershipChanged(entity1, false, false, true);
        verify(mockListener2, never()).ownershipChanged(eq(entity1), anyBoolean(), anyBoolean(), anyBoolean());
        verify(mockListener3, never()).ownershipChanged(eq(entity1), anyBoolean(), anyBoolean(), anyBoolean());
