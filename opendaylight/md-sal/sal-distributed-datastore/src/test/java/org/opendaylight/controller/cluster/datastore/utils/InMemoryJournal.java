...
public class InMemoryJournal extends AsyncWriteJournal {
    ...
    private static CountDownLatch deleteMessagesComplete = new CountDownLatch(1);
    ...
    public static void waitForDeleteMessagesComplete() {
        assertEquals("Recovery complete", true,
                Uninterruptibles.awaitUninterruptibly(deleteMessagesComplete, 5, TimeUnit.SECONDS));
    }
    ...
    public Future<Void> doAsyncDeleteMessagesTo(String persistenceId, long toSequenceNr, boolean permanent) {
        ...
        deleteMessagesComplete.countDown();
        return Futures.successful(null);
    }
}
