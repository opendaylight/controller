...
/**
 * Unit tests for EntityOwnerDataChangeListener.
 *
 * @author Thomas Pantelis
 */
public class EntityOwnerDataChangeListenerTest {
    ...
    private static final Entity ENTITY = new Entity(ENTITY_TYPE, ENTITY_ID1);
    ...
    private EntityOwnerDataChangeListener listener;

    @Before
    public void setup() {
        listener = new EntityOwnerDataChangeListener(LOCAL_MEMBER_NAME, mockListenerSupport);
    ...
    public void testOnDataChanged() throws Exception {
        ...
        verify(mockListenerSupport).notifyEntityOwnershipListeners(ENTITY, false, true);

        reset(mockListenerSupport);
        writeNode(entityPath(ENTITY_TYPE, ENTITY_ID1), entityEntryWithOwner(ENTITY_ID1, REMOTE_MEMBER_NAME1));

        verify(mockListenerSupport).notifyEntityOwnershipListeners(ENTITY, true, false);
