...
public class AccessClientUtil {
    ...
    public static <T extends BackendInfo> ConnectedClientConnection<T>
    createConnectedConnection(final ClientActorContext context, final Long cookie, final T backend) {
