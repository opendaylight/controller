...
import static org.opendaylight.controller.cluster.datastore.DatastoreContext.DEFAULT_EXPORT_ON_RECOVERY;
...
public class DatastoreContextTest {
    ...
    public void testNewBuilderWithCustomSettings() {
        ...
        builder.exportOnRecovery(DatastoreContext.ExportOnRecovery.JSON);
    ...
    private static void verifyCustomSettings(final DatastoreContext context) {
        ...
        assertEquals(DatastoreContext.ExportOnRecovery.JSON, context.getExportOnRecovery());
    }
}
