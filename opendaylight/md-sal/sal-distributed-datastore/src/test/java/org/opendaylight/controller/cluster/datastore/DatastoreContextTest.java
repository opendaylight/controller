...
import static org.opendaylight.controller.cluster.datastore.DatastoreContext.DEFAULT_RECOVERY_JSON_DUMP;
...
public class DatastoreContextTest {
    ...
    public void testNewBuilderWithDefaultSettings() {
        ...
        assertEquals(DEFAULT_RECOVERY_JSON_DUMP, context.getRecoveryJsonDump());
    }
    ...
    public void testNewBuilderWithCustomSettings() {
        ...
        builder.exportOnRecovery(true);
        builder.recoveryJsonDump(DEFAULT_RECOVERY_JSON_DUMP + "-new");
    ...
    private static void verifyCustomSettings(final DatastoreContext context) {
        ...
        assertEquals(DEFAULT_RECOVERY_JSON_DUMP + "-new",
                context.getRecoveryJsonDump());
