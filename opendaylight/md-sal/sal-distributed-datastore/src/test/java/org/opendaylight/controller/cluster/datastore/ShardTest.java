        ...
        new ShardTestKit(getSystem()) {
            {
                ...
                final RegisterDataTreeNotificationListenerReply reply = expectMsgClass(Duration.ofSeconds(3),
        ...
        new ShardTestKit(getSystem()) {
            {
                ...
                final RegisterDataTreeNotificationListenerReply reply = expectMsgClass(Duration.ofSeconds(5),
                        RegisterDataTreeNotificationListenerReply.class);
                assertNotNull("getListenerRegistratioznPath", reply.getListenerRegistrationPath());

                shard.tell(FindLeader.INSTANCE, getRef());
                final FindLeaderReply findLeadeReply = expectMsgClass(Duration.ofSeconds(5), FindLeaderReply.class);
        ...
        new ShardTestKit(getSystem()) {
            {
                ...
                final CreateTransactionReply reply = expectMsgClass(Duration.ofSeconds(3),
        ...
        new ShardTestKit(getSystem()) {
            {
                ...
                final Failure failure = expectMsgClass(Duration.ofSeconds(5), akka.actor.Status.Failure.class);
        ...
        new ShardTestKit(getSystem()) {
            {
                ...
                failure = expectMsgClass(Duration.ofSeconds(5), akka.actor.Status.Failure.class);
        ...
        new ShardTestKit(getSystem()) {
            {
                ...
                final CreateTransactionReply createReply = expectMsgClass(Duration.ofSeconds(3),
                        CreateTransactionReply.class);

                getSystem().actorSelection(createReply.getTransactionPath())
                        .tell(new ReadData(path, DataStoreVersions.CURRENT_VERSION), getRef());
                final ReadDataReply readReply = expectMsgClass(Duration.ofSeconds(3), ReadDataReply.class);
