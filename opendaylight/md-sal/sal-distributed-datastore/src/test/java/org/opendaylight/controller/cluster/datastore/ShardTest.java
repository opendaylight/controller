...
import static org.opendaylight.controller.cluster.datastore.messages.CreateTransaction.CURRENT_MESSAGE_VERSION;
...
public class ShardTest extends AbstractActorTest {
    ...
    public void testConcurrentThreePhaseCommits() throws Throwable {
        new ShardTestKit(getSystem()) {{
            ...
            shard.tell(new ForwardedReadyTransaction(transactionID1, CURRENT_MESSAGE_VERSION,
            ...
            shard.tell(new ForwardedReadyTransaction(transactionID2, CURRENT_MESSAGE_VERSION,
                    cohort2, modification2, true), getRef());
            expectMsgClass(duration, ReadyTransactionReply.SERIALIZABLE_CLASS);

            shard.tell(new ForwardedReadyTransaction(transactionID3, CURRENT_MESSAGE_VERSION,
    ...
    public void testPreCommitPhaseFailure() throws Throwable {
        new ShardTestKit(getSystem()) {{
            ...
            shard.tell(new ForwardedReadyTransaction(transactionID, CURRENT_MESSAGE_VERSION,
