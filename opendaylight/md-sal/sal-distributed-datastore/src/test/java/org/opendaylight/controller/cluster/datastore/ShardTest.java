...
//                inOrder.verify(cohort3.getCommit()).onSuccess(any(UnsignedLong.class));
    ...
    public void testAbortWithCommitPending() throws Exception {
        ...
        assertInstanceOf(ModifyTransactionSuccess.class,
            client.request(duration, self -> ModifyTransactionRequest.builder(transactionID, self)
                .setSequence(0)
        ...
        assertInstanceOf(TransactionPreCommitSuccess.class,
            client.request(duration, self -> new TransactionPreCommitRequest(transactionID, 2, self)));
        ...
        final var commit = assertInstanceOf(TransactionFailure.class,
            testKit.expectMsgClass(duration, FailureEnvelope.class).getMessage());
