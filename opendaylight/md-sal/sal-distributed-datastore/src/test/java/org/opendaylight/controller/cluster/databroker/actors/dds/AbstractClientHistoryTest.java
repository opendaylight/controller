...
public abstract class AbstractClientHistoryTest<T extends AbstractClientHistory> {
    ...
    @Mock
    private ClientActorContext context;
    @Mock
    private ShardBackendInfo info;
    @Mock
    ...
    public void testStartReconnect() throws Exception {
        final ConnectedClientConnection newConn = AccessClientUtil.createConnectedConnection(context, 0L, info);
