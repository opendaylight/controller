...
public abstract class AbstractClientHistoryTest<T extends AbstractClientHistory> {
    ...
    protected final ClientTransaction clientTransaction = new ClientTransaction(object(), TRANSACTION_ID);
    ...
    @Mock
    protected AbstractTransactionCommitCohort abstractTransactionCommitCohort;
