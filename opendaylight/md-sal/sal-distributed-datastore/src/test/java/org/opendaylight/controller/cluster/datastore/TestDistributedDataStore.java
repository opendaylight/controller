...
public class TestDistributedDataStore extends DistributedDataStore {
    ...
    public Map<String, TestActorRef<TestShard>> getShardActors() {
        TestShardManager.GetShardActorsReply reply =
                (TestShardManager.GetShardActorsReply) getActorUtils()
                        .executeOperation(getActorUtils().getShardManager(), TestShardManager.GetShardActors.INSTANCE);
        return reply.getActors();
    }
