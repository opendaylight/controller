...
public class RootDataTreeChangeListenerProxyTest extends AbstractActorTest {
    ...
    public void testSuccessfulRegistrationOnTwoShards() {
        ...
        RootDataTreeChangeListenerProxy<ClusteredDOMDataTreeChangeListener> rootListenerProxy =
        ...
        //TODO: create 2 dummy dataTreeCandidates to be merged into initial state, then verify only 1 dataChanged was
        // invoked on the mockClusteredListener
//        final TestKit kit2 = new TestKit(getSystem());
//        ActorRef rootListenerActor = getSystem().actorFor(registerForShard1.getListenerActorPath());
//        rootListenerActor.tell(new DataTreeChanged(candidates1), kit.getRef());
//        rootListenerActor.tell(new DataTreeChanged(candidates2), kit2.getRef());
//        verify(mockClusteredListener, times(1)).onDataTreeChanged(any());
