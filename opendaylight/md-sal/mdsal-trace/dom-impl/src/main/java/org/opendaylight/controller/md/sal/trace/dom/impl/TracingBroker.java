...
public class TracingBroker implements TracingDOMDataBroker {
    ...
    public @NonNull ClassToInstanceMap<DOMDataBrokerExtension> getExtensions() {
        ClassToInstanceMap<DOMDataBrokerExtension> res = delegate.getExtensions();
        ...
        return ImmutableClassToInstanceMap.of(DOMDataTreeChangeService.class, new DOMDataTreeChangeService() {
            @Nonnull
            @Override
