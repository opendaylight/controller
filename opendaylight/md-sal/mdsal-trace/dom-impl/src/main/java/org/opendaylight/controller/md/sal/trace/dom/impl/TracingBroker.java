...
public class TracingBroker implements TracingDOMDataBroker {
    ...
    public boolean printOpenTransactions(PrintStream ps) {
        ...
        transactionChainsRegistry.getAllUnique().forEach(entry -> {
            ...
            TracingTransactionChain tracingTxChain = (TracingTransactionChain) entry.getExampleCloseTracked();
            printRegistryOpenTransactions(tracingTxChain.getReadOnlyTransactionsRegistry(), ps, "    ");
            printRegistryOpenTransactions(tracingTxChain.getWriteTransactionsRegistry(), ps, "    ");
            printRegistryOpenTransactions(tracingTxChain.getReadWriteTransactionsRegistry(), ps, "    ");
        });
        ps.println();
