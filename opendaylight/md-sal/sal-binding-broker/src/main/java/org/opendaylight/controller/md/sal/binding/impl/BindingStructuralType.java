 ...
 *
 * Not all bidning data are addresable by instance identifier
...
enum BindingStructuralType {
     ...
     * data are not lost, but are available only via parent object.
     *
    ...
    NOT_ADDRESSABLE,
    /**
     * Data container is addresable in NormalizedNode format,
     * but in Binding it is not represented in Instance Identifier.
     *
     * This are lists as a whole and choice / case nodes.
     *
     * This data are still accessible using parent object and their
    ...
    VISIBLE_CONTAINER,
    /**
     * Mapping algoritmus was unable to detect type or was not updated after introduction
    ...
    private static boolean isInvisibleContainer(final NormalizedNode<?, ?> data) {
        return data instanceof MapNode || data instanceof ChoiceNode;
    }
