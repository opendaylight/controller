...
public class BindingBrokerWiring implements AutoCloseable {
    ...
    public BindingBrokerWiring(ClassLoadingStrategy classLoadingStrategy, DOMSchemaService schemaService,
        ...
        // Binding DataBroker
        dataBroker = new BindingDOMDataBrokerAdapter(domDataBroker, bindingToNormalizedNodeCodec);

        // Binding PingPong DataBroker
        pingPongDataBroker = new BindingDOMDataBrokerAdapter(domPingPongDataBroker, bindingToNormalizedNodeCodec);
    }
