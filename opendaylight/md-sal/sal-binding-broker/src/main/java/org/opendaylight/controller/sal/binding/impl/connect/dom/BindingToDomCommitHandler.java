...
class BindingToDomCommitHandler implements
    ...
    private final ConcurrentMap<Object, BindingToDomTransaction> bindingOpenedTransactions = new ConcurrentHashMap<>();
    ...
    public org.opendaylight.controller.md.sal.common.api.data.DataCommitHandler.DataCommitTransaction<InstanceIdentifier<? extends DataObject>, DataObject> requestCommit(
        ...
        BindingToDomTransaction wrapped = new BindingToDomTransaction(domTransaction, bindingTransaction, bindingOpenedTransactions);
