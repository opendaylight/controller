...
import org.opendaylight.controller.md.sal.binding.api.DataReadTransaction;
import org.opendaylight.controller.md.sal.binding.api.DataReadWriteTransaction;
import org.opendaylight.controller.md.sal.binding.api.DataWriteTransaction;
...
public class ForwardedBindingDataBroker extends AbstractForwardedDataBroker implements DataBroker {
    ...
    private class BindingDataWriteTransactionImpl<T extends DOMDataWriteTransaction> extends
            AbstractBindingTransaction<T> implements DataWriteTransaction {
    ...
    private class BindingDataReadWriteTransactionImpl extends
            BindingDataWriteTransactionImpl<DOMDataReadWriteTransaction> implements DataReadWriteTransaction {
