...
import org.opendaylight.controller.md.sal.dom.broker.impl.ReadFailedExceptionMapper;
import org.opendaylight.controller.sal.common.util.concurrent.MappingCheckedFuture;
...
abstract class AbstractForwardedTransaction<T extends AsyncTransaction<InstanceIdentifier, NormalizedNode<?, ?>>>
    ...
    protected final <T extends DataObject> CheckedFuture<Optional<T>,ReadFailedException> doRead(
        ...
        return MappingCheckedFuture.create(
                    ...
                    ReadFailedExceptionMapper.MAPPER);
    }
}
