...
public class BindingAsyncDataBrokerImplModule extends
    ...
    public java.lang.AutoCloseable createInstance() {
        Broker domBroker = getTargetDomBrokerDependency();
        BindingIndependentMappingService mappingService = getBindingDomMappingServiceDependency();

        // FIXME: Switch this to DOM Broker registration which would not require
        // BundleContext
        // When API are updated.
