...
public class BackwardsCompatibleNotificationBroker implements NotificationProviderService, AutoCloseable {
    private static final Logger LOG = LoggerFactory.getLogger(BackwardsCompatibleNotificationBroker.class);
    ...
    public BackwardsCompatibleNotificationBroker(NotificationPublishService notificationPublishService,
    ...
    public <T extends Notification> ListenerRegistration<org.opendaylight.controller.sal.binding.api.NotificationListener<T>> registerNotificationListener(
        ...
        synchronized (this) {
            ...
            knownTypesMutable.add(notificationType);
    ...
    private static final class ListenersMap {
        ...
        public ListenersMap(final Set<Class<? extends Notification>> knownTypes) {
    ...
    private class NotificationInvoker<T extends Notification> implements DOMNotificationListener {
        ...
        public NotificationInvoker(final org.opendaylight.controller.sal.binding.api.NotificationListener<T> listener) {
        ...
        public void onNotification(@Nonnull DOMNotification notification) {
            final Notification baNotification = codec.fromNormalizedNodeNotification(notification.getType(),
