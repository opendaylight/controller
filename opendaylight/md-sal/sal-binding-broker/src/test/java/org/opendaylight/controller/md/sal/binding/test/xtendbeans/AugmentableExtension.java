...
/*
    public <E extends Augmentation<?>>
    Map<Class<? extends Augmentation<E>>, Augmentation<E>>
        getAugmentations(Augmentable<?> augmentable) {
*/
    public Map<Class<? extends Augmentation<?>>, Augmentation<?>> getAugmentations(Augmentable<?> augmentable) {
        if (augmentable instanceof AugmentationReader) {
            AugmentationReader augmentationReader = (AugmentationReader) augmentable;
            return augmentationReader.getAugmentations(augmentable);
            ...
            try {
                return REFLECT_EXTENSIONS.get(augmentable, "augmentation");
