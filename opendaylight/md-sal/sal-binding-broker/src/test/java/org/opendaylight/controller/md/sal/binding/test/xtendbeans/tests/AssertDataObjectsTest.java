...
public class AssertDataObjectsTest extends AbstractDataBrokerTest {
    ...
    public void testAssertDataObjectsWithTopLevelListKey() {
        AssertDataObjects.assertEqualByText("TODO", new TopLevelListKey("test"));
    }

    @Test
    public void testAssertDataObjectsWithInstanceIdentifier() {
        AssertDataObjects.assertEqualByText("TODO", ExampleYangObjects.topLevelList().getKey());
    }
    ...
    public void testAssertDataObjectsWithDataBroker() throws Exception {
        ...
        System.out.println(new AugmentableExtension().getAugmentations(ExampleYangObjects.topLevelList().getValue()));
        System.out.println(new AugmentableExtension().getAugmentations(actualTop));
        System.out.println(new AugmentableExtension().getAugmentations(actualTop.getTopLevelList().get(0)));
