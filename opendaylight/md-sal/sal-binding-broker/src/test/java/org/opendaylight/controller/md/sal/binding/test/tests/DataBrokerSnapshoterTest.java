...
import org.opendaylight.controller.md.sal.binding.test.DataBrokerSnapshoter;
...
public class DataBrokerSnapshoterTest extends AbstractDataBrokerTest {
    ...
    @Test
    public void testDataBrokerSnapshoter() throws Exception {
    ...
    class XtendYangBeanGenerator extends XtendBeanGenerator {
        ...
        protected CharSequence getNewBeanExpression(Object bean) {
            if (bean instanceof DataContainer) {
                ...
                Class<?> builderClass = getBuilderClassByAppendingBuilderToClassName(dataContainerBean.getImplementedInterface());
