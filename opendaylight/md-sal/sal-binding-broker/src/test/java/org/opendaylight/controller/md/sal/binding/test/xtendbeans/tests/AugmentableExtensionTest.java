...
import org.opendaylight.controller.md.sal.binding.test.tests.DataBrokerTransactionHelper;
...
public class AugmentableExtensionTest extends AbstractDataBrokerTest {
    ...
    public void testAugmentableExtensionWithDataBroker() throws Exception {
        DataBrokerTransactionHelper dataBrokerUtils = new DataBrokerTransactionHelper(getDataBroker());
        dataBrokerUtils.writeInNewTx(OPERATIONAL, ExampleYangObjects.topLevelList());

        Top actualTop = dataBrokerUtils.readInNewTx(OPERATIONAL, Top.class);
