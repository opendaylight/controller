...
public class ChangeID implements ISerializer{
    ...
    public void encode(Object value, EncodeDataContainer ba) {
        ...
        EncodeUtils.encodeInt32(cid.address, ba);
        EncodeUtils.encodeInt32(cid.port, ba);
        EncodeUtils.encodeInt32(cid.changeNum, ba);
    }
    ...
    public Object decode(EncodeDataContainer ba, int length) {
        ...
        cid.address = EncodeUtils.decodeInt32(ba);
        cid.port = EncodeUtils.decodeInt32(ba);
        cid.changeNum = EncodeUtils.decodeInt32(ba);
        return cid;
    }
