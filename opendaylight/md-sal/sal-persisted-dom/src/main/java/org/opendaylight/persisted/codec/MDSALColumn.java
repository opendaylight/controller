...
public class MDSALColumn {
    ...
    public MDSALColumn(String _logicalFieldName, String _logicalTableName,String _origFieldName, String _origTableName) {
    ...
    public MDSALColumn(Method m, Class<?> clazz) {
        this.getMethod = m;
        this.myClass = clazz;
    ...
    public MDSALColumn(String _methodName, String _className) {
    ...
    public boolean equals(Object obj) {
        MDSALColumn other = (MDSALColumn) obj;
    ...
    public void encode(BytesArray ba) {
        MDSALEncoder.encodeString(this.methodName, ba);
        MDSALEncoder.encodeString(this.className, ba);
        MDSALEncoder.encodeString(this.augmentedTableName, ba);
    }

    public static MDSALColumn decode(BytesArray ba) {
        MDSALColumn p = new MDSALColumn(MDSALEncoder.decodeString(ba),MDSALEncoder.decodeString(ba));
        p.setAugmentedTableName(MDSALEncoder.decodeString(ba));
        return p;
    }
