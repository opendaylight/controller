...
public class MDSALColumn {
    ...
    public Object get(Object element, Map<?, ?> augmentationMap,
            Class<?> elementClass) {
    ...
    public void encode(BytesArray ba) {
        MDSALEncoder.encodeString(methodName, ba);
        MDSALEncoder.encodeString(className, ba);
    }

    public static MDSALColumn decode(BytesArray ba) {
        MDSALColumn p = new MDSALColumn(MDSALEncoder.decodeString(ba),
                MDSALEncoder.decodeString(ba));
        return p;
    }
