...
public class EncodeUtils {
    ...
    public static final void encodeObject(Object value, EncodeDataContainer ba,Class<?> objectType) {
        if(value instanceof Class){
            encodeInt16(ClassCodes.Class.getCode(),ba);
            encodeString(((Class)value).getName(), ba);
            return;
        }else
        if(value instanceof String){
            encodeInt16(ClassCodes.String.getCode(),ba);
            encodeString((String)value, ba);
            return;
        }else
        if(value instanceof Integer){
            encodeInt16(ClassCodes.Integer.getCode(),ba);
            encodeInt32((Integer)value,ba);
            return;
        }else
        if(value instanceof Long){
            encodeInt16(ClassCodes.Long.getCode(),ba);
            encodeInt64((Long)value,ba);
            return;
        }else
        if(value instanceof List){
            encodeInt16(ClassCodes.List.getCode(), ba);
        ...
        ISerializer serializer = getSerializer(objectType,ba.getTypeDescriptorContainer());
        if (serializer != null) {
            int classCode = ba.getTypeDescriptorContainer().getTypeDescriptorByClass(objectType).getClassCode();
            encodeInt16(classCode, ba);
    ...
    public static final Object decodeObject(EncodeDataContainer ba) {
        ...
        if(classCode==ClassCodes.String.getCode()){
            return decodeString(ba);
        }else
        if(classCode==ClassCodes.Class.getCode()){
            String className = decodeString(ba);
            //@TODO need to support different class loaders....
            try{
        ...
        if(classCode==ClassCodes.Integer.getCode()){
            return decodeInt32(ba);
        }else
        if(classCode==ClassCodes.Long.getCode()){
            return decodeInt64(ba);
        }else
        if(classCode==ClassCodes.List.getCode()){
