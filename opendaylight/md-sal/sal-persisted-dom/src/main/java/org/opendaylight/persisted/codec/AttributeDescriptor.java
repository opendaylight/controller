...
public class AttributeDescriptor {
    ...
    public void encode(EncodeDataContainer ba) {
        EncodeUtils.encodeString(this.methodName, ba);
        EncodeUtils.encodeString(this.className, ba);
        EncodeUtils.encodeString(this.augmentedTableName, ba);
    }

    public static AttributeDescriptor decode(EncodeDataContainer ba) {
        AttributeDescriptor p = new AttributeDescriptor(EncodeUtils.decodeString(ba),EncodeUtils.decodeString(ba));
        p.setAugmentedTableName(EncodeUtils.decodeString(ba));
        return p;
    }
