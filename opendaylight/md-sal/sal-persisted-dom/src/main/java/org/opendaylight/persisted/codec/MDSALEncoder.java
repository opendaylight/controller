...
public class MDSALEncoder {
    ...
    public static final void encodeAugmentations(Object value, BytesArray ba) {
        ...
        MDSALTable ctype = MDSALTableRepository.getInstance().getCtypeByClass(
                ((DataObject) value).getImplementedInterface());
        ...
        if (ctype.getAugmentationField(value) != null) {
            try {
                Map<?, ?> augmentations = (Map<?, ?>) ctype
                        .getAugmentationField(value).get(value);
                if (augmentations == null) {
                    encodeNULL(ba);
                } else {
                    encodeInt16(augmentations.size(), ba);
                    for (Iterator<?> iter = augmentations.entrySet().iterator(); iter
                            .hasNext();) {
    ...
    public static final void decodeAugmentations(Object builder, BytesArray ba,
    ...
    public static final Object decodeObject(BytesArray ba) {
        ...
        if (serializer == null) {
            MDSALTableRepository.getInstance().getCTypeByCode(classCode)
                    .getMyClass();
        }
        if (serializer != null) {
