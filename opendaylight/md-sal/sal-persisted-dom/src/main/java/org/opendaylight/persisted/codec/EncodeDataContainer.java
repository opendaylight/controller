...
public class EncodeDataContainer {
    ...
    public EncodeDataContainer(byte[] data) {
        this(data, null);
    }

    public EncodeDataContainer(byte[] data, Object _codingOption) {
        this.bytes = data;
        this.codingOption = _codingOption;
    }

    public EncodeDataContainer(int size) {
        this(size, null);
    }

    public EncodeDataContainer(int size, Object _codingOption) {
    ...
    public void addSubElementData(int classType, EncodeDataContainer subBytesArray,Object _element) {
        ...
        if(_element!=null){
            subBytesArray.setMD5ID(TypeDesciptorRepository.getInstance().getTypeDescriptorByObject(_element).getMD5IDForObject(_element));
        }
    ...
    public static byte[] toSingleByteArray(EncodeDataContainer source){
        EncodeDataContainer enc = new EncodeDataContainer(1024);
    ...
    public static EncodeDataContainer fromSingleByteArray(EncodeDataContainer source){
        EncodeDataContainer result = new EncodeDataContainer(1024);
        ...
        for(int i=0;i<subMapSize;i++){
            ...
            for(int j=0;j<size;j++){
                ...
                EncodeDataContainer subBASource = new EncodeDataContainer(subData);
