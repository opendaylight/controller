...
public class NetworkTest {
    ...
    @Test
    public void testClusterMapsNodeUnreachable(){
        TypeDescriptorsContainer container = new TypeDescriptorsContainer("./");
        AutonomousAgentManager m1 = new AutonomousAgentManager(container);
        ...
        ClusterMap<String, TestObject> map3 = new ClusterMap<>(125, m3.getNetworkNode().getLocalHost(), m3);
        ...
        ClusterMap<String, TestObject> map4 = new ClusterMap<>(125, m4.getNetworkNode().getLocalHost(), m4);
        ...
        map4 = new ClusterMap<>(125, m4.getNetworkNode().getLocalHost(), m4);
