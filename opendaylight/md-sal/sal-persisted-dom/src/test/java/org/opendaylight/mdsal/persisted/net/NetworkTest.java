...
public class NetworkTest {
    ...
    public static void main(String args[]){
        ...
        try {
            System.out.println("Sleeping 20 seconds to allow nodes to sync");
            Thread.sleep(20000);
        } catch (Exception err) {
            err.printStackTrace();
        }
    ...
    public static void clean(){
        ...
        ObjectDataStore.deleteDirectory(f);
        f = new File("./node2");
        ObjectDataStore.deleteDirectory(f);
    }
}
