...
import org.opendaylight.persisted.ThreadPool;
...
public class MDSALDBTest {
    ...
    public void setupFlagsAndCreateDB() {
        ...
        database = new ObjectDataStore("MDSalDataStoreTest",true);
        setupObservers();
    }
    ...
    public void mdsalEncoderTest() {
        EncodeDataContainer ba = new EncodeDataContainer(1024,database.getTypeDescriptorsContainer());
        ...
        EncodeDataContainer singleSource = new EncodeDataContainer(data,database.getTypeDescriptorsContainer());
