...
public class MDSALDBTest {
    ...
    public static void cleanAll(){
        ...
        TypeDescriptor.addChildAttributeObserver(new MDSalObjectChildRule());
        TypeDescriptor.addTypeAttributeObserver(new MDSALObjectTypeRule());
        TypeDescriptor.setClassExtractor(new MDSALClassExtractor());
        TypeDescriptor.addMethodFilterObserver(new MDSALMethodFilter());
    }
    ...
    private int numberOfRecordsPerThread = 10000;
