...
public class MDSALDBTest {
    ...
    public void testSelect100Of10000(){
        ...
        database.executeSql("select * from SalPersistedDomTest where RowIndex>=203 and RowIndex<=303;", System.out, false);
    }
    ...
    public void testSelect100Of10000JustAugmentationFields(){
        ...
        setEndTime();
        setStartTime("Selecting 100 of those 10000...");
        database.executeSql("select MainString2,Atypedeftest,AtestInt32 from SalPersistedDomTest where RowIndex>=700 and RowIndex<=800;", System.out, false);
    }
    ...
    public void testSelect100Of20000SubElements(){
        ...
        database.executeSql("select NoKeysubList.Name,Typedeftest from NoKeysubList where RowIndex>=557 and RowIndex<=657;", System.out, false);
    }
