...
class DataJournalEntryFragmenter {
    ...
    static long getFirstFragmentIndexOf(final FromFragmentedPersistence fromFragPersistence, final long fromIndex) {
        return fromIndex - fromFragPersistence.getFragmentIndex();
    }

    static long getLastFragmentIndexOf(final FromFragmentedPersistence fromFragPersistence, final long fromIndex) {
        return fromIndex + fromFragPersistence.getFragmentCount() - (fromFragPersistence.getFragmentIndex() + 1);
    }
}
