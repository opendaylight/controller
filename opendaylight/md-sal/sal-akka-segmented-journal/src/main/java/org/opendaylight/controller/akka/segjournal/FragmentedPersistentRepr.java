 ...
 * This is not the case for fragmented payload. After the fragment is created, no more serialization is needed nor
 * desired. Therefore the fragmented payload is kept specifically as byte[] and not as Object.
 */
final class FragmentedPersistentRepr {
    ...
    FragmentedPersistentRepr(final byte[] payloadFragment, final long sequenceNr, final String persistenceId,
                             final String manifest, final boolean deleted, final ActorRef sender,
    ...
    static FragmentedPersistentRepr apply(final byte[] payloadFragment, final long sequenceNr,
                                          final String persistenceId, final String manifest, final boolean deleted,
