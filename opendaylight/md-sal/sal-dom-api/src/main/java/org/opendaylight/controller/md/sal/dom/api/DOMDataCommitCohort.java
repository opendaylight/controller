...
public interface DOMDataCommitCohort {
     ...
     */
    @Nonnull CommitCohortTransaction canCommit(@Nonnull Object txId, @Nonnull DataTreeCandidate candidate,
            @Nonnull SchemaContext ctx) throws DataValidationFailedException;
}
