...
public interface DOMRpcProviderService extends DOMService {
     ...
     * @throws IllegalArgumentException if types is empty or contains a null element.
     */
    @Nonnull <T extends DOMRpcImplementation> DOMRpcImplementationRegistration<T> registerRpcImplementation(@Nonnull T implementation, @Nonnull Collection<DOMRpcIdentifier> rpcs);
}
