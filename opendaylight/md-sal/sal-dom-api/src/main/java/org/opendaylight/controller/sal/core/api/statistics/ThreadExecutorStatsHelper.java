...
public final class ThreadExecutorStatsHelper {
     ...
     * {@link ExecutorService}. This method uses reflection to create the instance and introspection
    ...
    private static void setProperty(String propName, Object obj, Object value,
        ...
        if(propDesc == null) {
            throw new IllegalArgumentException(
                    String.format("No property for %s on class %s", propName, obj.getClass()));
        }

        Method writeMethod = propDesc.getWriteMethod();
        if(writeMethod == null) {
            throw new IllegalArgumentException(
                    String.format("No write method for property for %s on class %s",
