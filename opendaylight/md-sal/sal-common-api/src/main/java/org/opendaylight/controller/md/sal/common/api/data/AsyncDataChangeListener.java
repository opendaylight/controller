...
public interface AsyncDataChangeListener<P extends Path<P>, D> extends EventListener {
    /**
     *
     * Invoked when there is data change for particular path, which was used to
     * register this listener.
     * <p>
     * This method may be also invoked during registration of the listener if
     * there are any preexisting data in conceptual data tree for supplied path.
     * This initial event will contains all preexisting data as created.
     *
     * <p>
