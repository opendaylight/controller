 ...
 * receive notifications for changes to data under the path they register for. See
 * {@link AsyncDataBroker#registerDataChangeListener(LogicalDatastoreType, Path, AsyncDataChangeListener, org.opendaylight.controller.md.sal.common.api.data.AsyncDataBroker.DataChangeScope)}
...
public interface AsyncDataChangeEvent<P extends Path<P>, D> extends Immutable {
     ...
     * which was in scope of listener registration and was created.
     * This data tree nodes contains their whole subtree
     ...
     * with current state.
     *
     * Node is considered updated if it contents was replaced or one of
