...
public interface AsyncDataChangeEvent<P extends Path<P>, D> extends Immutable {
     ...
     *
     * This map contains all data tree nodes (and paths to them), which were in
    ...
    /**
     * Returns a map of paths and updated objects, which were changed by this
     ...
     * nodes contain the whole subtree with their current state.
     *
    ...
    /**
     * Return an immutable map of paths and original state of updated and removed
     * objects.
     *
    ...
    /**
     * Returns an immutable stable view of data state, which captures state of
    ...
    /**
     * Returns an immutable stable view of data, which captures state of data
