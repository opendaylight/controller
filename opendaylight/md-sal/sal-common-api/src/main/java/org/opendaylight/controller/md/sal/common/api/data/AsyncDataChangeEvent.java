 ...
 * {@link AsyncDataBroker#registerDataChangeListener(LogicalDatastoreType, Path, AsyncDataChangeListener, org.opendaylight.controller.md.sal.common.api.data.AsyncDataBroker.DataChangeScope)}
 * to lear more about registration scopes.
 *
 * The entire subtree under the path is be provided via instance methods of Data
...
public interface AsyncDataChangeEvent<P extends Path<P>, D> extends Immutable {
    /**
     * Returns a map of paths and newly created objects, which was introduced by
     * this change into conceptual data tree, if no new objects were introduced
     * this map will be empty.
     *
     * This map contains all data tree nodes (and paths to them), which was in
     * scope of listener registration and was created. This data tree nodes
     * contains their whole subtree with their current state.
     *
    ...
    /**
     * Returns a map of paths and updated objects, which was changed by this
     * change into conceptual data tree, if no existing objects were updated
     * this map will be empty.
     *
     * This map contains data tree nodes (and paths to them) which are in the
     * scope of the listener registration and have been updated. The data tree
     * nodes contains the whole subtree with their current state.
     *
     * Node is considered updated if it contents was replaced or one of its
     ...
     * of the listener registration and have been removed.
     *
     ...
     * could be accessed only via {@link #getCreatedData()},
