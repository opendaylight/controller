...
public interface AsyncDataChangeEvent<P extends Path<P>, D> extends Immutable {
     ...
     *<p>
     * This map contains all data tree nodes (and paths to them) which were created and are in
     * the scope of listener registration. The data tree nodes
     ...
     * this map will be empty.
     *<p>
     * This map contains all data tree nodes (and paths to them) which were update and are in
     * the scope of listener registration. The data tree nodes
     * contain their whole subtree with their current state.
     *<p>
    ...
    /**
     * Return an immutable map of paths and the original state of updated and removed
     * objects.
     *<p>
