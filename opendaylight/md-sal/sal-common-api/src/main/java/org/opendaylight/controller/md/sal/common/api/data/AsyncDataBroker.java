...
public interface AsyncDataBroker<P extends Path<P>, D, L extends AsyncDataChangeListener<P, D>> extends //
    ...
    public enum DataChangeScope {
        ...
        ONE,
        /**
         * Represents a change of the node or any of its child nodes.
         *
     ...
     * notifications when data changes under a given path in conceptual data
     * tree.
     * <p>
     * You are able to register for notifications for any node or subtree which
     * is possible to reference via supplied path type.
     * <p>
     * If path type allows it, you may specify paths up to the leaf nodes. It is possible
