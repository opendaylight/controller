...
class DOMRpcImplementationAdapter<T extends org.opendaylight.controller.md.sal.dom.api.DOMRpcImplementation>
    ...
    private final Map<DOMRpcIdentifier, org.opendaylight.controller.md.sal.dom.api.DOMRpcIdentifier> rpcMap;
    ...
    public DOMRpcImplementationAdapter(T implementation2,
        ...
        Map<DOMRpcIdentifier, org.opendaylight.controller.md.sal.dom.api.DOMRpcIdentifier> map = new HashMap<>(rpcs.size());
        ...
        rpcMap = (Map<DOMRpcIdentifier, org.opendaylight.controller.md.sal.dom.api.DOMRpcIdentifier>) Collections
                .unmodifiableMap(map);
    }
