...
public class BackwardsCompatibleMountPoint implements MountProvisionInstance, SchemaContextProvider {
    ...
    private final DelgatingNotificationPublishService notificationPublishService;
    ...
    private static final class BackwardsCompatibleDomStore implements DOMDataBroker {
        ...
        public BackwardsCompatibleDomStore(final DataBrokerImpl dataReader, final SchemaContextProvider schemaContextProvider) {
        ...
        private static final class BackwardsCompatibleReadTransaction implements DOMDataReadOnlyTransaction {
            ...
            public BackwardsCompatibleReadTransaction(final DataBrokerImpl dataReader, final DataNormalizer normalizer) {
                this.dataReader = dataReader;
        ...
        private static final class BackwardsCompatibleWriteTransaction implements DOMDataWriteTransaction {
            private DataTransactionImpl oldTx;
            private final DataNormalizer dataNormalizer;

            public BackwardsCompatibleWriteTransaction(final DataBrokerImpl dataReader, final DataNormalizer dataNormalizer) {
        ...
        private class BackwardsCompatibleReadWriteTransaction implements DOMDataReadWriteTransaction {
            ...
            public BackwardsCompatibleReadWriteTransaction(final DataBrokerImpl dataReader, final DataNormalizer dataNormalizer) {
                this.dataReader = dataReader;
                this.dataNormalizer = dataNormalizer;
