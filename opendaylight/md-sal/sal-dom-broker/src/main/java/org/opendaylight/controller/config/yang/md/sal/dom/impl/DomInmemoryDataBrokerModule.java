...
//        ListeningExecutorService storeExecutor = MoreExecutors.listeningDecorator(Executors.newFixedThreadPool(2));
        ...
        DataStoreImpl operStore = new DataStoreImpl("operational", null, MoreExecutors.listeningDecorator(Executors.newFixedThreadPool(10)));
        DataStoreImpl configStore = new DataStoreImpl("config", null, MoreExecutors.listeningDecorator(Executors.newFixedThreadPool(10)));
