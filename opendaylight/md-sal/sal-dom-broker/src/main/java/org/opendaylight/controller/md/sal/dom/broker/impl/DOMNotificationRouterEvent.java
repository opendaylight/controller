...
final class DOMNotificationRouterEvent {
    ...
    private Collection<DOMNotificationListenerRegistration> subscribers;
    ...
    ListenableFuture<Void> initialize(final DOMNotification notification, final Collection<DOMNotificationListenerRegistration> subscribers) {
    ...
    void deliverNotification() {
        for (DOMNotificationListenerRegistration r : subscribers) {
