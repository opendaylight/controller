...
//        }
        return new DOMForwardedReadOnlyTransaction(newTransactionIdentifier(), storeTxFactories);
    }
...
//        }
        return new DOMForwardedReadWriteTransaction(newTransactionIdentifier(), storeTxFactories, this);
    }
