...
public class DOMDataBrokerTransactionChainImpl extends AbstractDOMForwardedTransactionFactory<DOMStoreTransactionChain> implements
    ...
    public DOMDataBrokerTransactionChainImpl(final long chainId,final ImmutableMap<LogicalDatastoreType, DOMStoreTransactionChain> chains,
    ...
    @Override
    public synchronized ListenableFuture<RpcResult<TransactionStatus>> commit(final DOMDataWriteTransaction transaction,
