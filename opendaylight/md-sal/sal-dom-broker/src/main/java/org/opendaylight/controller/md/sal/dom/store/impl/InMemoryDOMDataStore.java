...
public class InMemoryDOMDataStore implements DOMStore, Identifiable<String>, SchemaContextListener, TransactionReadyPrototype {
    ...
    private class DOMStoreTransactionChainImpl implements DOMStoreTransactionChain, TransactionReadyPrototype {
        ...
        public synchronized DOMStoreReadWriteTransaction newReadWriteTransaction() {
            ...
            final SnapshotBackedReadWriteTransaction ret = new SnapshotBackedReadWriteTransaction(nextIdentifier(), snapshot,this);
        ...
        public synchronized DOMStoreWriteTransaction newWriteOnlyTransaction() {
            ...
            final SnapshotBackedWriteTransaction ret =new SnapshotBackedWriteTransaction(nextIdentifier(), snapshot,this);
            latestOutstandingTx = ret;
            return ret;
        }
        ...
        protected synchronized void onTransactionFailed(final SnapshotBackedWriteTransaction transaction, final Throwable t) {
            chainFailed = true;

        }

        public synchronized void onTransactionCommited(final SnapshotBackedWriteTransaction transaction) {
            // If commited transaction is latestOutstandingTx we clear latestOutstandingTx
            // field in order to base new transactions on Datastore Data Tree directly.
