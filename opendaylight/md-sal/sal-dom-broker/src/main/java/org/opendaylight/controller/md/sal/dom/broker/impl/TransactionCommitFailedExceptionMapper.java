...
final class TransactionCommitFailedExceptionMapper implements
    ...
    private TransactionCommitFailedExceptionMapper(String opName) {
        this.opName = Preconditions.checkNotNull(opName);
    }

    public static final TransactionCommitFailedExceptionMapper create(String opName) {
        return new TransactionCommitFailedExceptionMapper(opName);
    }

    @Override
    public TransactionCommitFailedException apply(Exception e) {
