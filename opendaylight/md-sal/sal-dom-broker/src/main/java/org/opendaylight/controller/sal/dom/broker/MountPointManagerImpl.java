...
public class MountPointManagerImpl implements MountProvisionService {
	...
	private ConcurrentMap<InstanceIdentifier, MountPointImpl> mounts;

	public MountPointManagerImpl() {
		listeners = ListenerRegistry.create();
		mounts = new ConcurrentHashMap<InstanceIdentifier, MountPointImpl>();
	}
