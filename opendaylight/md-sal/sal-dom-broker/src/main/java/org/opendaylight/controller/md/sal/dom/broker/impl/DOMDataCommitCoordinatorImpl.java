...
import org.opendaylight.controller.md.sal.dom.broker.impl.jmx.CommitStatsTracker;
...
public class DOMDataCommitCoordinatorImpl implements DOMDataCommitExecutor {
    ...
    private CommitStatsTracker commitStatsTracker;
    ...
    public void setCommitStatTracker(CommitStatsTracker commitStatTracker) {
    ...
    private static class CommitCoordinationTask implements Callable<Void> {
        ...
        private final CommitStatsTracker commitStatTracker;
        ...
        public CommitCoordinationTask(final DOMDataWriteTransaction transaction,
                ...
                final CommitStatsTracker commitStatTracker) {
        ...
        public Void call() throws TransactionCommitFailedException {
            ...
            try {
                ...
                if(commitStatTracker != null) {
                    commitStatTracker.addCommitStats(System.nanoTime() - startTime);
                }
            }
        }
