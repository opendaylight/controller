...
/**
 * Implementation of Write transaction which is backed by {@link DataTreeSnapshot}
...
class SnapshotBackedWriteTransaction extends AbstractDOMStoreTransaction implements DOMStoreWriteTransaction {
    ...
    public void write(final InstanceIdentifier path, final NormalizedNode<?, ?> data) {
        ...
        try {
            ...
            LOG.error("Tx: {}, failed to write {}:{} in {}", getIdentifier(), path, data,
                    mutableTree, e);
        }
    }
    ...
    /**
     * Prototype implementation of {@link #ready(SnapshotBackedWriteTransaction)}
     *
     * This class is intended to be implemented by Transaction factories responsible
     * for allocation of {@link SnapshotBackedWriteTransaction} and providing
     * underlying logic for applying implementation.
     *
     */
    public static interface TransactionReadyPrototype {
         ...
         *
         * @param tx Transaction on which ready was invoked.
