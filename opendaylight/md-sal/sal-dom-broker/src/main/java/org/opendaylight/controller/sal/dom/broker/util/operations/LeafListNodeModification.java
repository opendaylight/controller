...
class LeafListNodeModification implements Modification<LeafListSchemaNode, Modification.LeafListNodeWrapper> {

    @Override
    public LeafListNodeWrapper modify(LeafListSchemaNode schemaNode, LeafListNodeWrapper actualNodes, LeafListNodeWrapper modificationNodes,
        ...
        if(actualNodes.isEmpty() == false)
            resultNodes.addAll(actualNodes.getNodes());
