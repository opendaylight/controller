...
public interface DOMDataCommitExecutor {
    ...
    /**
     * Submits supplied transaction to be executed in context of provided cohorts.
     *
     * Transaction is used only as a context, cohorts should be associated with
     * this transaction.
     *
     * @param tx Transaction to be used
     * @param cohort DOM Store cohorts representing provided transaction.
     * @param listener Error lister which should be notified if transaction failed.
     * @return
     */
