...
public class DOMBrokerTest {
    ...
    @Test
    public void testWriteOnlyTxAccessingBothDataStores() throws Exception {
    ...
    @Test
    public void testWriteOnlyTxAccessingOneDataStore() throws Exception {
        DOMStore mockConfigStore = setupMockConfigDataStore();
        DOMStore mockOperStore = setupMockOperDataStore();
    ...
    @Test
    public void testWriteTxAccessingNoDataStore() throws Exception {
        DOMStore mockConfigStore = setupMockConfigDataStore();
        DOMStore mockOperStore = setupMockOperDataStore();
        ...
        Mockito.verifyZeroInteractions(mockConfigStore, mockOperStore);
    }

    @Test
    public void testReadWriteTxAccessingBothDataStores() throws Exception {
        DOMStore mockConfigStore = setupMockConfigDataStore();
        DOMStore mockOperStore = setupMockOperDataStore();
    ...
    @Test
    public void testReadWriteTxAccessingOneDataStore() throws Exception {
        DOMStore mockConfigStore = setupMockConfigDataStore();
        DOMStore mockOperStore = setupMockOperDataStore();
    ...
    @Test
    public void testReadOnlyTxAccessingBothDataStores() throws Exception {
        DOMStore mockConfigStore = setupMockConfigDataStore();
        DOMStore mockOperStore = setupMockOperDataStore();
    ...
    @Test
    public void testReadOnlyTxAccessingOneDataStore() throws Exception {
        DOMStore mockConfigStore = setupMockConfigDataStore();
        DOMStore mockOperStore = setupMockOperDataStore();
