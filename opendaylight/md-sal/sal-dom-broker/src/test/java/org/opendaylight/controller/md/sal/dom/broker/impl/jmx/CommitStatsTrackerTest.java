...
public class CommitStatsTrackerTest {
    ...
    public void test() {
        ...
        tracker.reset();
        assertEquals("getTotalCommits", 0, tracker.getTotalCommits());
        assertEquals("getAverageCommitTime", 0.0, tracker.getAverageCommitTime(), 0.1);
        assertEquals("getLongestCommitTime", 0, tracker.getLongestCommitTime());
        assertEquals("getShortestCommitTime", 0, tracker.getShortestCommitTime());
