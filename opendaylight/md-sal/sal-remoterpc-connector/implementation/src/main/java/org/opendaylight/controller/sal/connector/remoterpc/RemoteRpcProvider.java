...
public class RemoteRpcProvider implements
  ...
  public void start() {
    ...
    RpcProvisionRegistry registry = brokerSession.getService(RpcProvisionRegistry.class);
    registry.setRoutedRpcDefaultDelegate(this);
    registry.registerRouteChangeListener(routeChangeListener);
