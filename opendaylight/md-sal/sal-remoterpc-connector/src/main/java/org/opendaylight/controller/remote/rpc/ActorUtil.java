...
public class ActorUtil {
  ...
  public static final FiniteDuration REMOTE_ASK_DURATION = Duration.create(5, TimeUnit.SECONDS);
  public static final FiniteDuration ASK_DURATION = Duration.create(7, TimeUnit.SECONDS);
  public static final FiniteDuration LOCAL_AWAIT_DURATION = Duration.create(2, TimeUnit.SECONDS);
  public static final FiniteDuration REMOTE_AWAIT_DURATION = Duration.create(5, TimeUnit.SECONDS);
  public static final FiniteDuration AWAIT_DURATION = Duration.create(7, TimeUnit.SECONDS);
