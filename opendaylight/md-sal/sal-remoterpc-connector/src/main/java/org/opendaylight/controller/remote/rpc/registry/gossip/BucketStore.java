...
public final class BucketStore {
    ...
    void getBucketVersions(final BiConsumer<Throwable, Map<Address, Long>> callback) {
        Patterns.ask(context.parent(), GET_BUCKET_VERSIONS, timeout).onComplete(new OnComplete<Object>() {
            @SuppressWarnings("unchecked")
            @Override
            public void onComplete(final Throwable arg0, final Object arg1) {
    ...
    @VisibleForTesting
    public static final Object GET_BUCKET_VERSIONS = new Object() {
        @Override
        public String toString() {
            return "GET_BUCKET_VERSIONS";
        }
    };
