...
public final class RPCAccessibleClasses extends DelegatingAccessibleClasses {
    private RPCAccessibleClasses(final ClassLoader classLoader) {
     ...
     */
    public RPCAccessibleClasses() {
        this(RPCAccessibleClasses.class.getClassLoader());
    }

    @Activate
    public RPCAccessibleClasses(final BundleContext bundleContext) {
