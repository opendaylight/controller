...
public final class OSGiRemoteOpsProvider {
    ...
    @Reference
    DOMActionProviderService actionProvisionRegistry;
    @Reference
    ...
    void activate(final Config config) {
        ...
        opsManager = actorSystem.actorOf(OpsManager.props(rpcProvisionRegistry, rpcService, opsConfig,
                actionProvisionRegistry, actionService), opsConfig.getRpcManagerName());
