...
public final class ExecuteRpc extends AbstractExecute<NormalizedNode<?, ?>> {
    ...
    public static @NonNull ExecuteRpc from(final @NonNull DOMRpcIdentifier rpc,
        ...
        final SchemaPath type = rpc.getType();
        verify(type.getParent() == null, "RPCs are required to have a single-element type, %s encountered", type);
        return new ExecuteRpc(type, input);
    }
