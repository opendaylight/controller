...
final class RpcInvoker extends AbstractUntypedActor {
    ...
    private void executeRpc(final ExecuteRpc msg) {
        ...
        try {
            final NormalizedNode<?, ?> input = msg.getInputNormalizedNode() == null ?  null
                    : NormalizedNodeSerializer.deSerialize(msg.getInputNormalizedNode());

            future = rpcService.invokeRpc(schemaPath, input);
        ...
        Futures.addCallback(future, new FutureCallback<DOMRpcResult>() {
            ...
            public void onSuccess(final DOMRpcResult result) {
                ...
                if (!result.getErrors().isEmpty()) {
                    ...
                    sender.tell(new RpcResponse(result.getResult() == null ? null :
                        NormalizedNodeSerializer.serialize(result.getResult())), self);
                }
            }
