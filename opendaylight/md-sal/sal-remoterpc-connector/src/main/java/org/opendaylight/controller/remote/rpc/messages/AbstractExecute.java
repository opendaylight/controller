...
public abstract class AbstractExecute<T extends NormalizedNode<?, ?>> implements Serializable {
    ...
    private transient final @NonNull SchemaPath type;
    private transient final @Nullable T input;

    AbstractExecute(final @NonNull SchemaPath type, final @Nullable T input) {
    ...
    public final @Nullable T getInput() {
        return input;
    }
