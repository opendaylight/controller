...
public class RemoteRpcProviderConfig extends CommonConfig {
    ...
    protected static final String TAG_RPC_REGISTRATOR_NAME = "rpc-registrator-name";
    ...
    public String getRpcRegistratorName() {
        return get().getString(TAG_RPC_REGISTRATOR_NAME);
    }
    ...
    public static class Builder extends CommonConfig.Builder<Builder> {
        ...
        public Builder(final String actorSystemName) {
            ...
            configHolder.put(TAG_RPC_REGISTRATOR_NAME, "registrator");
