...
public class RemoteRpcProvider implements AutoCloseable, Provider{
  ...
  private void start() {
    ...
    rpcRegistry = actorSystem.actorOf(RpcRegistry.props(new ClusterWrapperImpl(actorSystem)), "rpc-registry");
    rpcBroker = actorSystem.actorOf(RpcBroker.props(brokerSession, rpcRegistry), "rpc-broker");
