...
public class RoutingTable implements Copier<RoutingTable> {
    ...
    /// Getter, Setters
    ///
    Map<RpcRouter.RouteIdentifier<?, ?, ?>, Long> getTable() {
        return table;
    }

    void setTable(Map<RpcRouter.RouteIdentifier<?, ?, ?>, Long> Long) {
        this.table = table;
    }
