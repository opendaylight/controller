...
public class RoutedRpcListener implements RouteChangeListener<RpcRoutingContext, YangInstanceIdentifier>{
  ...
  private void announce(Set<RpcRouter.RouteIdentifier<?, ?, ?>> announcements) {
    ...
    RpcRegistry.Messages.AddOrUpdateRoute addRpcMsg = new RpcRegistry.Messages.AddOrUpdateRoute(announcements.iterator().next());
    try {
  ...
  private void remove(Set<RpcRouter.RouteIdentifier<?, ?, ?>> removals){
    ...
    RpcRegistry.Messages.RemoveRoute removeRpcMsg = new RpcRegistry.Messages.RemoveRoute(removals.iterator().next());
    try {
