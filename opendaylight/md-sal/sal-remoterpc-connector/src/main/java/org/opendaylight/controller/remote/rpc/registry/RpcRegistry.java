 ...
 */
public class RpcRegistry extends BucketStore<RoutingTableImpl> {

    final LoggingAdapter log = Logging.getLogger(getContext().system(), this);

    public RpcRegistry() {
        getLocalBucket().setData(new RoutingTableImpl());
    }
    ...
    private void receiveAddRoutes(AddOrUpdateRoutes msg) {
        ...
        RoutingTableImpl table = getLocalBucket().getData().copy();
    ...
    private void receiveGetRouter(FindRouters msg) {
        ...
        for(Bucket<RoutingTableImpl> bucket : getRemoteBuckets().values()) {
    ...
    private void findRoutes(RoutingTableImpl table, RpcRouter.RouteIdentifier<?, ?, ?> routeId,
