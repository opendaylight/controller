...
public class RemoteRpcRegistryMXBeanImplTest {
    ...
    private TestActorRef<?> testActor;
    ...
    private JavaTestKit supervisor;
    ...
    public void setUp() throws Exception {
        ...
        buckets = Lists.newArrayList(localRpcIdentifier);
        ...
        supervisor = new JavaTestKit(system);
        final Props props = RpcRegistry.props(
                config, invoker.getRef(), registrar.getRef(), localRpcIdentifier, emptyRpcIdentifier);
