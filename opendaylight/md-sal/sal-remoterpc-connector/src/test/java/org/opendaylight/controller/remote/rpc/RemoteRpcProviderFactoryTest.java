...
public class RemoteRpcProviderFactoryTest {
    ...
    @Mock
    private RemoteRpcProviderConfig remoteRpcProviderConfig;
    ...
    public void testCreateInstanceFail() throws Exception {
        RemoteRpcProviderFactory.createInstance(null, null, null, null);
    }
}