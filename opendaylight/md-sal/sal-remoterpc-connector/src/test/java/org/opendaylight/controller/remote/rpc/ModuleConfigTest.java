...
public class ModuleConfigTest {
    ...
    public void testModuleConfigDefaults(){
        ModuleConfig config = new ModuleConfig.Builder("unit-test").build();
    ...
    public void testModuleConfigWithMetricsCaptureEnabled(){
        ModuleConfig config = new ModuleConfig.Builder("unit-test").
    ...
    public void testModuleConfigWithBoundedMailboxCapacity(){
        ...
        Config actorConfig = config.get();
        Assert.assertTrue(actorConfig.hasPath(ModuleConfig.TAG_MAILBOX));

        String mailboxCapacityPath = ModuleConfig.TAG_MAILBOX + "." + ModuleConfig.TAG_MAILBOX_CAPACITY;
        Assert.assertTrue(actorConfig.hasPath(mailboxCapacityPath));

        Assert.assertEquals(expectedTimeout, actorConfig.getInt(mailboxCapacityPath));
    }
