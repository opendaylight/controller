...
public class RpcErrorsExceptionTest {
    ...
    public void testGetRpcErrors() throws Exception {
        ...
        Assert.assertEquals(expectedError.getCause(), error1.getCause());
        Assert.assertEquals(expectedError.getMessage(), error1.getMessage());
        Assert.assertEquals(expectedError.getApplicationTag(), error1.getApplicationTag());
        Assert.assertEquals(expectedError.getErrorType(), error1.getErrorType());
    }
}