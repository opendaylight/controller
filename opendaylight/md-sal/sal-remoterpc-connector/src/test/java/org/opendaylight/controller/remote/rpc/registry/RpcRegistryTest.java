...
import static org.opendaylight.controller.remote.rpc.registry.gossip.BucketStore.Singletons.GET_ALL_BUCKETS;
import static org.opendaylight.controller.remote.rpc.registry.gossip.BucketStore.Singletons.GET_BUCKET_VERSIONS;
...
public class RpcRegistryTest {
    ...
    private JavaTestKit registrator1;
    private JavaTestKit registrator2;
    private JavaTestKit registrator3;
    ...
    public void setup() {
        ...
        registrator1 = new JavaTestKit(node1);
        registry1 = node1.actorOf(RpcRegistry.props(config(node1), invoker1.getRef(), registrator1.getRef()));
        invoker2 = new JavaTestKit(node2);
        registrator2 = new JavaTestKit(node2);
        registry2 = node2.actorOf(RpcRegistry.props(config(node2), invoker2.getRef(), registrator2.getRef()));
        invoker3 = new JavaTestKit(node3);
        registrator3 = new JavaTestKit(node3);
        registry3 = node3.actorOf(RpcRegistry.props(config(node3), invoker3.getRef(), registrator3.getRef()));
    }
    ...
    public void teardown() {
        ...
        if (registrator1 != null) {
            node1.stop(registrator1.getRef());
        }
        if (registrator2 != null) {
            node2.stop(registrator2.getRef());
        }
        if (registrator3 != null) {
            node3.stop(registrator3.getRef());
        }
    }
    ...
    public void testRpcAddedOnMultiNodes() throws Exception {
        ...
        final UpdateRemoteEndpoints req1 = registrator3.expectMsgClass(Duration.create(3, TimeUnit.SECONDS),
        ...
        final UpdateRemoteEndpoints req2 = registrator3.expectMsgClass(Duration.create(3, TimeUnit.SECONDS),
            UpdateRemoteEndpoints.class);
