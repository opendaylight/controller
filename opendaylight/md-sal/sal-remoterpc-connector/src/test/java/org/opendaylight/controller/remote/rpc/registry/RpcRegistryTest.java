...
public class RpcRegistryTest {
    ...
    public void testAddRemoveRpcOnSameNode() throws Exception {
        ...
        registry1.tell(getAddRouteMessage(addedRouteIds), mockBroker.getRef());
    ...
    private AddOrUpdateRoutes getAddRouteMessage(List<RouteIdentifier<?, ?, ?>> routeIds)
            throws URISyntaxException {
        List<RouteIdentifier<?, ?, ?>> newRouteIds = createRouteIds();
        routeIds.addAll(newRouteIds);
        return new AddOrUpdateRoutes(routeIds);
    }
