...
final class ResolveDataChangeState {
    ...
    public void collectEvents(final Multimap<DataChangeListenerRegistration<?>, DOMImmutableDataChangeEvent> map) {
        LOG.trace("Collecting into {}", map);
