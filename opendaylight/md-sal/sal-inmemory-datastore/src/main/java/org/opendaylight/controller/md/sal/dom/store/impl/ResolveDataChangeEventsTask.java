...
final class ResolveDataChangeEventsTask {
     ...
     */
    public synchronized void resolve(final NotificationManager dataChangeListenerNotificationManager) {
        try (final Walker w = listenerRoot.getWalker()) {
            ...
            for (Entry<DataChangeListenerRegistration<?>, Collection<DOMImmutableDataChangeEvent>> e : collectedEvents.asMap().entrySet()) {
                ...
                dataChangeListenerNotificationManager.submitNotification(e.getKey().getInstance(), event);
            }
        }
    }
