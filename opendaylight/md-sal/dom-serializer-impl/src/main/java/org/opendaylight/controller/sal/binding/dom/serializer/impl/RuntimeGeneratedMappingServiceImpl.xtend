...
import org.opendaylight.controller.sal.binding.dom.serializer.api.DeserializationException
import java.util.concurrent.Callable
import org.opendaylight.yangtools.yang.binding.Augmentation
import org.opendaylight.controller.sal.binding.dom.serializer.util.YangSchemaUtils
...
class RuntimeGeneratedMappingServiceImpl implements BindingIndependentMappingService, SchemaContextListener, AutoCloseable {
    ...
    ServiceRegistration<SchemaContextListener> listenerRegistration
    ...
    public def void start(BundleContext ctx) {
        ...
        if (ctx !== null) {
            listenerRegistration = ctx.registerService(SchemaContextListener, this, new Hashtable<String, String>());
        }
    }
