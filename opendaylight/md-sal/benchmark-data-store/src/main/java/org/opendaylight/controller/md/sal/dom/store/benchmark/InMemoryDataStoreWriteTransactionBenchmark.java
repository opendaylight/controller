...
@Fork(1)
public class InMemoryDataStoreWriteTransactionBenchmark {
    ...
    public static void main(String... args) throws IOException, RunnerException {
        Options opt = new OptionsBuilder()
            .include(".*" + InMemoryDataStoreWriteTransactionBenchmark.class.getSimpleName() + ".*")
            .forks(1)
            .build();
    ...
    private void initTestNode() throws Exception {
