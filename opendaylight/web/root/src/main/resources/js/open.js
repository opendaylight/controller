	...
	remove : {
		modal : {
			initialize : function(id) {
				...
				// remove binding
				$('#' + one.main.admin.id.modal.remove.user, $modal).click(
						function() {
							one.main.admin.remove.modal.ajax(id, function(
									result) {
								if (result == 'Success') {
									$modal.modal('hide');
									// body inject
			...
			ajax : function(id, callback) {
				$.post(one.main.admin.address.root
						+ one.main.admin.address.users + '/' + id, function(
						data) {
					callback(data);
				});
			},
	...
	add : {
		modal : {
			initialize : function() {
				...
				// add binding
				$('#' + one.main.admin.id.modal.add.user, $modal).click(
						function() {
							one.main.admin.add.modal.add($modal, function(
									result) {
								if (result == 'Success') {
									$modal.modal('hide');
									// body inject
