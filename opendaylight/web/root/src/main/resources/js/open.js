...
one.main.admin = {
  ...
  remove : {
    ...
    footer : function() {
      var footer = [];
      var modifyButton = one.lib.dashlet.button.single("Modify Role",
          one.main.admin.id.modal.modify.user, "btn-primary", "");
  ...
  add : {
    modal : {
      initialize : function(id, edit) {
        var h3 = edit? "Modify Role of user " + id:"Add User";
    ...
    footer : function(edit) {
      ...
      var buttonText = edit ? "Modify User" : "Add User";
