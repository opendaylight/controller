 ...
 *
 */
public class InfinispanSessionServiceImpl implements ClusterSessionService,
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(InfinispanSessionServiceImpl.class);
  ...
  public InfinispanSessionServiceImpl(ClusterSessionManager manager) {
  ...
  private void retrieveCache(){
    if (clusterGlobalServices == null) {
      LOGGER.error("un-initialized clusterGlobalService, can't retrieve cache");
      return;
    }
