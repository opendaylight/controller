...
public class TestingConfigRegistry implements ConfigRegistryMXBean {
	...
	static {
		conf1 = ObjectNameUtil.createON(ObjectNameUtil.ON_DOMAIN + ":type=Module,"
				+ ObjectNameUtil.MODULE_FACTORY_NAME_KEY + "=" + moduleName1);
		conf2 = ObjectNameUtil.createON(ObjectNameUtil.ON_DOMAIN + ":type=Module,"
				+ ObjectNameUtil.MODULE_FACTORY_NAME_KEY + "=" + moduleName1 + "," + ObjectNameUtil.INSTANCE_NAME_KEY
				+ "=" + instName1);
		conf3 = ObjectNameUtil.createON(ObjectNameUtil.ON_DOMAIN + ":type=Module,"
				+ ObjectNameUtil.MODULE_FACTORY_NAME_KEY + "=" + moduleName2 + "," + ObjectNameUtil.INSTANCE_NAME_KEY
				+ "=" + instName2);
		run1 = ObjectNameUtil.createON(ObjectNameUtil.ON_DOMAIN + ":type=RuntimeBean,"
				+ ObjectNameUtil.MODULE_FACTORY_NAME_KEY + "=" + moduleName1);
		run2 = ObjectNameUtil.createON(ObjectNameUtil.ON_DOMAIN + ":type=RuntimeBean,"
				+ ObjectNameUtil.MODULE_FACTORY_NAME_KEY + "=" + moduleName1 + "," + ObjectNameUtil.INSTANCE_NAME_KEY
				+ "=" + instName1);
		run3 = ObjectNameUtil.createON(ObjectNameUtil.ON_DOMAIN + ":type=RuntimeBean,"
				+ ObjectNameUtil.MODULE_FACTORY_NAME_KEY + "=" + moduleName2 + "," + ObjectNameUtil.INSTANCE_NAME_KEY
				+ "=" + instName2);
	}
	...
	@Override
	public CommitStatus commitConfig(ObjectName transactonControllerON) throws ConflictingVersionException,
			ValidationException {
	...
	public Set<ObjectName> lookupConfigBeans(String moduleName, String instanceName) {
		...
		} else if (moduleName.equals(moduleName2) && instanceName.equals(instName2)) {
			return Sets.newHashSet(conf3);
		} else {
			return null;
		}
