...
public class LookupTest {
	...
	private ConfigTransactionClient jmxTransactionClient, jolokiaTransactionClient;
	...
	public void setUp() throws Exception {
		...
		testingTransactionControllerON = new ObjectName(ObjectNameUtil.ON_DOMAIN + ":"
		...
		jmxTransactionClient = new ConfigTransactionJMXClient(null,
				testingTransactionControllerON, ManagementFactory.getPlatformMBeanServer());
		jolokiaTransactionClient = new ConfigTransactionJolokiaClient(
				jolokiaURL, testingTransactionControllerON, null);
		lookupProvidersToClients = ImmutableMap.of(testingRegistry, Sets.newHashSet(jmxRegistryClient, jolokiaRegistryClient),
	...
	public void testLookupConfigBeans1() throws Exception {
		Method method = LookupRegistry.class.getMethod("lookupConfigBeans", String.class);
	...
	public void testLookupConfigBeans2() throws Exception {
		Method method = LookupRegistry.class.getMethod("lookupConfigBeans", String.class, String.class);
	...
	public void testLookupConfigBean() throws Exception {
		Method method = LookupRegistry.class.getMethod("lookupConfigBean", String.class, String.class);
		Object[] args = new Object[]{TestingConfigRegistry.moduleName1, TestingConfigRegistry.instName1};
		test(method, args);
	}
