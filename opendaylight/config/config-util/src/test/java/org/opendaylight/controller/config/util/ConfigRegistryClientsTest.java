...
public class ConfigRegistryClientsTest {
    ...
    public void testCreateTransaction() throws Exception{
        ...
        assertEquals(null, jmxTransactionClient);
    }
    ...
    public void testNewMXBeanProxy() throws Exception{
        if (jmxRegistryClient instanceof ConfigRegistryJMXClient) {
            ...
            assertEquals(null, client.newMXBeanProxy(testingRegistryON, String.class));
        } else {
    ...
    public void testCommitConfig() throws Exception{
        assertEquals(null, jmxRegistryClient.commitConfig(testingRegistryON));
    }

    @Test
    public void testGetOpenConfigs() throws Exception{
        assertEquals(null, jmxRegistryClient.getOpenConfigs());
    }
    ...
    public void testGetAvailableModuleNames() throws Exception{
        assertEquals(null, jmxRegistryClient.getAvailableModuleNames());
    }
    ...
    public void testGetServiceMapping() throws Exception{
        assertEquals(null, jmxRegistryClient.getServiceMapping());
    }
    ...
    public void testLookupServiceInterfaceNames() throws Exception{
        for(String str : clientLookupServiceInterfaceNames(testingRegistryON)){
            if(str != TestingConfigRegistry.serviceQName2){
                assertEquals(TestingConfigRegistry.serviceQName1, str);
            }
            else{
                assertEquals(TestingConfigRegistry.serviceQName2, str);
            }
        }
    }
    ...
    public void testGetServiceInterfaceName() throws Exception{
        assertEquals(null, jmxRegistryClient.getServiceInterfaceName(null, null));
    }

    @Test(expected = RuntimeException.class)
    public void testInvokeMethod() throws Exception{
        assertEquals(null, jmxRegistryClient.invokeMethod(testingRegistryON, "name", null, null));
    }

    @Test(expected = RuntimeException.class)
    public void testGetAttributeCurrentValue() throws Exception{
        assertEquals(null, jmxRegistryClient.getAttributeCurrentValue(testingRegistryON, "attrName"));
    }
