...
import org.opendaylight.controller.config.util.jolokia.ListableJolokiaClient;
...
public class ListableJolokiaClientTest {
	...
	public void testParsing() {
		...
		ValidationException val2 = ListableJolokiaClient.createValidationExceptionFromJSONObject(e);
