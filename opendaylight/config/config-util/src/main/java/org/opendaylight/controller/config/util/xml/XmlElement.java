...
public final class XmlElement {
    ...
    public void checkName(String expectedName) throws DocumentedException {
        if (!getName().equals(expectedName)){
            throw new DocumentedException(String.format("Expected %s xml element but was %s", expectedName,
                    getName()),
                    DocumentedException.ErrorType.application,
    ...
    public void checkNamespaceAttribute(String expectedNamespace) throws DocumentedException {
        if (!getNamespaceAttribute().equals(expectedNamespace))
        {
            throw new DocumentedException(String.format("Unexpected namespace %s should be %s",
    ...
    public void checkNamespace(String expectedNamespace) throws DocumentedException {
    ...
    public String getNamespaceAttribute() throws DocumentedException {
        String attribute = element.getAttribute(XmlUtil.XMLNS_ATTRIBUTE_KEY);
        if (attribute == null || attribute.equals(DEFAULT_NAMESPACE_PREFIX)){
            throw new DocumentedException(String.format("Element %s must specify namespace",
                    toString()),
                    DocumentedException.ErrorType.application,
                    DocumentedException.ErrorTag.operation_failed,
                    DocumentedException.ErrorSeverity.error);
    ...
    public String getNamespace() throws DocumentedException {
        Optional<String> namespaceURI = getNamespaceOptionally();
        if (!namespaceURI.isPresent()){
            throw new DocumentedException(String.format("No namespace defined for %s", this),
                    DocumentedException.ErrorType.application,
                    DocumentedException.ErrorTag.operation_failed,
                    DocumentedException.ErrorSeverity.error);
        }
    ...
    public List<XmlElement> getChildElementsWithSameNamespace(final String childName) throws DocumentedException {
