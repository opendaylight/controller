...
public class ConfigRegistryJolokiaClient extends ListableJolokiaClient implements ConfigRegistryClient {
	...
	@Override
	public ConfigTransactionJolokiaClient getConfigTransactionClient(String transactionName) {
	...
	@Override
	public ConfigTransactionJolokiaClient getConfigTransactionClient(ObjectName objectName) {
	...
	public CommitStatus commitConfig(ObjectName transactionControllerON) throws ConflictingVersionException, ValidationException {
		...
		JSONArray newInstancesArray = (JSONArray) jsonObject.get("newInstances");
		List<ObjectName> newInstances = jsonArrayToObjectNames(newInstancesArray);
		JSONArray reusedInstancesArray = (JSONArray) jsonObject.get("reusedInstances");
		List<ObjectName> reusedInstances = jsonArrayToObjectNames(reusedInstancesArray);
		JSONArray recreatedInstancesArray = (JSONArray) jsonObject.get("recreatedInstances");
	...
	public ObjectName getAttributeON(ObjectName configBeanTransactionON, String key) {
		JSONObject jsonAttrib = (JSONObject) getAttribute(configBeanTransactionON, key);
	...
	public Set<ObjectName> lookupRuntimeBeans(String moduleName, String instanceName) {
		return lookupSomething("lookupRuntimeBeans(java.lang.String,java.lang.String)", new Object[]{moduleName, instanceName});
	}
