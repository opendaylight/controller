...
import static org.opendaylight.controller.config.util.xml.XmlNetconfConstants.ERROR_INFO;
import static org.opendaylight.controller.config.util.xml.XmlNetconfConstants.ERROR_MESSAGE;
import static org.opendaylight.controller.config.util.xml.XmlNetconfConstants.ERROR_SEVERITY;
import static org.opendaylight.controller.config.util.xml.XmlNetconfConstants.ERROR_TAG;
import static org.opendaylight.controller.config.util.xml.XmlNetconfConstants.ERROR_TYPE;
import static org.opendaylight.controller.config.util.xml.XmlNetconfConstants.RPC_ERROR;
import static org.opendaylight.controller.config.util.xml.XmlNetconfConstants.RPC_REPLY_KEY;
import static org.opendaylight.controller.config.util.xml.XmlNetconfConstants.URN_IETF_PARAMS_XML_NS_NETCONF_BASE_1_0;
