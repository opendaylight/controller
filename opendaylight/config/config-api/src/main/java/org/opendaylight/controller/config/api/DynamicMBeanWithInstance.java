...
/**
 * Each {@link org.opendaylight.controller.config.spi.Module} that is committed will be wrapped into this interface.
 */
public interface DynamicMBeanWithInstance extends DynamicMBean {
	 ...
	 * reconfiguring {@link org.opendaylight.controller.config.spi.Module} instances.
	 */
