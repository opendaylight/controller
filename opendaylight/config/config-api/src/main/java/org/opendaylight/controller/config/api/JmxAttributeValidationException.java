...
/**
 * Exception that can be thrown during validation phase. This allows for pointing user to a
 * specific list of parameters that fail the validation. Note that {@link org.opendaylight.controller.config.spi.Module#validate()}
 * can throw any runtime exception to trigger validation failure.
 */
