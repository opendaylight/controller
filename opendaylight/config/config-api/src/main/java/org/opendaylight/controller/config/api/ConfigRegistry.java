...
public interface ConfigRegistry extends LookupRegistry {
	 ...
	 * @param transactionControllerON {@link ObjectName} of {@link ConfigTransactionControllerMXBean} that was received in {@link #beginConfig()} method call.
	 * @return CommitStatus
	 * @throws ValidationException if validation fails
	 * @throws ConflictingVersionException if configuration state was changed
	 */
	 ...
	 * @param moduleName of bean
	 * @param instanceName of bean
	 * @return objectNames
	 */
