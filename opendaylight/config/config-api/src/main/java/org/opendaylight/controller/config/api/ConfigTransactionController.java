...
public interface ConfigTransactionController extends LookupRegistry {
	 ...
	 * @throws InstanceAlreadyExistsException if given ifcName and instanceName is already registered
	 */
	 ...
	 * @param objectName can be either read-only module name that can be obtained using {@link ConfigRegistry#lookupConfigBean(String, String)}
	 * or writable module name that must contain current transaction name.
	 * @throws InstanceNotFoundException if module is not found
	 * @throws IllegalArgumentException if object name contains wrong transaction name or domain
	 */
