...
public interface HierarchicalRuntimeBeanRegistration extends AutoCloseable {
	...
	HierarchicalRuntimeBeanRegistration register(String key, String value, RuntimeBean mxBean);

	/**
	 * Unregister beans that were registered using this registrator and its child registrators.
	 * This method is not idempotent, it is not allowed to use this instance or child registrators after they are
	 * closed.
	 */
	@Override
	void close();
