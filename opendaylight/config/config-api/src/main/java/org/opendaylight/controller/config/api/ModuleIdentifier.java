...
public class ModuleIdentifier implements Identifier {
	...
	public ModuleIdentifier(String factoryName, String instanceName) {
		if (factoryName == null) throw new IllegalArgumentException("Parameter 'factoryName' is null");
		if (instanceName == null) throw new IllegalArgumentException("Parameter 'instanceName' is null");
	...
	public boolean equals(Object o) {
		...
		if (!factoryName.equals(that.factoryName)) return false;
