...
public class CommitStatus {
	private final List<ObjectName> newInstances, reusedInstances, recreatedInstances;
	...
	public CommitStatus(List<ObjectName> newInstances, List<ObjectName> reusedInstances,
