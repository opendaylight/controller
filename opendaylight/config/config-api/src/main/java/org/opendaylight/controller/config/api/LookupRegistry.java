...
public interface LookupRegistry {
	...
	/**
	 * Find read modules.
	 * @param moduleName exact match for searched module name, can contain '*' to match all values.
	 * @param instanceName exact match for searched instance name, can contain '*' to match all values.
	 * @return objectNames
	 */
