...
/**
 * Each new {@link org.opendaylight.controller.config.spi.Module} can receive resolver from {@link org.opendaylight.controller.config.spi.ModuleFactory}
...
public interface DependencyResolver {
	 ...
	 * @param objectName ObjectName of dependent module without transaction name (platformON).
	 * @param jmxAttribute
	 * @throws {@link IllegalArgumentException} when module is not found
	 * @throws {@link IllegalStateException} if module does not export this service interface.
	 */
	void validateDependency(Class<? extends AbstractServiceInterface> expectedServiceInterface, ObjectName objectName,
	                        JmxAttribute jmxAttribute);

	@Deprecated // TODO remove once all config code is generated
	void validateDependency(Class<? extends AbstractServiceInterface> expectedServiceInterface, ObjectName objectName,
	                        String attributeNameForErrorReporting);

	/**
	 * To be used during commit phase to wire actual dependencies.
	 * @return dependency instance using {@link org.opendaylight.controller.config.spi.Module#getInstance()}
	 * @throws {@link IllegalArgumentException} when module is not found
	 */
