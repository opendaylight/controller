...
public class YangStoreSnapshotImpl implements YangStoreSnapshot {
    ...
    private final Map<String /*Namespace from yang file*/, Map<String /*Name of module entry from yang file*/, ModuleMXBeanEntry>> moduleMXBeanEntryMap;

    private final Map<String, Entry<Module, String>> moduleMap;

    public YangStoreSnapshotImpl(Map<String, Map<String, ModuleMXBeanEntry>> moduleMXBeanEntryMap, Map<String,
		    Entry<Module, String>> moduleMap) {
    ...
    public int countModuleMXBeanEntries() {
        int i = 0;
        for (Map<String, ModuleMXBeanEntry> value : moduleMXBeanEntryMap.values()) {
            i += value.keySet().size();
        }
        return i;
    }
