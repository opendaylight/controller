...
public class Activator implements BundleActivator {
    ...
    public void start(BundleContext context) throws Exception {
        ...
        if (featureref == null) {
            ...
            logger.error("Could not get feature service reference! Please start feature service and retry this bundle.");
        }
        if (configref == null) {
            System.out.println("FeatureTracker Could not get config pusher service reference.");
            logger.error("Could not get config pusher service reference! Please start config pusher service and retry this bundle.");
        }
