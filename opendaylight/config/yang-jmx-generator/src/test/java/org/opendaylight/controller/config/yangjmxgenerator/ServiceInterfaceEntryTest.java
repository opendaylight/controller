...
public class ServiceInterfaceEntryTest extends AbstractYangTest {
	...
	public static final QName EVENTBUS_QNAME = new QName(THREADS_NAMESPACE, THREADS_REVISION_DATE, "eventbus");
	public static final QName THREADFACTORY_QNAME = new QName(THREADS_NAMESPACE, THREADS_REVISION_DATE, "threadfactory");
	public static final QName THREADPOOL_QNAME = new QName(THREADS_NAMESPACE, THREADS_REVISION_DATE, "threadpool");
	public static final QName SCHEDULED_THREADPOOL_QNAME = new QName(THREADS_NAMESPACE, THREADS_REVISION_DATE, "scheduled-threadpool");
	public static final QName SCHEDULED_EXECUTOR_SERVICE_QNAME = new QName(THREADS_NAMESPACE, THREADS_REVISION_DATE,
	...
	public void testCreateFromIdentities() {
		...
		Map<QName, ServiceInterfaceEntry> namesToSIEntries = ServiceInterfaceEntry.create(threadsModule, PACKAGE_NAME);
		// expected eventbus, threadfactory, threadpool, scheduled-threadpool,thread-rpc-context
		assertThat(namesToSIEntries.size(), is(
				expectedSIEFileNames.size()));

		Set<QName> withNoBaseType = Sets.newHashSet(EVENTBUS_QNAME, THREADFACTORY_QNAME, THREADPOOL_QNAME,
