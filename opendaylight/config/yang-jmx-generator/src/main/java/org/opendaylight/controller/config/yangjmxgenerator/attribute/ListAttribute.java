...
public class ListAttribute extends AbstractAttribute {
	...
	public static ListAttribute create(ListSchemaNode node, TypeProviderWrapper typeProvider) {
	...
	ListAttribute(DataSchemaNode attrNode, AttributeIfc innerAttribute, String description) {
		super(attrNode);
	...
	public String toString() {
		return "ListAttribute{" + getAttributeYangName() + "," + "to=" + innerAttribute + '}';
	}
