...
public class DependencyAttribute extends AbstractAttribute implements TypedAttribute {

	private final Dependency dependency;
	private final String nullableDescription, nullableDefault;


	public DependencyAttribute(DataSchemaNode attrNode, ServiceInterfaceEntry sie, boolean mandatory,
	...
	public boolean equals(Object o) {
		...
		if (nullableDefault != null ? !nullableDefault.equals(that.nullableDefault) : that.nullableDefault != null)
			return false;
		if (nullableDescription != null ? !nullableDescription.equals(that.nullableDescription) : that
	...
	public static class Dependency {
		...
		public boolean equals(Object o) {
			...
			if (!sie.equals(that.sie)) return false;
