...
public abstract class AbstractAttribute implements AttributeIfc {
	private final String attributeYangName, upperCaseCammelCase, lowerCaseCammelCase;
	...
	public boolean equals(Object o) {
		...
		if (attributeYangName != null ? !attributeYangName.equals(that.attributeYangName) : that.attributeYangName !=
				null)
			return false;
	...
	/**
	 *
	 * @return Yang name converted to cammel case, starting with a capital letter. For details see
