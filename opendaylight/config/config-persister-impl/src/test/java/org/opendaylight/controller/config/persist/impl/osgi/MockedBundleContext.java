...
import org.opendaylight.controller.config.persist.impl.DummyAdapter;
...
//        doReturn(innerFilterString).when(outerFilter).toString();
        ...
        //TODO fix this we do we even need innerFilter now?
...
//        doNothing().when(context).addServiceListener(any(ServiceListener.class), eq(innerFilterString));
        ...
        doReturn(toBeReturned).when(context).getServiceReferences(any(String.class), any(String.class));
//        doReturn(FilterImpl.newInstance("(" + Constants.OBJECTCLASS + "=" + SchemaContextProvider.class.toString() + ")"))
//                .when(context).createFilter(any(String.class));
        doNothing().when(context).addServiceListener(any(ServiceListener.class), any(String.class));
        ...
        doReturn(schemaContextProvider).when(context).getService(any(ServiceReference.class));
