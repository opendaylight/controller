...
import org.opendaylight.controller.config.persist.impl.osgi.MockedBundleContext.DummyAdapterWithInitialSnapshot;
...
public class ConfigPersisterTest {
    ...
    //TODO rewrite tests without NetconfOperationFactory
    @Test
    @Ignore
