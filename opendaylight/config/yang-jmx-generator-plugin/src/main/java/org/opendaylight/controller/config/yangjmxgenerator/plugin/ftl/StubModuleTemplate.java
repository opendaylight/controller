...
public class StubModuleTemplate extends GeneralClassTemplate {
	...
	public StubModuleTemplate(Header header, String packageName, String stubModuleName, String extendedClass) {
		super(header, packageName, stubModuleName, Lists.newArrayList(extendedClass), Collections.<String> emptyList(),
				Collections.<Field> emptyList(), Collections.<MethodDefinition> emptyList(), false, true, Collections
