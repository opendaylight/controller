...
public class StubFactoryTemplate extends GeneralClassTemplate {
	...
	public StubFactoryTemplate(Header header, String packageName, String name, String extendedClass,
			String moduleInstanceType) {
		super(header, packageName, name, Lists.newArrayList(extendedClass), Collections.<String> emptyList(),
				Collections.<Field> emptyList(), Collections.<MethodDefinition> emptyList());
