	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body)
		...
		if (object != null) {
			if (object instanceof SimpleSequence)
				...
				throw new IllegalArgumentException("Object must be a SimpleSequence or instance of "
						+ AbstractModuleTemplate.class + "but was " + object.getClass());
		}
		...
		for (ModuleField field : fields) {
			build.append("\t");
			build.append("protected final " + JmxAttribute.class.getCanonicalName() + " " + field.getName()
					+ "JmxAttribute = new " + JmxAttribute.class.getCanonicalName() + "(\"" + field.getAttributeName()
					+ "\");");
			...
			if (field.isDependent()) {
				String comment = field.getDependency().isMandatory() ? "mandatory" : "optional";
