...
public class MethodDefinition implements Method {
	...
	public MethodDefinition(String returnType, String name, List<Field> parameters, String body) {
		this(Collections.<String> emptyList(), returnType, name, parameters, Collections.<String> emptyList(),
				Collections.<Annotation> emptyList(), body);
	}

	public MethodDefinition(String returnType, String name, List<Field> parameters, List<Annotation> annotations,
			String body) {
		this(Collections.<String> emptyList(), returnType, name, parameters, Collections.<String> emptyList(),
				annotations, body);
	}

	public MethodDefinition(List<String> modifiers, String returnType, String name, List<Field> parameters,
