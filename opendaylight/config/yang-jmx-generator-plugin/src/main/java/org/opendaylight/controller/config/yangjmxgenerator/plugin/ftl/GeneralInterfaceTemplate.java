...
public class GeneralInterfaceTemplate extends AbstractFtlTemplate {
	...
	public GeneralInterfaceTemplate(Header header, String packageName, String name, List<String> extendedInterfaces,
			List<MethodDeclaration> methods) {
		super(header, packageName, Collections.<Field> emptyList(), methods, new TypeDeclaration("interface", name,
				extendedInterfaces, Collections.<String> emptyList()));
	}
}
