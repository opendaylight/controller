...
public class JavadocDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body)
		...
		if (object != null) {
			if (object instanceof SimpleScalar)
				...
				throw new IllegalArgumentException("Object must be a String or instance of " + FtlTemplate.class
	...
	static void writeJavadoc(StringBuilder build, String javadoc, String linePrefix) {
