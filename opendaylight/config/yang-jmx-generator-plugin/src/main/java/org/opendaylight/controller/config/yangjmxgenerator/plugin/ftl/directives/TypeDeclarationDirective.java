...
public class TypeDeclarationDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body)
		...
		Preconditions.checkArgument(object instanceof TypeDeclaration, "Type declaration should be instance of "
				+ TypeDeclaration.class + " but was " + object.getClass());
	...
	private void generateExtendOrImplement(StringBuilder build, String prefix, Collection<String> elements) {
		if (elements.isEmpty())
			return;
