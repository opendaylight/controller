...
public class AbstractModuleTemplate extends GeneralClassTemplate {
	...
	public AbstractModuleTemplate(Header header, String packageName, String abstractModuleName,
			List<String> implementedIfcs, List<ModuleField> moduleFields, List<MethodDefinition> methods, boolean isRuntime, String registratorType) {
		super(header, packageName, abstractModuleName, Collections.<String> emptyList(), implementedIfcs, Collections.<Field> emptyList(), methods, true, false, Collections.<Constructor> emptyList());
