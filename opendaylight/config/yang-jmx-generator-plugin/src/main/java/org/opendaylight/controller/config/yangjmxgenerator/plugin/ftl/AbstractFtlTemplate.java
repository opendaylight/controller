...
public abstract class AbstractFtlTemplate implements FtlTemplate {
	...
	protected AbstractFtlTemplate(Header header, String packageName, List<Field> fields,
			List<? extends Method> methods, TypeDeclaration typeDeclaration) {
	...
	public File getRelativeFile() {
		return new File(packageName.replace(".", File.separator), getTypeDeclaration().getName() + ".java");
	}
