...
public class ModuleField extends Field {
	...
	public ModuleField(List<String> modifiers, String type, String name, String attributeName, String nullableDefault,
			boolean isDependency, Dependency dependency) {
