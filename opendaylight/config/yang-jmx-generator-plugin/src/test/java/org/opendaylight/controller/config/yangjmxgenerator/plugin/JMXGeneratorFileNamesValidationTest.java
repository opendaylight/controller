...
public class JMXGeneratorFileNamesValidationTest extends JMXGeneratorTest {
    ...
    public void test() {
        map.clear();
        map.put(JMXGenerator.NAMESPACE_TO_PACKAGE_PREFIX + "1", ConfigConstants.CONFIG_NAMESPACE + ":test:files1"
                + JMXGenerator.NAMESPACE_TO_PACKAGE_DIVIDER + PackageTranslatorTest.EXPECTED_PACKAGE_PREFIX);
        map.put(JMXGenerator.NAMESPACE_TO_PACKAGE_PREFIX + "2", ConfigConstants.CONFIG_NAMESPACE + ":test:files"
                + JMXGenerator.NAMESPACE_TO_PACKAGE_DIVIDER + PackageTranslatorTest.EXPECTED_PACKAGE_PREFIX);
        ...
        try {
            ...
            assertThat(cause.getMessage(), containsString("Name conflict in generated files"));
