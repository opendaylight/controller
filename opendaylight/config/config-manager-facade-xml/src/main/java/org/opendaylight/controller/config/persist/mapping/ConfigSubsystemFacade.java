 ...
 * <p/>
 * TODO extract generic interface for config subsystem
 */
public class ConfigSubsystemFacade implements Closeable {
    ...
    public Element get(Document document) throws DocumentedException {
        ...
        try {
            ...
            final org.opendaylight.controller.config.persist.mapping.runtime.Runtime runtime = new Runtime(moduleRuntimes, moduleConfigs);
