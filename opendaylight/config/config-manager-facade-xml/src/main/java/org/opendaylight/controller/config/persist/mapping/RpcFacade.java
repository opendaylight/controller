...
public class RpcFacade {
    ...
    public Object executeOperation(final NetconfOperationExecution execution) {
    ...
    public Element toXml(Document doc, Object result, NetconfOperationExecution execution) throws DocumentedException {
    ...
    public class NetconfOperationExecution {
