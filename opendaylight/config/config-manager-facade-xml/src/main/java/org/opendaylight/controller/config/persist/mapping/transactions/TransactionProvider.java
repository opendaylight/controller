...
package org.opendaylight.controller.config.persist.mapping.transactions;
...
public class TransactionProvider implements AutoCloseable {
     ...
     */
    public CommitStatus commitTransaction() throws ValidationException, ConflictingVersionException, NoTransactionFoundException {
