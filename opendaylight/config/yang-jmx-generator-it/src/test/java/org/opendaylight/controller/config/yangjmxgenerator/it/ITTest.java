...
// Do not know how to make a org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.inet.types.rev2010924.AsNumber from a CompositeData: no method from(CompositeData); no constructor has @ConstructorProperties annotation; does not have a public no-arg constructor; not an interface
public class ITTest extends AbstractConfigTest {
	...
	private ObjectName createModule(ConfigTransactionJMXClient transaction, String instanceName)
			throws InstanceAlreadyExistsException {
		ObjectName nameCreated = transaction.createModule(factory.getImplementationName(), instanceName);
		TestImplModuleMXBean mxBean = transaction.newMBeanProxy(nameCreated, TestImplModuleMXBean.class);
