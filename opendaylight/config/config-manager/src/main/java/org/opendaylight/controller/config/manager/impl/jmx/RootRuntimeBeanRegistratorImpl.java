...
public class RootRuntimeBeanRegistratorImpl implements RootRuntimeBeanRegistrator {
	...
	public RootRuntimeBeanRegistratorImpl(InternalJMXRegistrator internalJMXRegistrator,
	...
	public HierarchicalRuntimeBeanRegistrationImpl registerRoot(RuntimeBean mxBean) {
		...
		return new HierarchicalRuntimeBeanRegistrationImpl(moduleIdentifier, internalJMXRegistrator, Collections.<String,
				String>emptyMap());
	}
	...
	static IllegalStateException sanitize(InstanceAlreadyExistsException e, ModuleIdentifier moduleIdentifier,
	                                      ObjectName on) {
		throw new IllegalStateException("Could not register runtime bean in " + moduleIdentifier + " under name " +
				on, e);
