...
/**
 * Structure obtained during first phase commit, contains destroyed modules from previous transactions that need to
 * be closed and all committed modules with meta data.
 */
@Immutable
public class CommitInfo {
	...
	/**
	 * Get ordered list of modules that can be closed in the same order, i.e. first element will be a leaf on which
	 * no other module depends, n-th element can only have dependencies with index smaller than n.
	 */
