...
public class InterfacesHelper {
	...
	/**
	 * Get all implemented interfaces that have {@link org.opendaylight.controller.config.api.annotations.ServiceInterfaceAnnotation} annotation.
	 */
	...
	/**
	 * Get OSGi registration types under which config bean instance should be registered. This is specified
	 * in {@link org.opendaylight.controller.config.api.annotations.ServiceInterfaceAnnotation#osgiRegistrationType()}
	 */
