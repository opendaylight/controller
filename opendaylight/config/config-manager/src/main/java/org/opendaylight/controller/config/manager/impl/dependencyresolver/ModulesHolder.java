...
class ModulesHolder implements TransactionHolder {
	...
	public CommitInfo toCommitInfo() {
		List<DestroyedModule> orderedDestroyedFromPreviousTransactions = new ArrayList<>(unorderedDestroyedFromPreviousTransactions.size());
	...
	private ModuleInternalTransactionalInfo findModuleInternalTransactionalInfo(ModuleIdentifier moduleIdentifier,
		...
		JmxAttributeValidationException.checkNotNull(moduleInternalTransactionalInfo, "Module " + moduleIdentifier + "" +
				" not found in transaction " +
				transactionName, jmxAttributeForReporting);
	...
	public Module findModule(ModuleIdentifier moduleIdentifier, JmxAttribute jmxAttributeForReporting){
		return findModuleInternalTransactionalInfo(moduleIdentifier, jmxAttributeForReporting).getModule();
	}
	...
	public void put(ModuleInternalTransactionalInfo moduleInternalTransactionalInfo) {
		commitMap.put(moduleInternalTransactionalInfo.getName(), moduleInternalTransactionalInfo);
	}
