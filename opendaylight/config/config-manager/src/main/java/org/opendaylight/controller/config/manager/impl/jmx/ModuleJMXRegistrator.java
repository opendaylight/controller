 ...
 * used as underlying provider in
 * {@link RuntimeBeanRegistratorImpl}.
 * Closing the instance thus unregisters all JMX beans related to the module
 * excluding currently open transactions.
 */
@ThreadSafe
public class ModuleJMXRegistrator implements Closeable {
	...
	public ModuleJMXRegistration registerMBean(Object object, ObjectName on) throws InstanceAlreadyExistsException {
		...
		return new ModuleJMXRegistration(childJMXRegistrator.registerMBean(object, on));
	}
