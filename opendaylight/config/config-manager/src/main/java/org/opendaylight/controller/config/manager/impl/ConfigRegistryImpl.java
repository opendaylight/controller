...
public class ConfigRegistryImpl implements AutoCloseable, ConfigRegistryImplMXBean {
    ...
    private CommitStatus commitConfigSafe(final ObjectName transactionControllerON)
        ...
        Entry<ConfigTransactionControllerInternal, ConfigTransactionLookupRegistry> configTransactionControllerEntry = transactions
                .get(transactionName);
    ...
    class TransactionsHolder {
         ...
         */
        private final ConcurrentMap<String /* transactionName */, Entry<ConfigTransactionControllerInternal, ConfigTransactionLookupRegistry>> transactions = new ConcurrentHashMap<>();
