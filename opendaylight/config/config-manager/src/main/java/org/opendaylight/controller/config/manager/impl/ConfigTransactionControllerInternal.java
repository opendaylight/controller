...
interface ConfigTransactionControllerInternal extends ConfigTransactionControllerImplMXBean, AutoCloseable {
     ...
     * .ModuleFactory#getDefaultModules(org.opendaylight.controller.config
     * .api.DependencyResolverFactory, BundleContext)}
     ...
     * @return CommitInfo
     * @throws {@link
     *             RuntimeException} if validation fails. It is safe to run this
     *             method in future
     */
