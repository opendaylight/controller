...
class AnnotationsHelper {
	...
	/**
	 * Look for annotation specified by annotationType on method. First observe method's class, then its super classes, then
	 * all provided interfaces. Used for finding @Description and @RequireInterface
	 * @param <T> generic type of annotation
	 * @return list of found annotations
	 */
	static <T extends Annotation> List<T> findMethodAnnotationInSuperClassesAndIfcs(final Method setter, Class<T> annotationType,
	...
	/**
	 * Look for annotation specified by annotationType on type. First observe class clazz, then its super classes, then
	 * all exported interfaces with their super types. Used for finding @Description of modules.
	 * @return list of found annotations
	 */
	static <T extends Annotation> List<T> findClassAnnotationInSuperClassesAndIfcs(Class<?> clazz,
