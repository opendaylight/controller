...
public class HierarchicalRuntimeBeanRegistrationImpl implements HierarchicalRuntimeBeanRegistration {
	...
	public HierarchicalRuntimeBeanRegistrationImpl(ModuleIdentifier moduleIdentifier, InternalJMXRegistrator
			internalJMXRegistrator, Map<String, String> properties) {
	...
	public ObjectName getObjectName() {
		return ObjectNameUtil.createRuntimeBeanName(moduleIdentifier.getFactoryName(),
	...
	public HierarchicalRuntimeBeanRegistrationImpl register(String key, String value, RuntimeBean mxBean) {
		...
		ObjectName on = ObjectNameUtil.createRuntimeBeanName(moduleIdentifier.getFactoryName(),
