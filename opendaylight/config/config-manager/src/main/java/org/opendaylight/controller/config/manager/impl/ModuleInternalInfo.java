 ...
 */
public class ModuleInternalInfo implements NamedObject<ModuleIdentifier>, Comparable<ModuleInternalInfo> {

	private final ModuleIdentifier name;
	// this registrator is passed to runtime bean registrator and config registry to register read only module.
	...
	public ModuleInternalInfo(ModuleIdentifier name, @Nullable DynamicReadableWrapper readableModule,
	                          OsgiRegistration osgiRegistration, RootRuntimeBeanRegistratorImpl runtimeBeanRegistrator,
	...
	public DestroyedModule toDestroyedModule() {
		return new DestroyedModule(getName(), getReadableModule().getInstance(), getModuleJMXRegistrator(),
