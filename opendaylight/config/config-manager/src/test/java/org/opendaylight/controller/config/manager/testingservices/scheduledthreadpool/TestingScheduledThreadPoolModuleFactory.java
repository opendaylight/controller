...
public class TestingScheduledThreadPoolModuleFactory implements ModuleFactory {
    ...
    private static List<Class<? extends TestingThreadPoolServiceInterface>> ifc = Arrays.asList(TestingScheduledThreadPoolServiceInterface.class, TestingThreadPoolServiceInterface.class);
	...
	public Module createModule(String instanceName, DependencyResolver dependencyResolver,
		...
		TestingScheduledThreadPoolModule configBean = new TestingScheduledThreadPoolModule(new ModuleIdentifier(NAME, instanceName),
