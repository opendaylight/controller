...
public class AnnotationsTest {
	...
	private void assertRequireInterfaceAnnotationHasCorrectValue(Class<?> clazz, String methodName,
	...
	public void testFindAnnotation_directly() throws Exception {
		assertRequireInterfaceAnnotationHasCorrectValue(SuperClass.class, setSomethingString, emptySetOfInterfaces(), SimpleSI.class);
	...
	public void testFindAnnotation_subclassWithout() throws Exception {
		assertRequireInterfaceAnnotationHasCorrectValue(SubClassWithout.class, setSomethingString, emptySetOfInterfaces(), SimpleSI.class);
	...
	public void testOverridingWithoutAnnotation() throws Exception {
		assertRequireInterfaceAnnotationHasCorrectValue(SubClassWithEmptyMethod.class, setSomethingString, emptySetOfInterfaces(), SimpleSI.class);
	...
	public void testFindAnnotation_SubClassWithAnnotation() throws Exception {
		...
		try {
			assertRequireInterfaceAnnotationHasCorrectValue(SubClassWithAnnotation.class, setSomethingString, emptySetOfInterfaces(), SubSI2.class);
			fail();
		} catch(IllegalStateException e) {
			assertTrue(e.getMessage(), e.getMessage().startsWith("Error finding @RequireInterface. More than one value specified"));
		}
	}
	...
	public void testFindAnnotation_SubClassWithoutMethodWithInterface() throws Exception {
		assertRequireInterfaceAnnotationHasCorrectValue(SubClassWithoutMethodWithInterface.class, setSomethingString, emptySetOfInterfaces(), SimpleSI.class);
		assertDescription(SubClassWithoutMethodWithInterface.class, setSomethingString, emptySetOfInterfaces(), "descr");
	}
	...
	public void testFindAnnotation_SubClassOfSuperClassWithInterface() throws Exception {
		assertRequireInterfaceAnnotationHasCorrectValue(SubClassOfSuperClassWithInterface.class, setSomethingString, emptySetOfInterfaces(), SubSI2.class);
	...
	public void testHasSomeMethodWithAnnotationsImpl() {
		...
		assertDescription(HasSomeMethodWithAnnotationsImpl.class, setSomethingString,
				exportedInterfaces, "descr");

		assertDescriptionOnClass(HasSomeMethodWithAnnotationsImpl.class,
				new HashSet<Class<?>>(Arrays.asList(HasSomeMethodWithAnnotations.class)), "class");
	}
