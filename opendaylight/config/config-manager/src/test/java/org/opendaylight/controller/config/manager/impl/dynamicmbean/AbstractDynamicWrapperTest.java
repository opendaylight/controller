...
public abstract class AbstractDynamicWrapperTest extends AbstractLockedPlatformMBeanServerTest {
	...
	public void registerToJMX() throws Exception {
		...
		AbstractDynamicWrapper dynamicWrapper = getDynamicWrapper(threadPoolConfigBean, moduleIdentifier);
	...
	public void testReadAttributes() throws Exception {
		...
		AttributeList attributes = proxy.getAttributes(new String[] { THREAD_COUNT,
				TRIGGER_NEW_INSTANCE_CREATION });
