...
public class DependencyResolverManagerTest {
	...
	final ModuleIdentifier apspName = new ModuleIdentifier("apsp", "apsp"); // depends on:
	...
	public void testOrdering(){
		...
		DependencyResolverImpl threadPoolDRI = tested.getOrCreate(threadPoolName);
	...
	/**
	 * Simulate dependentResolver resolving its dependency identified by dependentName.
	 */
