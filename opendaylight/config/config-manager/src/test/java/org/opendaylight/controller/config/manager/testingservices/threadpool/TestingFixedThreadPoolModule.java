...
@NotThreadSafe
public class TestingFixedThreadPoolModule implements TestingFixedThreadPoolConfigMXBean, Module,
	...
	TestingFixedThreadPoolModule(ModuleIdentifier name, @Nullable AutoCloseable oldCloseable,
	...
	public Closeable getInstance() {
		if (instance == null) {
			if (isReusable() && triggerNewInstanceCreation == false) { // simulate big change using triggerNewInstanceCreation
				...
				instance = new TestingFixedThreadPool(threadCount, name.toString());
			}
		}
		return instance;
	}
