...
public class ConfigTransactionControllerImplTest extends AbstractLockedPlatformMBeanServerTest {
	...
	private static final ObjectName name1 = ObjectNameUtil.createTransactionModuleON(transactionName123,
			moduleName124, instanceName134);
	private static final ObjectName name2 = ObjectNameUtil.createTransactionModuleON(transactionName123,
			moduleName124, instanceName2);
	private static final ObjectName name3 = ObjectNameUtil.createTransactionModuleON(transactionName123, moduleName3,
			instanceName134);
	private static final ObjectName name4 = ObjectNameUtil.createTransactionModuleON(transactionName4, moduleName124,
			instanceName134);
	...
	public void setUp() throws Exception {
		...
		TransactionJMXRegistrator jmxRegistrator123 = baseJMXRegistrator.createTransactionJMXRegistrator
				(transactionName123);

		testedTxController = new ConfigTransactionControllerImpl(transactionName123,
				jmxRegistrator123, 1, 1, currentlyRegisteredFactories, transactionsMBeanServer, ManagementFactory.getPlatformMBeanServer());
		...
		TransactionJMXRegistrator jmxRegistrator4 = baseJMXRegistrator.createTransactionJMXRegistrator
				(transactionName4);
	...
	public void testLookupConfigBeansWithModuleName() {
		Set<ObjectName> beans = testedTxController.lookupConfigBeans(moduleName124);
		assertEquals(Sets.newHashSet(name1, name2), beans);
	}

	@Test
	public void lookupConfigBeansWithModuleNameAndImplName() throws Exception {
		Set<ObjectName> beans = testedTxController.lookupConfigBeans(moduleName124, instanceName134);
