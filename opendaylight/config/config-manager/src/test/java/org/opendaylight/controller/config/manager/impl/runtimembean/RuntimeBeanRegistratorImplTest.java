...
public class RuntimeBeanRegistratorImplTest extends AbstractLockedPlatformMBeanServerTest {
	...
	private HierarchicalRuntimeBeanRegistrationImpl createRoot() throws Exception {
		...
		ObjectName expectedON1 = ObjectNameUtil.createRuntimeBeanName(module1, INSTANCE_NAME, Maps.<String,
				String>newHashMap());
	...
	private HierarchicalRuntimeBeanRegistration createAdditional(HierarchicalRuntimeBeanRegistrationImpl
			                                                             rootRegistration) throws Exception {
