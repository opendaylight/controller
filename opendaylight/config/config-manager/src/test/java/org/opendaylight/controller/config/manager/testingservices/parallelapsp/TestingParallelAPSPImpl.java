...
public class TestingParallelAPSPImpl implements TestingAPSP, Closeable {
	...
	public TestingParallelAPSPImpl(TestingThreadPoolIfc threadPool, String someParam) {
		checkArgument(threadPool.getMaxNumberOfThreads() >= MINIMAL_NUMBER_OF_THREADS, "Parameter 'threadPool' has not enough threads");
		checkArgument(Strings.isNullOrEmpty(someParam)==false, "Parameter 'someParam' is blank");
