...
/**
 * This class has two exported interfaces and two runtime beans. Recreation is triggered by setting Recreate attribute to true.
 */
public class TestingScheduledThreadPoolModule implements Module,
		TestingScheduledThreadPoolConfigBeanMXBean, RuntimeBeanRegistratorAwareModule, TestingScheduledThreadPoolServiceInterface {
	...
	public TestingScheduledThreadPoolModule(ModuleIdentifier name, @Nullable AutoCloseable oldCloseable,
