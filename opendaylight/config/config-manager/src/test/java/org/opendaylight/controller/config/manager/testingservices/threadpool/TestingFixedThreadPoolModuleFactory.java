...
public class TestingFixedThreadPoolModuleFactory implements ModuleFactory {
    ...
    private static List<Class<? extends TestingThreadPoolServiceInterface>> ifc = Arrays.asList(ModifiableThreadPoolServiceInterface.class, TestingThreadPoolServiceInterface.class);
	...
	@Override
	public TestingFixedThreadPoolModule createModule(String instanceName, DependencyResolver dependencyResolver) {
