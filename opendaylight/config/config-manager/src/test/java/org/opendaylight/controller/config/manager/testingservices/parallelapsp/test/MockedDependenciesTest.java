...
public class MockedDependenciesTest extends AbstractParallelAPSPTest {
	...
	public void setUp() {
		...
		super.initConfigTransactionManagerImpl(new HardcodedModuleFactoriesResolver(
				new TestingParallelAPSPModuleFactory(), mockedThreadPoolConfigFactory));
	}

	public static interface MockedTestingThreadPoolConfigMXBean extends TestingThreadPoolConfigMXBean {
	...
	public static class MockedThreadPoolModule implements Module, MockedTestingThreadPoolConfigMXBean , TestingThreadPoolServiceInterface {
		...
		public MockedThreadPoolModule(DynamicMBeanWithInstance dynamicMBeanWithInstance) {
