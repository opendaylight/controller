...
public class ConfigRegistryImplLookupTest extends AbstractLockedPlatformMBeanServerTest {
	...
	private static final ObjectName name5 = ObjectNameUtil.createRuntimeBeanName(moduleNameA, instanceNameA, Collections.<String, String>emptyMap());
	private static final ObjectName name6 = ObjectNameUtil.createRuntimeBeanName(moduleNameA, instanceNameB, Collections.<String, String>emptyMap());
	private static final ObjectName name8 = ObjectNameUtil.createRuntimeBeanName(moduleNameB, instanceNameA, Collections.<String, String>emptyMap());

	private static final ObjectName name9 = ObjectNameUtil.createTransactionModuleON("transaction", moduleNameA,
			instanceNameA);

	@Before
	public void setUp() throws Exception {
		configRegistryImpl = new ConfigRegistryImpl(null, null, ManagementFactory.getPlatformMBeanServer());
	...
	private void registerModuleBean(TestingRuntimeBean testingRuntimeBean, BaseJMXRegistrator baseJMXRegistrator,
	...
	private void registerRuntimeBean(RuntimeBean object, BaseJMXRegistrator baseJMXRegistrator,
	                                 ObjectName runtimeON) throws InstanceAlreadyExistsException {
		...
		RootRuntimeBeanRegistratorImpl runtimeBeanRegistrator = baseJMXRegistrator.createRuntimeBeanRegistrator(new
				ModuleIdentifier(factoryName, instanceName));
	...
	public void testLookupConfigBeanWithModuleName() throws Exception {
		Set<ObjectName> bean = configRegistryImpl.lookupConfigBeans(moduleNameA);
	...
	public void testLookupConfigBeanWithModuleNameAndInstanceName() throws Exception {
		Set<ObjectName> bean = configRegistryImpl.lookupConfigBeans(moduleNameA, instanceNameA);
	...
	public void testLookupRuntimeBeansWithIFcNameAndImplName() throws Exception {
		Set<ObjectName> beans = configRegistryImpl.lookupRuntimeBeans(moduleNameA, instanceNameA);
