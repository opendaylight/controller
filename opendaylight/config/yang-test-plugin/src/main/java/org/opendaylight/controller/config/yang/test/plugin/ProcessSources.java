    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        for (File sourceFile: sourceFiles) {
            if (sourceFile.getName().endsWith(".java")) {
                ...
                try {
                    sourceContent = Files.toString(sourceFile, Charset.defaultCharset());
                } catch (IOException e) {
                ...
                if (sourceFile.getName().endsWith("Module.java") || sourceFile.getName().endsWith("ModuleFactory.java")) {
                    ...
                    if (stubFile.exists()) {
                        ...
                        try {
                            stubContent = Files.toString(stubFile, Charset.defaultCharset());
                        } catch (IOException e) {
                ...
                try {
                    Files.write(sourceContent, sourceFile, Charset.defaultCharset());
                } catch (IOException e) {
