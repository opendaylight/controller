...
public abstract class AbstractNetconfSession extends AbstractProtocolSession<NetconfMessage> implements NetconfSession {
    ...
    protected AbstractNetconfSession(SessionListener<NetconfMessage, NetconfSession, NetconfTerminationReason> sessionListener, Channel channel, long sessionId) {
