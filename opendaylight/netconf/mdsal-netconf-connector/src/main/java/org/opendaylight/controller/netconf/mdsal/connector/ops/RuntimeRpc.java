...
public class RuntimeRpc extends AbstractSingletonNetconfOperation {
    ...
    public HandlingPriority canHandle(final Document message) throws NetconfDocumentedException {
        final XmlElement operationElement = getRequestElementWithCheck(message).getOnlyChildElement();
        return canHandle(operationElement.getName(), operationElement.getNamespace());
    }
    ...
    protected HandlingPriority canHandle(final String netconfOperationName, final String namespace) {
        ...
        try {
            ...
            LOG.debug("Cannot handle rpc: {}, {}", netconfOperationName, namespace, e);
        }
    ...
    private URI createNsUri(final String namespace) throws NetconfDocumentedException {
    ...
    private Module getModule(final URI namespaceURI) throws NetconfDocumentedException {
    ...
    protected Element handleWithNoSubsequentOperations(final Document document, final XmlElement operationElement) throws NetconfDocumentedException {
        ...
        final RpcDefinition rpcDefinition = getRpcDefinitionFromModule(module, namespaceURI, netconfOperationName);
