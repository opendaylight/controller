...
public class IOUtil {
    ...
    protected static final String PROMPT_PREFIX = "netconf-client";
    protected static final String PROMPT_SUFIX = ">";
    ...
    public static QName qNameFromKeyString(final String qName) {
        ...
        return new QName(URI.create(matcher.group(2)), parseDate(matcher.group(3) + "-" + matcher.group(4) + "-" + matcher.group(5)), matcher.group(1));
    }
