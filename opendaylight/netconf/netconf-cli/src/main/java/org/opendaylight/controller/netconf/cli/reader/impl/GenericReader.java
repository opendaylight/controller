...
public class GenericReader extends AbstractReader<DataSchemaNode> {
    ...
    public GenericReader(ConsoleIO console) {
        super(console);
    }
    ...
    protected List<Node<?>> readInner(final DataSchemaNode schemaNode) throws IOException, ReadingException {
        ...
        if (schemaNode instanceof LeafSchemaNode) {
            ...
            return new GenericListReader<>(console, new ListEntryReader(console))
    ...
    public List<Node<?>> read(Iterable<DataSchemaNode> nodes) throws ReadingException {
        List<Node<?>> newNodes = new ArrayList<>();
        for (DataSchemaNode schemaNode : nodes) {
    ...
    @Override
    protected ConsoleContext getContext(DataSchemaNode schemaNode) {
