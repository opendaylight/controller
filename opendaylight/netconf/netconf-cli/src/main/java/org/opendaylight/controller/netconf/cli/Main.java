...
public class Main {
    ...
    public static void main(final String[] args) {
        ...
        final CommandArgHandlerRegistry argumentHandlerRegistry = new CommandArgHandlerRegistry(consoleIO, schemaContextRegistry);
        final NetconfDeviceConnectionManager connectionManager = new NetconfDeviceConnectionManager(commandDispatcher, argumentHandlerRegistry, schemaContextRegistry);

        commandDispatcher.addLocalCommands(connectionManager, localSchema);
