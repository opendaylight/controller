...
public class Main {
    ...
    public static void main(final String[] args) {
        ...
        final NetconfDevice device = NetconfDevice.createNetconfDevice(deviceId, getGlobalNetconfSchemaProvider(), executor,
                handler);
    ...
    private static NetconfReconnectingClientConfiguration getClientConfig(final Namespace ns,
        ...
        try {
            // FIXME
            socketAddress = new InetSocketAddress(InetAddress.getByName(ns.getString("server")), Integer.valueOf(ns.getString("port")));
