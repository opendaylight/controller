...
public class CommandDispatcher {
     ...
     * @return
     */
    public static CommandDispatcher fromSchemas(final RpcImplementation rpcInvoker, final SchemaContext localCommandsSchema,
        ...
        for (final SchemaContext context : schemaContexts) {
            for (final Module module : context.getModules()) {
                for (final RpcDefinition rpcDefinition : module.getRpcs()) {
                    ...
                    commands.put(rpcDefinition.getQName(), RemoteCommand.fromRpc(rpcDefinition, rpcInvoker));
                }
            }
        }
