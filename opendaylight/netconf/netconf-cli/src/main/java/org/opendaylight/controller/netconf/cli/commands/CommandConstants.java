...
public class CommandConstants {
    ...
    public static final QName CLOSE_QNAME = new QName(HELP_QNAME, "close");
    public static final QName CONNECT_QNAME = new QName(HELP_QNAME, "connect");
    public static final QName DISCONNECT_QNAME = new QName(CONNECT_QNAME, "disconnect");

    public static final QName ARG_HANDLER_EXT_QNAME = new QName(
