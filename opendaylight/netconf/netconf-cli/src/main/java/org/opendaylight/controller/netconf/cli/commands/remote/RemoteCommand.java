...
public class RemoteCommand extends AbstractCommand {
    ...
    public RemoteCommand(final QName qName, final InputDefinition args, final OutputDefinition output, final RpcImplementation rpc) {
    ...
    public static Command fromRpc(final RpcDefinition rpcDefinition, final RpcImplementation rpcInvoker) {
        ...
        return new RemoteCommand(rpcDefinition.getQName(), args, retVal, rpcInvoker);
    }
}
