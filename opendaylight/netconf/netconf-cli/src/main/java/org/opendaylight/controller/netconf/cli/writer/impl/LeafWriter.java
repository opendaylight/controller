...
public class LeafWriter extends AbstractWriter<LeafSchemaNode> {
    ...
    public LeafWriter(ConsoleIO console, String indent) {
        super(console, indent);
    }

    @Override
    public void writeInner(LeafSchemaNode leafSchemaNode, List<Node<?>> dataNode) throws WriteException, IOException {
