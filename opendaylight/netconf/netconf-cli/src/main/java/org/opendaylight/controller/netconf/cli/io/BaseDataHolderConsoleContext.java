...
public class BaseDataHolderConsoleContext extends BaseConsoleContext {
    ...
    public Completer getCompleter() {
        ...
        if (dataType instanceof EnumerationType) {
            Collection<String> completerNames = new ArrayList<>();
            for (EnumPair enumPair : ((EnumerationType) dataType).getValues()) {
