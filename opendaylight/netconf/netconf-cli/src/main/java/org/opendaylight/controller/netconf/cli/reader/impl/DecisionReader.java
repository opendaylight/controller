...
public class DecisionReader {
    ...
    // FIXME why is this reader static ?
    public static boolean read(final ConsoleIO console, final String questionMessage) throws IOException {
        final ConsoleContext ctx = getContext();
        console.enterContext(ctx);
        try {

            console.writeLn("");
            console.writeLn(questionMessage);
