...
public final class CliOutputFromNormalizedNodeSerializerFactory implements FromNormalizedNodeSerializerFactory<String> {
    ...
    private CliOutputFromNormalizedNodeSerializerFactory(final OutFormatter out, final XmlCodecProvider codecProvider) {
        ...
        choiceSerializer = new ChoiceNodeCliSerializer(dispatcher);
        augmentSerializer = new AugmentationNodeCliSerializer(dispatcher);
        leafNodeSerializer = new LeafNodeCliSerializer(out, codecProvider);

        leafSetEntryNodeSerializer = new LeafSetEntryNodeCliSerializer(codecProvider);
        ...
        mapNodeSerializer = new MapNodeCliSerializer(mapEntryNodeSerializer);
    }
