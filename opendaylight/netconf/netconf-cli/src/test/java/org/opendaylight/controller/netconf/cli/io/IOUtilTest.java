...
public class IOUtilTest {
    @Test
    public void testQNameFromKeyString() throws Exception {
        final String s = IOUtil.qNameToKeyString(CommandConstants.HELP_QNAME);
        final QName qName = IOUtil.qNameFromKeyString(s);
