...
import static org.opendaylight.controller.netconf.util.xml.XmlUtil.XMLNS_ATTRIBUTE_KEY;
import static org.opendaylight.controller.netconf.util.xml.XmlUtil.XMLNS_URI;
...
public class SAX2DOM implements ContentHandler {
    ...
    public void startElement(String namespace, String localName, String qName, Attributes attrs) {
        ...
        while (iterator.hasNext()) {
            ...
            if(prefixToNamespace.getKey().isEmpty()) {
                addNamespaceAttribute(newElement, XMLNS_ATTRIBUTE_KEY, prefixToNamespace.getValue());
            } else {
                addNamespaceAttribute(newElement, COLON_JOINER.join(XMLNS_ATTRIBUTE_KEY, prefixToNamespace.getKey()), prefixToNamespace.getValue());
            }
    ...
    private void addNamespaceAttribute(final Element newElement, final String xmlnsAttributeKey, final String value) {
        final Attr attributeNS = document.createAttributeNS(XMLNS_URI, xmlnsAttributeKey);
