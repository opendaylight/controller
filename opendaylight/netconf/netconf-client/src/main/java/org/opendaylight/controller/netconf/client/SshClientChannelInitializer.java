...
import org.opendaylight.controller.netconf.nettyutil.handler.ssh.client.MinaSshHandler;
...
final class SshClientChannelInitializer extends AbstractChannelInitializer<NetconfClientSession> {
    ...
    public void initialize(final Channel ch, final Promise<NetconfClientSession> promise) {
        try {
            ch.pipeline().addFirst(MinaSshHandler.createForNetconfSubsystem(authenticationHandler));
