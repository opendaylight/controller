 ...
 */
public class NetconfClientNotifySessionListener extends NetconfClientSessionListener {
    /*
    ...
    /**
     * Method intended to customize notification processing. Default behaviour is publish message to SAL.
     *
     * @param session {@see NetconfClientSessionListener#onMessage(NetconfClientSession, NetconfMessage)}
     * @param message {@see NetconfClientSessionListener#onMessage(NetconfClientSession, NetconfMessage)}
     */
    ...
    private boolean isNotification(NetconfMessage message) {
        XmlElement xmle = XmlElement.fromDomElement(message.getDocument().getDocumentElement());
