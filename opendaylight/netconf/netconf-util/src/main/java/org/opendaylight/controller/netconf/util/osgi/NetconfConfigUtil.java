...
public class NetconfConfigUtil {
    ...
    private static final String PRIVATE_KEY_PROP = ".pk";
    ...
    public static String getPrivateKey(BundleContext context){
        return getPropertyValue(context,PREFIX_PROP + InfixProp.ssh +PRIVATE_KEY_PROP);
    }
