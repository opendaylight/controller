...
public class RestPerfClient {
    ...
    private static final String dest = "http://{HOST}:{PORT}/restconf/config/opendaylight-inventory:nodes/node/{DEVICE_PORT}-sim-device/yang-ext:mount/cisco-vpp:vpp/bridge-domains";
