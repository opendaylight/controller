...
public class NetconfITSecureTestTool
{
    ...
    private String xmlFile = "netconfMessages/getConfig.xml";
    ...
    public void testSecureStress() throws Exception {
        ...
        try (TestingNetconfClient netconfClient = new TestingNetconfClient("testing-ssh-client", dispatch, NetconfITSecureTest.getClientConfiguration(sessionListener, TLS_ADDRESS));)
        {
            ...
            for (int i = 0; i < requests; i++) {
                ...
                Runnable worker = new NetconfITSecureSTestToolRunnable(getConfig,i, sessionListener, futures, responseCounter);
    ...
    class NetconfITSecureSTestToolRunnable implements Runnable {
        ...
        public NetconfITSecureSTestToolRunnable(NetconfMessage getConfig, int it, NetconfDeviceCommunicator sessionListener, List<ListenableFuture<RpcResult<NetconfMessage>>> futures, AtomicInteger responseCounter){
