...
public class NetconfITSecureTest extends AbstractConfigTest {
    ...
    private NetconfServerDispatcher createDispatcher(Optional<SSLContext> sslC,
        ...
        NetconfServerDispatcher.ServerChannelInitializer serverChannelInitializer = new NetconfServerDispatcher.ServerChannelInitializer(sslC, serverNegotiatorFactory, listenerFactory);
