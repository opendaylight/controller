...
final class MonitoringSession {
    ...
    public String getSourceHost() {
        return extractIp(managementSession.getSourceHost().getDomainName().getValue());
    }

    private static final Pattern ipPortpattern = Pattern.compile("/([^:/]*):(.*)");
    private String extractIp(String value) {
        // TODO remote IP needs to be acquired from Ssh proxy
        Matcher matcher = ipPortpattern.matcher(value);
