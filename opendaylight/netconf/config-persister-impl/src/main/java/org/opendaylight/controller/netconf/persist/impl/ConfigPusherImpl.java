...
public class ConfigPusherImpl implements ConfigPusher {
    ...
    private final BlockingQueue<List<? extends ConfigSnapshotHolder>> queue = new LinkedBlockingQueue<List<? extends ConfigSnapshotHolder>>(QUEUE_SIZE);
        ...
        for (ConfigSnapshotHolder configSnapshotHolder : configs) {
            if(configSnapshotHolder != null) {
                ...
                try {
                    ...
                    throw new IllegalStateException("Failed to apply configuration snapshot " + configSnapshotHolder, e);
                }
