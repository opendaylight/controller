...
public class ConfigPusher {
    ...
    private static NetconfMessage getResponse(NetconfMessage request, NetconfClient netconfClient) {
        ...
        try {
            ...
            logger.error("Error while sending message to netconf client, total time spent {} ms", diffMillis);
            logger.debug("Error while sending message {} to {}", request, netconfClient);
            throw e;
        }
    }
