...
final class YangStoreSnapshot implements YangStoreContext, EnumResolver {
    ...
    public String toYang(final String enumClass, final String enumJavaValue) {
        ...
        return Preconditions.checkNotNull(javaName, "Unable to map enum value %s for enum class %s with assumed enum mapping: %s", enumJavaValue, enumClass, enumMapping.inverse());
    }
}
