...
public class DefaultStartExi extends AbstractNetconfOperation implements DefaultNetconfOperation {
    ...
    protected Element handle(Document document, XmlElement operationElement,
        ...
        try {
            ...
            netconfSession.addFirst(ExiDecoderHandler.HANDLER_NAME, new ExiDecoderHandler(exiParams));
            netconfSession.addAfterMessageSend(ExiEncoderHandler.HANDLER_NAME,null,new ExiEncoderHandler(exiParams));
            netconfSession.remove(NetconfMessageAggregator.class);
