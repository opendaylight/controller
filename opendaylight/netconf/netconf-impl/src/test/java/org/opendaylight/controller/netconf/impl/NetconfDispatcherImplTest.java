...
public class NetconfDispatcherImplTest {
    ...
    public void test() throws Exception {
        ...
        NetconfServerDispatcher.ServerChannelInitializer serverChannelInitializer = new NetconfServerDispatcher.ServerChannelInitializer(Optional.<SSLContext>absent(), serverNegotiatorFactory, listenerFactory);
