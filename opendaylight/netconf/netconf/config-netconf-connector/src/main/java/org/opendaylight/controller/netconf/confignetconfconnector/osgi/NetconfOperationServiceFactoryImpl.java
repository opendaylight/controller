...
public class NetconfOperationServiceFactoryImpl implements NetconfOperationServiceFactory {
    ...
    public Set<Capability> getCapabilities() {
        return NetconfMonitoringServiceImpl.setupCapabilities(Sets.newHashSet(
                NetconfNotificationManager.transformModulesToCapabilities(yangStoreService.getModules())));
    }

    @Override
    public AutoCloseable registerCapabilityListener(final CapabilityListener listener) {
        return yangStoreService.registerModuleListener(new ModuleListener() {
            @Override
