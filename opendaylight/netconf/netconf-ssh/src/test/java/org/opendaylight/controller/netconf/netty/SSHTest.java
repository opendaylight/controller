...
public class SSHTest {
    ...
    public void test() throws Exception {
        ...
        final InetSocketAddress addr = InetSocketAddress.createUnresolved("127.0.0.1", 10831);
        final SshProxyServer server = new SshProxyServer(addr, NetconfConfigUtil.getNetconfLocalAddress(),
        ...
        final EchoClientHandler echoClientHandler = connectClient(new InetSocketAddress("localhost", 10831));
