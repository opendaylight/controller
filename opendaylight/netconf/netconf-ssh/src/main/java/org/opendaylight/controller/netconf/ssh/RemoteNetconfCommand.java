...
public class RemoteNetconfCommand implements AsyncCommand, SessionAware {
    ...
    public RemoteNetconfCommand(final Bootstrap clientBootstrap, final LocalAddress localAddress) {
    ...
    public static class NetconfCommandFactory implements NamedFactory<Command> {
        ...
        public NetconfCommandFactory(final Bootstrap clientBootstrap, final LocalAddress localAddress) {
