 ...
 * starts SSH Server in its own thread. Server opens socket and listen for client connections. Each client connection
 * creation is handled in separate {@link org.opendaylight.controller.netconf.ssh.threads.SocketThread} thread.
