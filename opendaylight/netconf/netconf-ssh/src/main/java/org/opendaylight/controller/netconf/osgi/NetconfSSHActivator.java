 ...
 * starts SSH Server. Server opens socket and listen for client connections. Each client connection creation is handled
 * in separate {@link org.opendaylight.controller.netconf.ssh.threads.SocketThread} thread. This thread creates two
 * additional threads {@link org.opendaylight.controller.netconf.ssh.threads.IOThread} forwarding data from/to client.
 * IOThread closes servers session and server connection when it gets -1 on input stream.
