...
public enum NodeAccessPermission {
	...
	/*
	 * This option could be used to retrieve the cluster-members who 
	 * have rights only to read the Node state but are not eligible
	 * for modifying the state of Node 
	 */
	READONLY_ACCESS,
	
	/*
	 * This option could be used to retrieve the cluster-members who
	 * have rights to read and modify the state of Node
	 */
	READWRITE_ACCESS
