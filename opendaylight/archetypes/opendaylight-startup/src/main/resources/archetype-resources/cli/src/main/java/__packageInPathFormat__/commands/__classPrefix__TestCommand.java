...
public class ${classPrefix}TestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(${classPrefix}TestCommand.class);
    protected final ${classPrefix}Commands service;

    public ${classPrefix}TestCommand(final ${classPrefix}Commands service) {
