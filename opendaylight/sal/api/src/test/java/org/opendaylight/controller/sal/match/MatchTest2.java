...
public class MatchTest2 {
    ...
    public void testMatchCreation() {
        ...
        MatchField2 field = new InPort(port);

        Assert.assertTrue(field != null);
        Assert.assertTrue(field.getType() == InPort.TYPE);
    ...
    public void testMatchSetGet() {
        ...
        Assert.assertTrue(((NodeConnector) x.getField(InPort.TYPE).getValue()).equals(inPort));
    ...
    public void testMatchSetGetNWAddr() throws UnknownHostException {
        ...
        Assert.assertTrue(ip.equals(((InetAddress) x.getField(NwSrc.TYPE).getValue()).getHostAddress()));
        Assert.assertTrue(x.getField(NwSrc.TYPE).getMask().equals(mask));
    }
    ...
    public void testMatchSetGetEtherType() throws UnknownHostException {
        ...
        Assert.assertTrue(((Short) x.getField(DlType.TYPE).getValue()).equals(EtherTypes.QINQ.shortValue()));
        Assert.assertFalse(x.getField(DlType.TYPE).getValue() == EtherTypes.QINQ);
        Assert.assertFalse(x.getField(DlType.TYPE).getValue().equals(EtherTypes.QINQ));

        x.setField(new DlType(EtherTypes.LLDP.shortValue()));
        Assert.assertTrue(((Short) x.getField(DlType.TYPE).getValue()).equals(EtherTypes.LLDP.shortValue()));
    ...
    public void testSetGetNwProto() {
        ...
        Object o = x.getField(NwProtocol.TYPE).getValue();
    ...
    public void testHashCode() throws Exception {
        ...
        MatchField2 field1 = new DlSrc(srcMac1);
        MatchField2 field2 = new DlSrc(srcMac2);
        ...
        MatchField2 field3 = new DlDst(dstMac1);
        MatchField2 field4 = new DlDst(dstMac2);
        ...
        MatchField2 field5 = new DlType(ethertype);
        MatchField2 field6 = new DlType(ethertype2);
        ...
        MatchField2 field7 = new NwSrc(srcIP1, ipMask1);
        MatchField2 field8 = new NwSrc(srcIP2, ipMask2);
    ...
    public void testCloning() throws Exception {
        ...
        Assert.assertFalse(match.getField(DlSrc.TYPE) == cloned.getField(DlSrc.TYPE));
        Assert.assertFalse(match.getField(NwDst.TYPE) == cloned.getField(NwDst.TYPE));
        Assert.assertTrue(match.getField(NwDst.TYPE).getMask()
                .equals(cloned.getField(NwDst.TYPE).getMask()));
    ...
    public void testFlip() throws Exception {
        ...
        Match2 flipflip = flipped.reverse().reverse();
    ...
    public void testVlanNone() throws Exception {
        ...
        short vlan = (short) 0;
        MatchField2 field = new DlVlan(vlan);
    ...
    public void testIntersection() throws UnknownHostException {
        ...
        Match2 i = m1.getIntersection(m2);
        ...
        Match2 ii = m3.getIntersection(m4);
        ...
        Match2 i2 = m4.getIntersection(m3);
