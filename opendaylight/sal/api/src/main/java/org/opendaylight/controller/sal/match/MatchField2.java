...
public abstract class MatchField2<T> implements Cloneable, Serializable {
     ...
     */
    public abstract MatchField2<T> getReverse();
    ...
    @Override
    public abstract MatchField2<T> clone();
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MatchField2)) {
            return false;
        }
        MatchField2<?> other = (MatchField2<?>) obj;
        if (type == null) {
            if (other.type != null) {
                return false;
            }
