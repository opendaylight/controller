...
public class NodeFlowRTO {
    @XmlElement
    private FlowRTO flow; // Flow descriptor
    @XmlElement
    ...
    public NodeFlowRTO(FlowRTO flow) {
        this.flow = flow;
    }
    ...
    public String toString() {
        return "NodeFlowRTO[flow =" + flow + ", tableId = " + tableId
