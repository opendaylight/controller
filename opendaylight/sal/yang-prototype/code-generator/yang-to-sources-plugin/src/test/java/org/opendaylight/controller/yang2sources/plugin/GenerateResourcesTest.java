...
import org.opendaylight.controller.yang2sources.spi.ResourceProvider;
...
public class GenerateResourcesTest {
    ...
    public static class ProviderMock implements ResourceProvider {

        private static int called = 0;
        private static File baseDir;

        @Override
        public void provideResourceFiles(Collection<File> resources,
                File outputDir) {
            called++;
            baseDir = outputDir;
        }
    ...
    public static class ProviderMock2 implements ResourceProvider {
