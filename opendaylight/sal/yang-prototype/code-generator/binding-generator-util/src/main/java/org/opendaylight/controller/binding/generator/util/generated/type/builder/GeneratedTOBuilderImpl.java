...
import org.opendaylight.controller.sal.binding.model.api.GeneratedTransferObject.YangType;
...
public final class GeneratedTOBuilderImpl extends AbstractGeneratedTypeBuilder implements GeneratedTOBuilder {
    ...
    private YangType yangType = YangType.unspecified;
    ...
    public GeneratedTransferObject toInstance() {
        return new GeneratedTransferObjectImpl(null, getPackageName(), getName(), getComment(), getAnnotations(),
                ...
                hashProperties, toStringProperties, yangType);
    }
    ...
    @Override
    public void setYangType(YangType yangType) {
    ...
    private static final class GeneratedTransferObjectImpl extends AbstractGeneratedType implements
        ...
        private final YangType yangType;
        ...
        GeneratedTransferObjectImpl(final Type parent, final String packageName, final String name,
                ...
                final List<GeneratedPropertyBuilder> stringBuilders, final YangType yangType) {
        ...
        @Override
        public YangType getOriginYangType() {
            return yangType;
        }
