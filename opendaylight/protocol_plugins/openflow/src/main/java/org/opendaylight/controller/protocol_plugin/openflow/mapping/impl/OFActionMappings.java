...
import org.opendaylight.controller.sal.utils.NetUtilsTest;
...
public class OFActionMappings {
    ...
    public Class<OFActionOutput> getOfClass(){ return OFActionOutput.class; }
    ...
    public Class<OFActionVirtualLanIdentifier> getOfClass(){ return OFActionVirtualLanIdentifier.class; }

		public Action salFromOpenflow(OFAction ofAction, Node flowNode) {
			Action salAction = null;
    ...
    public Class<OFActionStripVirtualLan> getOfClass(){ return OFActionStripVirtualLan.class; }
    ...
    public Class<OFActionVirtualLanPriorityCodePoint> getOfClass(){ return OFActionVirtualLanPriorityCodePoint.class; }
    ...
    public Class<OFActionDataLayerSource> getOfClass(){ return OFActionDataLayerSource.class; }
    ...
    public Class<OFActionDataLayerDestination> getOfClass(){ return OFActionDataLayerDestination.class; }
    ...
    public Class<OFActionNetworkLayerSource> getOfClass(){ return OFActionNetworkLayerSource.class; }

		public Action salFromOpenflow(OFAction ofAction, Node flowNode) {
			Action salAction = null;
			byte addr[] = BigInteger
					.valueOf(
    ...
    public Class<OFActionNetworkLayerDestination> getOfClass(){ return OFActionNetworkLayerDestination.class; }
    ...
    public Class<OFActionNetworkTypeOfService> getOfClass(){ return OFActionNetworkTypeOfService.class; }
    ...
    public Class<OFActionTransportLayerSource> getOfClass(){ return OFActionTransportLayerSource.class; }
    ...
    public Class<OFActionTransportLayerDestination> getOfClass(){ return OFActionTransportLayerDestination.class; }
