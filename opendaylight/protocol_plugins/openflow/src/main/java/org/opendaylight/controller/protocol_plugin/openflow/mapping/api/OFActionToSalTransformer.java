 ...
 * 
 * @param <T>
 *            {@link OFAction} subclass for which mapper provides translation
 *            facilities.
 */
public interface OFActionToSalTransformer<T extends OFAction> {
    ...
    /**
     * Translates {@link OFAction} into {@link Action} in the context of
     * specified {@link Node}.
     * 
