...
@Command(scope = "controller", name = "showConnConfig", description="show conn config")
public class ControllerShowConnConfig extends OsgiCommandSupport{
    private IControllerShell controller;

    @Override
    protected Object doExecute() throws Exception {
        for(String p : controller.controllerShowConnConfig()) {
