 ...
 */
package org.opendaylight.controller.websocket.client;
...
public class WebSocketIClient  {
    ...
    private static final Logger logger = LoggerFactory.getLogger(WebSocketIClient.class.toString());
    private Channel clientChannel;
    private final EventLoopGroup group = new NioEventLoopGroup();


    public WebSocketIClient(URI uri,IClientMessageCallback clientMessageCallback) {
        this.uri = uri;
