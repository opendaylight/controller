...
public class FRMUtil {
	...
	public static boolean validateActions (List<org.opendaylight.yang.gen.v1.urn.opendaylight.action.types.rev131112.action.list.Action> actions)
	{
		...
		for (org.opendaylight.yang.gen.v1.urn.opendaylight.action.types.rev131112.action.list.Action curaction : actions)
		{
	...
	public static boolean validateInstructions(NodeFlow flow)
	{
		...
		for (org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.instruction.list.Instruction instruction : instructionsList) {
			...
			if (curInstruction instanceof GoToTable) {
				...
				List<org.opendaylight.yang.gen.v1.urn.opendaylight.action.types.rev131112.action.list.Action> action = ((WriteActions) curInstruction).getAction();
				validateActions(action);

			}

			else if (curInstruction instanceof ApplyActions) {
				List<org.opendaylight.yang.gen.v1.urn.opendaylight.action.types.rev131112.action.list.Action> action = ((ApplyActions) curInstruction).getAction();
				validateActions(action);
			}

			else if (curInstruction instanceof ClearActions) {
				List<org.opendaylight.yang.gen.v1.urn.opendaylight.action.types.rev131112.action.list.Action> action = ((ClearActions) curInstruction).getAction();
				validateActions(action);
			}
