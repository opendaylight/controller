...
public class UmAddUser extends OsgiCommandSupport{
    ...
    @Argument(index = 0, name = "arg1", description = "The second argument passed to the addUser command", required = false, multiValued = false)
    String arg1 = null;

    @Argument(index = 0, name = "arg2", description = "The third argument passed to the addUser command", required = false, multiValued = false)
    String arg2 = null;

    @Argument(index = 0, name = "arg3", description = "The third argument passed to the addUser command", required = false, multiValued = false)
    String arg3 = null;
