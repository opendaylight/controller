...
@Command(scope = "usermanager", name = "addUser", description="Adds a user to the usermanagerr")
public class UmAddUser extends OsgiCommandSupport{
    ...
    @Argument(index = 1, name = "arg1", description = "The second argument passed to the addUser command", required = false, multiValued = false)
    String arg1 = null;

    @Argument(index = 2, name = "arg2", description = "The third argument passed to the addUser command", required = false, multiValued = false)
    String arg2 = null;

    @Argument(index = 3, name = "arg3", description = "The third argument passed to the addUser command", required = false, multiValued = false)
    String arg3 = null;
