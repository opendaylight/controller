...
from controller_testlib import excepts
from controller_testlib.infra import shell, wait_for_string_in_file
...
def fail_if_exception_found_during_test(step_name: str):
    ...
    It checks the log messages for concrete step. Relies on the
    "ROBOT MESSAGE: Starting step: ..." marker written to karaf.log by
    log_message_to_karaf (via fixtures.allure_step_with_separate_logging or
    fixtures.log_test_case_start_end_to_karaf) for the given step.
