...
def allure_step_with_separate_logging(
    ...
    This fixture extends standard allure_step context manager with functionality
    ...
    def _log_step(title: str) -> Generator[any, None, None]:
        ...
        tox_ini_log_format = request.config.getini("log_format")
        formatter = logging.Formatter(tox_ini_log_format)
