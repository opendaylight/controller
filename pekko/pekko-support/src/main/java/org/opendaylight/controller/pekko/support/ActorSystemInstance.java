...
import org.opendaylight.controller.pekko.support.impl.AbstractActorSystemInstance;
...
public sealed interface ActorSystemInstance {
     ...
     */
    sealed interface WithShutdown extends ActorSystemInstance, AutoCloseable permits AbstractActorSystemInstance {
        /**
         ...
         */
        void shutdownAndWait(Duration atMost) throws InterruptedException, TimeoutException;
