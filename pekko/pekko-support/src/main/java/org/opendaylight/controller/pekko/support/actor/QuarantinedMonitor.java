...
public final class QuarantinedMonitor extends UntypedAbstractActor {
    ...
    private final ActorSystemCreator.Callbacks callbacks;

    private boolean quarantined;
    private int count = 0;

    QuarantinedMonitor(final ActorSystemCreator.Callbacks callbacks) {
    ...
    public static Props props(final ActorSystemCreator.Callbacks callbacks) {
